---
title: Office2SharePoint for Office のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/16/2021
...
description: Office2SharePoint for Office、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
---
# <a name="application-information-for-office2sharepoint-for-office-by-iglobe"></a>iGlobe による Office2SharePoint for Office のアプリケーション情報

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>開発者が最終更新日: 2021 年 8 月 16 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381787" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Office2SharePoint for Office |
| ID | WA104381787 |
| サポートされているOffice 365 クライアント | Mac のExcel 2016以降、Windows、Excel on the web、Word 2016 以降、mac、Word on the web、Word 2016 以降のWindowsでExcel 2016以降、mac、PowerPoint on the web、PowerPoint 2016 以降のWindowsでPowerPoint 2016以降 |
| パートナー会社名 | iGlobe |
| 会社の Web サイト | [https://www.iglobecrm.com](https://www.iglobecrm.com) |
| アプリの使用条件 | [https://www.iglobecrm.com/content/end-user-license-agreemen...](https://www.iglobecrm.com/content/end-user-license-agreement-office2sharepoint) |
| アプリのコア機能 | Office2SharePoint - OutlookからSharePointとTeamsを操作し、簡単な方法でOfficeします。 チーム メンバー間のコミュニケーションの障壁を打破し、ドキュメントと電子メールの添付ファイルをSharePoint Teams &amp; のすべてのユーザーがアクセスできるようにします。 電子メールとメールの添付ファイルをOutlookから任意のデバイスおよびプラットフォーム上のSharePointまたはTeamsに直接保存します。 Office2SharePoint アプリ サービスのアクセス許可レベルは、Outlook アドインと Office アドインの両方に設定されます。 |
| 会社の本社の場所 | デンマーク |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | 委任 | アプリケーション データベースにはデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Directory.Read.All | 委任 | アプリケーション データベースにはデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Directory.ReadWrite.All | 委任 | アプリケーション データベースにはデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Group.Read.All | 委任 | アプリケーション データベースにはデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Group.ReadWrite.All | 委任 | アプリケーション データベースにはデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Mail.ReadWrite | 委任 | アプリケーション データベースにはデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Sites.Manage.All | 委任 | アプリケーション データベースにはデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Sites.Read.All | 委任 | アプリケーション データベースにはデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| Sites.ReadWrite.All | 委任 | アプリケーション データベースにはデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
>| User.Read | 委任 | アプリケーション データベースにはデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
