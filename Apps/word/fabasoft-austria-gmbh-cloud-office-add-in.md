...
description: Fabasoft Cloud Office アドイン、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63541205"
---
# <a name="fabasoft-cloud-office-add-in"></a>Fabasoft Cloud Office アドイン
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Fabasoft Cloud Office アドイン |
| ID | WA200002917 |
