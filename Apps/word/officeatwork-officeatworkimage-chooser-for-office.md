---
title: Officeatwork |の Word アプリケーション情報Officeatwork 別のOffice用イメージ 選択子
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: officeatwork |で使用可能なすべてのセキュリティ情報とコンプライアンス情報Office用の Image Chooser、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64784396"
---
# <a name="word--officeatwork--image-chooser-for-office"></a>Word |officeatwork |Office用のイメージ選択子
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | officeatwork \| Image Chooser for Office |
| ID | WA200002683 |
