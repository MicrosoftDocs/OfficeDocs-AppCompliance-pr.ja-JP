...
| アプリの利用規約 | [https://appsource.microsoft.com](https://appsource.microsoft.com) |
| アプリのコア機能 | AuditBoard サブスクライバーが AB のナラティブの編集中に、AB サイトへのリンク データ &amp; を埋め込むのを有効にできます。  |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
