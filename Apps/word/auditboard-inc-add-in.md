...
description: AuditBoard アドインで利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリのコア機能 | AuditBoard サブスクライバーが AB のナラティブの &amp; 編集中に、AB サイトへのリンク データを埋め込むのを有効にできます。  |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
