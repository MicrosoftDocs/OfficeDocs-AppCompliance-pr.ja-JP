...
description: CrossCheck で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64881203"
---
# <a name="crosscheck"></a>CrossCheck

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 8 月 24 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003198" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

kRevealLLC から Microsoft に提供される情報:
...
| パートナー会社名 | kRevealLLC |
| 会社の Web サイト | [https://kreveal.com](https://kreveal.com) |
| アプリの使用条件 | [https://crosscheck.krevealaddins.com/docs/license.htm](https://crosscheck.krevealaddins.com/docs/license.htm) |
| アプリのコア機能 | CrossCheck は、ドキュメントのレビューを効率化し、一般的な下書きミスを特定します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://admin.krevealaddins.com/help](https://admin.krevealaddins.com/help) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する kRevealLLC によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | アプリケーション | データは収集または使用されません。 | [5edad654-f2d5-41d8-bfc0-92c2735252e1](../azure/5edad654-f2d5-41d8-bfc0-92c2735252e1.md) |
