...
description: LegalMind Word AddIn、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200002192" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

LegalMind から Microsoft に提供される情報:
...
| アプリの使用条件 | [https://www.legalmind.cn](https://www.legalmind.cn) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、LegalMind によって提供されています。
