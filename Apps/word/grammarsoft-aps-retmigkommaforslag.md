---
title: RetMig &amp; Kommaforslag by GrammarSoft ApS のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: RetMig Kommaforslag &amp; の使用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA104382003" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

GrammarSoft ApS から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | RetMig &amp; Kommaforslag |
| ID | WA104382003 |
| サポートされているOffice 365 クライアント | Mac のWord 2016以降、Windows、Word on the webでWord 2016以降 |
| パートナー会社名 | GrammarSoft ApS |
| 会社の Web サイト | [https://retmig.dk](https://retmig.dk) |
| アプリの使用条件 | [https://retmig.dk/terms](https://retmig.dk/terms) |
| アプリのコア機能 | RetMig er en avanceret stave- og grammatikkontrol for dansk, mens Kommaforslag retter kommafejj. |
| 会社の本社の場所 | デンマーク |
| アプリ情報ページ | [https://retmig.dk](https://retmig.dk) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、GrammarSoft ApS から提供されています。
