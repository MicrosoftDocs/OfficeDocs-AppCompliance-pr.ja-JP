---
title: ValidSign by ValidSign のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: ValidSign に使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200001890" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ValidSign から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | ValidSign |
| ID | WA200001890 |
| サポートされているOffice 365 クライアント | Mac、Word on the web、Word 2013 以降の Windows でのWord 2016以降 |
| パートナー会社名 | ValidSign |
| 会社の Web サイト | [https://www.validsign.eu](https://www.validsign.eu) |
| アプリの使用条件 | [https://www.validsign.eu/word-license-terms/](https://www.validsign.eu/word-license-terms/) |
| アプリのコア機能 | ValidSign Word アドインを使用して、よりスマートで効率的に作業する |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | [https://www.validsign.eu/connectors/word/](https://www.validsign.eu/connectors/word/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて ValidSign から提供されています。
...
| プライバシー ポリシーの URL | https://www.validsign.eu/validsign-privacy-statement/ |
