...
description: SmartCite for Papers、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.papersapp.com/terms](https://www.papersapp.com/terms) |
| アプリのコア機能 | ReadCube Papers ライブラリから参照を引用し、書誌を自動的に生成します。 |
| 会社の本社所在地 | アメリカ |
