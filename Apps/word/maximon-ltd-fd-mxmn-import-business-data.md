---
title: FD Mxmn のアプリケーション情報 - Maximon Ltd によってビジネス データをインポートします。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: FD Mxmn で使用可能なすべてのセキュリティ情報とコンプライアンス情報 - ビジネス データ、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報をインポートします。
...
---
# <a name="fd-mxmn---import-business-data"></a>FD Mxmn - ビジネス データをインポートする

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 3 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004151" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Maximon Ltd. から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | FD Mxmn - ビジネス データをインポートする |
| ID | WA200004151 |
| サポートされている Office 365 クライアント | Word 2016 以降の Mac、Word on the web、Word 2013 以降の Windows |
| パートナー会社名 | Maximon Ltd. |
| 会社の Web サイト | [https://www.maximon.ltd/fdmxmn/](https://www.maximon.ltd/fdmxmn/) |
| アプリの使用条件 | [https://www.maximon.ltd/legal_tou.php](https://www.maximon.ltd/legal_tou.php) |
| アプリのコア機能 | ACRA BizFile の抽出から直接企業データをインポートすることで、法的な起草を効率化します。 |
| 会社の本社の場所 | 米国 |
| アプリ情報ページ | |
...
この情報は Maximon Ltd から提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について説明します。
...
| プライバシー ポリシーの URL | https://www.maximon.ltd/legal_privacy.php |
...
| Microsoft ID プラットフォーム統合チェックリストに記載されているすべての適用可能なベスト プラクティスを確認し、準拠していますか? | いいえ |
