---
title: Loio Inc. による Loio Contract Review Software のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Loio Contract Review Software で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64875244"
---
# <a name="loio-contract-review-software"></a>Loio コントラクト レビュー ソフトウェア

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 6 月 24 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002273" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Loio コントラクト レビュー ソフトウェア |
| ID | WA200002273 |
| サポートされているOffice 365 クライアント | mac、Word on the web、Word 2013 以降のWindowsでWord 2016以降 |
| パートナー会社名 | Loio Inc. |
| 会社の Web サイト | [https://loio.com](https://loio.com) |
| アプリの使用条件 | [https://loio.com/terms-of-use/](https://loio.com/terms-of-use/) |
| アプリのコア機能 | &amp; Loio Contract Assistant を使用して、コントラクトをより迅速かつ正確に分析します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://loio.com](https://loio.com) |
...
この情報は Loio Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
