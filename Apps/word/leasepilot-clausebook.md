---
title: LeasePilot による Clausebook のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Clausebook で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200004044" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

LeasePilot から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | Clausebook |
| ID | WA200004044 |
| サポートされているOffice 365 クライアント | Mac、Word on the web、Word 2016以降の Windows でのWord 2016以降 |
| パートナー会社名 | LeasePilot |
| 会社の Web サイト | [https://clausebook.com](https://clausebook.com) |
| アプリの使用条件 | [https://clausebook.com/terms](https://clausebook.com/terms) |
| アプリのコア機能 | Clausebook はドキュメントの下書きコンパニオンです。 チームは、組織のプラクティスを迅速に作成し、組織化するために、フォームライブラリと句ライブラリをキャプチャ、整理、下書き、共有するのに役立ちます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Paas |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | その他、Vercel |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、LeasePilot によって提供されています。
