---
title: Taxy.io GmbH による TaxKit Docs のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: TaxKit Docs で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200002849" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Taxy.io GmbH から Microsoft に提供される情報:
...
| パートナー会社名 | Taxy.io GmbH |
| 会社の Web サイト | [https://www.taxy.io](https://www.taxy.io) |
| アプリの使用条件 | [https://go.microsoft.com](https://go.microsoft.com) |
| アプリのコア機能 | TaxKit Docs を使用すると、税務アドバイザーは、作業中のドキュメントとケースに関連する法的文献を見つけることができます。 これにより、クライアントに対するより効果的なアドバイスが得られるようになります。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | |
...
この情報は、Taxy.io GmbH によって、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
