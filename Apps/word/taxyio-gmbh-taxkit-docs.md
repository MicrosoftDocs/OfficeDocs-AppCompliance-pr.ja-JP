---
title: TaxKit Docs のアプリケーション情報 (GmbH Taxy.io)
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
* <a href="https://appsource.microsoft.com/product/office/WA200002849" target="_blank">AppSource での表示</a>
...
| アプリのコア機能 | TaxKit Docs は、税理士がドキュメントとケースに関連する法的文献を見つけるのに役立ちます。 これは、クライアントに対してより効果的にアドバイスするのに役立ちます。 |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | |
...
この情報は、Taxy.io GmbH によって、このアプリが組織データを収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールについて提供されています。
