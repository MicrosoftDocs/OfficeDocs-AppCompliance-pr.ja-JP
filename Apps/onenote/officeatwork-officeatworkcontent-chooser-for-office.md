---
title: officeatwork |officeatwork Officeコンテンツの選択
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: officeatwork サービスで使用可能なすべてのセキュリティおよびコンプライアンス情報|CSA STAR レジストリOffice、データ処理ポリシー、アプリ カタログMicrosoft Cloud App Security情報、セキュリティ/コンプライアンス情報のコンテンツ選択機能。
...
| ID | WA104380602 |
| Office 365サポートされているクライアント | Excel iPad、Excel 2016 以降の Mac、Excel 2013 Service Pack 1 以降の Windows、Excel on the web、Word on iPad、Word 2016 以降の Mac、Word on the web、Windows の Windows、PowerPoint、iPad、PowerPoint 2016 以降の Mac、PowerPoint on the web、PowerPoint 2013 Service Pack 1 以降の Word 2013 Service Pack 1 以降、OneNote on the web |
...
>| Sites.Read.All | 委任 | データベースに保存されているユーザー テンプレート ファイルを読み取SharePoint | [edb24f8f-38af-4b3e-9475-0da243678d5a](../azure/edb24f8f-38af-4b3e-9475-0da243678d5a.md) |
