---
title: officeatwork |のアプリケーション情報をOneNoteするOfficeatwork 別のOffice用イメージ 選択子
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: OneNoteは、セキュリティ、コンプライアンス、およびデータ処理のプラクティスに関する業界標準と制御に対して Microsoft によってレビューされています。 officeatwork |で使用可能なすべてのセキュリティ情報とコンプライアンス情報Office用の Image Chooser、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64784336"
---
# <a name="onenote--officeatwork--image-chooser-for-office"></a>officeatwork |をOneNote |するOffice用のイメージ選択子
