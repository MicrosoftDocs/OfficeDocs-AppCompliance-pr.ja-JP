...
**Post Publisher構成証明の承認: 発行元の証明されたアプリの AppSource のリンクの例**
...
![提出をレビューするアナリスト](../media/UserGuidePhotos/17.png)
...
- アプリを区別するために、AppSource、Teamsストア、Officeストア、その他のストアフロントで認定バッジを維持します。 
- 認定アプリの使用に関する顧客の信頼を高める。 
- IT 管理者が、更新された認定情報で情報に基づいた意思決定を行う際に役立ちます。 

パートナー センターでは、シームレスなエクスペリエンス [を提供](https://partner.microsoft.com/dashboard/home) するために、更新プロセスを利用できます。 有効期限の 90 日前からパートナー センターに更新通知が表示されます。 定期的なリマインダーは、有効期限の 90 日前、60 日前、30 日前に電子メールで送信されます。
...
![認定更新](../media/UserGuidePhotos/32.png)
