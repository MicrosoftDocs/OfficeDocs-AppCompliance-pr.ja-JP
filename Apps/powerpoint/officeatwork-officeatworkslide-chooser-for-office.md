...
description: officeatwork サービスで使用可能なすべてのセキュリティおよびコンプライアンス情報|スライドの選択Office、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報です。
...
| ID | WA200002582 |
| Office 365サポートされているクライアント | PowerPoint 2016の Mac、PowerPoint on the web、PowerPoint 2016以降のWindows |
...
>| Sites.Read.All | 委任 | データベースに保存されているユーザー テンプレート ファイルを読み取SharePoint | [3f2fa737-e376-4c4d-a49d-b8eb08ca7e8d](../azure/3f2fa737-e376-4c4d-a49d-b8eb08ca7e8d.md) |
...
>| offline_access | 委任 | 古いホストの自動サインインをOfficeする | [3f2fa737-e376-4c4d-a49d-b8eb08ca7e8d](../azure/3f2fa737-e376-4c4d-a49d-b8eb08ca7e8d.md) |
