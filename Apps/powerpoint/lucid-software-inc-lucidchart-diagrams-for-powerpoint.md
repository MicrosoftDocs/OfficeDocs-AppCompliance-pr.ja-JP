...
ms.locfileid: "52095793"
---
# <a name="lucidchart-diagrams-for-powerpoint"></a>Lucidchart ダイアグラム for PowerPoint

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2019 年 12 月 16 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380117" target="_blank">AppSource での表示</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Lucidchart ダイアグラム for PowerPoint |
| ID | WA104380117 |
...
>| **アクセス許可**  | **説明** |
>|:----------------|:----------------|
>| ドキュメントの書き込み | ドキュメントに変更を加える、または提案できる |
