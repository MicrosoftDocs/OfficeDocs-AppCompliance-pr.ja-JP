---
title: チェリーウェアによる Showmaster (ヘルパー プラグイン) のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Showmaster (ヘルパー プラグイン)、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63545245"
---
# <a name="showmaster-helper-plugin"></a>Showmaster (ヘルパー プラグイン)

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者による最終更新日: 2021 年 12 月 8 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003676" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

チェリーウェアから Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Showmaster (ヘルパー プラグイン) |
| ID | WA200003676 |
| Office 365サポートされているクライアント | PowerPoint 2016 2013 以降の Mac、PowerPoint on the web、PowerPoint 2013 以降Windows |
| パートナー会社名 | cherryware |
| 会社の Web サイト | [https://www.cherryware.com](https://www.cherryware.com) |
| アプリの利用規約 | [https://showmaster.app/terms/](https://showmaster.app/terms/) |
| アプリのコア機能 | Showmaster は、PowerPoint、カウントダウン、音楽など、待ち時間や休憩中に、話の周りにエキサイティングなフレームを作成する便利なアドインです。 |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | [https://showmaster.app](https://showmaster.app) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関するチェリーウェアによって提供されています。
