---
title: Cherryware による Showmaster (ヘルパー プラグイン) のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: Showmaster (ヘルパー プラグイン)、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003676" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

お知り合いから Microsoft に提供される情報:
...
| アプリの使用条件 | [https://showmaster.app/terms/](https://showmaster.app/terms/) |
| アプリのコア機能 | Showmaster はPowerPointアドインであり、待ち時間中に話の周りに刺激的なフレームを作成し、見出し、カウントダウン、音楽などを使って休憩します。 |
| 会社の本社の場所 | ドイツ |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、お気に入りから提供されています。
