...
description: Showmaster (ヘルパー プラグイン)、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリのコア機能 | Showmaster は、PowerPoint、カウントダウン、音楽など、待ち時間や休憩中に話の周りにエキサイティングなフレームを作り出す、便利なアドインです。 |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | |
