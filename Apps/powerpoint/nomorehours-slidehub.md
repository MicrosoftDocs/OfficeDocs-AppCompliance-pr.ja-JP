...
| アプリの利用規約 | [https://nomorehours.com/eula](https://nomorehours.com/eula) |
| アプリのコア機能 | NoMore は、ビジネス ユーザーにPowerPointサービスとPowerPointの両方を提供し、これらのサービスの効率を向上PowerPoint。 デザイン サービスの一環として、NoMore はラフ ドラフトをクライアント対応スライドに 8 時間で変換します。 アドインは、サービスに迅速にアクセスするのに役立ちますが、ユーザーは、事前に作成されたスライド デザインや会社固有のスライド ライブラリ、および異なる生産性ツールを含む &#8220;コンサルティング ツールキット&#8221; にアクセスできます。 |
| 会社の本社所在地 | デンマーク |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | アプリケーション | メールと名前。 電子メールは、アプリケーションのユーザー名として使用されます。 電子メールを収集すると、アプリケーションの登録とログインを迅速に行うことができます。 名前は、登録イベントの場合に使用されます。 | [33ccef75-8248-44e8-88d3-24526ca9c2d3](../azure/33ccef75-8248-44e8-88d3-24526ca9c2d3.md) |
