...
description: SlideHub で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200001625" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Nomorehours から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | SlideHub |
| ID | WA200001625 |
| サポートされているOffice 365 クライアント | mac、PowerPoint on the web、PowerPoint 2013 以降のWindowsでPowerPoint 2016以降 |
| パートナー会社名 | nomorehours |
| 会社の Web サイト | [https://nomorehours.com](https://nomorehours.com) |
| アプリの使用条件 | [https://nomorehours.com/eula](https://nomorehours.com/eula) |
| アプリのコア機能 | NoMore は、ビジネス ユーザー PowerPoint設計サービスと、PowerPointでの効率向上を目的としたPowerPointアドインを提供します。 NoMore は、設計サービスの一環として、約 8 時間で粗い下書きをクライアント対応スライドに変換します。 アドインは、サービスへのアクセスを高速化するのに役立ちますが、ユーザーは事前に作成されたスライド デザインや会社固有のスライド ライブラリ、およびさまざまな生産性ツールを含む&#8220;コンサルティング ツールキット&#8221;にアクセスすることもできます。 |
| 会社の本社の場所 | デンマーク |
| アプリ情報ページ | [https://nomorehours.com](https://nomorehours.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Nomorehours によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | アプリケーション | 電子メールと名前。 電子メールは、アプリケーションのユーザー名として使用されます。 電子メールを収集すると、アプリケーションへの登録とログインの高速化に役立ちます。 この名前は、登録イベントの場合に使用されます。 | [33ccef75-8248-44e8-88d3-24526ca9c2d3](../azure/33ccef75-8248-44e8-88d3-24526ca9c2d3.md) |
