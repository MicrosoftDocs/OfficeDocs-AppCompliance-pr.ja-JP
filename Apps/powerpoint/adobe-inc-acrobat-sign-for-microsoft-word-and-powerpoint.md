---
title: Adobe Acrobat Sign for adobe Inc. Microsoft WordおよびPowerPointアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Microsoft Word および PowerPoint の Adobe Acrobat Sign、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "64602575"
---
# <a name="adobe-acrobat-sign-for-microsoft-word-and-powerpoint"></a>Adobe Acrobat Sign for Microsoft WordとPowerPoint
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Adobe Acrobat Sign for Microsoft WordとPowerPoint |
| ID | WA104381155 |
| Office 365サポートされているクライアント | Word 2016 Word on the web、Word 2013 Service Pack 1 以降の Mac、Windows PowerPoint on the web、PowerPoint 2016 以降の Mac、PowerPoint on the web、PowerPoint Service Pack 1 以降の場合Windows |
| パートナー会社名 | Adobe Inc. |
