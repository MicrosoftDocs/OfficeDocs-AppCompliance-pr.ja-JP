---
title: Flow Simulation Ltd. による Breaktime のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/04/2022
...
description: Breaktime、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "65229409"
---
# <a name="breaktime"></a>Breaktime

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 4 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001661" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Flow Simulation Ltd. から Microsoft に提供される情報:
...
| パートナー会社名 | Flow Simulation Ltd. |
| 会社の Web サイト | [https://www.flosim.com](https://www.flosim.com) |
| アプリの使用条件 | [https://www.flosim.com/breaktime/EULA.html](https://www.flosim.com/breaktime/EULA.html) |
| アプリのコア機能 | ブレークタイムなので、戻るタイミングを全員に伝える簡単な方法です。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://www.flosim.com/breaktime/Breaktime.html](https://www.flosim.com/breaktime/Breaktime.html) |
...
この情報は、Flow Simulation Ltd によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について説明しています。
