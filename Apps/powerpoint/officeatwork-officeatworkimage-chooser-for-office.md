---
title: officeatwork |のアプリケーション情報をPowerPointするOfficeatwork 別のOffice用イメージ 選択子
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: PowerPointは、セキュリティ、コンプライアンス、およびデータ処理のプラクティスに関する業界標準と制御に対して Microsoft によってレビューされています。 このページには、officeatwork |で使用可能なすべてのセキュリティとコンプライアンスの情報が一覧表示されますOffice用のイメージ選択子。
...
ms.locfileid: "64784456"
---
# <a name="image-chooser-for-office"></a>Office用のイメージ選択子
