---
title: AvePoint Inc. によるMicrosoft Office 365のポリシー &amp; インサイトのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/01/2021
...
description: Microsoft Office 365のポリシー &amp; インサイト、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "64876574"
---
# <a name="policies-amp-insights-for-microsoft-office-365"></a>Microsoft Office 365のポリシー &amp; インサイト

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>開発者が最終更新日: 2021 年 10 月 26 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/avepoint.policies-insights_mo365_byol" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Microsoft Office 365のポリシー &amp; インサイト |
...
| アプリのコア機能 | セキュリティ分析情報を取得し、自動化されたポリシーをTeams、グループ、SharePoint、OneDriveに適用する |
| 会社の本社の場所 | 米国 オブ アメリカ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.ReadWrite.All | アプリケーション |   組織のディレクトリでユーザーとグループのデータを読み取り、書き込みます。 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
...
>| Sites.FullControl.All | アプリケーション | サイト コレクションとグループ/チーム&#8217;サイトの情報を取得して更新します。 | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
...
>| User.ReadWrite.All | アプリケーション | ユーザーの設定の読み取りと書き込み | [4d69a8e1-9c38-4b33-b76f-9d59b5ae051b](../azure/4d69a8e1-9c38-4b33-b76f-9d59b5ae051b.md) |
