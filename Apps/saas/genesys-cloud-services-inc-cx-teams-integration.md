---
title: Genesys Cloud Services, Inc. による Genesys Cloud CX Teams 統合のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Genesys Cloud CX Teams Integration で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
---
# <a name="genesys-cloud-cx-teams-integration"></a>Genesys Cloud CX Teams の統合

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 17 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/genesyslabs.genesys-cloud_teams_integration" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Genesys Cloud Services, Inc から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Genesys Cloud CX Teams の統合 |
| ID | genesyslabs.genesys-cloud_teams_integration |
| パートナー会社名 | Genesys Cloud Services, Inc |
| 会社の Web サイト | [https://www.genesys.com](https://www.genesys.com) |
| アプリの使用条件 | [https://help.mypurecloud.com/articles/global-genesys-cloud-...](https://help.mypurecloud.com/articles/global-genesys-cloud-service-terms-and-conditions/) |
| アプリのコア機能 | Microsoft Teams の Genesys Cloud CX&#8482;統合 |
| 会社の本社の場所 | 米国 オブ アメリカ |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Genesys Cloud Services, Inc. から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Presence.Read.All | 両方 | 連絡先センター エージェントは、電話を転送する前に、同僚のプレゼンスを確認できる必要があります | [728ece5a-0f26-4c43-9705-cea9debe3fb5](../azure/728ece5a-0f26-4c43-9705-cea9debe3fb5.md) |
