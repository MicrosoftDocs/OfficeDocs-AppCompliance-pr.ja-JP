...
* <a href="https://appsource.microsoft.com/product/web-apps/genesyslabs.genesys-cloud_teams_integration" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ジェネシス クラウド サービス社から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | ジェネシス クラウド CX Teams統合 |
| ID | genesyslabs.genesys-cloud_teams_integration |
| パートナー会社名 | ジェネシス クラウド サービス, Inc |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、ジェネシス クラウド サービス社から提供されています。
