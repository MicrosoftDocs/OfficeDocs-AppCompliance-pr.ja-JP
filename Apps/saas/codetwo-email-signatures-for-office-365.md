...
| アプリのコア機能 | CodeTwo email Signatures for Office 365 は、電子メール クライアント デバイスから送信されたメッセージに自動電子メール署名、法的免責事項、ブランド化を追加する Azure ベースのクラウド サービス &amp; です。 これにより、ユーザー (管理者または委任されたユーザー) またはチームが、組織の電子メール署名を一Microsoft 365管理Office 365できます。 署名は、クラウド (電子メールの送信後) に追加するか、ユーザーが入力したOutlookに直接追加できます。 |
| 会社の本社所在地 | ポーランド |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザーがアプリにサインインし、アプリがサインインしているユーザーのプロファイルを読み取るのを許可します。 また、アプリはサインインしているユーザーの基本的な組織情報を読み取る機能も提供します。 | [2a93620e-4345-4e3b-9bae-0195f08aab69](https://docs.microsoft.com/microsoft-365-app-certification/azure/2a93620e-4345-4e3b-9bae-0195f08aab69) |
