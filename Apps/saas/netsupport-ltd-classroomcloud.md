---
title: NETSUPPORT ltd Classroom.cloud アプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/08/2021
...
* <a href="https://appsource.microsoft.com/product/web-apps/netsupportltd1595255396224.classroom_cloud" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

NETSUPPORT LTD から提供される情報。 Microsoft に:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Classroom.cloud |
| ID | netsupportltd1595255396224.classroom_cloud |
| パートナー会社名 | NETSUPPORT LTD. |
| 会社の Web サイト | [https://www.NetSupportSoftware.com](https://www.NetSupportSoftware.com) |
| アプリの利用規約 | [https://classroom.cloud/terms-of-service/](https://classroom.cloud/terms-of-service/) |
| アプリのコア機能 | 低コストのクラウド ベースの教室管理、教育、および学校や地区のオンラインの安全性。  |
| 会社の本社所在地 | 英国英国と北アイルランド (the) |
| アプリ情報ページ | [https://www.classroom.cloud](https://www.classroom.cloud) |
...
この情報は NETSUPPORT LTD によって提供されています。 このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて。
...
| データベースに格納されているデータは何ですか? | 電子メール アドレス、デバイス ID |
...
| プライバシー ポリシーの URL | https://classroom.cloud/data-processing-agreement/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | アプリケーション | 学生のTeamsのオンライン classroom.cloud 監視を提供するために、ユーザーからの統合に使用されます。 | [99455ec0-6207-4889-9c8c-96216a274a6b](../azure/99455ec0-6207-4889-9c8c-96216a274a6b.md) |
>| ChannelMessage.Read.All | アプリケーション | 学生のTeamsのオンライン classroom.cloud 監視を提供するために、ユーザーからの統合に使用されます。 | [99455ec0-6207-4889-9c8c-96216a274a6b](../azure/99455ec0-6207-4889-9c8c-96216a274a6b.md) |
>| ChannelSettings.Read.All | アプリケーション | 学生のTeamsのオンライン classroom.cloud 監視を提供するために、ユーザーからの統合に使用されます。 | [99455ec0-6207-4889-9c8c-96216a274a6b](../azure/99455ec0-6207-4889-9c8c-96216a274a6b.md) |
>| Chat.Read.All | アプリケーション | 学生のTeamsのオンライン classroom.cloud 監視を提供するために、ユーザーからの統合に使用されます。 | [99455ec0-6207-4889-9c8c-96216a274a6b](../azure/99455ec0-6207-4889-9c8c-96216a274a6b.md) |
>| Directory.Read.All | アプリケーション | 学生のTeamsのオンライン classroom.cloud 監視を提供するために、ユーザーからの統合に使用されます。 | [99455ec0-6207-4889-9c8c-96216a274a6b](../azure/99455ec0-6207-4889-9c8c-96216a274a6b.md) |
>| Team.ReadBasic.All | アプリケーション | 学生のTeamsのオンライン classroom.cloud 監視を提供するために、ユーザーからの統合に使用されます。 | [99455ec0-6207-4889-9c8c-96216a274a6b](../azure/99455ec0-6207-4889-9c8c-96216a274a6b.md) |
