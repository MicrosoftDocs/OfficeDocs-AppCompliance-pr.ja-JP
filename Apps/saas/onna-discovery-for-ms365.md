---
title: Onna による MS365 の Onna Discovery のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: Onna Discovery for MS365 で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
ms.locfileid: "63552226"
---
# <a name="onna-discovery-for-ms365"></a>MS365 の Onna Discovery

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 2 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/onna1600902517721.onna-discovery-1" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Onna が Microsoft に提供する情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | MS365 の Onna Discovery |
| ID | onna1600902517721.onna-discovery-1 |
| パートナー会社名 | Onna |
| 会社の Web サイト | [https://onna.com](https://onna.com) |
| アプリの利用規約 | [https://onna.com/master-subscription-agreement](https://onna.com/master-subscription-agreement) |
| アプリのコア機能 | Onna は、データ収集、検索、および早期ケース評価を、ユーザーに対してMicrosoft 365 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://onna.com/features](https://onna.com/features) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Onna によって提供されています。
...
| データベースに格納されているデータは何ですか? | 電子メール、電子メール アドレス、ユーザー ID、チャット、ファイル。 保持ポリシーと削除ポリシーは、エンド ユーザーが構成できます。  |
...
| プライバシー ポリシーの URL | https://onna.com/privacy-policy/ |
