---
title: CallCabinet Corporation による CallCabinet Atmos コンプライアンス記録および分析のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/16/2022
...
description: CallCabinet Atmos コンプライアンス記録および分析に使用できるすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66785161"
---
# <a name="callcabinet-atmos-compliance-recording-and-analytics"></a>CallCabinet Atmos コンプライアンス記録と分析

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 1 月 26 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/callcabinetcorporation1584393576335.atmos" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

CallCabinet Corporation から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | CallCabinet Atmos コンプライアンス記録と分析 |
| ID | callcabinetcorporation1584393576335.atmos |
| パートナー会社名 | CallCabinet Corporation |
| 会社の Web サイト | [https://www.callcabinet.com](https://www.callcabinet.com) |
| アプリの使用条件 | [https://www.callcabinet.com/terms-and-conditions/](https://www.callcabinet.com/terms-and-conditions/) |
| アプリのコア機能 | CallCabinet による Atmos は、Microsoft Teams やその他のコラボレーションまたはコンタクト センター システム用の Azure ネイティブコンプライアンス通話記録、AI 分析、QA SaaS ソリューションです。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.callcabinet.com/compliance-microsoft-teams-call...](https://www.callcabinet.com/compliance-microsoft-teams-call-recording/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、CallCabinet Corporation から提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 録画された Teams の会話、ビデオ、画面共有 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | 録画された Teams の会話、ビデオ、画面共有 |
