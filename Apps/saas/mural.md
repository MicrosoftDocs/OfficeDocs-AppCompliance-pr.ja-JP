...
description: そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての使用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/web-apps/tactivosincdbamural1608253315049.sol-43803-aek" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

MICROSOFT に対して、MURAL によって提供される情報:
...
| パートナー会社名 | MURAL |
| 会社の Web サイト | [https://www.mural.co](https://www.mural.co) |
| アプリの使用条件 | [https://www.mural.co/terms/terms-of-use](https://www.mural.co/terms/terms-of-use) |
| アプリのコア機能 | 視覚的に考えて共同作業する |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://support.mural.co](https://support.mural.co) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、その情報が表示されます。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ログインには、名前、姓、電子メール アドレスのみが必要です。 処理/保存するデータの種類は、顧客によって異なります。 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ログインのために、ユーザーからの名、姓、電子メールのみが保存されます。 保存されるその他の情報は、顧客が自分の壁に保存する情報によって異なります。 |
...
| 最新の SOC2 認定日 | 2021-04-01 |
| アプリはサービス組織コントロール (SOC 3) に準拠していますか? | はい |
| 最新の SOC3 認定日 | 2021-04-01 |
...
| プライバシー ポリシーの URL | https://www.mural.co/terms/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | 委任 | DOCUMENT にドキュメントをアップロードするために必要な Files.read。 | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | 委任 | アカウントの作成には名、姓、電子メールが必要であるため、User.read。 | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
