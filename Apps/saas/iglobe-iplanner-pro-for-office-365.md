---
title: iPlanner Pro for Office 365 by iGlobe のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/04/2022
...
description: iPlanner Pro for Office 365、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "66656555"
---
# <a name="iplanner-pro-for-office-365"></a>iPlanner Pro for Office 365

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>開発者が最終更新日: 2022 年 7 月 4 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/17859280.iplannerpro" target="_blank">AppSource で表示する</a>
...
|:----------------|:-------------|
| アプリ名 | iPlanner Pro for Office 365 |
| ID | 17859280.iplannerpro |
| パートナー会社名 | iGlobe |
| 会社の Web サイト | [https://www.iglobecrm.com](https://www.iglobecrm.com) |
| アプリの使用条件 | [https://iglobecrm.com/content/end-user-license-agreement-ig...](https://iglobecrm.com/content/end-user-license-agreement-iglobe-iplanner-add-ins) |
| アプリのコア機能 | 任意のデバイス上の Outlook で、Office 365 Planner &amp; Teams から Planner タスクを手に入れることができます。 タスクの管理と作成が簡単になりました。 Outlook for Windows、MAC、IOS、または Web メールで、Office 365 Planner &amp; Teams から Planner タスクを手に入れることができます。 |
| 会社の本社の場所 | デンマーク |
...
| アプリによって処理されるデータは何ですか? | お客様と iGlobe が組織&#8217;ライセンス アカウントを管理できるように収集されたデータは、電子メールと名前を収集しています。 収集された情報は、組織のアプリ管理者が [アプリ ライセンス管理] ページで表示できます。 |
...
| サポートされているポリシーの種類を一覧表示する | Azure AD SSO、セキュリティの既定値、およびその他の一般的なポリシー (レガシ認証のブロック* 管理者に MFA を要求する* Azure 管理に MFA が必要* すべてのユーザーに MFA が必要* など) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | 期限を使用して iPlanner Pro から予定表エントリを作成して、ユーザーの予定表にエントリを追加できるようにする | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| Directory.AccessAsUser.All | 委任 | サインインしているユーザーと同じディレクトリ内の情報にアクセスできるようにします。 ユーザーのアクセス許可レベルを保持していることを確認する | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| Files.Read | 委任 | Azure Ad SSO と iPlanner Pro で必要なユーザー ファイルを読み取り、ファイルを開いてファイルを保存できるようにする必要があります | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| Group.Read.All | 委任 | iPlanner Pro は、ユーザーがメンバーになっているプランと、サインインしているユーザーに割り当てられたタスクを取得できるようにします。 | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| Group.ReadWrite.All | 委任 | ユーザーが iPlanner Pro で Planner HUB を表示し、割り当てられた他のタスクやタスクを読み取ることができるようにする | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| Mail.Read | 委任 | メールの読み取りを許可することで、ユーザーは選択したメールからタスクにメールまたは添付ファイルを保存できます。 | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| User.Read | 委任 | Azure AD SSO で必要であり、ユーザーは iPlanner Pro にサインインでき、アプリはサインインしているユーザーのプロファイルを読み取りできます。 | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| User.ReadBasic.All | 委任 | iPlanner Pro がサインインしているユーザーのプロファイルを読み取り、ユーザータスクを取得できるようにします。 ユーザーが iPlanner Pro で Planner HUB を表示し、割り当てられた他のタスクやタスクを読み取ることができるようにする | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
>| profile | 委任 | Azure AD SSO で必要であり、ユーザーがログイン ユーザーの画像を表示し、ユーザーが正しくサインインしていることを確認できるようにします | [a6f5c2f4-0bc2-48bf-8afe-6c93583a152b](../azure/a6f5c2f4-0bc2-48bf-8afe-6c93583a152b.md) |
