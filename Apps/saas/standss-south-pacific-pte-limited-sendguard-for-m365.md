---
title: スタンド (南太平洋) PTE Limited による M365 用 SendGuard のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
description: SendGuard for M365 で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
---
# <a name="sendguard-for-m365"></a>SendGuard for M365
