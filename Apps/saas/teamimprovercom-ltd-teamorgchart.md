---
title: TeamOrgChart by TeamImprover.Com Ltd のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: TeamOrgChart で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/web-apps/teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

TeamImprover.Com Ltd から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | TeamOrgChart |
| ID | teamorgchart.66763c6e-79ef-434a-b4b5-8c64c980ac13 |
| パートナー会社名 | TeamImprover.Com Ltd |
| 会社の Web サイト | [https://teamimprover.com](https://teamimprover.com) |
| アプリの使用条件 | [https://teamorgchart.com/termsofservice](https://teamorgchart.com/termsofservice) |
| アプリのコア機能 | 組織図の作成、共有、検索、印刷 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://teamorgchart.com/website/features.cshtml](https://teamorgchart.com/website/features.cshtml) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、TeamImprover.Com Ltd から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 組織階層情報は、アプリケーションによって処理されます。   |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | TeamOrgChart には、グラフ名、ルール、ブックマーク、表示レベルの数など、グラフを記述するメタデータが格納されます。 |
...
| プライバシー ポリシーの URL | https://teamorgchart.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | アプリケーションは、Azure ADから組織図をビルドして表示します。  ユーザー情報をAzure ADから読み取ることができる必要があります  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
>| User.Read.All | 委任 | アプリケーションは、Azure ADから組織図をビルドして表示します。  ユーザー情報をAzure ADから読み取ることができる必要があります  | [b12699ab-e60a-46b1-8c9e-231d489947aa](../azure/b12699ab-e60a-46b1-8c9e-231d489947aa.md) |
