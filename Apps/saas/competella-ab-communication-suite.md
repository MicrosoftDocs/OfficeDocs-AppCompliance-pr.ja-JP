...
description: Competella Communication Suite、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリのコア機能 | 連絡先センターとアテンダント コンソール ソリューションで、優れたカスタマー サービスを提供Microsoft Teams。 |
| 会社の本社所在地 | スウェーデン |
| アプリ情報ページ | |
