---
title: Competella AB による Competella Communication Suite のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: Competella Communication Suite で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/web-apps/competellaab.sol-52202-iyi" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Competella AB から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | Competella Communication Suite |
| ID | competellaab.sol-52202-iyi |
| パートナー会社名 | Competella AB |
| 会社の Web サイト | [https://www.competella.com](https://www.competella.com) |
| アプリの使用条件 | [https://www.competella.com](https://www.competella.com) |
| アプリのコア機能 | Microsoft Teams で優れたカスタマー サービスを提供する Contact Center および Attendant Console ソリューション。 |
| 会社の本社の場所 | スウェーデン |
| アプリ情報ページ | [https://competella.com/Solutions%20for%20Teams/overview](https://competella.com/Solutions%20for%20Teams/overview) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Competella AB から提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイルと通話情報 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー プロファイル情報と会話ログ |
...
| 多要素認証 (MFA) が有効になっているのは次のとおりです。 | 資格情報、DNSManagement |
...
| プライバシー ポリシーの URL | www.competella.com |
