---
title: コンペテラ AB による Competella Communication Suite のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/30/2021
...
description: Competella Communication Suite、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63546135"
---
# <a name="competella-communication-suite"></a>コンペテラ コミュニケーション スイート

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 29 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/competellaab.sol-52202-iyi" target="_blank">AppSource での表示</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | コンペテラ コミュニケーション スイート |
| ID | competellaab.sol-52202-iyi |
| パートナー会社名 | コンペテラ AB |
| 会社の Web サイト | [https://www.competella.com](https://www.competella.com) |
| アプリの利用規約 | [https://www.competella.com](https://www.competella.com) |
| アプリのコア機能 | 連絡先センターとアテンダント コンソール ソリューションで、優れたカスタマー サービスを提供し、Microsoft Teams。 |
| 会社の本社所在地 | スウェーデン |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関して、Competella AB によって提供されています。
