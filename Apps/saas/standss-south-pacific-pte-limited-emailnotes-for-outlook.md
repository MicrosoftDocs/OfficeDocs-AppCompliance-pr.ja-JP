---
title: スタンド (南太平洋) PTE Limited Outlook EmailNotes のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
ms.locfileid: "63541385"
---
# <a name="emailnotes-for-outlook"></a>EmailNotes for Outlook

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 28 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/standsssouthpacificltd1581455821226.emailnotes" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Standss (南太平洋) PTE が Microsoft に限定して提供する情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | EmailNotes for Outlook |
| ID | standsssouthpacificltd1581455821226.emailnotes |
| パートナー会社名 | スタンド (南太平洋) PTE Limited |
| 会社の Web サイト | [https://www.standss.com](https://www.standss.com) |
| アプリの利用規約 | [https://www.standss.com/sendguard_m365/terms_conditions.htm](https://www.standss.com/sendguard_m365/terms_conditions.htm) |
| アプリのコア機能 | SendGuard for Outlook M365 は、機密情報、機密情報、または不適切な情報を意図しない受信者に電子メールで送信するユーザーを検出、プロンプト、警告、保護するためのリスクおよびコンプライアンス ツールです。 |
| 会社の本社所在地 | フィジー |
| アプリ情報ページ | [https://www.standss.com/sendguard_m365/default.htm](https://www.standss.com/sendguard_m365/default.htm) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関するスタンド (南太平洋) PTE Limited によって提供されています。
...
| プライバシー ポリシーの URL | http://www.standss.com/sr/sg_m365/privacy_policy.asp |
...
| サポートされているポリシーの種類を一覧表示する | 管理者ロールを持つユーザーに多要素認証を要求する |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | 件名、本文、会議出席依頼に添付されている添付ファイルの内容を読み取る  | [471294e9-96d6-475b-b503-e02acd9ed2cd](../azure/471294e9-96d6-475b-b503-e02acd9ed2cd.md) |
>| Mail.ReadWrite | 委任 | 件名、本文、メール アイテムに添付されている添付ファイルの内容を読み取る  | [471294e9-96d6-475b-b503-e02acd9ed2cd](../azure/471294e9-96d6-475b-b503-e02acd9ed2cd.md) |
>| User.Read | 委任 | これは、ユーザー データを読み取って、ドメイン/ユーザー アカウントのライセンス情報を確認することです。 | [471294e9-96d6-475b-b503-e02acd9ed2cd](../azure/471294e9-96d6-475b-b503-e02acd9ed2cd.md) |
>| openid | 委任 | シングル サインオン (SSO) アクセス許可の要件 | [471294e9-96d6-475b-b503-e02acd9ed2cd](../azure/471294e9-96d6-475b-b503-e02acd9ed2cd.md) |
>| profile | 委任 | シングル サインオン (SSO) アクセス許可の要件 | [471294e9-96d6-475b-b503-e02acd9ed2cd](../azure/471294e9-96d6-475b-b503-e02acd9ed2cd.md) |
