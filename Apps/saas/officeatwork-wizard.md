...
ms.locfileid: "65225321"
---
# <a name="officeatwork-wizard-overview"></a>officeatwork ウィザードの概要
...
| アプリのコア機能 | 数回クリックするだけで、パーソナライズされたドキュメントを作成し、パーソナライズされたコンテンツを挿入できます。 |
| 会社の本社の場所 | スイス |
