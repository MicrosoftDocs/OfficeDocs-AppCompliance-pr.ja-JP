...
* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.wizard" target="_blank">AppSource での表示</a>
...
| アプリのコア機能 | カスタマイズされたドキュメントを作成し、数回クリックしてパーソナライズされたコンテンツを挿入します。 |
| 会社の本社所在地 | スイス |
| アプリ情報ページ | |
