...
>|:------------------------|:--------------------|:------------------------------------|
>| Calls.Initiate.All | アプリケーション | Teamsレコーディング |
>| Calls.InitiateGroupCall.All | アプリケーション | Teamsレコーディング |
>| Calls.JoinGroupCall.All | アプリケーション | Teamsレコーディング |
>| Calls.JoinGroupCallasGuest.All | アプリケーション | Teamsレコーディング |
>| Calls.AccessMedia.All | アプリケーション | Teamsレコーディング |
>| OnlineMeetings.Read.All | アプリケーション | Teamsレコーディング |
>| OnlineMeetings.ReadWrite.All | アプリケーション | Teamsレコーディング |
>| Group.Read.All | アプリケーション | Teamsレコーディング |
>| GroupMember.Read.All | アプリケーション | Teamsレコーディング |
>| User.Read.All | アプリケーション | Teamsレコーディング |
