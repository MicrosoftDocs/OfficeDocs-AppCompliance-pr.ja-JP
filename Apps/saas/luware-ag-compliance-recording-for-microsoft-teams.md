---
title: Luware AG によるMicrosoft Teamsの Luware コンプライアンス記録のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: Microsoft Teams、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する Luware Compliance Recording で利用可能なすべてのセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "64881434"
---
# <a name="luware-compliance-recording-for-microsoft-teams"></a>Microsoft Teamsの Luware コンプライアンス記録

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 10 月 21 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/luwareagzurich.recording_azure_marketplace" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Microsoft Teamsの Luware コンプライアンス記録 |
...
| アプリのコア機能 | すべての通信モードをキャプチャ、アーカイブ、分析、取得するのに役立つクラウド ソリューション。 |
| 会社の本社の場所 | スイス |
| アプリ情報ページ | [https://luware.com/en/solution/microsoft-teams-recording/](https://luware.com/en/solution/microsoft-teams-recording/) |
...
| アプリによって処理されるデータは何ですか? | 発信者/呼び出し先情報 (電話番号、upn、duration、email &amp; im address など)、通話の詳細、メタデータ、  |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | Azure オブジェクト ID、UPN、電子メール &amp; IM アドレス、表示名、名、姓、場所 (省略可能)、department(省略可能) |
| 基になるインファ構造が Microsoft 顧客データを処理または格納する場合、このデータは地理的にどこに保存されますか? | スイス |
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | Oauth 2.0 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | アプリケーション | Teams記録 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.Initiate.All | アプリケーション | Teams記録 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.InitiateGroupCall.All | アプリケーション | Teams記録 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.JoinGroupCall.All | アプリケーション | Teams記録 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Calls.JoinGroupCallasGuest.All | アプリケーション | Teams記録 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| Group.Read.All | アプリケーション | Teams記録 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| GroupMember.Read.All | アプリケーション | Teams記録 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| OnlineMeetings.Read.All | アプリケーション | Teams記録 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| OnlineMeetings.ReadWrite.All | アプリケーション | Teams記録 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| User.Read | 委任 | シングル サインオン | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
>| User.Read.All | アプリケーション | Teams記録 | [5e5d72e0-2df7-4ca7-be58-81dc28d3bdad](../azure/5e5d72e0-2df7-4ca7-be58-81dc28d3bdad.md) |
