---
title: WorkSTREAMPEOPLE BV による Anywhere365 Contact Center for Teams のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: Anywhere365 Contact Center for Teams で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2022 年 3 月 14 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/workstreampeople.anywhere365contactcenterforteams" target="_blank">AppSource で表示する</a>
...
|:----------------|:-------------|
| アプリ名 | Anywhere365 Contact Center for Teams |
...
| アプリの使用条件 | [https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialo...](https://anywhere365.io/wspstorage/2022/02/Anywhere365-Dialogue-Cloud-Agreement_202112_V3.6.pdf) |
| アプリのコア機能 | Anywhere365&#174;ダイアログ クラウド プラットフォーム for Omnichannel Communications は、Microsoft eocystem と完全に統合された、世界で初めての Microsoft 認定連絡先センターです。Azure、Sharepoint、Teams から Dynamics 365、PowerApps、PowerBI まで。 低コード通信オートメーション プラットフォームのダイアログ スタジオの提供により、任意の API ベースのボット フレームワーク、通信レイヤー、インテリジェンス システムと統合できます。 |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | [https://anywhere365.io/category/anywhere365-dialogue-cloud/](https://anywhere365.io/category/anywhere365-dialogue-cloud/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、WORKSTREAMPEOPLE BV によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 通信 &amp; プレゼンス データ |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | 通信 &amp; プレゼンス データ |
| 基になるインファ構造が Microsoft 顧客データを処理または格納する場合、このデータは地理的にどこに保存されますか? | オランダ (the), 米国 of America, Singapore |
...
| プライバシー ポリシーの URL | https://anywhere365.io/wp-content/uploads/2021/07/Anywhere365-Privacy-Policy-2021.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | 顧客ドメインを収集する | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| Presence.Read.All | 委任 | 顧客のプレゼンスの詳細を収集します。 | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
>| User.ReadBasic.All | 委任 | 顧客の表示名を収集する | [d1762bac-3696-429d-ab0b-2a61463d6b7a](../azure/d1762bac-3696-429d-ab0b-2a61463d6b7a.md) |
