---
title: CC4ALL による CC4Teams のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/11/2022
...
* <a href="https://appsource.microsoft.com/product/web-apps/contactcenter4all1634641680587.cc4all_01" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

CC4ALL から Microsoft に提供される情報:
...
| パートナー会社名 | CC4ALL |
| 会社の Web サイト | [https://contactcenter4all.com](https://contactcenter4all.com) |
| アプリの利用規約 | [https://contactcenter4all.com/contactcenter4all-saas-agreem...](https://contactcenter4all.com/contactcenter4all-saas-agreement/) |
| アプリのコア機能 | CC4Teams は、ルーティング、ウォーム転送、通話録音、レポートなどの機能をユーザーに追加Teams |
| 会社の本社所在地 | オランダ (the) |
| アプリ情報ページ | [https://contactcenter4all.com/cc4teams/](https://contactcenter4all.com/cc4teams/) |
...
この情報は、CC4ALL によって、このアプリが組織データを収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| データベースに格納されているデータは何ですか? | コール センターでのエージェント名、電子メール アドレス、エージェント アクティビティ |
...
| 多要素認証 (MFA) が有効になっているのは、次の場合です。 | 資格情報、DNSManagement |
...
| プライバシー ポリシーの URL | https://ss-usa.s3.amazonaws.com/c/308460351/media/12330608ab57a01be064335765158501/CC4ALL%20-%20Data%20Processing%20Agreement%20V1.0.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| CallRecords.Read.All | アプリケーション | 録音に使用する | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Calls.AccessMedia.All | アプリケーション | メディアにアクセスするために使用される | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Calls.Initiate.All | アプリケーション | 連絡先センターで通話を開始するために使用される | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Calls.InitiateGroupCall.All | アプリケーション | 連絡先センターで通話を開始するために使用される | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Calls.JoinGroupCall.All | アプリケーション | 連絡先センターで通話を開始するために使用される | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Calls.JoinGroupCallasGuest.All | アプリケーション | 連絡先センターで通話を開始するために使用される | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Presence.Read | 委任 | 連絡先センターのエージェントの状態を確認するために使用される | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
>| Presence.Read.All | 委任 | 連絡先センターのエージェントの状態を確認するために使用される | [9430520a-241f-4a00-b041-56aa8bbc9cc9](../azure/9430520a-241f-4a00-b041-56aa8bbc9cc9.md) |
