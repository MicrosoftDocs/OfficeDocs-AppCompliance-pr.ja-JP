---
title: officeatwork で Image Chooser のアプリケーション情報をOneNoteする
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: OneNoteは、セキュリティ、コンプライアンス、およびデータ処理のプラクティスに関する業界標準と制御に対して Microsoft によってレビューされています。
...
* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.image-chooser" target="_blank">AppSource で表示する</a>
