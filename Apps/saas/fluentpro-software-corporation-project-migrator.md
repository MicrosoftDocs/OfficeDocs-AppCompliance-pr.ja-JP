---
title: FluentPro Software Corporation によるProject Migrator のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Project Migrator、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "65811256"
---
# <a name="project-migrator"></a>Project Migrator

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 30 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/fluentpro-4571949.project_migrator" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://fluentpro.com](https://fluentpro.com) |
| アプリの使用条件 | [https://projectmigrator.com/terms-of-use/](https://projectmigrator.com/terms-of-use/) |
| アプリのコア機能 | 最も一般的なプロジェクト管理ソフトウェア間でプロジェクトを移行します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://projectmigrator.com](https://projectmigrator.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて FluentPro Software Corporation から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、MS365 グループ データ、Web データのProject。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | Planner データの読み取りと書き込み | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| Group.ReadWrite.All | 委任 | Planner データの読み取りと書き込み | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| Sites.ReadWrite.All | 委任 | Planner データの読み取りと書き込み | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.Read | 委任 | Planner データの読み取りと書き込み | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.ReadBasic.All | 委任 | Planner データの読み取りと書き込み | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| offline_access | 委任 | Planner データの移行に失敗した再起動 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.Read | 委任 | ユーザー サインイン | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| メール | 委任 | ユーザーのメールボックスを読み取る | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| openid | 委任 | ユーザー サインイン | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| profile | 委任 | ユーザー サインイン | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
>| Directory.Read.All | 委任 | Web データのProjectの読み取りと書き込み | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| Group.Read.All | 委任 | Web データのProjectの読み取りと書き込み | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| Group.ReadWrite.All | 委任 | Web データのProjectの読み取りと書き込み | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| User.Read | 委任 | Web データのProjectの読み取りと書き込み | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
>| User.ReadBasic.All | 委任 | Web データのProjectの読み取りと書き込み | [ca9b0417-d519-4ed6-ae2a-d939583a083c](../azure/ca9b0417-d519-4ed6-ae2a-d939583a083c.md) |
