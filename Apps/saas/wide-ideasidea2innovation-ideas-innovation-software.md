---
title: 幅広いアイデアのアプリケーション情報 - 幅広いアイデア/Idea2Innovation によるイノベーション ソフトウェア
ms.author: elmalova
author: elenamalova
ms.date: 12/08/2021
ms.topic: article
...
description: Wide Ideas - Innovation Software、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報など、利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "62251203"
---
# <a name="wide-ideas---innovation-software"></a>幅広いアイデア - イノベーション ソフトウェア

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 12 月 2 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/wideideaspoweredbyidea2innovaitonswedenab.innovation_cloud_application" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Wide Ideas/Idea2Innovation から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | 幅広いアイデア - イノベーション ソフトウェア |
| ID | wideideaspoweredbyidea2innovaitonswedenab.innovation_cloud_application |
| パートナー会社名 | 幅広いアイデア/Idea2Innovation |
| 会社の Web サイト | [https://getwideideas.com](https://getwideideas.com) |
| アプリの利用規約 | [https://getwideideas.com/eula](https://getwideideas.com/eula) |
| アプリのコア機能 | Microsoft 365 と Teams に埋め込まれた Wide Ideas のイノベーション管理ソフトウェアにより、新しいソリューションの課題、カスタマー エクスペリエンス、アイデアを共有することは、従業員の作業文化の一部となります。 |
| 会社の本社所在地 | スウェーデン |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Wide Ideas/Idea2Innovation によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザー名とメールアドレス |
| 基になるインファ構造が Microsoft 顧客データを処理または保存する場合、このデータは地理的にどこに保存されますか? | スウェーデン |
...
| プライバシー ポリシーの URL | https://getwideideas.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | 委任 | ワイド アイデア管理センターは、サインインしているユーザーに代わって、任意のチームにチャネルを作成できます。  | [0d56e89d-8356-457f-89a2-618386a39eb8](https://docs.microsoft.com/microsoft-365-app-certification/azure/0d56e89d-8356-457f-89a2-618386a39eb8) |
>| Directory.Read.All | 委任 | ワイド アイデア管理センターでは、組織のユーザー、グループ、アプリ&#8217;ディレクトリ内のデータを読み取る | [0d56e89d-8356-457f-89a2-618386a39eb8](https://docs.microsoft.com/microsoft-365-app-certification/azure/0d56e89d-8356-457f-89a2-618386a39eb8) |
>| Group.Read.All | 委任 | ワイド アイデア管理センターでは、グループを一覧表示し、サインインしているユーザーに代わってプロパティとすべてのグループ メンバーシップを読み取ることができます。 | [0d56e89d-8356-457f-89a2-618386a39eb8](https://docs.microsoft.com/microsoft-365-app-certification/azure/0d56e89d-8356-457f-89a2-618386a39eb8) |
>| TeamsAppInstallation.ReadWriteForTeam | 委任 | ワイド アイデア管理センターでは、サインインしているユーザーがアクセスできるチームTeamsアプリを読み取り、インストール、アップグレード、アンインストールできます。  | [0d56e89d-8356-457f-89a2-618386a39eb8](https://docs.microsoft.com/microsoft-365-app-certification/azure/0d56e89d-8356-457f-89a2-618386a39eb8) |
>| TeamsTab.Create | 委任 |  ワイド アイデア管理センターでは、サインインしているユーザーに代わって、Microsoft Teamsで任意のチームにタブを作成できます。 | [0d56e89d-8356-457f-89a2-618386a39eb8](https://docs.microsoft.com/microsoft-365-app-certification/azure/0d56e89d-8356-457f-89a2-618386a39eb8) |
>| User.Read | 委任 | を使用すると、ユーザーはワイド アイデア管理センターにサインインし、アプリはサインインしているユーザーのプロファイルを読み取りできます。  | [0d56e89d-8356-457f-89a2-618386a39eb8](https://docs.microsoft.com/microsoft-365-app-certification/azure/0d56e89d-8356-457f-89a2-618386a39eb8) |
