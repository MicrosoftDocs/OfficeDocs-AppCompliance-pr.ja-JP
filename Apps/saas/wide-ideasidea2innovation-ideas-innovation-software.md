...
>|:------------------------|:--------------------|:------------------------------------|
>| TeamsAppInstallation.ReadWriteForTeam | 委任 | ワイド アイデア管理センターでは、サインインしているユーザーがアクセスできるチームTeamsアプリを読み取り、インストール、アップグレード、アンインストールできます。  |
>| Channel.Create | 委任 | ワイド アイデア管理センターは、サインインしているユーザーに代わって、任意のチームにチャネルを作成できます。  |
>| TeamsTab.Create | 委任 |  ワイド アイデア管理センターでは、サインインしているユーザーに代わって、Microsoft Teamsで任意のチームにタブを作成できます。 |
>| Directory.Read.All | 委任 | ワイド アイデア管理センターでは、組織のユーザー、グループ、アプリ&#8217;ディレクトリ内のデータを読み取る |
>| Group.Read.All | 委任 | ワイド アイデア管理センターでは、グループを一覧表示し、サインインしているユーザーに代わってプロパティとすべてのグループ メンバーシップを読み取ることができます。 |
>| User.Read | 委任 | を使用すると、ユーザーはワイド アイデア管理センターにサインインし、アプリはサインインしているユーザーのプロファイルを読み取りできます。  |
