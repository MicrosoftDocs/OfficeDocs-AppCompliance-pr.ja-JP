---
title: WORKSTREAMPEOPLE BV による Anywhere365 アテンダント Microsoft Teamsのアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 02/22/2022
ms.topic: article
...
description: Microsoft Teams 用 Anywhere365 Attendant Console、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
<p>開発者が最終更新日: 2022 年 1 月 17 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/workstreampeople.attendantconsoleformsftteams" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

WORKSTREAMPEOPLE BV から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Anywhere365 Attendant Console for Microsoft Teams |
| ID | workstreampeople.attendantconsoleformsftteams |
| パートナー会社名 | WORKSTREAMPEOPLE BV |
| 会社の Web サイト | [https://anywhere365.io](https://anywhere365.io) |
| アプリの利用規約 | [https://anywhere365.io/terms-conditions/](https://anywhere365.io/terms-conditions/) |
| アプリのコア機能 | 市場で最も強力でユーザーフレンドリーなアテンダント コンソールで、ユーザーにMicrosoft Teams |
| 会社の本社所在地 | オランダ (the) |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する WORKSTREAMPEOPLE BV によって提供されています。
...
| データベースに格納されているデータは何ですか? | TenantId |
...
| プライバシー ポリシーの URL | https://delivery.anywhere365.io/deployment/msteams/Anywhere365-Attendant-Console-Compliance.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read.Shared | 委任 | ユーザーがアクセスできる同僚の予定表を表示する | [a7bdb4c6-23d0-4e4a-958a-168b50d67465](https://docs.microsoft.com/microsoft-365-app-certification/azure/a7bdb4c6-23d0-4e4a-958a-168b50d67465) |
>| People.Read | 委任 | ユーザーに到達するために、ユーザーの同僚の詳細を表示する | [a7bdb4c6-23d0-4e4a-958a-168b50d67465](https://docs.microsoft.com/microsoft-365-app-certification/azure/a7bdb4c6-23d0-4e4a-958a-168b50d67465) |
>| Presence.Read.All | 委任 | 連絡先リスト内のすべてのユーザーのプレゼンスを表示する | [a7bdb4c6-23d0-4e4a-958a-168b50d67465](https://docs.microsoft.com/microsoft-365-app-certification/azure/a7bdb4c6-23d0-4e4a-958a-168b50d67465) |
>| User.Read.All | 委任 | 同僚のすべての情報を表示する | [a7bdb4c6-23d0-4e4a-958a-168b50d67465](https://docs.microsoft.com/microsoft-365-app-certification/azure/a7bdb4c6-23d0-4e4a-958a-168b50d67465) |
>| メール | 委任 | ユーザーに電子メールを送信し、それを呼び出しメッセージで使用する | [a7bdb4c6-23d0-4e4a-958a-168b50d67465](https://docs.microsoft.com/microsoft-365-app-certification/azure/a7bdb4c6-23d0-4e4a-958a-168b50d67465) |
>| offline_access | 委任 | データを最新の状態に保つ | [a7bdb4c6-23d0-4e4a-958a-168b50d67465](https://docs.microsoft.com/microsoft-365-app-certification/azure/a7bdb4c6-23d0-4e4a-958a-168b50d67465) |
>| openid | 委任 | プラットフォーム内のユーザーを特定するには | [a7bdb4c6-23d0-4e4a-958a-168b50d67465](https://docs.microsoft.com/microsoft-365-app-certification/azure/a7bdb4c6-23d0-4e4a-958a-168b50d67465) |
>| profile | 委任 | ユーザーを識別し、エクスペリエンスをカスタマイズするには、プロファイル データが必要です。 | [a7bdb4c6-23d0-4e4a-958a-168b50d67465](https://docs.microsoft.com/microsoft-365-app-certification/azure/a7bdb4c6-23d0-4e4a-958a-168b50d67465) |
