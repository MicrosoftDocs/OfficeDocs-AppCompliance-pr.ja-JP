---
title: デシジョン ポイント別 Beagle のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: Beagle で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64877714"
---
# <a name="beagle"></a>Beagle

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 6 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/a0f836a9-178e-4407-9c26-4579dcd17bd1" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002687" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Decision Point から Microsoft に提供される情報:
...
| パートナー会社名 | 判断ポイント |
| 会社の Web サイト | [https://decisionpoint.ai](https://decisionpoint.ai) |
| アプリの使用条件 | [https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms...](https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms-of-Use.pdf) |
| アプリのコア機能 | Beagle は、MS Teamsなどのプラットフォームと統合されたチャット ベースの BI ツールです。 Beagle は導入の障壁を下げ、コラボレーション アプリを通じてユーザーにデータを提供することで、(個人の) トレーニングの必要性を排除します。  Beagle は、分析情報カードの形式でユーザーに関連するデータを表示し、フィルターを使用して詳細に分析し、迅速な意思決定に役立ちます。  |
| 会社の本社の場所 | インド |
| アプリ情報ページ | [https://beagleanalytics.ai](https://beagleanalytics.ai) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関するデシジョン ポイントによって提供されています。
