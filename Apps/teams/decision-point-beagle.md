...
description: Beagle のすべての利用可能なセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms...](https://beagleanalytics.ai/wp-content/uploads/2021/02/Terms-of-Use.pdf) |
| アプリのコア機能 | Beagle はチャット ベースの BI ツールで、MS や MS など、プラットフォームTeams。 Beagle は、コラボレーション アプリを通じてユーザーにデータを取り込み、導入の障壁を下げ、(個人の) トレーニングの必要性を排除します。  Beagle は、インサイト カードの形式でユーザーに関連するデータを表示し、フィルターを使用してユーザーに深く掘り下げ、意思決定の迅速化に役立ちます。  |
| 会社の本社所在地 | インド |
