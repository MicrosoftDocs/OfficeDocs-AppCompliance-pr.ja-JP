...
description: Kazoo、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.kazoohr.com/terms-of-use](https://www.kazoohr.com/terms-of-use) |
| アプリのコア機能 | ピアピアの認識と報酬を通じて企業文化と従業員の満足度を向上させる Employee Engagement and Performance Management ツールと、継続的なパフォーマンス管理。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
