...
>| Sites.ReadWrite.All | 委任 | アプリケーション構成データは、データ処理の観点から保存されます | すべてのサイト コレクション内のアイテムを編集または削除する | 4d69a8e1-9c38-4b33-b76f-9d59b5ae051b |
>| User.Read.All | 両方とも | アプリケーション構成データは、データ処理の観点から保存されます | フル プロファイルのすべてのユーザー&#8217;読み取る | 4d69a8e1-9c38-4b33-b76f-9d59b5ae051b |
