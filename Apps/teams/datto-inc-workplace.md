...
description: Datto Workplace で利用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://us.workplace.datto.com/partner/at/eula/eula_en.html](https://us.workplace.datto.com/partner/at/eula/eula_en.html) |
| アプリのコア機能 | Datto Workplace ファイル共有およびコラボレーション ツールを使用して生産性を向上させます。 |
| 会社の本社所在地 | アメリカ |
