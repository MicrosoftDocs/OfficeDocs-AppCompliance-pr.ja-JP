---
title: Captivate IO Ltd による Captivate Hub のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/14/2021
...
description: Captivate Hub、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/0ea8ef28-454a-4796-84dc-06c775639565" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003575" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Captivate IO Ltd が Microsoft に提供する情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | The Captivate Hub |
| ID | WA200003575 |
| Office 365サポートされているクライアント | Microsoft Teams |
| パートナー会社名 | Captivate IO Ltd |
| 会社の Web サイト | [https://captivat.io](https://captivat.io) |
| アプリの利用規約 | [https://captivat.io/tos](https://captivat.io/tos) |
| アプリのコア機能 | Captivate Hub はコードフリーの拡張可能なシステムで、複数のチャネルで人間とコンピューターの会話をサポートするように設計されています。 マルチベンダーのデジタル アシスタントと多数のライブ チャット ソリューションをサポートします。 |
| 会社の本社所在地 | 英国英国と北アイルランド (the) |
| アプリ情報ページ | [https://manual.captivat.io/docs/teams](https://manual.captivat.io/docs/teams) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Iaas |
| アプリで使用するホスティング クラウド プロバイダー | IBMCloud |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Captivate IO Ltd によって提供されています。
...
| データベースに格納されているデータは何ですか? | テナント ID、Teamsグループ、チャネル グループ、およびアプリケーションに接続されている teams グループに含まれるユーザー |
...
| プライバシー ポリシーの URL | https://www.captivat.io/privacy-policy/ |
