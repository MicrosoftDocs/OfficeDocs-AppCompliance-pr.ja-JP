...
| パートナー会社名 | YAROOMS |
| 会社の Web サイト | [https://yarooms.com](https://yarooms.com) |
| アプリの利用規約 | [https://www.yarooms.com/legal/terms-conditions/](https://www.yarooms.com/legal/terms-conditions/) |
| アプリのコア機能 | Room &amp; Desk Booking Software |
| 会社の本社所在地 | ルーマニア |
| アプリ情報ページ | [https://yarooms.com/help](https://yarooms.com/help) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Iaas |
| アプリで使用するホスティング クラウド プロバイダー | Aws、Azure、GCP |
...
| プライバシー ポリシーの URL | https://www.yarooms.com/legal/privacy-policy |
