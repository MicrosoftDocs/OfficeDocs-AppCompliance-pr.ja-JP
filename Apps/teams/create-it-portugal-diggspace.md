---
title: IT ポルトガルの作成による Diggspace のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Diggspace で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66656169"
---
# <a name="diggspace"></a>Diggspace

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 17 日</p>

* <a href="https://teams.microsoft.com/l/app/661a0fd1-38d6-4a93-8450-1dd493d9974d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004347" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

It ポルトガルの作成から Microsoft に提供される情報:
...
| パートナー会社名 | IT ポルトガルを作成する |
| 会社の Web サイト | [https://www.create.pt](https://www.create.pt) |
| アプリの使用条件 | [https://www.diggspace.com/en/terms-of-use](https://www.diggspace.com/en/terms-of-use) |
| アプリのコア機能 | Diggspace は、イントラネットの構築を支援する、すぐに使用できるカスタマイズ可能なプラットフォームです。 |
| 会社の本社の場所 | ポルトガル |
| アプリ情報ページ | [https://www.diggspace.com](https://www.diggspace.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、IT ポルトガルの作成によって提供されています。
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | ADAL |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.AccessAsUser.All | 委任 | Auth | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| Mail.ReadBasic | 委任 | Outlook の電子メール数を表示する | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| Tasks.Read | 委任 | ユーザー タスクを表示する | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| User.Read | 委任 | 認証とプロファイル情報 | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| User.Read.All | アプリケーション | プロファイル データを同期する | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| メール | 委任 | Auth | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| offline_access | 委任 | Auth | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
>| profile | 委任 | Auth | [a6604cc9-a6f7-4009-96ba-9f837e528977](../azure/a6604cc9-a6f7-4009-96ba-9f837e528977.md) |
