---
title: IdeaScale による IdeaScale のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: IdeaScale で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
ms.locfileid: "63698859"
---
# <a name="ideascale"></a>IdeaScale

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 1 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/a4de8de4-33b1-4e55-97ac-9f87b5978c0f" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003868" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

IdeaScale から Microsoft に提供される情報:
...
| パートナー会社名 | IdeaScale |
| 会社の Web サイト | [https://ideascale.com](https://ideascale.com) |
| アプリの利用規約 | [https://ideascale.com/terms-and-conditions-of-use](https://ideascale.com/terms-and-conditions-of-use) |
| アプリのコア機能 | IdeaScale は、イノベーション チームの主要なアイデア管理プラットフォームです。 組織内の誰でも、コミュニティ内の他のユーザーに表示されるアイデアを共有し、フィードバックとリソースを収集して、それらのアイデアを新しい製品やプロジェクトに変えます。 これで、IdeaScale コミュニティを自分のワークスペースMicrosoft Teams接続して、アイデアを管理Teams。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://ideascale.com/teams/](https://ideascale.com/teams/) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する IdeaScale によって提供されています。
...
| プライバシー ポリシーの URL | https://ideascale.com/privacy-policy |
