---
title: ngDesk by All Blue Solutions のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/22/2021
...
description: ngDesk で使用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/64d24486-30aa-4fae-8bdc-2680a85dcbb5" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002968" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

All Blue Solutions から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://ngdesk.com](https://ngdesk.com) |
| アプリの使用条件 | [https://ngdesk.com/terms-of-service/](https://ngdesk.com/terms-of-service/) |
| アプリのコア機能 | ngDesk には、すぐに使える、使いやすいオールインワン アプリケーションのサポート、販売、資産管理、マーケティング、ポケットベルが含まれています。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://ngdesk.com](https://ngdesk.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、All Blue Solutions によって提供されています。
