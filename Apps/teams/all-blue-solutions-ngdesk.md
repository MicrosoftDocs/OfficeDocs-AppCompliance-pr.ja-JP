...
description: ngDesk で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/64d24486-30aa-4fae-8bdc-2680a85dcbb5" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002968" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://ngdesk.com/terms-of-service/](https://ngdesk.com/terms-of-service/) |
| アプリのコア機能 | ngDesk には、サポート、販売、資産管理、マーケティング、およびページアが、すぐに使える、すぐに使える、1 つのアプリケーションに含まれています。 |
| 会社の本社所在地 | アメリカ |
