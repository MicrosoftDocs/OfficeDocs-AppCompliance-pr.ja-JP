...
description: cSA STAR レジストリ内の iManage、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、およびセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://support.imanage.com/worksite/iManage_Cloud_Services...](https://support.imanage.com/worksite/iManage_Cloud_Services_Agreement.pdf) |
| アプリのコア機能 | コンテンツが iManage に保存および管理されている間、自由に共同作業を行います。 |
| 会社の本社所在地 | アメリカ |
