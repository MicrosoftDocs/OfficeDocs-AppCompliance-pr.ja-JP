---
title: Powow AI による Powow のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/20/2021
...
description: Powow、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/5e6f557b-3d89-40e6-9d8e-0ccb5c956c22" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002952" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Powow AI が Microsoft に提供する情報:
...
| パートナー会社名 | Powow AI |
| 会社の Web サイト | [https://www.powow.ai](https://www.powow.ai) |
| アプリの利用規約 | [https://www.powow.ai/legal/tos.pdf](https://www.powow.ai/legal/tos.pdf) |
| アプリのコア機能 | Powow は、ビジネス会議で AI の力を発揮する SaaS プラットフォームです。 独自の AI アルゴリズムを使用して会議を書き起こし、分析し、アクション可能な分析情報に変換します。 Powow を使用すると、組織のスタッフは会議に参加する時間を少なくし、会議の検出、分析、およびコラボレーションを通じて生産性を向上させることができます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://powow-ai.zendesk.com/hc/en-us](https://powow-ai.zendesk.com/hc/en-us) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Paas |
| アプリで使用するホスティング クラウド プロバイダー | Azure、GCP |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Powow AI によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ、ユーザー メール、予定表イベント |
...
| 多要素認証 (MFA) が有効になっているのは、次の場合です。 | CodeRepositories, DNSManagement |
...
| プライバシー ポリシーの URL | https://www.sembly.ai/wp-content/uploads/2021/09/privacy.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ExternalItem.ReadWrite.All | アプリケーション | 検索コネクタに使用されます (Powow データを Microsoft インデックスにプッシュして、データ全体を検索Microsoft サービス) | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| User.Read | 委任 | 登録とログインのためにサインインしてユーザー プロファイルを読み取る | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| User.Read.All | アプリケーション | 検索コネクタに使用されます (Powow データを Microsoft インデックスにプッシュして、データ全体を検索Microsoft サービス) | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| メール | 委任 | 登録とログインのためにユーザーのメール アドレスを表示する | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| offline_access | 委任 | アプリケーション内のユーザーのデータにアクセスするには (予定表の更新を追跡する) | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| openid | 委任 | ユーザーのサインイン | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
>| profile | 委任 | 登録のためにユーザーの基本的なプロファイル情報にアクセスするには | [d871e46e-e346-445d-bfe8-2a66419bf278](../azure/d871e46e-e346-445d-bfe8-2a66419bf278.md) |
