---
title: etherFAX LLC による DirectFax のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: DirectFax で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66892084"
---
# <a name="directfax"></a>DirectFax

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 8 日</p>

* <a href="https://teams.microsoft.com/l/app/6530e8a1-213e-4847-ba53-5a36d8f4e20c" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002054" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

etherFAX LLC から Microsoft に提供される情報:
...
| パートナー会社名 | etherFAX LLC |
| 会社の Web サイト | [https://www.etherfax.net](https://www.etherfax.net) |
| アプリの使用条件 | [https://www.etherfax.net/terms-conditions/](https://www.etherfax.net/terms-conditions/) |
| アプリのコア機能 | DirectFax Messenger by etherFAX を使用すると、FAX やその他のビジネス ドキュメントを送受信できます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.etherfax.net/app-integrations/microsoft-teams/](https://www.etherfax.net/app-integrations/microsoft-teams/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、etherFAX LLC によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | アプリケーションを介して転送されるデータの種類または分類は、チームのユーザーの裁量で伝達され、責任を負います。 また、通信されたコンテンツを適切な受信者にルーティングするために、ユーザーの Teams の識別子も保持されます。 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | OAuth トークン、更新トークン、トークンの有効期限、Azure AD ユーザー オブジェクト ID  |
| 基になるインファ構造が Microsoft 顧客データを処理または格納する場合、このデータは地理的にどこに保存されますか? | 米国 of America(カナダ) |
...
| プライバシー ポリシーの URL | https://www.etherfax.net/gdpr-privacy-notice/ |
...
| サポートされているポリシーの種類を一覧表示する | MFA を要求 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.All | 委任 | メッセージを読み、DirectFax ボットと対話する手順として解釈する | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| ChannelMessage.Send | 委任 | ボットに代わってメッセージを送信し、FAX 状態の更新をユーザーに通知する | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| Chat.ReadWrite | 委任 | FAX の送受信を目的とするチャット メッセージの読み取りと投稿 | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| Files.ReadWrite.All | 委任 | FAX の送受信用のファイルにアクセスする | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| Group.ReadWrite.All | 委任 | Teams チャネルでの FAX の送受信を目的としたチャット メッセージの読み取りと投稿 | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| Mail.Send | 委任 | 他のユーザーとメールで FAX メッセージを共有します。 | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| User.Read | 委任 | デバイス情報を設定するためのユーザー プロファイルの読み取り | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| offline_access | 委任 | 電子メールで FAX 送信する画像を送信するファイルにアクセスする | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| openid | 委任 | ユーザーのサインイン | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
>| profile | 委任 | デバイス情報を設定するためのユーザー プロファイルの読み取り | [6530e8a1-213e-4847-ba53-5a36d8f4e20c](../azure/6530e8a1-213e-4847-ba53-5a36d8f4e20c.md) |
