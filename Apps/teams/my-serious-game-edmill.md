...
* <a href="https://teams.microsoft.com/l/app/484aa99e-4b6b-4182-8c89-3ae4f85f0cd6" target="_blank">Teams店舗で表示</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002622" target="_blank">アプリソースで表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

マイクロソフトにマイ・シリアス・ゲームによって提供される情報:
...
| パートナーウェブサイトのURL | [https://www.edmill.com/](https://www.edmill.com/) |
| アプリケーション情報ページTeams URL | [https://www.edmill.com](https://www.edmill.com) |
| プライバシーポリシーの URL | [https://app.edmill.com/privacy-policy](https://app.edmill.com/privacy-policy) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対する組織のコントロールについて My-Serious-Game によって提供されています。
...
<iframe height='1020' title='Microsoft Cloud App Security情報' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/36913' frameborder='no' style='width: 100%;'></iframe>
...
この情報は、このアプリが認証、承認、アプリケーション登録のベストプラクティス、およびその他のID基準を処理する方法についてMy-Serious-Gameによって提供されています。
