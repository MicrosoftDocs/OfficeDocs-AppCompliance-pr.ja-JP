...
description: LumApps で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/ba2c569f-de70-4442-9609-d9818e7152ca" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001015" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.lumapps.com/end-user-licence-agreement-english/](https://www.lumapps.com/end-user-licence-agreement-english/) |
| アプリのコア機能 | LumApps を複数の 2 つの方法の統合でMicrosoft Teamsにリンクする |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する LumApps によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | 委任 | プロファイル情報 | [170d42a4-4ec0-4f51-bef0-693c589fccfc](../azure/170d42a4-4ec0-4f51-bef0-693c589fccfc.md) |
>| openid | 委任 | ログインを承認する | [170d42a4-4ec0-4f51-bef0-693c589fccfc](../azure/170d42a4-4ec0-4f51-bef0-693c589fccfc.md) |
>| profile | 委任 | ログインに関する情報 | [170d42a4-4ec0-4f51-bef0-693c589fccfc](../azure/170d42a4-4ec0-4f51-bef0-693c589fccfc.md) |
