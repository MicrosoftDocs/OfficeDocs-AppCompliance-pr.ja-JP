---
title: メルトウォーターによるメルトウォーターのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: メルトウォーターで使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/83b0e721-a17c-4284-8af3-7ac51418dd86" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003094" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

メルトウォーターから Microsoft に提供される情報:
...
| パートナー会社名 | Meltwater |
| 会社の Web サイト | [https://www.meltwater.com](https://www.meltwater.com) |
| アプリの使用条件 | [https://www.meltwater.com/en/terms-of-use](https://www.meltwater.com/en/terms-of-use) |
| アプリのコア機能 | オンライン ニュース、ソーシャル メディア、印刷、ブロードキャスト、ポッドキャスト全体で包括的なメディア監視と分析を提供し、業界の誰よりも多くのコンテンツと会話をキャプチャします。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://help.meltwater.com/en/articles/5360376-set-up-your-...](https://help.meltwater.com/en/articles/5360376-set-up-your-alerts-with-teams-integration) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、メルトウォーターから提供されています。
...
| プライバシー ポリシーの URL | https://www.meltwater.com/en/privacy/gdpr |
