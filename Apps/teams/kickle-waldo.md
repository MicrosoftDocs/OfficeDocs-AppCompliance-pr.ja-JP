...
description: Waldo で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/1d041f16-ab49-4627-bfda-6b60ad2cab6a" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003139" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Kickle から Microsoft に提供される情報:
...
| アプリの使用条件 | [https://hellowaldo.app/terms-and-conditions](https://hellowaldo.app/terms-and-conditions) |
| アプリのコア機能 | デスクの予約、駐車場の予約。 Flex Office と宿題をシンプルにしました。 |
| 会社の本社の場所 | フランス |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Kickle によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 委任 | チャット履歴に基づいて、Waldo は同僚を識別します。 この一覧は、後で予定表ビューの状態を表示するために使用されます。 | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| User.Read | 委任 | このアクセス許可は、Microsoft Graph Toolkitのコンポーネント担当者によって使用されます。 | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| User.ReadBasic.All | 委任 | このアクセス許可は、Microsoft Graph Toolkitのコンポーネント担当者によって使用されます。 | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| offline_access | 委任 | アプリがユーザーに代わってバックグラウンド タスクを作成するために使用する (認証用のトークンを更新する) | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
>| openid | 委任 | 認証に必要 | [c71a6f53-cf0c-426d-a826-cedae8b073f7](../azure/c71a6f53-cf0c-426d-a826-cedae8b073f7.md) |
