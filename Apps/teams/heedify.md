...
description: Heedify で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリのコア機能 | ネイティブ受付アテンダントとコール センター エージェントのMicrosoft Teams。 |
| 会社の本社所在地 | フランス |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委任 | 受付は、電話を転送したり、電話で顧客と情報を共有する前に、ユーザーの予定表を確認する必要があります | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite | 委任 | アプリケーションは、user(agent) に連絡先を追加し、連絡先を読み取る必要があります。  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Contacts.ReadWrite.Shared | 委任 | アプリケーションは、他の user(agent) との共有連絡先を追加し、共有連絡先を読み取る必要があります。  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| Presence.Read.All | 委任 | 特に通話転送の場合は、通話の管理と連絡先の管理を向上するために、連絡先センター エージェントにプレゼンス情報が必要です。  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
>| User.Read.All | 委任 | 連絡先を管理するには、ログに記録されたユーザーがユーザーを閲覧し、そのユーザーの出発とマネージャーを含む情報を読み取る必要があります (受付の場合)  | [f3ad2154-7e10-4730-a055-8852ced42d47](../azure/f3ad2154-7e10-4730-a055-8852ced42d47.md) |
