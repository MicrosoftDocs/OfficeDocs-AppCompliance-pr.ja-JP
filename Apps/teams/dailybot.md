---
title: DailyBot による DailyBot のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: DailyBot で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66915655"
---
# <a name="dailybot"></a>DailyBot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 4 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/82bfb2e1-cad3-4e99-8995-5d140f295ef2" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001492" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

DailyBot から Microsoft に提供される情報:
...
| パートナー会社名 | DailyBot |
| 会社の Web サイト | [https://www.dailybot.com](https://www.dailybot.com) |
| アプリの使用条件 | [https://www.dailybot.com/legal/terms-and-conditions](https://www.dailybot.com/legal/terms-and-conditions) |
| アプリのコア機能 | DailyBot は、立ち上がり、毎日の状態レポート、振り返り、定期的なチェックインを自動化することで、会議の必要性を減らします。チームの動機を追跡し、良いフィードバックを、kudos と感謝を込めて促進します。 DailyBot には、ショートカット/コマンドを作成し、チャット ワークフローを自動化するための追加機能が含まれています。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.dailybot.com/integrations/msteams](https://www.dailybot.com/integrations/msteams) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、DailyBot によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー Email、テナント ID、MS チーム リソース ID と名前、チーム チャネル ID |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー Email、テナント ID、MS チーム リソース ID と名前、チーム チャネル ID、DailyBot の機能とワークフローによって収集されたユーザー応答のコンテンツ (チェックイン、アンケート、フォーム、Kudos など)。 |
...
| プライバシー ポリシーの URL | https://www.dailybot.com/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | DailyBot では、チームからユーザーの基本情報を読み取る必要があります。これは、プロセスのオンボードに関する優れたユーザー エクスペリエンスを提供し、メンバーの招待プロセスを容易にするために使用されます。 | [82bfb2e1-cad3-4e99-8995-5d140f295ef2](../azure/82bfb2e1-cad3-4e99-8995-5d140f295ef2.md) |
