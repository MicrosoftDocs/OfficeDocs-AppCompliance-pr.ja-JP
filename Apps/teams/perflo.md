---
title: Perflo による Perflo のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/03/2022
...
description: Perflo、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/abce776c-943c-4f4b-9f8b-53aa73af701e" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003721" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Perflo から Microsoft に提供される情報:
...
| パートナー会社名 | Perflo |
| 会社の Web サイト | [https://www.perflo.co](https://www.perflo.co) |
| アプリの利用規約 | [https://www.perflo.co/terms](https://www.perflo.co/terms) |
| アプリのコア機能 | チームにマイクロサーベイを送信し、マネージャー向けレポートを作成する。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://www.perflo.co](https://www.perflo.co) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関して Perflo によって提供されています。
...
| データベースに格納されているデータは何ですか? | チャネル、Teams、ユーザー プロファイル名、プロファイル画像、MS Teams ID |
...
| プライバシー ポリシーの URL | https://www.perflo.co/privacy |
