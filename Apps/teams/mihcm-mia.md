---
title: MiHCM による Mia のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 12/20/2021
ms.topic: article
...
description: Mia で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/0b48e71e-8f46-46d8-a545-608295f000ac" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002417" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

MiHCM から Microsoft に提供される情報:
...
| パートナー会社名 | MiHCM |
| 会社の Web サイト | [https://mihcm.com](https://mihcm.com) |
| アプリの利用規約 | [https://mia.work/terms-of-use](https://mia.work/terms-of-use) |
| アプリのコア機能 | Mia Workplace Virtual Assistantを使用すると、組織は、すべてのユーザーに合わせた仮想アシスタントを提供Microsoft Teamsできます。 Microsoft Teams のこのワークプレース アシスタントは、生産性の向上、従業員のエンゲージメントの向上、多数の人事要求の実行、仕事に関連するサービス要求、フィットネスの充実など、組織を支援します。 &amp; Mia は、従業員のエンゲージメント、平凡な人事サービス/対話のためのシームレスな従業員エクスペリエンスを確認します。 |
| 会社の本社所在地 | スリランカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する MiHCM によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザー 予定表イベント、ユーザー タイム ゾーン |
...
| プライバシー ポリシーの URL | https://mia.work/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | アプリケーション | ユーザーのスケジュールされた予定表イベントを読み取る | [7b90f2e4-fe97-4a56-952f-b3c553e537a7](https://docs.microsoft.com/microsoft-365-app-certification/azure/7b90f2e4-fe97-4a56-952f-b3c553e537a7) |
>| Group.Read.All | 委任 | ユーザーの Microsoft Planner タスクを読み取る | [7b90f2e4-fe97-4a56-952f-b3c553e537a7](https://docs.microsoft.com/microsoft-365-app-certification/azure/7b90f2e4-fe97-4a56-952f-b3c553e537a7) |
>| MailboxSettings.Read | アプリケーション | ユーザーのタイム ゾーンを読み取る | [7b90f2e4-fe97-4a56-952f-b3c553e537a7](https://docs.microsoft.com/microsoft-365-app-certification/azure/7b90f2e4-fe97-4a56-952f-b3c553e537a7) |
>| User.Read | 委任 | ユーザーを一意に識別するには | [7b90f2e4-fe97-4a56-952f-b3c553e537a7](https://docs.microsoft.com/microsoft-365-app-certification/azure/7b90f2e4-fe97-4a56-952f-b3c553e537a7) |
