...
| アプリの利用規約 | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/1-4-terms-of-use) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | 使用されるデータは、アプリケーションがアクセス トークンを使用して API を呼び出す許可をユーザーが明示的に確認Graphです。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | 委任 | 使用されるデータは、アプリケーションがアクセス トークンを使用して API を呼び出す許可をユーザーが明示的に確認Graphです。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | 委任 | 使用されるデータは、アプリケーションがアクセス トークンを使用して API を呼び出す許可をユーザーが明示的に確認Graphです。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
