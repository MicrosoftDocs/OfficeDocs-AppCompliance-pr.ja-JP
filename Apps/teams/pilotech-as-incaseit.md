...
description: InCaseIT で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/4420b597-c1d5-4d40-ba81-2b2a78575c81" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003265" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://incaseit.com](https://incaseit.com) |
| アプリの使用条件 | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/1-4-terms-of-use) |
| アプリのコア機能 | 危機管理システム。 危機とインシデントの準備と処理のためのシステム。 |
| 会社の本社の場所 | ノルウェー |
| アプリ情報ページ | [https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/t...](https://www.manula.com/manuals/pilotech-as/incaseit2/1/en/topic/introduction-to-incaseit-version-2-0) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について Pilotech AS から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | 使用される唯一のデータは、アプリケーションがアクセス トークンを使用してGraph APIを呼び出せるようにユーザーが明示的に確認することです。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| OnlineMeetings.ReadWrite | 委任 | 使用される唯一のデータは、アプリケーションがアクセス トークンを使用してGraph APIを呼び出せるようにユーザーが明示的に確認することです。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
>| User.Read | 委任 | 使用される唯一のデータは、アプリケーションがアクセス トークンを使用してGraph APIを呼び出せるようにユーザーが明示的に確認することです。 | [9af6eceb-6a8b-4710-b51d-dde2ac01cc71](../azure/9af6eceb-6a8b-4710-b51d-dde2ac01cc71.md) |
