...
description: 8x8 で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/bab6487a-dbe6-426f-b329-b7ef0d0fd5ba" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002665" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | 8x8、Inc |
| 会社の Web サイト | [https://www.8x8.com](https://www.8x8.com) |
| アプリの使用条件 | [https://www.8x8.com/terms-and-conditions](https://www.8x8.com/terms-and-conditions) |
| アプリのコア機能 | 8x8 Voice は、PSTN 通話を発信/受信するクラウドベースのダイレクト ルーティング サービスです。 エンタープライズ レベルのテレフォニーと連絡先センターの機能を備えたネイティブ エクスペリエンス。 47 か国の無制限通話プラン+ 43 か国の PSTN 交換サービス、Analytics、SMS、MMS、FAX。 ローカルまたは国際的に経済的な通話プランを取得し、Microsoft 365から最大限に活用するために、Microsoft がまだプランを提供していない国に PSTN 通話を延長&#8217;。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.8x8.com/products/integrations/8x8-voice-for-mic...](https://www.8x8.com/products/integrations/8x8-voice-for-microsoft-teams) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | AWS、OracleCloud |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、8x8, Inc から提供されています。
