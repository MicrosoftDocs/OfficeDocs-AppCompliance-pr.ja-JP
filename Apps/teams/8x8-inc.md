...
| アプリの利用規約 | [https://www.8x8.com/terms-and-conditions](https://www.8x8.com/terms-and-conditions) |
| アプリのコア機能 | 8x8 Voice は、PSTN 通話を送受信するクラウドベースの直接ルーティング サービスです。 エンタープライズ レベルのテレフォニー + コンタクト センター機能を使用したネイティブ エクスペリエンス。 47 か国での通話プランの無制限 + 43 か国の PSTN 交換サービス、分析、SMS、MMS、FAX。 ローカルまたは国際的に経済的な通話プランを取得し、MICROSOFT がまだプランを提供していない国&#8217;PSTN 通話を拡張して、サービスを利用Microsoft 365。 |
| 会社の本社所在地 | アメリカ |
...
| アプリで使用するホスティング クラウド プロバイダー | AWS、OracleCloud |
