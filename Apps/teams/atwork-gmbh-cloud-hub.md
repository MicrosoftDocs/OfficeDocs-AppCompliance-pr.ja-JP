...
| アプリの利用規約 | [https://www.atwork-it.com/eula](https://www.atwork-it.com/eula) |
| アプリのコア機能 | Cloud Hub は、クラウド ハブのビジネス Microsoft Teams。 これにより、ユーザーは、Microsoft メッセージ センターからの新機能や変更された機能、計画されたメンテナンス、その他の重要なアナウンスなど、今後の変更を追跡できます。 クラウド ハブ アプリをアプリ バーにピン留めMicrosoft Teams。 アプリは現在英語でサポートされ、コストはかからされていません。  |
| 会社の本社所在地 | オーストリア |
...
| アプリで処理されるデータは何ですか? | ユーザー データ、ログイン データ、Auth データ、テナント データ、Azure Service データ、Graph、Office 365管理データ |
| アプリは TLS 1.1 以上をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データが格納されていますか? | はい |
| データベースに格納されているデータは何ですか? | Graph、Office 365管理データ |
| 基になるインファ構造が Microsoft 顧客データを処理または保存する場合、このデータは地理的にどこに保存されますか? | オーストリア |
...
| アプリは個人に個人データを修正または更新する機能を提供しますか? | なし |
...
| サポートされているポリシーの種類を一覧表示する | マルチテナント アプリは、顧客の設定&#180;依存します |
