---
title: Zesavi GmbH による Zesavi のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: Zesavi、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| 会社の Web サイト | [https://zesavi.com](https://zesavi.com) |
| アプリの利用規約 | [https://zesavi.com/en/impressum/](https://zesavi.com/en/impressum/) |
| アプリのコア機能 | Zesavi を使用すると、会社の全員がインターネット ブラウザーで直接短いビデオ ドキュメントを作成、 &amp; 編集できます。 |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | |
...
| プライバシー ポリシーの URL | https://zesavi.com/en/datenschutz/ |
