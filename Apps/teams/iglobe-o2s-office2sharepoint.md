...
description: O2S - Office2SharePoint、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/281db76e-2714-4cc4-b8d8-bd87ac3190af" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003656" target="_blank">AppSource で表示する</a>
...
| アプリのコア機能 | Microsoft Teams、SharePoint、Outlook、Office、OneDrive 全体に統合された Microsoft 365 ユーザー エクスペリエンスを提供することで、毎日の作業を簡単にします。  |
| 会社の本社の場所 | デンマーク |
...
>| User.Read | 委任 | ユーザーの SharePoint サイト、OneDrive、およびグループ サイトを取得します。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](../azure/5971c986-9d39-409c-a6f8-1385b1f690ef.md) |
