...
| アプリの利用規約 | [https://weet.co/terms-of-service/](https://weet.co/terms-of-service/) |
| アプリのコア機能 | Weet、第 1 共同作業スクリーン &amp; ビデオ レコーダー 
シンプル、無料、無制限の画面記録 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 委任 | weet アプリが既にインストールされている場合の検出を許可する | [32eae2b8-2111-431f-9263-e8e1120d0a97](https://docs.microsoft.com/microsoft-365-app-certification/azure/32eae2b8-2111-431f-9263-e8e1120d0a97) |
>| User.Read | 委任 | データは収集しないが、ユーザーがオートコンプリート機能を利用するためにのみメールを使用する | [32eae2b8-2111-431f-9263-e8e1120d0a97](https://docs.microsoft.com/microsoft-365-app-certification/azure/32eae2b8-2111-431f-9263-e8e1120d0a97) |
>| User.ReadBasic.All | 委任 | データは収集しないが、ユーザーがオートコンプリート機能を利用するためにのみメールを使用する | [32eae2b8-2111-431f-9263-e8e1120d0a97](https://docs.microsoft.com/microsoft-365-app-certification/azure/32eae2b8-2111-431f-9263-e8e1120d0a97) |
>| offline_access | 委任 | データは収集しないが、ユーザーがオートコンプリート機能を利用するためにのみメールを使用する | [32eae2b8-2111-431f-9263-e8e1120d0a97](https://docs.microsoft.com/microsoft-365-app-certification/azure/32eae2b8-2111-431f-9263-e8e1120d0a97) |
>| openid | 委任 | データは収集しないが、ユーザーがオートコンプリート機能を利用するためにのみメールを使用する | [32eae2b8-2111-431f-9263-e8e1120d0a97](https://docs.microsoft.com/microsoft-365-app-certification/azure/32eae2b8-2111-431f-9263-e8e1120d0a97) |
>| profile | 委任 | データは収集しないが、ユーザーがオートコンプリート機能を利用するためにのみメールを使用する | [32eae2b8-2111-431f-9263-e8e1120d0a97](https://docs.microsoft.com/microsoft-365-app-certification/azure/32eae2b8-2111-431f-9263-e8e1120d0a97) |
