...
description: Weet Screen Recording に使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f0c0f156-329e-4083-a1a7-89649407a31b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003284" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | FYZ SERVICES |
| 会社の Web サイト | [https://weet.co](https://weet.co) |
| アプリの使用条件 | [https://weet.co/terms-of-service/](https://weet.co/terms-of-service/) |
| アプリのコア機能 | Weet、1st コラボレーションスクリーン &amp; ビデオ レコーダー シンプル、無料、無制限の画面記録 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://weet.co/weet-teams-integration/](https://weet.co/weet-teams-integration/) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | GCP、AWS |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、FYZ SERVICES によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 委任 | Weet アプリが既にインストールされているかどうかを検出することを許可する | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.Read | 委任 | データは収集されませんが、オートコンプリート機能を使用するユーザーを支援するためにのみ電子メールを使用しています | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.ReadBasic.All | 委任 | データは収集されませんが、オートコンプリート機能を使用するユーザーを支援するためにのみ電子メールを使用しています | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| offline_access | 委任 | データは収集されませんが、オートコンプリート機能を使用するユーザーを支援するためにのみ電子メールを使用しています | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| openid | 委任 | データは収集されませんが、オートコンプリート機能を使用するユーザーを支援するためにのみ電子メールを使用しています | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| profile | 委任 | データは収集されませんが、オートコンプリート機能を使用するユーザーを支援するためにのみ電子メールを使用しています | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
