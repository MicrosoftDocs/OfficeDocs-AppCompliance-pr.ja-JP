...
description: Weet Screen Recording、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | 委任 | weet アプリが既にインストールされている場合の検出を許可する | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.Read | 委任 | データは収集しないが、ユーザーがオートコンプリート機能を利用するためにのみメールを使用する | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| User.ReadBasic.All | 委任 | データは収集しないが、ユーザーがオートコンプリート機能を利用するためにのみメールを使用する | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| offline_access | 委任 | データは収集しないが、ユーザーがオートコンプリート機能を利用するためにのみメールを使用する | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| openid | 委任 | データは収集しないが、ユーザーがオートコンプリート機能を利用するためにのみメールを使用する | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
>| profile | 委任 | データは収集しないが、ユーザーがオートコンプリート機能を利用するためにのみメールを使用する | [32eae2b8-2111-431f-9263-e8e1120d0a97](../azure/32eae2b8-2111-431f-9263-e8e1120d0a97.md) |
