...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | アプリは、MS Treams からフィードバックを送信するときに、ユーザーが既定の基本設定を管理するための利便性を提供するためにチャネル ID と名前を使用します。 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | 委任 | アプリはチーム ID と名前を使用して、MS Treams からのフィードバックを送信するときに、ユーザーが既定の基本設定を管理するための利便性を提供します。 | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| メール | 委任 | メールは Neelix 内のユーザー登録の一部として使用されます。 最初の登録後、通知に電子メールが使用されます。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
...
>| User.Read | 委任 | ボット アプリは user.read を使用して情報ユーザーを送信し、Neelix コア プラットフォームがユーザーを識別できるよう | [bed170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |
