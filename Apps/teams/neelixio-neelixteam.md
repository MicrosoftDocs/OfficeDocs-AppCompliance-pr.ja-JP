---
title: Neelix.IO による Neelix.Team のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Neelix.Team で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/bed170ee-dbd7-4efa-b48e-b0937ded1689" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003047" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Neelix.IO から Microsoft に提供される情報:
...
| パートナー会社名 | Neelix.IO |
| 会社の Web サイト | [https://www.neelix.team](https://www.neelix.team) |
| アプリの使用条件 | [https://www.neelix.io/terms-of-use-en](https://www.neelix.io/terms-of-use-en) |
| アプリのコア機能 | Neelix プラットフォームは、フィードバック ループを完全なサイクルとして管理します。 ユーザーは、継続的なエクスペリエンス、振り返りフィードバック、センチメントをチームの履歴にチャネル化できます。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://www.neelix.team](https://www.neelix.team) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Neelix.IO によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | アプリでは、チャネル ID と名前を使用して、MS Treams からフィードバックを送信するときに既定の設定を管理するための利便性をユーザーに提供します | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| Team.ReadBasic.All | 委任 | アプリはチーム ID と名前を使用して、MS Treams からフィードバックを送信するときに既定の設定を管理するための利便性をユーザーに提供します | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| メール | 委任 | 電子メールは、Neelix 内のユーザー登録の一部として使用されます。 最初の登録後、電子メールが通知に使用されます。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| offline_access | 委任 | これは、更新トークンの取得に使用されます | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| profile | 委任 | ユーザー名は、Neelix に登録するときにユーザー アカウントを作成するために使用されます。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](../azure/6996cad6-a969-487a-9182-f4dc4c6c8803.md) |
>| User.Read | 委任 | ボット アプリは、Neelix コア プラットフォームがユーザーを識別できるように、ユーザーに情報を送信できるようにするために user.read を使用します。 | [bed170ee-dbd7-4efa-b48e-b0937ded1689](../azure/bed170ee-dbd7-4efa-b48e-b0937ded1689.md) |
