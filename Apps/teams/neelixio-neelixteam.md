...
| アプリの利用規約 | [https://www.neelix.io/terms-of-use-en](https://www.neelix.io/terms-of-use-en) |
| アプリのコア機能 | Neelix プラットフォームは、フィードバック ループを完全なサイクルとして管理します。 ユーザーは、継続的なエクスペリエンス、振り返りフィードバック、感情をチームのジャーナルにチャネル化できます。 |
| 会社の本社所在地 | オーストラリア |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | アプリは、MS Treams からフィードバックを送信するときに、ユーザーが既定の基本設定を管理するための利便性を提供するためにチャネル ID と名前を使用します。 | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| Team.ReadBasic.All | 委任 | アプリはチーム ID と名前を使用して、MS Treams からのフィードバックを送信するときに、ユーザーが既定の基本設定を管理するための利便性を提供します。 | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| メール | 委任 | メールは Neelix 内のユーザー登録の一部として使用されます。 最初の登録後、通知に電子メールが使用されます。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| offline_access | 委任 | これは、更新トークンの取得に使用されます。 | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| profile | 委任 | ユーザー名は、Neelix に登録するときにユーザー アカウントを作成するために使用されます。  | [6996cad6-a969-487a-9182-f4dc4c6c8803](https://docs.microsoft.com/microsoft-365-app-certification/azure/6996cad6-a969-487a-9182-f4dc4c6c8803) |
>| User.Read | 委任 | ボット アプリは user.read を使用して情報ユーザーを送信し、Neelix コア プラットフォームがユーザーを識別できるよう | [bed170ee-dbd7-4efa-b48e-b0937ded1689](https://docs.microsoft.com/microsoft-365-app-certification/azure/bed170ee-dbd7-4efa-b48e-b0937ded1689) |
