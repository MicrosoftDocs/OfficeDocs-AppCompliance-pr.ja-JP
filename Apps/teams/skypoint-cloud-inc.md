...
| アプリの利用規約 | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| アプリのコア機能 | SkyPoint は、ブランドが顧客を知り、戦略的な意思決定を行い、一貫して適切な行動を取って、消費者により良いサービスを提供し、ビジネスを成長させるのに役立ちます。 お客様のデータ プラットフォームは、データ管理と統合、プライバシーコンプライアンス、分析と分析、ライセンス認証に関するインテリジェントな機能を提供します。  |
| 会社の本社所在地 | アメリカ |
