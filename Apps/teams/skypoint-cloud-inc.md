...
description: SkyPoint Cloud で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64880561"
---
# <a name="skypoint-cloud"></a>SkyPoint Cloud

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/9637dd07-ec2d-48f7-83cd-bccad3be9fd4" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002580" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://skypointcloud.com](https://skypointcloud.com) |
| アプリの使用条件 | [https://skypointcloud.com/terms/](https://skypointcloud.com/terms/) |
| アプリのコア機能 | SkyPoint は、ブランドが顧客を知り、戦略的な意思決定を行い、消費者にサービスを提供し、ビジネスの成長を続けるために適切な行動を一貫して行うのに役立ちます。 Microsoft は、データ管理と統合、プライバシー コンプライアンス、分析と分析情報、アクティブ化に関するインテリジェントな機能を提供する顧客データ プラットフォームです。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://skypointcloud.com/platform/](https://skypointcloud.com/platform/) |
...
この情報は SkyPoint Cloud Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
