---
title: SuperQuickQuestion による SQQ のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 12/09/2021
ms.topic: article
...
description: SQQ で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/25379fc8-577f-4935-b681-6f027977fbe3" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002978" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

SuperQuickQuestion から Microsoft に提供される情報:
...
| パートナー会社名 | SuperQuickQuestion |
| 会社の Web サイト | [https://superquickquestion.com](https://superquickquestion.com) |
| アプリの利用規約 | [https://superquickquestion.com/termsofuse](https://superquickquestion.com/termsofuse) |
| アプリのコア機能 | SuperQuickQuestion は、60 秒の制限時間を持つライブの 1 対 1 のビデオ会議プラットフォームです。 より生産性の高い会話を促進し、不要な会議を排除し、問題解決の速度を上げ、カレンダーを一度に 1 分で取り戻すのに役立ちます。 12 人のユーザーが互いに話し合おうとして会議に時間を費やした人は誰でも証明できるので、長い会議は必ずしもより多くのコラボレーションに等しいとは限りません。また、SQQ が役立つ&#8217;s。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する SuperQuickQuestion によって提供されています。
...
| データベースに格納されているデータは何ですか? | 名、名、テナント名 |
...
| プライバシー ポリシーの URL | https://superquickquestion.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 委任 | チャットの参加者数を取得する | [25379fc8-577f-4935-b681-6f027977fbe3](https://docs.microsoft.com/microsoft-365-app-certification/azure/25379fc8-577f-4935-b681-6f027977fbe3) |
>| User.Read | 委任 | ユーザーテナント名の読み取り | [25379fc8-577f-4935-b681-6f027977fbe3](https://docs.microsoft.com/microsoft-365-app-certification/azure/25379fc8-577f-4935-b681-6f027977fbe3) |
>| openid | 委任 | アプリからユーザーをサインインして、エンドポイントにGraphする | [25379fc8-577f-4935-b681-6f027977fbe3](https://docs.microsoft.com/microsoft-365-app-certification/azure/25379fc8-577f-4935-b681-6f027977fbe3) |
