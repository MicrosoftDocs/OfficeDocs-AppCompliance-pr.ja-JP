---
title: Kanban Tool by Shore Labs のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Kanban Tool で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/b3c15d4f-1972-4836-a1eb-7575dd56a17e" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002121" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Shore Labs |
| 会社の Web サイト | [https://www.shorelabs.com](https://www.shorelabs.com) |
| アプリの使用条件 | [https://kanbantool.com/policy/terms-of-service](https://kanbantool.com/policy/terms-of-service) |
| アプリのコア機能 | かんばんボードで作業を視覚化し、時間を追跡します。 |
| 会社の本社の場所 | ポーランド |
| アプリ情報ページ | [https://kanbantool.com](https://kanbantool.com) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | AWS、SelfHosted、GCP |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、その情報が提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| メール | 委任 | 通信、ID 照合、通知の配信のためのユーザーの電子メール アドレス。 | [4e820d60-9e62-403c-accd-857b987cc13c](../azure/4e820d60-9e62-403c-accd-857b987cc13c.md) |
>| Team.ReadBasic.All | 委任 | ユーザーが直接メンバーであるチームの識別子と名前。 これらは、かんばんツールでユーザーを正しいグループに自動的に割り当てるために使用されます。 | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| User.Read | 委任 | サインインしているユーザーの会社の基本情報。 これは、単一のSign-On機能を提供するために、新しいアカウントのアカウントの詳細を設定し、組織に属するユーザーを認識するために使用されます。 | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| offline_access | 委任 | ユーザーのログイン時に、アプリにアクセス権を付与したデータの "Microsoft でサインイン" 機能と同期を許可します。 | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| openid | 委任 | [Microsoft でサインイン] ボタンを使用して、ユーザーが職場または学校のアカウントでアプリにサインインできるようにする ID トークンを開きます。 | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
>| profile | 委任 | かんばんツールで自動入力し、Microsoft Teamsの変更と同期するユーザー名。 | [a8ead1a3-85e1-42a3-9ed0-9afb97482b31](../azure/a8ead1a3-85e1-42a3-9ed0-9afb97482b31.md) |
