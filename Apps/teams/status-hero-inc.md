---
title: Status Hero, Inc. による Status Hero のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/10/2022
...
description: Status Hero で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/7917afd4-9825-4c1d-b683-ce1fcb77d5b4" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004205" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Status Hero, Inc. から Microsoft に提供される情報:
...
| パートナー会社名 | Status Hero, Inc. |
| 会社の Web サイト | [https://statushero.com](https://statushero.com) |
| アプリの使用条件 | [https://statushero.com/terms](https://statushero.com/terms) |
| アプリのコア機能 | Status Hero は、チームのツールからの非同期チェックインとデータを簡潔で洞察に満ちたレポートに変換します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://statushero.com/integrations/microsoft-teams](https://statushero.com/integrations/microsoft-teams) |
...
この情報は、Status Hero, Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
...
| プライバシー ポリシーの URL | https://statushero.com/privacy |
