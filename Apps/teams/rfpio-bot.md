...
description: RFPIO ボットで使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| パートナー会社名 | RFPIO |
| 会社の Web サイト | [https://www.rfpio.com](https://www.rfpio.com) |
| アプリの利用規約 | [https://www.rfpio.com/terms-of-service/](https://www.rfpio.com/terms-of-service/) |
| アプリのコア機能 | RFPIO は、RFP 応答管理ソリューションの第一人者であり、業界初の AI 対応の RFP ソフトウェアであり、RFP、RFIs、セキュリティ アンケート、および DDQ に対する応答を管理するために、世界で最もスマートな企業から信頼されています。  |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://www.rfpio.com/product/](https://www.rfpio.com/product/) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダー | Azure、AWS、GCP |
