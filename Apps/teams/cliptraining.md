...
| パートナー Web サイトの URL | [https://www.cliptraining.com](https://www.cliptraining.com) |
| [アプリケーション情報Teamsページの URL | [https://www.cliptraining.com](https://www.cliptraining.com) |
| プライバシー ポリシーの URL | [https://www.cliptraining.com/privacy-policy/](https://www.cliptraining.com/privacy-policy/) |
| 利用規約の URL | [https://www.cliptraining.com/eula/](https://www.cliptraining.com/eula/) |
...
>名、名、電子メール アドレス。 要求に応じて利用できる ClipTraining ポリシーごとの保持と削除

#### <a name="organizational-controls-for-data-stored-by-partner"></a>パートナーによって保存されるデータの組織的な制御

組織の管理者がパートナー システムで情報を制御する方法について説明します。削除、保持、監査、アーカイブ、エンドユーザー ポリシーなど。

>ClipTraining が利用し、アクセス権を持つパートナー システムは、ClipTraining ポリシーに従います。 
...
<iframe height='1020' title='Microsoft Cloud App Security情報' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/40836' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/40836" target="_blank">新しいタブで表示する</a>
...
この情報は、このアプリが認証、承認、アプリケーション登録のベスト プラクティス、その他の IDENTITY 条件を処理する方法について ClipTraining によって提供されています。
