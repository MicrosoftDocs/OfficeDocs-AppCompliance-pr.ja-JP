---
title: Health Hero by Health Hero のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Health Hero で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64875414"
---
# <a name="health-hero"></a>Health Hero

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 8 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/1394c825-0026-4f33-bcc9-abaa9ae5d83b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001405" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.gohealthhero.com/terms](https://www.gohealthhero.com/terms) |
| アプリのコア機能 | Health Hero を使用すると、ユーザーは正常なアクティビティをキャプチャし、アクティビティ ポイントを受け取ります。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Health Hero から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | アプリケーション | アカウントを作成するためのユーザー情報だけです。 | [5f1f4eb7-479e-42f3-b86f-4c1f53e1c222](../azure/5f1f4eb7-479e-42f3-b86f-4c1f53e1c222.md) |
