---
title: WorkplaceBuddy by WorkplaceBuddy のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: WorkplaceBuddy で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/6fef6052-d84d-4071-b679-8b542512a621" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001238" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.workplacebuddy.com/terms-of-use.pdf](https://www.workplacebuddy.com/terms-of-use.pdf) |
| アプリのコア機能 | WorkplaceBuddy を使用すると、生産性の向上に役立ちます |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | [https://www.workplacebuddy.com](https://www.workplacebuddy.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて WorkplaceBuddy によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | このデータを同期して、Teamsの WorkplaceBuddy タブを動作させ、チャットボットを使用して特定のユーザーをターゲットにする | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| Group.Read.All | 委任 | このデータを同期して、Teamsの WorkplaceBuddy タブを動作させ、チャットボットを使用して特定のユーザーをターゲットにする | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| User.Read | 委任 | ユーザーがログインできるように、このデータを同期します | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
>| User.ReadBasic.All | 委任 | ユーザーがログインできるように、このデータを同期します | [39073da9-c47c-4da8-b57a-3786461db8f4](../azure/39073da9-c47c-4da8-b57a-3786461db8f4.md) |
