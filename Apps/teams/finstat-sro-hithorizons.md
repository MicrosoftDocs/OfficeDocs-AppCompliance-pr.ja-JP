---
title: FinStat s.r.o による HitHorizons のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/15/2022
...
description: HitHorizons で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
ms.locfileid: "63541755"
---
# <a name="hithorizons"></a>HitHorizons

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 11 日</p>

* <a href="https://teams.microsoft.com/l/app/2b492ea3-0727-4789-90d7-8e2079d46717" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001411" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

FinStat s.r.o によって提供される情報。 Microsoft に:
...
| パートナー会社名 | FinStat s.r.o. |
| 会社の Web サイト | [https://www.hithorizons.com](https://www.hithorizons.com) |
| アプリの利用規約 | [https://www.hithorizons.com/legal/terms-and-conditions](https://www.hithorizons.com/legal/terms-and-conditions) |
| アプリのコア機能 | ヨーロッパおよびヨーロッパ以外の 75M 以上の企業の HitHorizons データベースにアクセスMicrosoft Teams |
| 会社の本社所在地 | スロバキア |
| アプリ情報ページ | [https://www.hithorizons.com/services/microsoft/teams](https://www.hithorizons.com/services/microsoft/teams) |
...
この情報は、FinStat s.r.o によって提供されています。 このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて。
