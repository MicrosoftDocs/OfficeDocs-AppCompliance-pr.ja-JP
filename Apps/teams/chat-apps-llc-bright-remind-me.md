---
title: Chat Apps、LLC による Bright Remind Me のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Bright Remind Me に使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/a66ea116-3ae1-495b-9f5f-b4b59f19945b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003002" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Chat Apps、LLC から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://brightbits.app](https://brightbits.app) |
| アプリの使用条件 | [https://brightbits.app/terms/](https://brightbits.app/terms/) |
| アプリのコア機能 | 返信に便利な場合は、重要なメッセージのリマインダーを取得します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://brightbits.app/bright-remind-me/](https://brightbits.app/bright-remind-me/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Chat Apps LLC によって提供されています。
