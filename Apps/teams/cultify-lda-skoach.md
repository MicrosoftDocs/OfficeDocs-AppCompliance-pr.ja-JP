---
title: Cultify、Lda による Skoach のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Skoach で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
ms.locfileid: "63552186"
---
# <a name="skoach"></a>Skoach

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 9 日</p>

* <a href="https://teams.microsoft.com/l/app/401ece51-d146-4cfb-b426-d7c8b70b056b" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003455" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Cultify、Lda から Microsoft に提供される情報:
...
| パートナー会社名 | Cultify, Lda |
| 会社の Web サイト | [https://skoach.com](https://skoach.com) |
| アプリの利用規約 | [https://www.skoach.com/terms-of-service](https://www.skoach.com/terms-of-service) |
| アプリのコア機能 | Skoach は、繰り返しのアンケート結果に基づいて、新しい行動を採用するために人々を支援する、チームを一緒に、整列し、生産性を維持する仮想コーチです。 Skoach &amp; は、チームのコミュニケーション フローを増やし、所属と調整につながるだけでなく、ハイブリッド作業に関する新しい課題に直面し、保持の生産性を向上させるのにも役立ちます。 |
| 会社の本社所在地 | ポルトガル |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Cultify、Lda によって提供されています。
...
| データベースに格納されているデータは何ですか? | 顧客名と、指定されている場合は電子メール。 |
...
| プライバシー ポリシーの URL | https://www.skoach.com/privacy-policy |
