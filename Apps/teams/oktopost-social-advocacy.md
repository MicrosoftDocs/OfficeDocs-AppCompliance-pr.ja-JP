...
| パートナー会社名 | Oktopost |
| 会社の Web サイト | [https://www.oktopost.com](https://www.oktopost.com) |
| アプリの利用規約 | [https://www.oktopost.com/terms](https://www.oktopost.com/terms) |
| アプリのコア機能 | Oktopost は、B2B のソーシャル メディア管理と従業員のアドボカシー プラットフォームです。 Oktopost を使用すると、すべてのソーシャル メディアアクティビティを 1 か所で管理、監視、測定できます。 Oktopost には、1) ソーシャル メディア管理 (発行、監視、分析、エンゲージメント、2) 従業員のアドボカシーなど、2 つの主要なソリューションがあります。マーケティング担当者は従業員のソーシャル共有プログラムを管理できます。 また、Oktopost 独自の価値提案により、マーケティング担当者はソーシャル データをマーケティング スタックに統合できます。 |
| 会社の本社所在地 | イスラエル |
| アプリ情報ページ | [https://www.oktopost.com](https://www.oktopost.com) |
...
| プライバシー ポリシーの URL | https://www.oktopost.com/privacy |
