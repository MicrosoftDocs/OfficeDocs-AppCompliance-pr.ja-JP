---
title: Assembly by ExponentHR Inc. のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: Assembly で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/3e674b5f-ba5d-41cc-8b06-e065b4394aeb" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002271" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

当社から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://www.joinassembly.com](https://www.joinassembly.com) |
| アプリの使用条件 | [https://joinassembly.com/terms-of-service](https://joinassembly.com/terms-of-service) |
| アプリのコア機能 | アセンブリは、従業員のエンゲージメントと認識プラットフォームです。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.joinassembly.com/about](https://www.joinassembly.com/about) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、この情報が、HeavyHR Inc. によって提供されています。
...
| 最新の SOC1 認定日 | 2020-09-01 |
| アプリはサービス組織コントロール (SOC 2) に準拠していますか? | はい |
| 最新の SOC2 認定日 | 2021-02-28 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | 委任 | ユーザーがアプリから新しく作成されたチャネルにアプリを割り当てることを許可する | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Directory.Read.All | アプリケーション | メンバーが Assembly で適切に検索できるように、プロファイルを同期したままにする | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Group.Read.All | 委任 | データを監視して、アプリを正しいグループに割り当てることができることを確認します | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| Teams.ReadBasic.All | アプリケーション | 正しいチーム タブにアプリを割り当てる機能 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| TeamsTab.Create | アプリケーション | これを使用して、アプリをチャネル/チームに適切に追加できるようにします | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| メール | 委任 | 特定のアカウントへのアクセスを許可できるように、ユーザーの電子メール | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
>| profile | 委任 | アセンブリを自動入力し、Microsoft Teamsの変更と同期を維持するユーザー名 | [0a1b7ca8-390e-4f55-a7b5-eee089c5a905](../azure/0a1b7ca8-390e-4f55-a7b5-eee089c5a905.md) |
