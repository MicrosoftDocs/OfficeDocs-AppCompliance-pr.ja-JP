---
title: Biggerbrains による大きな Brains eLearning のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Bigger Brains eLearning、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/12345514-afee-abcd-acde-c5b34109abcd" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002366" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://getbiggerbrains.com/privacy-legal/](https://getbiggerbrains.com/privacy-legal/) |
| アプリのコア機能 | オンライン トレーニング コースの受賞歴のあるライブラリは、現在、オンライン トレーニング コースのMicrosoft Teams。  任意のチャネルに [大きい脳] タブを追加することで、180 以上の eLearning コースと 3000 以上のビデオ レッスンに簡単にアクセスできます。 使用可能なトピックには、 &amp; Microsoft Teams Office 365Microsoft Excel、Word、Outlook、PowerPoint、Power BI、および Business の各トピックが含まれます。 |
| 会社の本社所在地 | アメリカ |
