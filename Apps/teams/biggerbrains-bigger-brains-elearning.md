...
| アプリのコア機能 | オンライン トレーニング コースの受賞歴のあるライブラリは、現在、オンライン トレーニング コースのMicrosoft Teams。  任意のチャネルに [大きい脳] タブを追加することで、180 以上の eLearning コースと 3000 以上のビデオ レッスンに簡単にアクセスできます。 使用可能なトピックには、365Micro Excel soft Microsoft Teams Office、Word、Outlook、PowerPoint、Power BI、および Business の各トピックが含 &amp; まれます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
