---
title: operaLogica srl による Meety のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: Meety で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66549566"
---
# <a name="meety"></a>Meety

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 20 日</p>

* <a href="https://teams.microsoft.com/l/app/9a68d494-f5ae-4e0c-ad18-478bf6fcd101" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004258" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

operaLogica が Microsoft に提供する情報:
...
| パートナー会社名 | operaLogica srl |
| 会社の Web サイト | [https://meety.business](https://meety.business) |
| アプリの使用条件 | [https://meety.business/termsofuse](https://meety.business/termsofuse) |
| アプリのコア機能 | 会議を収集して整理し、ターゲット、タスク、会議の履歴を使用して会議のエクスペリエンスを向上させる |
| 会社の本社の場所 | イタリア |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する operaLogica によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 電子メール、名前、姓、会議の挿入 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | 電子メール、名前、姓、会議の挿入 |
...
| プライバシー ポリシーの URL | https://meety.business/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | スレッドに会議を追加する可能性 | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| Chat.Read | 委任 | 会議に関する情報を読む | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| Chat.ReadBasic | 委任 | 会議に関する情報を読む | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| OnlineMeetingArtifact.Read.All | 委任 | 会議の成果物に関する情報を読んで、ユーザーのエクスペリエンスを向上させる | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| OnlineMeetings.Read | 委任 | 会議の ID を読み取ってさらにデータを追加する | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
>| User.Read | 委任 | アプリを使用しているユーザーに関する情報を取得する | [9a68d494-f5ae-4e0c-ad18-478bf6fcd101](../azure/9a68d494-f5ae-4e0c-ad18-478bf6fcd101.md) |
