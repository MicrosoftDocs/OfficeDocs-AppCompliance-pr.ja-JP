...
description: Mentimeter で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/6aa4a751-8a6a-429e-b924-1360ed272414" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002972" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.mentimeter.com/terms](https://www.mentimeter.com/terms) |
| アプリのコア機能 | 投票、クイズ、Word クラウド、QA&amp; などを使って参加者に参加させ、リアルタイムの入力をキャプチャします。  |
| 会社の本社の場所 | スウェーデン |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Mentimeter によって提供されています。
