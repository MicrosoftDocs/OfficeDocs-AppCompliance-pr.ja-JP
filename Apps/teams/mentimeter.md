---
title: Mentimeter による Mentimeter のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Mentimeter で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/6aa4a751-8a6a-429e-b924-1360ed272414" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002972" target="_blank">AppSource での表示</a>
...
| パートナー会社名 | Mentimeter |
| 会社の Web サイト | [https://www.mentimeter.com](https://www.mentimeter.com) |
| アプリの利用規約 | [https://www.mentimeter.com/terms](https://www.mentimeter.com/terms) |
| アプリのコア機能 | 参加者にアンケート、クイズ、Word Clouds、QA&amp; などと参加して、リアルタイムの入力をキャプチャします。
 |
| 会社の本社所在地 | スウェーデン |
| アプリ情報ページ | [https://www.mentimeter.com/features](https://www.mentimeter.com/features) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Mentimeter によって提供されています。
