...
| アプリの利用規約 | [https://systemz.io/files/EULA-Message-Reminder-EN.pdf](https://systemz.io/files/EULA-Message-Reminder-EN.pdf) |
| アプリのコア機能 | 任意のチャットまたはスレッド内の任意のメッセージにリマインダーを設定します。 |
| 会社の本社所在地 | ロシア連邦 (the) |
