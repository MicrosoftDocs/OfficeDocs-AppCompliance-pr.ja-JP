...
ms.locfileid: "65229021"
---
# <a name="application-information-for-message-reminder"></a>メッセージ アラームのアプリケーション情報
...
| 会社の Web サイト | [https://systemz.io](https://systemz.io) |
| アプリの使用条件 | [https://systemz.io/files/EULA-Message-Reminder-EN.pdf](https://systemz.io/files/EULA-Message-Reminder-EN.pdf) |
| アプリのコア機能 | チャットまたはスレッド内の任意のメッセージにリマインダーを設定します。 |
| 会社の本社の場所 | ロシア連邦 (the) |
| アプリ情報ページ | [https://systemz.io/product/message-reminder](https://systemz.io/product/message-reminder) |
