...
| 会社の Web サイト | [https://www.yuccahr.com](https://www.yuccahr.com) |
| アプリの利用規約 | [https://www.yuccahr.com/terms-of-use](https://www.yuccahr.com/terms-of-use) |
| アプリのコア機能 | Connect、新入社員の統合、エンゲージメントの構築を行います。 直接、Microsoft Teams。 |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | [https://www.yuccahr.com/product](https://www.yuccahr.com/product) |
...
| データベースに格納されているデータは何ですか? | UserID, TenantID, Microsoft Teams TeamID, Microsoft Teams ChannelID, User email address from admins |
...
| プライバシー ポリシーの URL | https://www.yuccahr.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | アプリケーション | 一致する関係者の予定表イベントをスケジュールするには | [815a5165-fd61-44b8-be99-6301f780bd68](../azure/815a5165-fd61-44b8-be99-6301f780bd68.md) |
>| Channel.ReadBasic.All | アプリケーション | Web アプリケーションでチャネル名を表示する | [815a5165-fd61-44b8-be99-6301f780bd68](../azure/815a5165-fd61-44b8-be99-6301f780bd68.md) |
>| ChannelMember.Read.All | アプリケーション | チャネル内または他のチャネルのユーザーを一致するには | [815a5165-fd61-44b8-be99-6301f780bd68](../azure/815a5165-fd61-44b8-be99-6301f780bd68.md) |
>| Group.Read.All | アプリケーション | Web アプリケーションにチーム名を表示する | [815a5165-fd61-44b8-be99-6301f780bd68](../azure/815a5165-fd61-44b8-be99-6301f780bd68.md) |
>| MailboxSettings.Read | アプリケーション | ユーザーが希望する言語を取得するには、メッセージを送信するときに | [815a5165-fd61-44b8-be99-6301f780bd68](../azure/815a5165-fd61-44b8-be99-6301f780bd68.md) |
>| User.Read.All | アプリケーション | ユーザーが直接チャットできるアダプティブ カードを生成するには、電子メールが必要です | [815a5165-fd61-44b8-be99-6301f780bd68](../azure/815a5165-fd61-44b8-be99-6301f780bd68.md) |
