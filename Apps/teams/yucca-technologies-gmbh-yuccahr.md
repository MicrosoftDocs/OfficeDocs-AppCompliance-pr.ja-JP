...
| **Information** | **Response** |
|:----------------|:-------------|
| GDPR または他のプライバシーまたはデータ保護の要件または義務 (CCPA など) はありますか? | 必要 |
...
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | アプリケーション | 一致する関係者の予定表イベントをスケジュールするには |
>| Channel.ReadBasic.All | アプリケーション | Web アプリケーションでチャネル名を表示する |
>| ChannelMember.Read.All | アプリケーション | チャネル内または他のチャネルのユーザーを一致するには |
>| Group.Read.All | アプリケーション | Web アプリケーションにチーム名を表示する |
>| MailboxSettings.Read | アプリケーション | ユーザーが希望する言語を取得するには、メッセージを送信するときに |
>| User.Read.All | アプリケーション | ユーザーが直接チャットできるアダプティブ カードを生成するには、電子メールが必要です |
