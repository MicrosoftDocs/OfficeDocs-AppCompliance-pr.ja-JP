---
title: Berryworks.ai による Berry のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Berry で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "65874247"
---
# <a name="berry"></a>ベリー

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/3694c470-c14b-11ec-97bc-6b8526f20a81" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004138" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Berryworks.ai から Microsoft に提供される情報:
...
| パートナー会社名 | Berryworks.ai |
| 会社の Web サイト | [https://berryworks.ai](https://berryworks.ai) |
| アプリの使用条件 | [https://www.berryworks.ai/tnc/](https://www.berryworks.ai/tnc/) |
| アプリのコア機能 | 従業員と対話し、感情をリアルタイムで解釈し、説明責任を推進する |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://berryworks.ai/teams-integration/](https://berryworks.ai/teams-integration/) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Berryworks.ai によって提供されています。
...
| データベースに格納されているデータは何ですか? | テナント ID、ユーザー通信 ID などのテナント情報 |
