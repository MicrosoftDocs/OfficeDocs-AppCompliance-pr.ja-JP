...
| アプリのコア機能 | WorkInSync を使用すると、組織はオフィスの &amp; 柔軟なデスク予約モデルの実行を簡単に計画できます。  従業員として、次の操作を実行できます。 - デスク予約を作成および管理する - &amp; マネージャーとして自宅の出勤から作業する場合の出勤 - チーム メンバーのクロックイン/ &amp; クロックアウトプランが通知されます。チーム アクティビティ タブでは、チャネル コンテキストにインストールできます。チーム全体が自分のプレゼンスから作業している場所を確認できます - &amp; 組織全体の特定の同僚を検索する |
| 会社の本社所在地 | インド |
| アプリ情報ページ | [https://www.workinsync.io/teams-app-for-workinsync/](https://www.workinsync.io/teams-app-for-workinsync/) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | 1. 推移的なグループ メンバーの詳細を取得します。 チャネル コンテキストにインストールされている場合は、[チーム アクティビティ] タブで使用されます。 2. 組織内のユーザーのログイン ユーザー プロファイルの詳細 &amp;  一覧を取得します。 これらは、個人のコンテキストで [チーム アクティビティ] タブがインストールされている場合に使用されます。ユーザー API が失敗した場合にチームメイトのプレビューを表示するためにフォール バックとして使用されます (Outlook 以外のユーザー) | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| People.Read | 委任 | ログインしているユーザーに最も関連のあるユーザーを [チーム アクティビティ] タブに表示するには、個人コンテキストにインストールされます。 | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| Presence.Read | 委任 | 個人用コンテキストとチャネル コンテキストの両方の [チーム アクティビティ] タブでユーザーのリストのプレゼンス情報を取得するには | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| Presence.Read.All | 委任 | 個人用コンテキストとチャネル コンテキストの両方の [チーム アクティビティ] タブでユーザーのリストのプレゼンス情報を取得するには | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| User.Read.All | アプリケーション | 予約とチェックイン/チェックアウトの通知をマネージャーに送信する任意のユーザーのレポート マネージャー情報を取得するために使用されます。 | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| User.ReadBasic.All | 委任 | 従業員のプロフィール写真を読み取る場合に使用します。 | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| メール | 委任 | クライアント ライブラリを使用して SSO トークンを取得Teams必要 | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| offline_access | 委任 | クライアント ライブラリを使用して SSO トークンを取得Teams必要 | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| openid | 委任 | クライアント ライブラリを使用して SSO トークンを取得Teams必要 | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
>| profile | 委任 | クライアント ライブラリを使用して SSO トークンを取得Teams必要 | [fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc](../azure/fdabfc71-2cf8-42f0-bcdd-83e5f4acfdcc.md) |
