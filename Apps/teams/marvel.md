---
title: Marvel by Marvel のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: Marvel で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/2e7fb70e-f75d-4e85-997e-90ce89000f43" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381801" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Marvel から Microsoft に提供される情報:
...
| パートナー会社名 | Marvel |
| 会社の Web サイト | [https://marvelapp.com](https://marvelapp.com) |
| アプリの使用条件 | [https://marvelapp.com/terms/](https://marvelapp.com/terms/) |
| アプリのコア機能 | Marvel - ワイヤーフレーム、デザイン、プロトタイプ作成 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://marvelapp.com](https://marvelapp.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Marvel から提供されています。
