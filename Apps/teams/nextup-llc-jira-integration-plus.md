...
* <a href="https://teams.microsoft.com/l/app/a3394b99-8ae6-48cb-bb45-898fd4c49f93" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003847" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.nextup.ai/terms](https://www.nextup.ai/terms) |
| アプリのコア機能 | 既存の Jira の問題を見つけて、新しい問題をTeamsを作成したり、編集したり、議論したりします。 メッセージ内の問題を送信します。 問題にコメントするか、詳細を参照してください。 状態の変更、割り当てなど。 コマンド ライン インターフェイス (CLI) を介して Jira を使用します。 コメント、ログの作業時間など。 チャネル (コネクタ) の問題に関する通知を取得します。 メッセージング拡張機能を持つメッセージから新しい問題を作成します。 ボード (タブ) を使用して問題を管理します。 メッセージの下にあるアイコンをクリックして問題を検索Teams。 |
| 会社の本社所在地 | アメリカ |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する LLC の Nextup によって提供されています。
