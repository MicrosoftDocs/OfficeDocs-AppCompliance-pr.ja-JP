---
title: Appfluence Inc によるマイ リマインダーのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: My Reminders で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66656090"
---
# <a name="my-reminders"></a>マイ リマインダー

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693569f7fc3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004342" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://teamsreminder.com/eula](https://teamsreminder.com/eula) |
| アプリのコア機能 | チャット ボットを使用して、リマインダー メッセージを送信するようにスケジュール設定します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://teamsreminder.com](https://teamsreminder.com) |
...
| アプリによって処理されるデータは何ですか? | ユーザーが特定の会話に関連しているかどうかをユーザーに示すために、Teams でユーザーのチャットを一覧表示します。 |
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | next-auth/react |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 委任 | アラームがチャットに関連付けられているかどうかを理解できるように、チャットに参加しているユーザーを表示する | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.Read | 委任 | ユーザーにサインインし、ユーザーの名前を確認する | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| User.ReadBasic.All | 委任 | 個人用チャットに関連するリマインダーをスケジュールするときに、関連するコラボレーターのアバターを表示する | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| offline_access | 委任 | アラーム配信のスケジュール時にアプリがユーザーとして機能することを許可する | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
>| profile | 委任 | ユーザーにサインインし、ユーザーの名前を確認する | [6b0ce2dd-a270-4ade-babb-7cf54bab8edd](../azure/6b0ce2dd-a270-4ade-babb-7cf54bab8edd.md) |
