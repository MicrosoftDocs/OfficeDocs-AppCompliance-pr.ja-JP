...
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | 委任 | canlendar から iGlobe に会議レポートを読み込むときに、ユーザーの予定表にアクセスする    |
>| Contacts.ReadWrite | 委任 | サインインしているユーザーと同じように、アプリでディレクトリ内の情報にアクセスできるようにします。    |
>| Directory.Read.All | 委任 | アクセス許可を確認し、サイトとリストを取得します。 フォルダーを作成し、ファイルを取得し、ファイルを保存します。   |
>| Directory.ReadWrite.All | 委任 | サインインしているユーザーと同じように、アプリでディレクトリ内の情報にアクセスできるようにします。   |
>| Files.ReadWrite.All | 委任 | 読み取り、更新、パンナー タスクの作成、ユーザーの最近のファイルと共有ファイルの読み取り、リスト、ライブラリ、ファイルSharePoint取得します。 ファイルとデータをリストに保存SharePointします。     |
>| Group.Read.All | 委任 | 読み取り、更新、パンナー タスクの作成、ユーザーの最近のファイルと共有ファイルの読み取り、リスト、ライブラリ、ファイルSharePoint取得します。 ファイルをリストに保存SharePointします。   |
>| Group.ReadWrite.All | 委任 | 読み取り、更新、パンナー タスクの作成、ユーザーの最近のファイルと共有ファイルの読み取り、リスト、ライブラリ、ファイルSharePoint取得します。 ファイルをリストに保存SharePointします。 iGlobe CRM Office 365     |
>| Mail.ReadWrite | 委任 | eamil を iGlobe CRM に Svae し、iGlobe から新しい e-amil に informatiopn を取得する    |
>| Sites.Manage.All | 委任 | iGlobe CRM でアイテムとリストを作成、編集、および削除する     |
>| Sites.Read.All | 委任 | iGlobe CRM のアイテムの読み取り     |
>| Sites.ReadWrite.All | 委任 | iGlobe CRM のアイテムとリストを編集、削除する  |
>| Tasks.ReadWrite | 委任 | iGlobe CRM からプランナー タスクを作成する     |
>| User.Read | 委任 | speficic ユーザーの iGlobe CRM の情報を取得するには    |
