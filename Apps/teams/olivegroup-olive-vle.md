---
title: OliveGroup による OLIVE VLE のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 07/12/2021
ms.topic: article
...
description: OLIVE VLE、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

OliveGroup から Microsoft に提供される情報:
...
| パートナー会社名 | OliveGroup |
| 会社の Web サイト | [https://www.olivegroup.io](https://www.olivegroup.io) |
| アプリの利用規約 | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| アプリのコア機能 | Olive VLE は、教師と教育プロバイダーがコース、見習いプログラム、学習者を作成および管理するのに役立ちます。 教育プロバイダーの管理者は、独自のオンライン コース、テスト、割り当て、プログラムを作成し、それらを学習者に割り当てできます。 Microsoft Teamsは、Graph API を使用して統合され、管理者は Teams 内でビデオ 教室を作成し、学習者をビデオ教室に招待することもできます。 学習者は、自分のコース、プログラムを参照して受講し、ポートフォリオの証拠を管理できます。 管理者はニュース フィードを投稿できます。 |
| 会社の本社所在地 | アイルランド |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、OliveGroup から提供されています。
