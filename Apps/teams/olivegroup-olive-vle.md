...
description: OLIVE VLE で使用可能なすべてのセキュリティとコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/ccb8561b-4f4a-496f-898f-b27e681c3a62" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003331" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://vle.olivegroup.io/termsofuse](https://vle.olivegroup.io/termsofuse) |
| アプリのコア機能 | Olive VLE は、講師や教育プロバイダーがコース、実習プログラム、学習者を作成および管理するのに役立ちます。 教育機関の管理者は、独自のオンライン コース、テスト、課題、プログラムを構築し、それらを学習者に割り当てることができます。 Microsoft TeamsはGraph APIを使用して統合されるため、管理者はTeams内にビデオ教室を作成し、学習者をビデオ教室に招待することもできます。 学習者は、自分のコース、プログラムを表示して取得し、ポートフォリオの証拠を管理できます。 管理者は、ニュース フィードを投稿することもできます。 |
| 会社の本社の場所 | アイルランド |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、OliveGroup から提供されています。
