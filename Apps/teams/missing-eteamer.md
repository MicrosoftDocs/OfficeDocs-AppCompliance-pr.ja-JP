...
| 利用規約の URL | [https://ecms2.edensoft.com.cn/#/Service](https://ecms2.edensoft.com.cn/#/Service) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| ChannelMember.ReadWrite.All | 両方とも | OAuth 2.0 の暗黙的な承認に対してテナント アプリケーション ID とアプリケーション パスワードが収集され、ユーザー情報が同期されます。 | テナント ID、テナント アプリケーション ID、アプリケーション パスワード、およびユーザー情報がデータベースに格納され、Teams 内のユーザーのチャネル ファイル情報を取得し、ファイルを操作するために使用されます。 | 3407e97c-3eed-4eca-add5-2549ed881269 |
...
>アプリケーションは 6 つのモジュールで構成され、1 つのファイルの承認と 1 つのユーザー/ロールの承認をサポートする 55 のアクセス許可 設定 に細分化されます。
