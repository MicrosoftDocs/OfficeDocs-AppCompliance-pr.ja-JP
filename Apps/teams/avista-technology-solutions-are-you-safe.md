---
title: Avista テクノロジ ソリューションセーフアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: CSA STAR レジストリで使用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、およびセキュリティ/コンプライアンス情報。 セーフ
...
ms.locfileid: "64463903"
---
# <a name="are-you-safe"></a>あなたはセーフ?

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 12 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/884e521a-dadc-41e9-a8af-fcaa907e783e" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003863" target="_blank">AppSource での表示</a>
...
| 会社の Web サイト | [https://safetybot.in](https://safetybot.in) |
| アプリの利用規約 | [https://safetybot.in/terms.html](https://safetybot.in/terms.html) |
| アプリのコア機能 | &quot;AreYouSafe?&quot; ボットは、カスタマイズされた危機管理アシスタントです。 緊急時に安全管理者や人事担当者がセットアップして使用する場合に最適です。  このアプリを使用するには、他のソフトウェアやサービスは必要ない。 ボットは使いやすく、危機を通じてアプリと外部Teams交換する必要が回避されます。  ボットを使用して、大きなインシデントの影響を受ける従業員の状態を知る。 &quot;AreYouSafe?&quot; ボットは、リアルタイムの更新を提供することで、必要なユーザーに支援を提供するのに役立ちます。 |
| 会社の本社所在地 | インド |
| アプリ情報ページ | [https://safetybot.in](https://safetybot.in) |
