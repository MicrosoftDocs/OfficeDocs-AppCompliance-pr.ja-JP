...
| アプリのコア機能 | SuitePro-G est un outil collaboratif et intuitif pour la gestion de votre portefeuille de projets. Connectez votre outil de pilotage de projets en 3 cliques et gardez une &#233;quipe projet impliqu&#233;e,&#233;e et connect&#233;e.  SuitePro-G は、プロジェクト ポートフォリオを管理できる、共同作業と直感的なソリューションです。 Connect管理ツールを 3 回クリックして、プロジェクト チームを関連付け、整理し、接続します。  |
| 会社の本社所在地 | フランス |
| アプリ情報ページ | |
