---
title: "അ用アプリケーション Org@Work情報 by \U0004EF05"
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Org@Work、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/b9f5d3b0-424e-473d-bcbe-dd01f17f9a41" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002461" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

囃子から Microsoft に提供される情報:
...
| パートナー会社名 | Lundano |
| 会社の Web サイト | [https://www.lundano.com/en/](https://www.lundano.com/en/) |
| アプリの使用条件 | [https://cp.lundano.com/Terms_en.html](https://cp.lundano.com/Terms_en.html) |
| アプリのコア機能 | 共同作業計画を使用して、作業組織とオフィスの占有率を管理する |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://www.lundano.com/orgatwork/index.html#](https://www.lundano.com/orgatwork/index.html#) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、匿月から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | データを格納しています。 データを使用してユーザーをOrg@workにログインするだけです。 | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| メール | 委任 | データを格納しています。 データを使用してユーザーをOrg@workにログインするだけです。 | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| offline_access | 委任 | データを格納しています。 データを使用してユーザーをOrg@workにログインするだけです。 | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| openid | 委任 | データを格納しています。 データを使用してユーザーをOrg@workにログインするだけです。 | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
>| profile | 委任 | データを格納しています。 データを使用してユーザーをOrg@workにログインするだけです。 | [aa1c54a1-f482-424d-9389-dbd131233483](../azure/aa1c54a1-f482-424d-9389-dbd131233483.md) |
