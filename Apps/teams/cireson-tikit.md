...
>|:------------------------|:--------------------|:------------------------------------|
>| Directory.Read.All | 委任 | アプリケーション内の RBAC の役割割り当てを読み取る場合に使用します。 |
>| Directory.AccessAsUser.All | 委任 | アプリケーション内の RBAC の役割割り当てを読み取る場合に使用します。 |
>| メール | 委任 | ログインのアクセス許可 |
>| Group.Read.All | 両方とも | アプリケーション内の RBAC の役割割り当てを読み取る場合に使用します。 |
>| openid | 委任 | ログイン |
>| profile | 委任 | ログイン |
>| User.Read | 委任 | ログイン |
>| User.Read.All | アプリケーション | ログイン |
>| User.ReadBasic.All | 委任 | ログイン |
