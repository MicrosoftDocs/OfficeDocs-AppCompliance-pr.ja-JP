...
| アプリの利用規約 | [https://trivia.springworks.in/tnc](https://trivia.springworks.in/tnc) |
| アプリのコア機能 | 一緒にプレイするチームは、より良い絆を持っています。 Trivia では、チームメイトとリアルタイムのクイズやパズルをプレイし、チームメイトと関わり、仕事中の社会的な休憩を超えて絆を結ぶ。 Trivia&#8217;s Suite of Features: Quizzes - MCQ 形式のクイズ、Word パズルでチームメイトと対戦する - 意味のある単語を形成するために文字を並び換えるだけでパズルを解決し、(Un)人気の意見 - 楽しい投票でチームでいくつかの論争を巻き起こす |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://www.springworks.in/trivia](https://www.springworks.in/trivia) |
...
| データベースに格納されているデータは何ですか? | name,email |
...
| プライバシー ポリシーの URL | https://www.springworks.in/privacy-policy/ |
