---
title: CyTrack による CyReport のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2022
...
description: CyReport で使用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66549465"
---
# <a name="cyreport"></a>CyReport

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 9 日</p>

* <a href="https://teams.microsoft.com/l/app/10b18ffa-155e-4b1f-89d5-88401ba0aa64" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004272" target="_blank">AppSource で表示する</a>
...
| アプリのコア機能 | Microsoft チームに対するビジネス分析情報のワークプレース分析とレポート&#8217;生産性 &amp; の相互作用。  チームの生産性、顧客とのやりとり、傾向、通話品質、コミュニケーション コストなどを&#8217;、ビジネス分析情報を分析するための使いやすい分析およびレポート 作成ソリューションです。 CyReport for Microsoft Teams は、コラボレーション、ビジネス コミュニケーションのパフォーマンス、効率性を向上させ、優れたカスタマー エクスペリエンスを実現します。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://web.cytrack.com/microsoft-teams/call-reporting-for-...](https://web.cytrack.com/microsoft-teams/call-reporting-for-microsoft-teams/) |
