---
title: スクワッドキャストによるスクワッドキャストのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/19/2022
...
description: スクワッドキャストで使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66892076"
---
# <a name="squadcast"></a>スクワッドキャスト

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 1 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/7792759a-43e8-4dc8-9f55-e7b0382c4a67" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004390" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

スクワッドキャストから Microsoft に提供される情報:
...
| パートナー会社名 | スクワッドキャスト |
| 会社の Web サイト | [https://www.squadcast.com](https://www.squadcast.com) |
| アプリの使用条件 | [https://www.squadcast.com/terms](https://www.squadcast.com/terms) |
| アプリのコア機能 | MS Teams から直接有効なインシデント管理。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://support.squadcast.com/docs/msteams](https://support.squadcast.com/docs/msteams) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、スクワッドキャストから提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ - ユーザー名のみ、Email |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | チーム ID、チーム名、チャネル ID、チャネル名、テナント ID |
...
| プライバシー ポリシーの URL | https://www.squadcast.com/privacy |
