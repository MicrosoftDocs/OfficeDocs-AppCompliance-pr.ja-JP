---
title: Stylebot による Stylebot のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/07/2021
...
description: Stylebot で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64880534"
---
# <a name="stylebot"></a>Stylebot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 12 月 7 日</p>

* <a href="https://teams.microsoft.com/l/app/db9c0532-d5d9-4e1b-839f-3952c88c8ee2" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003177" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.stylebot.app/apptermsofservice](https://www.stylebot.app/apptermsofservice) |
| アプリのコア機能 | Stylebot は、最新の言語とスタイルマニュアルを簡単に配置することで、文章を改善します |
| 会社の本社の場所 | 米国 オブ アメリカ |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Stylebot Inc から提供されています。
