...
description: Stylebot、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63540455"
---
# <a name="stylebot"></a>Stylebot

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者による最終更新日: 2021 年 12 月 7 日</p>

* <a href="https://teams.microsoft.com/l/app/db9c0532-d5d9-4e1b-839f-3952c88c8ee2" target="_blank">Teams ストアでの表示</a>
...
| 会社の Web サイト | [https://www.stylebot.app](https://www.stylebot.app) |
| アプリの利用規約 | [https://www.stylebot.app/apptermsofservice](https://www.stylebot.app/apptermsofservice) |
| アプリのコア機能 | Stylebot は、モダンな言語とスタイルのマニュアルをすぐに使って書き込みを改善します。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://www.stylebot.app/msteamshelp](https://www.stylebot.app/msteamshelp) |
