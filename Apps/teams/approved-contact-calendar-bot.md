...
description: Calendar BOT の使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f02fddc9-159a-4d58-9800-d94c4f64bfe8" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381271" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

承認済み連絡先から Microsoft に提供される情報:
...
| アプリの使用条件 | [https://approvedcontact.com/Terms%20of%20use.pdf](https://approvedcontact.com/Terms%20of%20use.pdf) |
| アプリのコア機能 | 承認済みの連絡先を使用すると、だれとでも簡単に予定表を共有できます。 予定表の更新に加えた変更は、承認済み連絡先に自動的に反映されます。 承認済み連絡先を使用すると、予定表を Web サイト、テキスト、電子メール、モバイル、音声認識、電話システムに接続できます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、承認済み連絡先から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | Calendar BOT では、複数のユーザーの空き時間を見つけるために、ユーザーの空き時間と空き時間を格納しています。  | [adef9811-448f-4dd5-88d9-68734050fe58](../azure/adef9811-448f-4dd5-88d9-68734050fe58.md) |
>| Contacts.Read | 委任 | はい。連絡先情報が保存されます。 | [adef9811-448f-4dd5-88d9-68734050fe58](../azure/adef9811-448f-4dd5-88d9-68734050fe58.md) |
>| User.Read | 委任 | はい | [adef9811-448f-4dd5-88d9-68734050fe58](../azure/adef9811-448f-4dd5-88d9-68734050fe58.md) |
>| User.ReadBasic.All | 委任 | いいえ | [adef9811-448f-4dd5-88d9-68734050fe58](../azure/adef9811-448f-4dd5-88d9-68734050fe58.md) |
>| offline_access | 委任 | はい。オフライン ユーザーの空き時間と空き時間。 | [adef9811-448f-4dd5-88d9-68734050fe58](../azure/adef9811-448f-4dd5-88d9-68734050fe58.md) |
>| openid | 委任 | いいえ | [adef9811-448f-4dd5-88d9-68734050fe58](../azure/adef9811-448f-4dd5-88d9-68734050fe58.md) |
