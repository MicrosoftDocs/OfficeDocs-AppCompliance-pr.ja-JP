...
| アプリの利用規約 | [https://chronus.com/service-terms-conditions](https://chronus.com/service-terms-conditions) |
| アプリのコア機能 | Chronus ソフトウェアは、世界最大の組織に対して、何千もの成功したメンタリング プログラム&#8217;力を提供します。 メンタリングへの影響を簡単に開始、管理、測定できます。  |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://chronus.com/services](https://chronus.com/services) |
