---
title: CyTrack による CyRecord のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: CyRecord で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/4073224c-6e1d-4e72-a754-510d91279b3b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004280" target="_blank">AppSource で表示する</a>
...
| アプリのコア機能 | CyRecord は、外部の Microsoft Teams の通話の音声録音に高度な機能を必要とするビジネス ユーザーを対象とします。   通話記録は、通話に関する明白な事実を提供し、より迅速な紛争解決につながります。 リスニングとトレーニングを通じて顧客サービスを向上させ、規制要件へのコンプライアンスを満たします。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://web.cytrack.com/microsoft-teams/call-recording-for-...](https://web.cytrack.com/microsoft-teams/call-recording-for-microsoft-teams/) |
