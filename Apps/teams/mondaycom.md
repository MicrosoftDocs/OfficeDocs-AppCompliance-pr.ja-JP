---
title: monday.com による monday.com のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: monday.com、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/eab2d3ce-6d6a-4415-abc4-5f40a8317b1f" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001798" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

monday.com から Microsoft に提供される情報:
...
| パートナー会社名 | monday.com |
| 会社の Web サイト | [https://monday.com](https://monday.com) |
| アプリの使用条件 | [https://monday.com/l/legal/tos/](https://monday.com/l/legal/tos/) |
| アプリのコア機能 | monday.com は、すべてのプログラム、プロジェクト、プロセスを整理、構造化、合理化する、リモート チームワークを促進する汎用の Work OS です。  monday.com を通じて、ボード、ビュー、グラフ、オートメーション、統合などの構成要素&#8211;を使用して、プロセス、プロジェクト、日常作業を実行するカスタム ワークフロー アプリを作成できます。 新しい monday.com ボードを作成するか、Microsoft Teams内から既存のボードに追加し、1 つの共同作業ワークスペースでチーム&#8217;作業を簡単に視覚化できます。 |
| 会社の本社の場所 | イスラエル |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する monday.com によって提供されています。
