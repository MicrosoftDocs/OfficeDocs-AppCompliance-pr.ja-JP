---
title: Solutions2Share GmbH による Espresso のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Espresso で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/95e54205-5e03-45e7-abef-1e8a41374407" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003212" target="_blank">AppSource での表示</a>
...
| アプリのコア機能 | イントラネットをインターネットに簡単にMicrosoft Teamsし、モダン なエクスペリエンスをユーザーに提供します。  |
| 会社の本社所在地 | ドイツ |
