...
| アプリのコア機能 | WorkJam は、デジタル ワークプレース ソリューション業界のリーダーが、第一線の生産性プラットフォーム&#8212;、または最前線の従業員ソリューションの中で、最前線の従業員を調整します。 37 以上の言語で利用可能で、38 か国以上に展開されている WorkJam は、市場をリードするタスク管理、シフト管理、アンケート、およびマイクロ ラーニング ツールを通じて、従業員オーケストレーション全体を提供します。  |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | アプリケーション | ユーザーに通知を送信するには | [f3388437-b373-4ea7-bcbd-58ec773e0ecf](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3388437-b373-4ea7-bcbd-58ec773e0ecf) |
>| User.Read | 委任 | ユーザーを SSO し、適切な情報を提示するには | [f3388437-b373-4ea7-bcbd-58ec773e0ecf](https://docs.microsoft.com/microsoft-365-app-certification/azure/f3388437-b373-4ea7-bcbd-58ec773e0ecf) |
