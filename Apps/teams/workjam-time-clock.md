---
title: WorkJam による WorkJam タイム クロックのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/13/2022
...
description: WorkJam タイム クロック、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63548215"
---
# <a name="workjam-time-clock"></a>WorkJam タイム クロック

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 12 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/c200f629-215e-46ad-a723-9c6b0b1f66f9" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003620" target="_blank">AppSource での表示</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | WorkJam タイム クロック |
| ID | WA200003620 |
| Office 365サポートされているクライアント | Microsoft Teams |
| パートナー会社名 | WorkJam |
| 会社の Web サイト | [https://www.workjam.com](https://www.workjam.com) |
| アプリの利用規約 | [https://appcontent.workjam.com/en/terms-of-use/](https://appcontent.workjam.com/en/terms-of-use/) |
| アプリのコア機能 | WorkJam は、デジタル ワークプレース ソリューション業界のリーダーが、第一線の生産性プラットフォームとして、または第一線の従業員ソリューション内で、&#8212;の従業員を調整します。 37 以上の言語で利用可能で、38 か国以上に展開されている WorkJam は、市場をリードするタスク管理、シフト管理、アンケート、およびマイクロ ラーニング ツールを通じて、従業員オーケストレーション全体を提供します。  |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | [https://www.workjam.com/portfolio-items/workjam-microsoft-t...](https://www.workjam.com/portfolio-items/workjam-microsoft-teams/) |
...
| データベースに格納されているデータは何ですか? | ユーザー関連データと会社関連データ |
...
| プライバシー ポリシーの URL | https://www.workjam.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | アプリケーション | ユーザーに通知を送信するには | [f3388437-b373-4ea7-bcbd-58ec773e0ecf](../azure/f3388437-b373-4ea7-bcbd-58ec773e0ecf.md) |
>| User.Read | 委任 | ユーザーを SSO し、適切な情報を提示するには | [f3388437-b373-4ea7-bcbd-58ec773e0ecf](../azure/f3388437-b373-4ea7-bcbd-58ec773e0ecf.md) |
