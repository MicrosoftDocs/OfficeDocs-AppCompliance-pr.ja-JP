...
description: RingCentral、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.ringcentral.com/legal/last-update-October-15-20...](https://www.ringcentral.com/legal/last-update-October-15-2019/eulatos.html) |
| アプリのコア機能 | クイック ボット コマンドとメッセージング機能を使用して、RingCentral ビデオまたはオーディオ通話を開始して参加します。 |
| 会社の本社所在地 | アメリカ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 |  アプリケーションが予定表を介して会議出席依頼イベントを送信できます | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| offline_access | 委任 |  アプリケーションが oauth トークンを取得および更新できます | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read | 委任 |  アプリは、連絡先の一致を行&#8217;の基本的なプロファイル (メール、名前) を読み取るアプリを許可します。 ユーザーがサインインし、O365 アカウントを RingCentral アカウントにリンクできます。 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read.All | 委任 | アプリケーションは、サービスで電話をかかするために、電話番号を使用してユーザーの完全なプロファイルを読み取るを許可します。 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
