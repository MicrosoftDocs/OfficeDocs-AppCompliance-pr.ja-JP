...
* <a href="https://teams.microsoft.com/l/app/2f285d77-896a-4c5f-901e-0902316003b5" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000135" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.ringcentral.com/legal/last-update-October-15-20...](https://www.ringcentral.com/legal/last-update-October-15-2019/eulatos.html) |
| アプリのコア機能 | クイック ボット コマンドとメッセージング機能を使用して、RingCentral のビデオ通話またはオーディオ通話を開始して参加します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.ringcentral.com/apps/ringcentral-for-microsoft-...](https://www.ringcentral.com/apps/ringcentral-for-microsoft-teams) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 |  アプリケーションが予定表を使用して会議出席依頼イベントを送信できるようにします | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| offline_access | 委任 |  アプリケーションが oauth トークンを取得して更新できるようにします | [ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/ 0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read | 委任 |  アプリでユーザー&#8217;の基本プロファイル (電子メール、名前) を読み取り、最後に連絡先の一致を行うことができます。 ユーザーがサインインし、自分の O365 アカウントを RingCentral アカウントにリンクできるようにします | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read.All | 委任 | アプリケーションが電話番号を使用してユーザーの完全なプロファイルを読み取り、サービスで電話をかけることを許可します。 | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
