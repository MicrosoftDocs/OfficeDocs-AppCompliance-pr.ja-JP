---
title: Content Manager by Colligo Inc のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: Content Manager で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/36ad88c6-ffce-4c52-a5a5-3eae64ed65bf" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003250" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.colligo.com](https://www.colligo.com) |
| アプリの使用条件 | [https://www.colligo.com/media/Colligo-Software-License-Agre...](https://www.colligo.com/media/Colligo-Software-License-Agreement-Schedule-A.pdf) |
| アプリのコア機能 | Content Manager を使用すると、Microsoft Teams内で直接Microsoft 365 ファイルにアクセスできます |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Colligo Inc から提供されています。
