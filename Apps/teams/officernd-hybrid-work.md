...
description: OfficeRnD Hybrid Work で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
ms.locfileid: "60953993"
---
# <a name="officernd-hybrid-work"></a>OfficeRnD ハイブリッド作業
