...
description: CI-Out-of-Office Lite、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/e76af3f9-8fb6-4018-84c0-d5444ad72b4c" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002748" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ci solution GmbH から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://www.ci-solution.com](https://www.ci-solution.com) |
| アプリの使用条件 | [https://www.ci-solution.com/agb](https://www.ci-solution.com/agb) |
| アプリのコア機能 | CI-Out-of-Office Lite を使用すると、休暇通知を標準化し、会社全体で一元的に制御できます。 この賞を受賞したアプリケーション (業界賞、イノベーション賞 IT を含む) を使用すると、Microsoft 365内の会社のプロフェッショナルで統一的で企業の ID に準拠した不在管理を保証できます。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | [https://www.ci-solution.com/support/en/ci-oof-lite/](https://www.ci-solution.com/support/en/ci-oof-lite/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、ソリューション GmbH によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| メール | 委任 | ユーザーのメール アドレスの表示 | [fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da](../azure/fc1e4e41-1e20-49ba-88aa-5f26fa8bc4da.md) |
