...
| アプリのコア機能 | CI-Out-of-Office Lite を使用すると、不在通知を会社全体で標準化および一元管理できます。 この賞を受賞したアプリケーション (業界賞、イノベーション賞 IT を含む) を使用すると、Microsoft 365 内で企業のプロフェッショナル、ユニフォーム、企業の ID 準拠のアウトオブオフィス管理を保証できます。 |
| 会社の本社所在地 | ドイツ |
