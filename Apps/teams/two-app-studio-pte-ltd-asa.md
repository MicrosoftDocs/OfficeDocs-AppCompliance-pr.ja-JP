---
title: Asa by Two App Studio Pte Ltd. のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/09/2021
...
description: Asa で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/2973405f-6e3b-45a3-a3a4-7c85d8d3be88" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003449" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Two App Studio Pte Ltd. から Microsoft に提供される情報:
...
| パートナー会社名 | Two App Studio Pte Ltd. |
| 会社の Web サイト | [https://asa.team](https://asa.team) |
| アプリの利用規約 | [https://asa.team/terms](https://asa.team/terms) |
| アプリのコア機能 | リモート ワークスペース管理ツール |
| 会社の本社所在地 | シンガポール |
| アプリ情報ページ | [https://asa.team](https://asa.team) |
...
この情報は、Two App Studio Pte Ltd. から、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| データベースに格納されているデータは何ですか? | microsoft tenantId for users and the group sending the bot messages from |
...
| プライバシー ポリシーの URL | https://asa.team/privacypolicy |
