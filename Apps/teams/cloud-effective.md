---
title: Cloud Effective による Cloud Effective のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Cloud Effective で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/c976a771-1aa9-4e98-b87d-32f271bd6e7f" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002408" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Cloud Effective から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://CloudEffective.com](https://CloudEffective.com) |
| アプリの使用条件 | [https://cloudeffective.com/term-of-use.php](https://cloudeffective.com/term-of-use.php) |
| アプリのコア機能 | コラボレーションを最適化します。 アイデアを結果に変えるチーム、目標、プロジェクト、タスクを管理します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://cloudeffective.com/products-pricing](https://cloudeffective.com/products-pricing) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Cloud Effective によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadWrite.All | 委任 | チーム名とメンバーを同期して、MS-Teamsのチーム メンバーが Cloud Effective の対応するチームに同じアクセス権を持っていることを確認します。  | [50356ee3-b48b-424b-a7a7-35e53c2ce736](../azure/50356ee3-b48b-424b-a7a7-35e53c2ce736.md) |
