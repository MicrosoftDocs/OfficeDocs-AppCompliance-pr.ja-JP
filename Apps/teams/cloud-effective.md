...
| 利用規約の URL | [https://cloudeffective.com/term-of-use.php](https://cloudeffective.com/term-of-use.php) |
...
>|:----------------|:------------------------------------------------|:--------------------------------------------------------|:--------------------------------------------------|:--------------------|
>| User.ReadWrite.All | 委任 | チーム名とメンバーを同期して、クラウドの効果的なMS-Teamsチームに同じアクセス権を持つチーム メンバーを確認します。  | ユーザー プロファイル名、タイトル、電子メール アドレスを使用して、ユーザーを識別し、Teamsと Cloud Effective の両方で相互に関連付けできます。  | [50356ee3-b48b-424b-a7a7-35e53c2ce736](https://docs.microsoft.com/microsoft-365-app-certification/azure/50356ee3-b48b-424b-a7a7-35e53c2ce736) |
...
>手動リンクを追加する機能を提供しますが、パートナー データは制御しない
