---
title: Cuckoo Networks Oy による Cuckoo のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/22/2022
...
description: Cuckoo で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66547422"
---
# <a name="cuckoo"></a>カッコウ

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 20 日</p>

* <a href="https://teams.microsoft.com/l/app/71138876-8738-4935-95b6-ae7c2fbe4e54" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002750" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://cuckoo.fi](https://cuckoo.fi) |
| アプリの使用条件 | [https://cuckoo.fi/terms-of-use/](https://cuckoo.fi/terms-of-use/) |
| アプリのコア機能 | エネルギーと頭脳を高めるために、楽しく簡単にゲーム化されたマイクロブレーク演習を行います。 |
| 会社の本社の場所 | フィンランド |
| アプリ情報ページ | [https://cuckoo.fi](https://cuckoo.fi) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Cuckoo Networks Oy によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、テナント ID、テナント名 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー アクティビティとユーザー識別可能な情報 |
...
| プライバシー ポリシーの URL | https://cuckoo.fi/en/privacy-policy/ |
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | passport-azure-ad, adal |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | Microsoft ログインを使用したサービスへのユーザー認証 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| メール | 委任 | アプリケーション イベント、利用可能なコンペティション、カスタマー サポートに関する情報を顧客に連絡する | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| offline_access | 委任 | Microsoft ログインを使用したサービスへのユーザー認証 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| openid | 委任 | Microsoft ログインを使用したサービスへのユーザー認証 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
>| profile | 委任 | Microsoft ログインを使用したサービスへのユーザー認証 | [71138876-8738-4935-95b6-ae7c2fbe4e54](../azure/71138876-8738-4935-95b6-ae7c2fbe4e54.md) |
