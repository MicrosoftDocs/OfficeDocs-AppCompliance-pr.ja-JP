...
| アプリのコア機能 | &#8220;TeaMe Health Check App&#8221;は、ビジネス企業向けアプリケーション サービスです。  このアプリは、従業員&#8221; と &#8220;組織の正常性チェック&#8221; に対して &#8220;の成長満足度マーキングを提供するツールで、従業員から一連のアンケートの回答を取得し、従業員間で結果の統計を共有します。 |
| 会社の本社所在地 | 日本 |
| アプリ情報ページ | |
