...
| アプリの利用規約 | [https://grouplotse.com/en/user-terms-of-service/](https://grouplotse.com/en/user-terms-of-service/) |
| アプリのコア機能 | 責任をすばやく明確にする。 AI、IoT、クラウド サービスへのインターフェイスが含まれています。 |
| 会社の本社所在地 | ドイツ |
