...
description: GroupLotse で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/0ec566bc-a37a-46ca-a252-54af50dfa86e" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002304" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://grouplotse.com](https://grouplotse.com) |
| アプリの使用条件 | [https://grouplotse.com/en/user-terms-of-service/](https://grouplotse.com/en/user-terms-of-service/) |
| アプリのコア機能 | 責任をすばやく明確にします。 AI、IoT、クラウド サービスへのインターフェイスが含まれています。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | [https://grouplotse.com/en/product/](https://grouplotse.com/en/product/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する controlex GmbH によって提供されています。
