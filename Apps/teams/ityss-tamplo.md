...
description: TAMPLO、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| パートナー会社名 | ITYSS |
| 会社の Web サイト | [https://www.tamplo.com](https://www.tamplo.com) |
| アプリの利用規約 | [https://www.tamplo.com/en/terms-conditions](https://www.tamplo.com/en/terms-conditions) |
| アプリのコア機能 | TAMPLO は会議をアクション プランに接続します。 会議をオンラインで準備し、すべてのチームメイトと明確な地図を共有します。 |
| 会社の本社所在地 | フランス |
| アプリ情報ページ | [https://www.tamplo.com/en/user-guide/User-Guide.pdf](https://www.tamplo.com/en/user-guide/User-Guide.pdf) |
...
| プライバシー ポリシーの URL | https://www.tamplo.com/en/privacy-policy |
