...
description: Smartnotation に使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000681" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Smartnotation B.V によって提供される情報。 Microsoft に対して:
...
| 会社の Web サイト | [https://www.smartnotation.com/landing/](https://www.smartnotation.com/landing/) |
| アプリの使用条件 | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| アプリのコア機能 | Smartnotation は、使いやすい音声対応会議の議事録ソリューションです。 ノート、アクション、決定は簡単に管理でき、情報は常に利用できます。 何よりも、不要なオーバーヘッドを取り除き、お客様とチームがコア ビジネスに専念できるようにします。 Smartnotation を MS Teamsと完全に統合できます。 コネクタを追加して、特定のプロジェクトのすべての重要な更新、新しいノート、アクション、決定の通知を受け取るか、タブを構成するか、Smartnotation を直接使用します。 |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | [https://www.smartnotation.com/landing/integrations/](https://www.smartnotation.com/landing/integrations/) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | Totaaldomein B.V. |
...
この情報は Smartnotation B.V によって提供されています。 このアプリが組織のデータを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
