...
| アプリのコア機能 | Smartnotation は使いやすい音声対応会議分ソリューションです。 メモ、アクション、意思決定は管理が簡単で、情報は常に利用できます。 何よりも、不要なオーバーヘッドを取り除き、チームはコア ビジネスに集中できます。 Smartnotation を MS と完全に統合Teams。 コネクタを追加して、特定のプロジェクトのすべての重要な更新プログラム、新しいメモ、アクション、決定の通知を受け取り、タブを構成するか、Smartnotation を直接使用します。 |
| 会社の本社所在地 | オランダ (the) |
| アプリ情報ページ | |
