...
* <a href="https://teams.microsoft.com/l/app/424b1333-fbf0-4941-acbe-336bf1f316ae" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000681" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.smartnotation.com/public/tos.pdf](https://www.smartnotation.com/public/tos.pdf) |
| アプリのコア機能 | Smartnotation は使いやすい音声対応会議分ソリューションです。 メモ、アクション、意思決定は管理が簡単で、情報は常に利用できます。 何よりも、不要なオーバーヘッドを取り除き、チームはコア ビジネスに集中できます。 Smartnotation を MS ファイルと完全に統合Teams。 コネクタを追加して、特定のプロジェクトのすべての重要な更新プログラム、新しいメモ、アクション、決定の通知を受け取り、タブを構成するか、Smartnotation を直接使用します。 |
| 会社の本社所在地 | オランダ (the) |
...
| アプリで使用するホスティング クラウド プロバイダー | Totaaldomein B.V. |
...
この情報は Smartnotation B.V によって提供されています。 このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて。
