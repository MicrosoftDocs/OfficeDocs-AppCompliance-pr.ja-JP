...
| パートナー会社名 | TINYpulse |
| 会社の Web サイト | [https://www.tinypulse.com](https://www.tinypulse.com) |
| アプリの使用条件 | [https://www.tinypulse.com/terms-and-conditions](https://www.tinypulse.com/terms-and-conditions) |
| アプリのコア機能 | 文化、認識を向上させ、盲点を回避するための最も評価の高いアプリ。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.tinypulse.com/engage](https://www.tinypulse.com/engage) |
...
| アプリによって処理されるデータは何ですか? | conversation_id、conversation_type、tenant_id、service_url、電子メール、userPrincialName、ユーザー ID、ユーザー オブジェクト ID (AADObjectId) |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | conversation_id、conversation_type、tenant_id、service_url、電子メール、userPrincialName、ユーザー ID、ユーザー オブジェクト ID (AADObjectId) |
...
| プライバシー ポリシーの URL | https://www.tinypulse.com/privacy-policy |
