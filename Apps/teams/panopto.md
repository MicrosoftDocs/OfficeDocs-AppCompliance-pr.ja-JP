---
title: Panopto による Panopto のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
description: Panopto、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/adb3c870-c01c-11eb-a2cc-4dbd838985a1" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003801" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Panopto から Microsoft に提供される情報:
...
| パートナー会社名 | Panopto |
| 会社の Web サイト | [https://www.panopto.com](https://www.panopto.com) |
| アプリの利用規約 | [https://www.panopto.com/terms-of-service/](https://www.panopto.com/terms-of-service/) |
| アプリのコア機能 | すべてのTeamsを Panopto にエクスポートし、Panopto ビデオを検索、共有、表示Teams。  すべての会議の視覚的なインデックスや、人間が確認したクローズド キャプションなどの機能を追加します。 Teams を離れることなく Panopto 機能にアクセスする: Panopto フォルダーにマップされた新しいチャネル タブを作成し、Panopto ビデオを検索して共有し、スケジュールされた会議で Panopto ビデオを提示し、新しい Panopto ビデオの準備ができたら通知を受け取る。 Panopto サイトが必要ですか? 開始 www.panopto.com/plans にアクセスします。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Panopto によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | 不要 |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データが格納されていますか? | はい |
| データベースに格納されているデータは何ですか? | 会議のTeamsおよびチャネルTeamsメタデータ。 |
...
| プライバシー ポリシーの URL | https://www.panopto.com/privacy/ |
