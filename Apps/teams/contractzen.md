---
title: ContractZen による ContractZen のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/30/2021
...
description: ContractZen、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/701972b8-c49f-45f9-8cfa-15cbd38cbef5" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001389" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ContractZen から Microsoft に提供される情報:
...
| パートナー会社名 | ContractZen |
| 会社の Web サイト | [https://www.contractzen.com](https://www.contractzen.com) |
| アプリの利用規約 | [https://my.contractzen.com/Terms](https://my.contractzen.com/Terms) |
| アプリのコア機能 | 高度な契約管理、ボード 会議管理、エンティティ管理、電子署名、仮想データ ルーム (VDR) のセキュリティ保護されたガバナンス ソフトウェア |
| 会社の本社所在地 | フィンランド |
| アプリ情報ページ | [https://appsource.microsoft.com/en-US/product/office/wa2000...](https://appsource.microsoft.com/en-US/product/office/wa200001389) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する ContractZen によって提供されています。
...
| プライバシー ポリシーの URL | https://my.contractzen.com/Privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザー プロファイル情報を使用するには | [0492ead3-ee26-40df-9757-d95cc693d856](../azure/0492ead3-ee26-40df-9757-d95cc693d856.md) |
