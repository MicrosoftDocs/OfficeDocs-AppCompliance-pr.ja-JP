---
title: Edgility による Edgility のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/14/2022
...
description: Edgility で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/fe2f94eb-7164-4fcd-a2c7-16db90307caa" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003970" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Edgility |
| 会社の Web サイト | [https://edgility.com.au](https://edgility.com.au) |
| アプリの使用条件 | [https://www.edgility.com.au/legal/](https://www.edgility.com.au/legal/) |
| アプリのコア機能 | Edgility は、統合エンタープライズ通信ツールの開発のリーダーです。 これらの SMS ソリューションを使用すると、組織は、既に依存しているプラットフォームを使用して、ビジネスにとって重要なユーザーに対する通知、促進、アラート、通知のプロセスを合理化できます。 これには、Excel、Outlook、Teamsなどの Microsoft 製品が含まれます。 ユーザーは、Microsoft OutlookとTeamsに SMS を受信することで、この効果的な会話ツールを最大限に活用できます。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://www.edgility.com.au/microsoft/teams/](https://www.edgility.com.au/microsoft/teams/) |
