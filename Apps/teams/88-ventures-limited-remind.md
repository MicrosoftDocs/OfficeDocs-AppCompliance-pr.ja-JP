...
description: Remind に使用できるすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/88546d4f-9973-4716-98e4-cd181c04bc2d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001444" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Microsoft に限定された 88 の企業から提供される情報:
...
| 会社の Web サイト | [https://moonbearapps.com](https://moonbearapps.com) |
| アプリの使用条件 | [https://teamsreminder.app/#terms](https://teamsreminder.app/#terms) |
| アプリのコア機能 | 重要な会議、To Do アイテム、誕生日などを自分またはチーム メンバーに思い出させます。 個人用アラーム、グループ チャットリマインダー、またはチャネルアラームを設定します。 定期的なリマインダー (毎週月曜日の午前 9 時にチーム会議など) を設定することもできます。 |
| 会社の本社の場所 | 香港特別行政区 |
| アプリ情報ページ | [https://teamsreminder.app](https://teamsreminder.app) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、88 の企業によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | いいえ |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | 他のユーザーに通知するときのユーザー GUID とユーザー名 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | 管理者がユーザーを検索してライセンスに割り当てるときに使用されます。 この機能の使用は完全に省略可能であり、通常のアプリの使用時には必要ありません。 | [88546d4f-9973-4716-98e4-cd181c04bc2d](../azure/88546d4f-9973-4716-98e4-cd181c04bc2d.md) |
>| People.Read.All | 委任 | ユーザーがライセンスにユーザーを割り当てる場合に使用されます | [88546d4f-9973-4716-98e4-cd181c04bc2d](../azure/88546d4f-9973-4716-98e4-cd181c04bc2d.md) |
