---
title: tim AG による ti8m の場所の&amp;アプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/04/2021
...
description: ti8m の場所で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://ti8m.com/products/places/places-nutzungsbedingungen](https://ti8m.com/products/places/places-nutzungsbedingungen) |
| アプリのコア機能 | 場所は、ハイブリッドワークプレースのセットアップで職場を予約するアプリです。 マップまたはカレンダー ベースのビューで予約を提供します。 アプリはアプリ内で完全に統合Microsoft Teams、Microsoft Services に基づくすべての認証を使用します。 |
| 会社の本社所在地 | スイス |
...
この情報は、この&amp;アプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する tim AG によって提供されています。
...
>| Directory.ReadWrite.All | 委任 | 管理サーバー グループのインストールとAAD - セキュリティ グループ  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
...
>| User.Read | 委任 | ユーザー名、メール、および表示名、アプリケーションで Userdata を表示するために必要 | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
