---
title: Si-NetによるSi-Netによる、このポータルのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/23/2022
...
description: お使いのセキュリティとコンプライアンスに関するすべての情報は、このポータルのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報です。
...
ms.locfileid: "65692407"
---
# <a name="kuro-portal"></a>くろポータル

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/c4af7af6-4fa4-4777-bab7-713cda6d0f74" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004019" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Si-Netから Microsoft に提供される情報:
...
| パートナー会社名 | Si-Net |
| 会社の Web サイト | [https://www.si-net.it](https://www.si-net.it) |
| アプリの使用条件 | [https://www.si-net.it/termini-di-utilizzo-kuro/](https://www.si-net.it/termini-di-utilizzo-kuro/) |
| アプリのコア機能 | Teams用のTEAMS用の「くろポータル」アプリは、ユーザーが必要なすべての顧客情報をひと目で把握できる軽量 CRM であり、電話帳として使用して、自分の電話オペレーターとチームから直接通話したり、連絡先のユーザーに直接メールを送信したり、チャットしたり、クロポータルのゲスト顧客との会議を作成したりできます。 顧客情報を簡単かつ迅速に検索し、選択した顧客&#8217;のドキュメント コレクションと共有ドキュメント管理に直接アクセスする  |
| 会社の本社の場所 | イタリア |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関するSi-Netによって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 顧客テナントとデバイス |
...
| プライバシー ポリシーの URL | https://www.si-net.it/termini-di-utilizzo-kuro/ |
