...
| アプリの利用規約 | [https://cdn2.hubspot.net/hubfs/1582050/3-DOWNLOAD_FILES/Ter...](https://cdn2.hubspot.net/hubfs/1582050/3-DOWNLOAD_FILES/TermsAndConditions.pdf) |
| アプリのコア機能 | Lucca は、管理プロセスと人事プロセスを最適化するための SaaS ソリューションを開発しています。 特定のニーズに対する簡単な回答を提供するソフトウェア ソリューションを設計します。休暇管理、経費レポート、時間の追跡。。。 |
| 会社の本社所在地 | フランス |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | 委任 | データは収集されません。 これらを使用して、表示する計画をフィルター処理しました。 チャネル内のユーザーだけが計画を表示します | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| Chat.ReadWrite | アプリケーション | データは収集または使用されません。 アプリは、その日の不在者を含むメッセージのみを投稿します。 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| Group.Read.All | アプリケーション | アプリが不在者とメッセージを送信するグループを知る GroupId を収集します。  | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| User.Read | 委任 | ユーザーのサインインに使用 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| User.Read.All | アプリケーション | ユーザー プロファイルの読み取りに使用 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| メール | 委任 | ユーザーのメールをアプリ タブに表示するために使用します。 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| openid | 委任 | ユーザーのログインに使用 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
>| profile | 委任 | ユーザー プロファイルをアプリ タブに表示するために使用します。 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](https://docs.microsoft.com/microsoft-365-app-certification/azure/53628f6a-ac66-4fde-8945-d639c8da4c0d) |
