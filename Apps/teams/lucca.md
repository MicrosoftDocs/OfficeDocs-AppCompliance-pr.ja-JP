---
title: '[アプリケーション情報] For[アプリケーション情報] by [ファイル名]'
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: ご利用いただけるすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/53628f6a-ac66-4fde-8945-d639c8da4c0d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001650" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Microsoft に対して提供される情報:
...
| パートナー会社名 | Lucca |
| 会社の Web サイト | [https://www.lucca.fr](https://www.lucca.fr) |
| アプリの使用条件 | [https://cdn2.hubspot.net/hubfs/1582050/3-DOWNLOAD_FILES/Ter...](https://cdn2.hubspot.net/hubfs/1582050/3-DOWNLOAD_FILES/TermsAndConditions.pdf) |
| アプリのコア機能 | SaaS ソリューションを開発し、管理プロセスと人事プロセスを最適化します。 休暇管理、経費報告書、時間追跡など、特定のニーズに対する簡単な回答を提供するソフトウェア ソリューションを設計しています。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | SelfHosted |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Intelli によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | 委任 | データは収集されません。 これらを使用して、表示する計画をフィルター処理しました。 チャネル内のユーザーのみが計画を表示します。 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| Chat.ReadWrite | アプリケーション | データは収集または使用されません。 アプリは、その日の不在者を含むメッセージのみを投稿します | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| Group.Read.All | アプリケーション | GroupId を収集して、アプリが不在者と共にメッセージを送信する必要があるグループを把握します。  | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| User.Read | 委任 | ユーザーのサインインに使用されます | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| User.Read.All | アプリケーション | ユーザー プロファイルの読み取りに使用します | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| メール | 委任 | ユーザーのメールをアプリ タブに表示するために使用します | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| openid | 委任 | ユーザーのログインに使用します | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| profile | 委任 | ユーザー プロファイルをアプリ タブに表示するために使用します | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
