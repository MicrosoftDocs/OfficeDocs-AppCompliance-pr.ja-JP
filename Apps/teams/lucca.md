...
description: Lucca のすべての利用可能なセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリで使用するホスティング クラウド プロバイダー | SelfHosted |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | 委任 | データは収集されません。 これらを使用して、表示する計画をフィルター処理しました。 チャネル内のユーザーだけが計画を表示します | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
...
>| Group.Read.All | アプリケーション | アプリが不在者とメッセージを送信するグループを知る GroupId を収集します。  | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| User.Read | 委任 | ユーザーのサインインに使用 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| User.Read.All | アプリケーション | ユーザー プロファイルの読み取りに使用 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| メール | 委任 | ユーザーのメールをアプリ タブに表示するために使用します。 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
>| openid | 委任 | ユーザーのログインに使用 | [53628f6a-ac66-4fde-8945-d639c8da4c0d](../azure/53628f6a-ac66-4fde-8945-d639c8da4c0d.md) |
