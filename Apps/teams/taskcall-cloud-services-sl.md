---
title: TaskCall Cloud Services、S.L. による TaskCall のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: TaskCall で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003914" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

TaskCall Cloud Services、S.L によって提供される情報。 Microsoft に対して:
...
| パートナー会社名 | TaskCall Cloud Services, S.L. |
| 会社の Web サイト | [https://taskcallapp.com](https://taskcallapp.com) |
| アプリの使用条件 | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| アプリのコア機能 | TaskCall のMicrosoft Teams双方向統合は、Microsoft Teams内からインシデントを処理できるようにすることで、コミュニケーションとIT-Opsコラボレーションを効率化します。 |
| 会社の本社の場所 | スペイン |
| アプリ情報ページ | [https://docs.taskcallapp.com/integrations/v1/microsoft-team...](https://docs.taskcallapp.com/integrations/v1/microsoft-teams-integration-guide) |
...
この情報は、TaskCall Cloud Services S.L によって提供されています。 このアプリが組織のデータを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
