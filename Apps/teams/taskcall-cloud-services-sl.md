---
title: TaskCall による TaskCall のアプリケーションCloud Services S.L.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: TaskCall、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/eea91208-6850-4a61-8508-64b6c45d23a1" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003914" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

TaskCall Cloud Services S.L. によって提供される情報。 Microsoft に:
...
| アプリの利用規約 | [https://www.taskcallapp.com/terms-of-service](https://www.taskcallapp.com/terms-of-service) |
| アプリのコア機能 | TaskCall の双方向Microsoft Teams統合により、IT-Ops内からインシデントを処理できるようにすることで、コミュニケーションとMicrosoft Teams。 |
| 会社の本社所在地 | スペイン |
...
この情報は、TaskCall Cloud Services S.L によって提供されています。 このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて。
