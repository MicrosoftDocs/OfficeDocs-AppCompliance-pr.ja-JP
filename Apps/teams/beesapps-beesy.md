...
description: Beesy で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2021 年 11 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/03a513ab-60d8-4d27-8c9a-5182934a43bb" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001248" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | BeesApps |
| 会社の Web サイト | [https://www.beesapps.com](https://www.beesapps.com) |
| アプリの使用条件 | [https://www.beesy.me/legal/termsofservice_en_v1.03.pdf](https://www.beesy.me/legal/termsofservice_en_v1.03.pdf) |
| アプリのコア機能 | すべてのアクティビティを追跡し、タスクで共同作業を行い、プロジェクト レポートを作成するスマート アシスタント。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://www.beesapps.com/use-beesy/beesy-and-microsoft-team...](https://www.beesapps.com/use-beesy/beesy-and-microsoft-teams/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する BeesApps によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル、Outlook からの一部のメール、会議のメモにリンクする予定表 ID |
...
| プライバシー ポリシーの URL | https://www.beesapps.com/support-beesy/le-rgpd-et-beesy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | Outlook イベントから beesy 会議ノートを作成する | [d27f56ed-ddc7-4cf8-86ac-721b76c7d287](../azure/d27f56ed-ddc7-4cf8-86ac-721b76c7d287.md) |
>| Calendars.ReadWrite.Shared | 委任 | 共有 Outlook イベントから beesy 会議ノートを作成する | [d27f56ed-ddc7-4cf8-86ac-721b76c7d287](../azure/d27f56ed-ddc7-4cf8-86ac-721b76c7d287.md) |
>| Chat.Read | 委任 | Microsoft Teams チャットから beesy アクションを作成する | [d27f56ed-ddc7-4cf8-86ac-721b76c7d287](../azure/d27f56ed-ddc7-4cf8-86ac-721b76c7d287.md) |
>| Files.Read.All | 委任 | Microsoft teams チャット メッセージからの添付を beesy アクションに追加する | [d27f56ed-ddc7-4cf8-86ac-721b76c7d287](../azure/d27f56ed-ddc7-4cf8-86ac-721b76c7d287.md) |
>| Mail.Read | 委任 | Outlook Web の補数から beesy にメールを送信する | [d27f56ed-ddc7-4cf8-86ac-721b76c7d287](../azure/d27f56ed-ddc7-4cf8-86ac-721b76c7d287.md) |
>| User.Read | 委任 | office365 プロファイルを beesy プロファイルにリンクする | [d27f56ed-ddc7-4cf8-86ac-721b76c7d287](../azure/d27f56ed-ddc7-4cf8-86ac-721b76c7d287.md) |
