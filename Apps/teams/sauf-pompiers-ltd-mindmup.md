...
description: MindMup、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.mindmup.com/resources/terms_mindmup.html](https://www.mindmup.com/resources/terms_mindmup.html) |
| アプリのコア機能 | MindMup を使用すると、ユーザーはマインド マップ、クモ図、概念マップ、引数の視覚化、階層グラフを使用してアイデアを簡単に視覚化できます。 |
