...
description: MindMup で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001759" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.mindmup.com](https://www.mindmup.com) |
| アプリの使用条件 | [https://www.mindmup.com/resources/terms_mindmup.html](https://www.mindmup.com/resources/terms_mindmup.html) |
| アプリのコア機能 | MindMup を使用すると、ユーザーは、マインド マップ、スパイダーダイアグラム、概念マップ、引数の視覚化、階層グラフを使用してアイデアを簡単に視覚化できます。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://www.mindmup.com/tutorials/microsoft-teams.html](https://www.mindmup.com/tutorials/microsoft-teams.html) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Sauf Pompiers Ltd から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Teams.ReadBasic.All | 委任 | ユーザーのチーム識別子とチーム名 | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
>| User.Read | 委任 | ユーザー識別子、認証後に表示する電子メール アドレス | [c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2](../azure/c12a3d54-d294-4a51-8cd3-4a48b6c7e6f2.md) |
