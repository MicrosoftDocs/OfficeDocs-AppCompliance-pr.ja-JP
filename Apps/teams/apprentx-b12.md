---
title: Apprentx による B12 のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/11/2022
...
description: B12 で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "65548882"
---
# <a name="b12"></a>B12

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 4 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/a4a2213d-2466-473b-8772-021094c5f013" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004073" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Apprentx から Microsoft に提供される情報:
...
| パートナー会社名 | Apprentx |
| 会社の Web サイト | [https://apprentx.rocks](https://apprentx.rocks) |
| アプリの使用条件 | [https://blogue.apprentx.rocks/terms-and-conditions](https://blogue.apprentx.rocks/terms-and-conditions) |
| アプリのコア機能 | B12 は、知識強化と実践を組み合わせて、影響を最大化します。 |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | [https://apprentx.rocks/en/nos-solutions](https://apprentx.rocks/en/nos-solutions) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Apprentx から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | オプションの SSO 機能のために、ユーザーの名前と電子メールを含む ID トークンを処理します |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | オプションの予定表同期機能のアクセス トークンを格納します |
...
| プライバシー ポリシーの URL | https://blogue.apprentx.rocks/en/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | SSO のTeams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| メール | 委任 | SSO のTeams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| offline_access | 委任 | SSO のTeams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| openid | 委任 | SSO のTeams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| profile | 委任 | SSO のTeams | [228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a](../azure/228af2d7-23b5-4d1f-a5bf-9a1670e4fb6a.md) |
>| Calendars.ReadWrite | 委任 | 予定表の同期 | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
>| User.Read | 委任 | 予定表の同期 | [75932bb9-5e71-449a-b584-b5cc01c2d118](../azure/75932bb9-5e71-449a-b584-b5cc01c2d118.md) |
