---
title: WNI による共有スレッドのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/09/2022
...
description: WNI による共有スレッド、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63551236"
---
# <a name="shared-thread-by-wni"></a>WNI による共有スレッド

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 1 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/33830d7f-553a-46ce-99b3-4dc436b28e45" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003755" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

WNI から Microsoft に提供される情報:
...
| パートナー会社名 | WNI |
| 会社の Web サイト | [https://www.wni.app](https://www.wni.app) |
| アプリの利用規約 | [https://www.wni.app/terms](https://www.wni.app/terms) |
| アプリのコア機能 | 別のチャネルまたは Slack Microsoft Teamsスレッドで会話とリンクできる会話を、Microsoft Teamsチャネルに作成します。  セットアップが完了したら、  |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | [https://www.wni.app/shared-thread/](https://www.wni.app/shared-thread/) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する WNI によって提供されています。
...
| プライバシー ポリシーの URL | https://www.wni.app/privacy |
