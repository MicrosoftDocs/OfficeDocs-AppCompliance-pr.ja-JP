...
description: qbo で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/834c6939-152c-450b-a305-c65b4dd5d1c7" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001708" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://unscrambl.com/service-agreement](https://unscrambl.com/service-agreement) |
| アプリのコア機能 | Unscrambl qbo insights を搭載した qbo は、クラス最高の NLP を使用して分析を会話可能にします。 ユーザーは質問を入力し、qbo は最も関連性の高い分析情報と視覚化をスナップで表示します。 ユーザーは、同僚と積極的に共同作業を行い、意思決定を行い、プレゼンテーション対応のボードで結果をキャプチャできます。 qbo を使用すると、組織内のすべてのユーザーがデータドリブンな意思決定を行うことができます。 qbo は、さまざまなクラウドまたはオンプレミスのソースに直接接続し、Microsoft Teamsまたはブラウザーからアクセスできます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://qbo.ai](https://qbo.ai) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Unscrambl によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | アカウントの作成には、名前と電子メール アドレスが使用されます |
