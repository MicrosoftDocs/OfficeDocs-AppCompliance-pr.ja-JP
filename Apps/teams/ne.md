...
description: NE で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/bd4bd4f6-ec6c-42b3-b296-bf39b8b758b3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000840" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

NE から Microsoft に提供される情報:
...
| パートナー会社名 | NE |
| 会社の Web サイト | [https://www.ne.se](https://www.ne.se) |
| アプリの使用条件 | [https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillk...](https://www.ne.se/info/hj%c3%a4lp/allm%c3%a4nna-avtalsvillkor/fleranv%c3%a4ndare/) |
| アプリのコア機能 | NE のお客様がチーム内からコンテンツ サービスにアクセスできるようにするチーム アプリ。 また、チーム メッセージ拡張機能も追加され、ユーザーはチャットで@neを入力して NE 百科事典を検索できます。 |
| 会社の本社の場所 | スウェーデン |
| アプリ情報ページ | [https://www.ne.se/info/om-oss/](https://www.ne.se/info/om-oss/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて NE から提供されています。
