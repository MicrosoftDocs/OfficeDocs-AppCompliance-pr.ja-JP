...
| パートナー会社名 | MURAL |
| 会社の Web サイト | [https://mural.co](https://mural.co) |
| アプリの利用規約 | [https://mural.co/terms](https://mural.co/terms) |
| アプリのコア機能 | 視覚的に考え、共同作業する |
| 会社の本社所在地 | 米国オブアメリカ |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する MURAL によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリで処理されるデータは何ですか? | MURAL では、ログイン目的でのみ Name、Last Name、および Email Address が必要です。 処理または保存するデータの種類は、顧客によって異なる |
| アプリは TLS 1.1 以上をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データが格納されていますか? | はい |
| データベースに格納されているデータは何ですか? | MURAL では、ログインの目的でユーザーの名前、名、および電子メールだけが必要であり、保存される情報の残りの部分は、ユーザーが自分の壁画に保存する情報に依存します。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read | 委任 | ドキュメントを MURAL にアップロードするために必要な Files.read。 | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
>| User.Read | 委任 | アカウントの作成には、壁画で名、名、および電子メールが必要なので、User.read。 | [a1ef3a23-74fc-4c91-909f-691cc47a1c8e](../azure/a1ef3a23-74fc-4c91-909f-691cc47a1c8e.md) |
