---
title: Standup Alice by Bao Le Duc のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Standup Alice で使用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/724b774e-aa53-4d2d-885b-6008c114cb37" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000758" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Bao Le Duc |
| 会社の Web サイト | [https://www.standupalice.com](https://www.standupalice.com) |
| アプリの使用条件 | [https://www.standupalice.com/terms](https://www.standupalice.com/terms) |
| アプリのコア機能 | Scrum チームの毎日の立ち上げ会議を効果的に実行するのに役立ちます |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | [https://www.standupalice.com](https://www.standupalice.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、以下の情報が提供されています。
