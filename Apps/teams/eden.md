---
title: Eden by Eden のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/22/2022
...
description: Eden で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/bb8a8db6-14d2-4bde-820d-c601586df0a5" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004430" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Microsoft に対する Eden から提供される情報:
...
| パートナー会社名 | エデン |
| 会社の Web サイト | [https://www.edenworkplace.com](https://www.edenworkplace.com) |
| アプリの使用条件 | [https://www.edenworkplace.com/terms-of-service](https://www.edenworkplace.com/terms-of-service) |
| アプリのコア機能 | Eden Workplace は、最新のオフィス向けのソフトウェアの完全なスイートです。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Eden によって提供されています。
...
| プライバシー ポリシーの URL | https://www.edenworkplace.com/privacy-policy |
