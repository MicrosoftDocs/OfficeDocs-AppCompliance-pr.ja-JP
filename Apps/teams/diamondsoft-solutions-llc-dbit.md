...
description: DBit、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/b28bb657-8edd-47ae-a912-c5fc11b3e89e" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001536" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.dbit.io/termsofuse.html](https://www.dbit.io/termsofuse.html) |
| アプリのコア機能 | 手間のかからない DBit パスワード管理ソリューション。 DBit は、小規模から大規模なチーム向けパスワード管理ツールです。 DBit を使用すると、チーム メンバー間でパスワードを安全に共有できます。 生成された共有パスワードとパスワードは、設定された時間 (分) 後に自動的に期限切れになります。 パスワードはサーバー上のメモリで暗号化され、ディスクストレージに保存されません。 パスワードの有効期限が切れると、サーバーのメモリから削除されます。 このアプリは、Diamondsoft Solutions LLC によって開発されています。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する、Diamondsoft Solutions LLC によって提供されています。
