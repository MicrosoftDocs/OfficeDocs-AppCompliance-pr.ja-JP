---
title: DSMN8 による従業員アドボカシーのアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 01/19/2022
ms.topic: article
...
description: DSMN8 による Employee Advocacy のすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "62259613"
---
# <a name="employee-advocacy-by-dsmn8"></a>DSMN8 による従業員のアドボカシー

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 26 日</p>

* <a href="https://teams.microsoft.com/l/app/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003677" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://dsmn8.com/terms-and-conditions](https://dsmn8.com/terms-and-conditions) |
| アプリのコア機能 |  DSMN8 は、会社が承認した会社のコンテンツを自分のソーシャル メディア チャネルに共有することで、従業員が会社のインフルエンサーになる権限を与えるアプリ ベースのプラットフォームです。  |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する DSMN8 によって提供されています。
...
| データベースに格納されているデータは何ですか? | 役職、名、名、電子メール アドレス |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 両方とも | サインオン プロセス中に役職、名、名、電子メール のデータを読み取り、アプリでプロファイルを作成するには | [3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c](https://docs.microsoft.com/microsoft-365-app-certification/azure/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c) |
