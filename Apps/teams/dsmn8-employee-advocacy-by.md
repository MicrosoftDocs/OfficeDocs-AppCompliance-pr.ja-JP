...
description: DSMN8 による Employee Advocacy の利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 両方とも | サインオン プロセス中に役職、名、名、電子メール のデータを読み取り、アプリでプロファイルを作成するには | [3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c](../azure/3cf056e3-1c08-4cda-b6d6-962f7c7a1f7c.md) |
