...
description: 加美の利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/95b82c84-8994-45f6-946a-dda105f9d5df" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004148" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

加美から Microsoft に提供される情報:
...
| パートナー会社名 | 上 |
| 会社の Web サイト | [https://kamiapp.com](https://kamiapp.com) |
| アプリの使用条件 | [https://kamiapp.com/terms-of-service/](https://kamiapp.com/terms-of-service/) |
| アプリのコア機能 | Microsoft Teamsのために今すぐ&#8211;を使って学ぶことを皆に愛していただけるMicrosoft Empower for ISV Initiative。 |
| 会社の本社の場所 | ニュージーランド |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、加美から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル (名前、電子メール)。 ファイルとメタデータをOneDriveします。 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ (名前、電子メール、ID)。 ファイル メタデータ (ファイル名、アイテム ID、ドライブ ID) をOneDriveします。 ドキュメントの注釈。 |
...
| プライバシー ポリシーの URL | https://www.kamiapp.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委任 | ユーザーがOneDriveファイルとSharePoint ファイルを開き、更新、エクスポートできるようにするには、次の操作を行います。 | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
>| User.Read | 委任 | 加美プロファイルを設定するためのユーザー プロファイル データ (電子メールと名前など) にアクセスする場合。 | [5fb90a92-665c-4ec3-863e-e37572074eb2](../azure/5fb90a92-665c-4ec3-863e-e37572074eb2.md) |
