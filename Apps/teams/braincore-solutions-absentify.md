---
title: BrainCore ソリューションによる不在時のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
description: 存在しない場合に使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/fbd349eb-146f-4e94-af76-df4754f40749" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003833" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

BrainCore Solutions から Microsoft に提供される情報:
...
| パートナー会社名 | BrainCore Solutions |
| 会社の Web サイト | [https://braincore.solutions](https://braincore.solutions) |
| アプリの使用条件 | [https://absentify.com/terms-and-conditions](https://absentify.com/terms-and-conditions) |
| アプリのコア機能 | 従業員の休暇を処理する最も簡単な方法 - Microsoft Teams |
| 会社の本社の場所 | スイス |
| アプリ情報ページ | [https://absentify.com](https://absentify.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する BrainCore ソリューションによって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | Microsoft ユーザー ID、電子メール、DisplayName |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | Microsoft ユーザー ID、電子メール、DisplayName |
...
| プライバシー ポリシーの URL | https://absentify.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | アプリケーション | 省略可能。 Microsoft Teamsに通知を送信する。 | [0f5eabc0-89bf-4cc6-80d1-10094b5919d2](/microsoft-365-app-certification/azure/0f5eabc0-89bf-4cc6-80d1-10094b5919d2) |
>| Calendars.ReadWrite | 委任 | 省略可能: 休暇のOutlook予定表エントリを自動的に作成します。 | [3dbcb38b-8d2f-4e97-9bd1-975fb770b31c](/microsoft-365-app-certification/azure/3dbcb38b-8d2f-4e97-9bd1-975fb770b31c) |
>| User.Read | 委任 | ログインの場合 | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
>| User.ReadBasic.All | 委任 | 省略可能: ユーザーの Microsoft プロファイル画像を表示します。 | [4dce2abf-3f8e-4281-9f7a-d602fc391886](/microsoft-365-app-certification/azure/4dce2abf-3f8e-4281-9f7a-d602fc391886) |
