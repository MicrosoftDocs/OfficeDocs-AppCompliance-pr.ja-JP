---
title: Advantive による 365-QA のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: 365-QA で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2021 年 12 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/03e51569-33a8-4000-abb6-9a825e33ece2" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001394" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Advantive から Microsoft に提供される情報:
...
| パートナー会社名 | Advantive |
| 会社の Web サイト | [https://www.advantive.be](https://www.advantive.be) |
| アプリの利用規約 | [https://www.advantive.be/terms-of-service-en/](https://www.advantive.be/terms-of-service-en/) |
| アプリのコア機能 | Advantive は、Microsoft テクノロジを使用して革新的な ICT ソリューションを開発および実装する、ICT 専門家の熱心なチームです。 Microsoft は、標準的な Microsoft 機能に基づいて、最高の品質のアドバイス、製品、サービスを提供します。 これにより、降臨&#8217;顧客は効率を高め、急速に変化する状況を利用できます。 当社のコアビジネスは、アドバイス、開発、実装、プロジェクトサポート、メンテナンスなどのサービスを提供します。 |
| 会社の本社所在地 | ベルギー |
| アプリ情報ページ | [https://www.advantive.be/365-qa-how-to/](https://www.advantive.be/365-qa-how-to/) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Advantive によって提供されています。
...
| どの SOC 2 認定を取得しましたか? | |
| 最新の SOC2 認定日 | |
| アプリは Service Organization Controls (SOC 3) に準拠していますか? | なし |
| 最新の SOC3 認定日 | |
...
| **Information** | **応答** |
|:----------------|:-------------|
| GDPR または他のプライバシーまたはデータ保護の要件または義務 (CCPA など) はありますか? | なし |
| アプリには、顧客データの収集、使用、共有、および保存方法を示す外部向けプライバシー通知がありますか? | なし |
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリケーションは Microsoft Identity Platform (Azure AD) と統合してシングル サインオンや API アクセスなどを行いますか。 | なし |
| 統合チェックリストの概要に示されている適用可能なすべてのベスト プラクティスを確認し、Microsoft ID プラットフォームしましたか? | なし |
