...
description: 365-QA で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/03e51569-33a8-4000-abb6-9a825e33ece2" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001394" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.advantive.be/terms-of-service-en/](https://www.advantive.be/terms-of-service-en/) |
| アプリのコア機能 | Advantive は、MICROSOFT テクノロジを使用して革新的なICT ソリューションを開発および実装する、ICT プロフェッショナルの熱いチームです。 Microsoft では、標準の Microsoft 機能に基づいて、高品質のアドバイス、製品、サービスを提供しています。 これにより、&#8217;の顧客は効率を高め、急速に変化する状況を利用できます。 私たちのコア ビジネスは、アドバイス、開発、実装、プロジェクトのサポート、メンテナンスを含むサービスを提供することです。 |
| 会社の本社の場所 | ベルギー |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Advantive によって提供されています。
