---
title: blue-zone GmbH による polumana Tour Route Planner のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
description: polumana Tour Route Planner に使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/4b4b3e3d-a1eb-4b52-b0b9-ba1a79b6be79" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004331" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Blue-zone GmbH から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | polumana Tour Route Planner |
| ID | WA200004331 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | blue-zone GmbH |
| 会社の Web サイト | [https://blue-zone.de](https://blue-zone.de) |
| アプリの使用条件 | [https://azaap-disp-route-planning.azurewebsites.net/#/terms...](https://azaap-disp-route-planning.azurewebsites.net/#/termsofuse) |
| アプリのコア機能 | 顧客訪問の効率を向上させる Polumana Tour &amp; Route Planner |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関するブルー ゾーン GmbH によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 連絡先、Emailアドレス |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | Email、連絡先のアドレス |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | アプリケーション | ルートの最適化後、新しい予定を作成し、既存の予定を削除する必要があります | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
>| Contacts.Read | アプリケーション | 予定を作成するには、連絡先を読む必要があります | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
>| User.Read | アプリケーション | 設定を保持するには、ユーザーのEmailを取得する必要があります | [d361752a-c257-474d-bb79-324fbe4898b5](../azure/d361752a-c257-474d-bb79-324fbe4898b5.md) |
