...
description: ForceManager CRM で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.forcemanager.com/info/terms-and-conditions/](https://www.forcemanager.com/info/terms-and-conditions/) |
| アプリのコア機能 | ForceManager は、ホーム、オフィス、フィールドなど、さまざまな作業スタイル用に作成されたフル サービス Web およびモバイル アプリを備える主要な CRM です。 このアプリは、ユーザーフレンドリーなインターフェイスと使いやすいアプリを使用して、毎日の議題とアクティビティを管理する必要がある営業担当者を対象とします。 |
| 会社の本社所在地 | スペイン |
| アプリ情報ページ | |
