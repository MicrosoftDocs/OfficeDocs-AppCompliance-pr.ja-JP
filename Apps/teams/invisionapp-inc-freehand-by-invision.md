---
title: InVisionApp, Inc. による Freehand by InVision のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2021
...
description: Freehand by InVision で利用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/67cf2c5a-db0e-4256-a423-14010cbeafdd" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381362" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

InVisionApp, Inc. から Microsoft に提供される情報:
...
| パートナー会社名 | InVisionApp, Inc. |
| 会社の Web サイト | [https://www.invisionapp.com](https://www.invisionapp.com) |
| アプリの使用条件 | [https://www.invisionapp.com/legal/terms-of-service](https://www.invisionapp.com/legal/terms-of-service) |
| アプリのコア機能 | オンラインホワイトボードを使用してリアルタイムで共同作業を行います。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.invisionapp.com/freehand](https://www.invisionapp.com/freehand) |
...
この情報は、InVisionApp, Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
...
| 最新の SOC2 認定日 | 2020-05-13 |
| アプリはサービス組織コントロール (SOC 3) に準拠していますか? | はい |
| 最新の SOC3 認定日 | 2020-06-12 |
