---
title: InVisionApp, Inc. による InVision によるフリーハンドのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2021
...
| アプリの利用規約 | [https://www.invisionapp.com/legal/terms-of-service](https://www.invisionapp.com/legal/terms-of-service) |
| アプリのコア機能 | オンライン ホワイトボードを使用してリアルタイムで共同作業を行います。 |
| 会社の本社所在地 | アメリカ |
...
この情報は、InVisionApp, Inc. から、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
