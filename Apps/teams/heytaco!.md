...
>| profile | 委任 | ユーザー名、プロファイル イメージ、タイム ゾーン オフセット、テナント ID、およびチーム ID をキャプチャするために使用されます。 | ユーザー名、アバター、タイム ゾーン オフセット、テナント ID、およびチーム ID をキャプチャするために使用されます。 | [be8d11cf-265a-4974-9912-4ff28c29fc21](https://docs.microsoft.com/microsoft-365-app-certification/azure/be8d11cf-265a-4974-9912-4ff28c29fc21) |
