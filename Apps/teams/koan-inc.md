...
| アプリのコア機能 | 目標管理とステータス追跡を直接管理Microsoft Teams進捗を確認し、チームを調整します。 Koan&#8217;統合により、従業員は仕事に集中し、仕事を離れることなく最も重要Microsoft Teams。 ステータスを共有し、勝利を認識し、懸念事項を早期に特定する前向きなチーム習慣を簡単に構築し、周囲の他の誰もが問題を引き起こす。 |
| 会社の本社所在地 | アメリカ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | チャネル ID とチャネル名が使用されます。 ユーザーがリフレクション通知を配信する場所を選択できるよう、データを使用します。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| Team.ReadBasic.All | 両方とも | チーム ID とチーム名は両方とも収集され、使用されます。 ユーザーがリフレクション通知を配信する場所を選択できるよう、データを使用します。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| User.Read | 委任 | ユーザー名、ユーザー ID、ユーザーの電子メール アドレスが使用されます。 データを使用して、ユーザー アカウントをユーザー アカウントと koan Microsoft Teamsリンクします。 これは、言及時にのみ適用されます。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
