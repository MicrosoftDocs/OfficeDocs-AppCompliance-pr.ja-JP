...
description: Koan で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/dae2b2c3-b014-4188-a887-c87c3ca4a227" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002936" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Koan, Inc. |
| 会社の Web サイト | [https://www.koan.co](https://www.koan.co) |
| アプリの使用条件 | [https://www.koan.co/terms-of-service](https://www.koan.co/terms-of-service) |
| アプリのコア機能 | 目標管理と状態追跡をMicrosoft Teamsに直接取り込み、進捗状況を確認し、チームの連携を維持します。 Koan&#8217;の統合により、従業員は、Microsoft Teamsを離れることなく、最も重要な作業に集中し続けることができます。 状態を共有し、勝ちを認識し、懸念を早期に特定するポジティブなチーム習慣を簡単に構築し、周囲の全員のバーを高めることができます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.koan.co/how-it-works](https://www.koan.co/how-it-works) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Koan, Inc. によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | チャネル ID とチャネル名が使用されます。 ユーザーがリフレクション通知を配信する場所を選択できるように、データを使用します。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| Team.ReadBasic.All | 両方とも | チーム ID とチーム名の両方が収集され、使用されます。 ユーザーがリフレクション通知を配信する場所を選択できるように、データを使用します。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
>| User.Read | 委任 | ユーザー名、ユーザー ID、ユーザー電子メール アドレスが使用されます。 このデータを使用して、Microsoft Teamsと Koan の間でユーザー アカウントをリンクします。 これは、at-mention にのみ適用されます。 | [5b599e19-a609-432b-9074-c9d4457e8766](../azure/5b599e19-a609-432b-9074-c9d4457e8766.md) |
