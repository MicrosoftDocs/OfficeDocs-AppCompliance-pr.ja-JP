...
description: マルチ承認プロセス LTAPP、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| 会社の Web サイト | [https://ltaddins.com](https://ltaddins.com) |
| アプリの利用規約 | [https://ltaddins.com/terms.html](https://ltaddins.com/terms.html) |
| アプリのコア機能 | マルチ承認プロセスは、エンドユーザーが要求を行うのを可能にする使いやすいアプリケーションです。 アプリは完全にカスタマイズ可能で、管理者は組織の仕様との一貫性を維持できます。 |
| 会社の本社所在地 | ベトナム |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザー情報テナント &amp; ID | [d2682b2a-2037-4545-94b6-3e7216ecca5f](../azure/d2682b2a-2037-4545-94b6-3e7216ecca5f.md) |
