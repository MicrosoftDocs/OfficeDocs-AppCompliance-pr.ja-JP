---
title: KUDO,Inc. による KUDO 多言語会議のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 11/15/2021
ms.topic: article
...
description: KUDO 多言語会議、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "60969193"
---
# <a name="kudo-multilingual-meetings"></a>KUDO 多言語会議

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/9ae3d116-3feb-48c6-b3c4-b61dceb760af" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003295" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

KUDO, Inc. から Microsoft に提供される情報:
...
| パートナー会社名 | KUDO, Inc. |
| 会社の Web サイト | [https://kudoway.com](https://kudoway.com) |
| アプリの利用規約 | [https://kudoway.com/terms-of-use/](https://kudoway.com/terms-of-use/) |
| アプリのコア機能 | KUDO を使用すると、企業は複数の言語でグローバルに通信できます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、KUDO, Inc. から、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| データベースに格納されているデータは何ですか? | 電子メール ID |
...
| プライバシー ポリシーの URL | https://kudoway.com/privacy-policy/ |
