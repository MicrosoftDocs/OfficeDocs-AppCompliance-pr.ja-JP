...
description: Timeneye で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64876414"
---
# <a name="timeneye"></a>Timeneye

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 8 月 31 日</p>

* <a href="https://teams.microsoft.com/l/app/015bf4ec-bc37-4931-9862-ef8686da652b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001950" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.timeneye.com/terms-and-conditions](https://www.timeneye.com/terms-and-conditions) |
| アプリのコア機能 | Microsoft Teamsから直接タスクに費やされた時間を追跡します。 |
| 会社の本社の場所 | イタリア |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する DM Digital SRL によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委任 | Event Start/End DateTime、Event Subject、Event ID、Event Web URI。 予定表イベントに基づいて候補を生成します。 | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Calendars.Read.Shared | 委任 | Event Start/End DateTime、Event Subject、Event ID、Event Web URI。 この情報を使用して、予定表イベントに基づいて候補を生成します。 | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Directory.Read.All | 委任 | ユーザーのグループの ID。 この情報を使用して、ユーザーがメンバーになっているグループを確認し、グループのプランナーを同期できるようにします。 | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Group.Read.All | 委任 | グループ名、グループ ID。 これらの情報は、Planner プロジェクトの同期中に使用されます。 | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| Tasks.Read | 委任 | タスク リスト名、タスク リスト ID。 この情報は、Planner プロジェクトの同期中に使用します。 | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| User.Read | 委任 | 電子メール、名前。 この情報を使用してユーザーにログイン/ユーザー アカウントを作成します | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| User.ReadBasic.All | 委任 | ユーザー名、電子メール。 この情報は、ユーザーが Planner/Microsoft からサービスに他のユーザーをインポートできるように使用します。 | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| メール | 委任 | 電子メール。 この情報を使用してユーザーにログイン/ユーザー アカウントを作成します | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| offline_access | 委任 | ユーザーがオンラインでない間にプランナー/予定表を同期するために必要なアクセス許可。 | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| openid | 委任 | id_token。 Microsoft SSO を使用したユーザーのログイン | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
>| profile | 委任 | 電子メール、名前。 この情報を使用してユーザーにログイン/ユーザー アカウントを作成します | [56412014-bafe-474e-95b4-ebfea106a167](../azure/56412014-bafe-474e-95b4-ebfea106a167.md) |
