...
* <a href="https://teams.microsoft.com/l/app/383cc171-22d5-4df5-87d0-6c656ddcff32" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002393" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| アプリのコア機能 | 50 は、カスタマイズされた課題を与えることによって、知識から行動に移るのを助ける。 これらの課題は、コア スキルの一部を統合または向上させるのに役立ちます。 |
| 会社の本社所在地 | フランス |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて、50 によって提供されています。
