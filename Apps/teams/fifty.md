---
title: フィフティ バイ フィフティのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 50 のセキュリティとコンプライアンスに関するすべての情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64875424"
---
# <a name="fifty"></a>Fifty

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 6 月 7 日</p>

* <a href="https://teams.microsoft.com/l/app/383cc171-22d5-4df5-87d0-6c656ddcff32" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002393" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Fifty |
| 会社の Web サイト | [https://app.fifty.do](https://app.fifty.do) |
| アプリの使用条件 | [https://app.fifty.do/CGUV.pdf](https://app.fifty.do/CGUV.pdf) |
| アプリのコア機能 | 50 人は、パーソナライズされた課題を与えることで、知識から行動へと移行するのに役立ちます。 これらの課題は、コア スキルの一部を統合または改善するのに役立ちます。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://www.fifty.do](https://www.fifty.do) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、50 人から提供されています。
