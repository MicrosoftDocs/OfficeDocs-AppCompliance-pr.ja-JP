---
title: HASHIAI による Hashiai のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2021
...
description: スナイ、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/714dce8d-d78a-470d-9d4a-8db9118a2106" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001902" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

HASHIAI から Microsoft に提供される情報:
...
| パートナー会社名 | KAKEAI |
| 会社の Web サイト | [https://kakeai.co.jp](https://kakeai.co.jp) |
| アプリの使用条件 | [https://kakeai.com/terms](https://kakeai.com/terms) |
| アプリのコア機能 | クラウド システム  HASHIAI; コミュニケーションの&#8220;品質&#8221;を向上させる |
| 会社の本社の場所 | 日本 |
| アプリ情報ページ | [https://help.kakeai.com/ja/articles/4230882](https://help.kakeai.com/ja/articles/4230882) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、HASHIAI によって提供されています。
