...
| アプリの利用規約 | [https://www.humu.com/humu-for-microsoft-teams-license](https://www.humu.com/humu-for-microsoft-teams-license) |
| アプリのコア機能 | Humu は、組織が毎週簡単に改善できるアクション管理プラットフォームです。 Humu は、ビジネス戦略を組織内のすべてのユーザーの個人的に関連するアクションに変換します。 当社の主な焦点は、組織の改善を大規模に推進し、生産性、共同作業、革新的、包括的な従業員を生み出しています。 Humu は変更を容易にすることで、より良い作業を行います。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
