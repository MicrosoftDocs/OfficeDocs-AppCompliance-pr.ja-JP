---
title: LawVu による LawVu USA のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: LawVu USA で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64682138"
---
# <a name="lawvu-usa"></a>LawVu USA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 22 日</p>

* <a href="https://teams.microsoft.com/l/app/410462ec-76c7-45ac-9f57-61e6f82a6792" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003911" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://lawvu.com/wp-content/uploads/Std-Saas-Agreement-202...](https://lawvu.com/wp-content/uploads/Std-Saas-Agreement-2021.pdf) |
| アプリのコア機能 | ビジネス ユーザーは、Teamsから法的要求を直接行うことができます。  この統合により、コンテンツや元のメッセージからの添付ファイルなど、関連するすべてのフィールドがキャプチャされ、LawVu で問題が作成され、法務チーム&#8217;のレコード システムの一部&#8217;されます。 |
| 会社の本社の場所 | ニュージーランド |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて LawVu によって提供されています。
...
| データベースに格納されているデータは何ですか? | MS チームの添付ファイルは、データ ストアに取り込まれます。 |
