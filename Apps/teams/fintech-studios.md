---
title: FinTech Studios による FinTech Studios のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: FinTech Studios で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64974380"
---
# <a name="fintech-studios"></a>FinTech Studios

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/65e85032-940c-4d03-ad03-029fe9fff997" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003969" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

FinTech Studios から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | FinTech Studios |
| ID | WA200003969 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | FinTech Studios |
| 会社の Web サイト | [https://www.fintechstudios.com](https://www.fintechstudios.com) |
| アプリの使用条件 | [https://www.fintechstudios.com/eula](https://www.fintechstudios.com/eula) |
| アプリのコア機能 | AI 主導のビジネス インテリジェンス |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.fintechstudios.com/products](https://www.fintechstudios.com/products) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する FinTech Studios によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、チーム名/ID、チャネル名/ID (メッセージ データなし)、チャット名/ID (メッセージ データなし) |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ (名前、電子メール、Microsoft Graph アクセス + 更新トークン) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | アプリケーションのタスク モジュールからコンテンツを共有するチャネルをユーザーに求めるには | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChannelMessage.Send | 委任 | アプリケーション内のタスク モジュールからチャネルに共有コンテンツを送信するには | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Chat.ReadBasic | 委任 | アプリケーションのタスク モジュールからコンテンツを共有するためのチャットをユーザーに求めるには | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| ChatMessage.Send | 委任 | アプリケーションのタスク モジュールからチャットに共有コンテンツを送信するには | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| Team.ReadBasic.All | 委任 | ユーザーがアクセスできるチャネルにアクセスできるように、ユーザーがアクセスできるチームを取得する必要があります。 | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
>| User.Read | 委任 | ユーザーに関する識別情報と通信情報を取得するには | [93b14320-d9b5-4876-b621-172af4d36985](../azure/93b14320-d9b5-4876-b621-172af4d36985.md) |
