---
title: Sense4code による Scormium のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Scormium で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/ad42b2ed-c5ad-4f2c-99e3-5da268a9c967" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004358" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Sense4code から Microsoft に提供される情報:
...
| パートナー会社名 | Sense4code |
| 会社の Web サイト | [https://en.scormium.com](https://en.scormium.com) |
| アプリの使用条件 | [https://en.scormium.com/podminky-a-pravidla-uziti](https://en.scormium.com/podminky-a-pravidla-uziti) |
| アプリのコア機能 | Scormium を使用して、E ラーニング、イベント、スタディ パスの機能をお楽しみください。  |
| 会社の本社の場所 | チェコ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Sense4code によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザーの電子メール   |
| アプリは TLS 1.1 以降をサポートしていますか? | 不要 |
...
| プライバシー ポリシーの URL | https://en.scormium.com/zasady-ochrany-soukromi |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | サインインおよびユーザー プロファイルの読み取り | [ffdbe361-6168-42f7-beef-d1931b7922da](../azure/ffdbe361-6168-42f7-beef-d1931b7922da.md) |
