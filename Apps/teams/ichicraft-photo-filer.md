---
title: Photo Filer by Ichicraft のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Photo Filer で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003881" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://photofiler.ichicraft.com/terms/](https://photofiler.ichicraft.com/terms/) |
| アプリのコア機能 | Microsoft Teamsで写真を共有してアーカイブする最も簡単な方法です。 |
| 会社の本社の場所 | オランダ (the) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、一方的に提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 委任 | ユーザーによってアップロードされた写真の小さな概要を含むチャット メッセージを作成します。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | 委任 | フォルダー構造を読み取り、SharePoint ドキュメント ライブラリ内のファイルをアップロードします。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
