---
title: Ichicraft によるフォト ファイルのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Photo Filer、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "64464026"
---
# <a name="photo-filer"></a>Photo Filer

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/28fdbeb3-f306-4d78-a1d8-2c1bef32e6ea" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003881" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Ichicraft から Microsoft に提供される情報:
...
| パートナー会社名 | Ichicraft |
| 会社の Web サイト | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
| アプリの利用規約 | [https://photofiler.ichicraft.com/terms/](https://photofiler.ichicraft.com/terms/) |
| アプリのコア機能 | 写真を共有してアーカイブする最も簡単な方法は、Microsoft Teams。 |
| 会社の本社所在地 | オランダ (the) |
| アプリ情報ページ | [https://photofiler.ichicraft.com](https://photofiler.ichicraft.com) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Ichicraft によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 委任 | ユーザーがアップロードした写真の小さな概要を含むチャット メッセージを作成します。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| Files.ReadWrite.All | 委任 | フォルダー構造を読み取り、ドキュメント ライブラリSharePointアップロードします。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
>| User.Read | 委任 | ユーザー プロファイルから読み取る。 | [e54fe734-bab8-48b2-9ec8-05c2545cc49d](../azure/e54fe734-bab8-48b2-9ec8-05c2545cc49d.md) |
