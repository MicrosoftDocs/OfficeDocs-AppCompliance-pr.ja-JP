...
description: TagMyFav、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63553537"
---
# <a name="tagmyfav"></a>TagMyFav

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者による最終更新日: 2022 年 3 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/4adaed2f-7c6a-4128-ba20-4fb097581b1b" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002713" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.tagmyfav.com/terms-conditions](https://www.tagmyfav.com/terms-conditions) |
| アプリのコア機能 | TagMyFav for Microsoft 365コラボレーションコミュニケーションを容易にする簡単なブックマーク ソリューション&amp;を提供します。 Microsoft Teams &amp; で会話をしながら共有リンクを保存し、Outlook で電子メールを読み、Word でドキュメントを作成したり、ブラウザーで調査を行っている間に保存します。 TagMyFav &amp; は、顧客サポート、技術サポート、法務担当者、学生教師、マーケティング、人事など、すべての業界で、共同作業や研究に役立つリンクを整理して共有するために適しています。 |
| 会社の本社所在地 | インド |
...
この情報は、Avishkaram Technologies Pvt Ltd から、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| データベースに格納されているデータは何ですか? | メール、名前、TimeZone、Microsoft Teams ID |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read | 委任 | ユーザーの連絡先の読み取り | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| User.Read | 委任 | ユーザーの基本的なプロファイル情報の読み取り | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| メール | 委任 | ユーザーのメールの表示 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| offline_access | 委任 | アクセス許可を付与したデータへのアクセスの維持 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| openid | 委任 | ユーザーにサインインする | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
>| profile | 委任 | ユーザー プロファイルの表示 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](../azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7.md) |
