---
title: Avishkaram Technologies Pvt Ltd による TagMyFav のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: TagMyFav で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2022 年 3 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/4adaed2f-7c6a-4128-ba20-4fb097581b1b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002713" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Avishkaram Technologies Pvt Ltd から Microsoft に提供される情報:
...
| パートナー会社名 | Avishkaram Technologies Pvt Ltd |
| 会社の Web サイト | [https://www.avishkaram.com](https://www.avishkaram.com) |
| アプリの使用条件 | [https://www.tagmyfav.com/terms-conditions](https://www.tagmyfav.com/terms-conditions) |
| アプリのコア機能 | TagMyFav for Microsoft 365では、共同作業&amp;のコミュニケーションを容易にする簡単なブックマーク ソリューションが提供されます。 Word で文書を作成している間、またはブラウザーで調査を行っている間に、Outlookでメールを読んでいる間に、Microsoft Teamsで会話をしながら共有リンクを保存&amp;します。 TagMyFav は、カスタマー サポート、テクニカル サポート、法律専門家、学生 &amp; 教師、マーケティング、人事など、あらゆる業界に適しており、コラボレーションや研究に役立つリンクを整理して共有します。 |
| 会社の本社の場所 | インド |
| アプリ情報ページ | [https://www.tagmyfav.com](https://www.tagmyfav.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Avishkaram Technologies Pvt Ltd から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、電子メール |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | 電子メール、名前、TimeZone、Microsoft Teams ID |
...
| プライバシー ポリシーの URL | https://www.tagmyfav.com/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Contacts.Read | 委任 | ユーザーの連絡先の読み取り | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| User.Read | 委任 | ユーザーの基本的なプロファイル情報を読み取る | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| メール | 委任 | ユーザーのメールを表示する | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| offline_access | 委任 | アクセス許可を付与したデータへのアクセスの維持 | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| openid | 委任 | ユーザーにサインインする | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
>| profile | 委任 | ユーザー プロファイルを表示する | [f5f2921e-bfb3-4d75-b84f-0b2cc13096f7](/microsoft-365-app-certification/azure/f5f2921e-bfb3-4d75-b84f-0b2cc13096f7) |
