---
title: GmbH 内のコーネルセン eCademy &amp; による eCademy Lernplattform のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: eCademy Lernplattform、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.ecademy-learning.com/agb/](https://www.ecademy-learning.com/agb/) |
| アプリのコア機能 | 革新的な教育と学習を可能にしたいトレーナーや研修生のために、eCademy Lernplattformは、いつでも、どんな場所でも、個々の実践的な学習パスを開くデジタル学習ソリューションです。 企業や教育機関が、将来の労働市場における熟練した労働者と従業員のトレーニングと開発を成功に向け、需要の増加や異質な人材プールの増加に直面して、より良いパフォーマンスを得るのを支援します。 |
| 会社の本社所在地 | ドイツ |
