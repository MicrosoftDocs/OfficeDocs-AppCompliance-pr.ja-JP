---
title: GmbH 内の eCademy Lernplattform by Cornelsen eCademy &amp; のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: eCademy Lernplattform で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/8b1066b0-59c2-4a7b-8ac6-f43edcfe5eef" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002717" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.ecademy-learning.com](https://www.ecademy-learning.com) |
| アプリの使用条件 | [https://www.ecademy-learning.com/agb/](https://www.ecademy-learning.com/agb/) |
| アプリのコア機能 | 革新的な教育と学習を有効にしたいトレーナーや研修生にとって、eCademy Lernplattform は、いつでも、任意の場所で個人と実践的な学習パスを開くデジタル学習ソリューションです。 私たちは、企業や教育機関が、将来の労働市場に向けて熟練した労働者と従業員のトレーニングと開発に成功し、需要の増加とますます異質な人材プールに直面して、より良いパフォーマンスを発揮できるように支援します。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | [https://www.ecademy-learning.com](https://www.ecademy-learning.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、GmbH 内の Cornelsen eCademy &amp; によって提供されています。
