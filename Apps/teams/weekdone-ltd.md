---
title: Weekdone Ltd による Weekdone のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/28/2021
...
description: Weekdone、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/fa662fca-9224-49e3-9566-f66d2a6949af" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003399" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Weekdone Ltd から Microsoft に提供される情報:
...
| パートナー会社名 | Weekdone Ltd |
| 会社の Web サイト | [https://weekdone.com](https://weekdone.com) |
| アプリの利用規約 | [https://weekdone.com/terms-of-service](https://weekdone.com/terms-of-service) |
| アプリのコア機能 | 毎週のチェックインと OKRs を表示および更新し、更新プログラムに関する通知を受け取る |
| 会社の本社所在地 | エストニア |
| アプリ情報ページ | [https://weekdone.com/integrations/microsoft-teams](https://weekdone.com/integrations/microsoft-teams) |
...
この情報は、Weekdone Ltd によって、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| データベースに格納されているデータは何ですか? | デバイスの IP アドレス。 顧客の名前と電子メール アドレス。 |
...
| プライバシー ポリシーの URL | https://weekdone.com/privacy |
