...
description: TeamsChamp で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/4fea4594-3f83-4e33-9929-9af6b78a7340" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001487" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.teamschamp.com/terms/](https://www.teamschamp.com/terms/) |
| アプリのコア機能 | TeamsChamp は、従業員のデジタル コンピテンシーのゲーム化を通じて、組織の情報システム (投資先) の使用と導入を強化します。  新鮮な空気とデジタル変革を促進する文化で、Microsoft 365導入を再び強化します。 |
| 会社の本社の場所 | スペイン |
| アプリ情報ページ | [https://www.teamschamp.com](https://www.teamschamp.com) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | サインインしてユーザー プロファイルを読み取る | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
>| User.ReadBasic.All | 委任 | すべてのユーザーの基本プロファイルを読み取る | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
>| profile | 委任 | ユーザーの基本プロファイルの表示 | [79d7af39-4f57-4e95-adaf-ec8ff756d0df](../azure/79d7af39-4f57-4e95-adaf-ec8ff756d0df.md) |
