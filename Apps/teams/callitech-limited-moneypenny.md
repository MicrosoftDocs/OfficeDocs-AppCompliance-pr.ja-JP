---
title: CALLITECH LIMITED による Moneypenny のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 11/08/2021
ms.topic: article
...
description: Moneypenny、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/ff5b7b81-ef94-441d-bc7c-eb04e53a188f" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003396" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

MICROSOFT に限定される CALLITECH によって提供される情報:
...
| パートナー会社名 | CALLITECH LIMITED |
| 会社の Web サイト | [https://www.moneypenny.com](https://www.moneypenny.com) |
| アプリの利用規約 | [https://www.moneypenny.com/uk/microsoft-teams-terms-and-con...](https://www.moneypenny.com/uk/microsoft-teams-terms-and-conditions/) |
| アプリのコア機能 | アプリの主な機能は、Teamsユーザーがボット経由で Moneypenny から通話を受け取る場合です。 |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する CALLITECH LIMITED によって提供されています。
...
| データベースに格納されているデータは何ですか? | Microsoft テナント ID、Microsoft オブジェクト ID |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calls.AccessMedia.All | アプリケーション | ボットからユーザーにメディアをTeamsするには | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](https://docs.microsoft.com/microsoft-365-app-certification/azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1) |
>| Calls.Initiate.All | アプリケーション | ボットを介してユーザーにTeamsするには | [8277a51c-3ad6-446c-9b7e-e3f6e27257c1](https://docs.microsoft.com/microsoft-365-app-certification/azure/8277a51c-3ad6-446c-9b7e-e3f6e27257c1) |
