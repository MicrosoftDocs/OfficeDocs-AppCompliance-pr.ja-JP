...
description: School Day で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64879214"
---
# <a name="school-day"></a>School Day

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 10 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/7caaa66b-34b0-4c15-a65d-dba6edf0c8fd" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001430" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

School Day の中で Microsoft に提供される情報:
...
| 会社の Web サイト | [https://www.schoolday.com](https://www.schoolday.com) |
| アプリの使用条件 | [https://www.schoolday.com/eula](https://www.schoolday.com/eula) |
| アプリのコア機能 | Microsoft Teamsの学校の日に学生のウェルビーイングとSocial-Emotional ラーニング (SEL) を強化します。 |
| 会社の本社の場所 | フィンランド |
| アプリ情報ページ | [https://www.schoolday.com/en/resources/faq](https://www.schoolday.com/en/resources/faq) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、School Day の AltoOy によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | 委任 | グループ名とグループ メンバーシップ。 教師であるユーザーは、グループから学生を School Day に追加できます。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| Team.ReadBasic.All | 委任 | チームの名前は、教師ユーザーが自分のチームとグループから学生を追加する場合に使用されます。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| User.Read | 委任 | ユーザーの管理と認証には、ユーザーの電子メール、名前、ID トークンが使用されます。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| User.ReadBasic.All | 委任 | ユーザーのアバターで使用するユーザー プロファイルの画像。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| メール | 委任 | ユーザーの電子メールは、アカウント認証のために収集されます。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| offline_access | 委任 | 認証 - アクセス トークンの更新。 スムーズなユーザー エクスペリエンス。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| openid | 委任 | OpenID サインインのユーザーの一意識別子。  | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
>| profile | 委任 | ユーザー管理と認証の目的で優先されるユーザー名とオブジェクト ID。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](../azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f.md) |
