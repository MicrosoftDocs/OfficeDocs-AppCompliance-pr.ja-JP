---
title: 学校の日ヘルシンキ Oy による学校の日のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 10/12/2021
ms.topic: article
...
description: 学校の日に利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.schoolday.com/eula](https://www.schoolday.com/eula) |
| アプリのコア機能 | 学生のウェルビーリングとSocial-Emotional ラーニング (SEL) を学校の日にMicrosoft Teams! |
| 会社の本社所在地 | フィンランド |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| GroupMember.Read.All | 委任 | グループ名とグループ メンバーシップ。 教師であるユーザーは、グループから学生を学校の日に追加できます。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| Team.ReadBasic.All | 委任 | チームの名前は、教師ユーザーが自分のチームとグループから学生を追加する場合に使用されます。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| User.Read | 委任 | ユーザーの電子メール、名前、ID トークンは、ユーザーの管理と認証に使用されます。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| User.ReadBasic.All | 委任 | ユーザー アバターで使用するユーザー プロファイルの画像。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| メール | 委任 | ユーザーの電子メールは、アカウント認証のために収集されます。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| offline_access | 委任 | 認証 - アクセス トークンの更新。 スムーズなユーザー エクスペリエンス。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| openid | 委任 | OpenID サインインのユーザーの一意の識別子。  | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
>| profile | 委任 | ユーザー管理と認証の目的で優先されるユーザー名とオブジェクト ID。 | [61dc5e28-775a-4dd0-8990-aaabe3be9e2f](https://docs.microsoft.com/microsoft-365-app-certification/azure/61dc5e28-775a-4dd0-8990-aaabe3be9e2f) |
