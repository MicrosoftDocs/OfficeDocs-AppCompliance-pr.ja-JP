...
| アプリの利用規約 | [https://www.weekly10.com/terms/customer](https://www.weekly10.com/terms/customer) |
| アプリのコア機能 | 毎週のチェックインを通じて、フィードバックを増やし、パフォーマンスを管理し、従業員のエンゲージメントを測定します。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | アプリケーション | ユーザーが Weekly10 にAzure AD同期する (オプション) | [2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb](https://docs.microsoft.com/microsoft-365-app-certification/azure/2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb) |
>| Calendars.ReadWrite | アプリケーション | 従業員の空き時間の確認と会議の自動予約 (オプション)。 | [494610b2-b490-4f54-8384-312d6f9b4869](https://docs.microsoft.com/microsoft-365-app-certification/azure/494610b2-b490-4f54-8384-312d6f9b4869) |
>| User.Read | 委任 | SSO 目的のユーザーの検証を、Azure AD。 | [6fd1421e-89e8-4a8b-bd01-9397656a50d5](https://docs.microsoft.com/microsoft-365-app-certification/azure/6fd1421e-89e8-4a8b-bd01-9397656a50d5) |
