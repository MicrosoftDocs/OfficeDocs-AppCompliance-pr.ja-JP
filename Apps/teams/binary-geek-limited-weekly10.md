...
description: Weekly10 で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/c80cee99-d17f-4b2d-a2a4-57652ffd2a4b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001441" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Binary Geek Limited to Microsoft によって提供される情報:
...
| 会社の Web サイト | [https://www.weekly10.com](https://www.weekly10.com) |
| アプリの使用条件 | [https://www.weekly10.com/terms/customer](https://www.weekly10.com/terms/customer) |
| アプリのコア機能 | 毎週のチェックインを通じて、フィードバックの向上、パフォーマンスの管理、従業員のエンゲージメントの測定を行います。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://www.weekly10.com/integrations/microsoft-teams/](https://www.weekly10.com/integrations/microsoft-teams/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Binary Geek Limited によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | アプリケーション | Azure ADから Weekly10 へのユーザーの同期 (省略可能) | [2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb](../azure/2cc7f3cd-05e3-4ebb-b9f9-d92f1bcda7fb.md) |
>| Calendars.ReadWrite | アプリケーション | 従業員の空き状況の確認と会議の自動予約 (省略可能)。 | [494610b2-b490-4f54-8384-312d6f9b4869](../azure/494610b2-b490-4f54-8384-312d6f9b4869.md) |
>| User.Read | 委任 | Azure ADでの SSO を目的とするユーザーの検証。 | [6fd1421e-89e8-4a8b-bd01-9397656a50d5](../azure/6fd1421e-89e8-4a8b-bd01-9397656a50d5.md) |
