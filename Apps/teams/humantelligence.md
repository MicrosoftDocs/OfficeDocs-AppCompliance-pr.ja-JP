---
title: Humantelligence による Humantelligence のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: Humantelligence、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/4082650b-ff26-4eae-b0af-ac0bed45228d" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002650" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Humantelligence が Microsoft に提供する情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Humantelligence |
| ID | WA200002650 |
| Office 365サポートされているクライアント | Microsoft Teams |
| パートナー会社名 | Humantelligence |
| 会社の Web サイト | [https://humantelligence.com](https://humantelligence.com) |
| アプリの利用規約 | [https://humantelligence.com/terms/](https://humantelligence.com/terms/) |
| アプリのコア機能 | Humantelligence を使用して同僚とより効果的にコミュニケーションを取る。 |
| 会社の本社所在地 | 米国オブアメリカ |
| アプリ情報ページ | [https://humantelligence.com](https://humantelligence.com) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Humantelligence によって提供されています。
...
| プライバシー ポリシーの URL | https://humantelligence.com/privacy |
