...
description: Attensa で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/0c42cdbf-56a5-4cdb-ae89-9253cb8138f0" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003148" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://attensa.com/terms/](https://attensa.com/terms/) |
| アプリのコア機能 | Attensa のブリーフィングを使用して、プロジェクトに焦点を当てたニュースや情報についてチームに情報を提供し、最新の状態に保ちます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
