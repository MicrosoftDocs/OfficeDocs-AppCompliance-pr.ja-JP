---
title: Attensa Corporation による Attensa のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Attensa で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/0c42cdbf-56a5-4cdb-ae89-9253cb8138f0" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003148" target="_blank">AppSource での表示</a>
...
| パートナー会社名 | Attensa Corporation |
| 会社の Web サイト | [https://attensa.com](https://attensa.com) |
| アプリの利用規約 | [https://attensa.com/terms/](https://attensa.com/terms/) |
| アプリのコア機能 | Attensa のブリーフィングを使用して、プロジェクトに焦点を当てたニュースや情報に関する情報をチームに通知し、最新の状態に保つ |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://attensa.com/product/](https://attensa.com/product/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Attensa Corporation から提供されています。
