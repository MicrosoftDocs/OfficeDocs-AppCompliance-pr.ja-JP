...
description: CSA STAR レジストリ内の Webex Call、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、およびセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| パートナー会社名 | Cisco |
| 会社の Web サイト | [https://www.cisco.com](https://www.cisco.com) |
| アプリの利用規約 | [https://www.cisco.com/c/en/us/products/universal-cloud-agre...](https://www.cisco.com/c/en/us/products/universal-cloud-agreement.html) |
| アプリのコア機能 | Webex 通話アプリを使用して、Microsoft Teams音声通話とビデオ通話を行います。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://help.webex.com/en-US/article/ngmx08cb/Webex-Call-in...](https://help.webex.com/en-US/article/ngmx08cb/Webex-Call-integration-with-Microsoft-Teams) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 委任 | チーム チャネル メンバーを読み取り、ユーザーがチームから選択できるよう | [9a7ce614-bdc8-4640-aaea-d8c626c58966](../azure/9a7ce614-bdc8-4640-aaea-d8c626c58966.md) |
>| Contacts.Read | 委任 | ユーザーが連絡先リストから短縮ダイヤルを作成できます | [9a7ce614-bdc8-4640-aaea-d8c626c58966](../azure/9a7ce614-bdc8-4640-aaea-d8c626c58966.md) |
