---
title: NLSQL による IQ のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: IQ に関するすべての利用可能なセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "65935454"
---
# <a name="iq"></a>IQ

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 18 日</p>

* <a href="https://teams.microsoft.com/l/app/9d0bdc38-2705-4109-835f-3c14534f923f" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004126" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

NLSQL から Microsoft に提供される情報:
...
| パートナー会社名 | NLSQL |
| 会社の Web サイト | [https://nlsql.com](https://nlsql.com) |
| アプリの使用条件 | [https://www.nlsql.com/terms_of_use](https://www.nlsql.com/terms_of_use) |
| アプリのコア機能 | IQ では、マネージャーが面接に関する質問を生成し、面接の準備をする候補者をサポートしています。 面接の質問の準備は、位置入力に基づいてランダムな質問を生成する人工知能ソフトウェアです。これにより、面接の準備が整う方法を完全に把握できます。 候補者は、より良い準備をするために、自由に面接の質問を生成できます。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://www.nlsql.com/blog/post/interview-questions-to-ask-...](https://www.nlsql.com/blog/post/interview-questions-to-ask-candidates-and-managers/) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて NLSQL から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | サインインおよびユーザー プロファイルの読み取り | [f9555238-64f3-4ec2-a8fc-3787baa157aa](../azure/f9555238-64f3-4ec2-a8fc-3787baa157aa.md) |
