...
description: Cyberday で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/a8e43ae4-a97b-4d1a-b364-b27794da19a4" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001774" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Digiturvamalli から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://cyberday.ai](https://cyberday.ai) |
| アプリの使用条件 | [https://cyberday.ai/terms-of-use](https://cyberday.ai/terms-of-use) |
| アプリのコア機能 | Cyberday は、選択したセキュリティ フレームワークへの準拠に向けて顧客を誘導する情報セキュリティ管理システムです。 |
| 会社の本社の場所 | フィンランド |
| アプリ情報ページ | [https://cyberday.ai](https://cyberday.ai) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Digiturvamalli によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 電子メールを使用して、このユーザーがユーザーであるアプリ管理者のユーザーと表示を識別する | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
>| openid | 委任 | ユーザー ID を使用してユーザーを識別する | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](../azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941.md) |
