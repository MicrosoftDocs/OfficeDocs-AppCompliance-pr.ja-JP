...
| アプリの利用規約 | [https://cyberday.ai/terms-of-use](https://cyberday.ai/terms-of-use) |
| アプリのコア機能 | Cyberday は、お客様が選択したセキュリティ フレームワークへの準拠を導く情報セキュリティ管理システムです。 |
| 会社の本社所在地 | フィンランド |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 電子メールを使用して、ユーザーを識別し、このユーザーがアプリ管理者に表示される | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](https://docs.microsoft.com/microsoft-365-app-certification/azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941) |
>| openid | 委任 | ユーザー ID を使用してユーザーを識別する | [1c7d277c-ff8a-4ea4-bc14-7d06314f8941](https://docs.microsoft.com/microsoft-365-app-certification/azure/1c7d277c-ff8a-4ea4-bc14-7d06314f8941) |
