...
| 会社の Web サイト | [https://geekbot.com](https://geekbot.com) |
| アプリの利用規約 | [https://geekbot.com/tos/](https://geekbot.com/tos/) |
| アプリのコア機能 | 非同期のスタンドアップ、回顧展、アンケートを実行し、タイム ゾーン間でチームの知識を共有します。 |
| 会社の本社所在地 | キプロス |
| アプリ情報ページ | |
...
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ、ユーザー メール データ、Microsoft Teams チーム データ(チーム ID、チャネル データ)、レポート |
...
| プライバシー ポリシーの URL | https://geekbot.com/privacy/ |
