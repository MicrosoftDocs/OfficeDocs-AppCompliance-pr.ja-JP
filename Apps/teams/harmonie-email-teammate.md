...
| アプリの利用規約 | [https://harmon.ie/legal/teammate-eula](https://harmon.ie/legal/teammate-eula) |
| アプリのコア機能 | メール TeamMate を使用Microsoft Teams会話にメールを追加する  |
| 会社の本社所在地 | イスラエル |
| アプリ情報ページ | |
...
この情報は、このアプリ harmon.ie 収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールに関する情報を提供しています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.Read | 委任 | TeamMate が特定の会話のチャット メンバーを取得して、SharePoint/One ドライブに保存されたファイルを会話チャット メンバーと共有するために必要 | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](https://docs.microsoft.com/microsoft-365-app-certification/azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4) |
>| Files.ReadWrite.All | 委任 | TeamMate が電子メールの添付ファイルを &amp; SharePoint/Teams/OneDrive | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](https://docs.microsoft.com/microsoft-365-app-certification/azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4) |
>| Mail.ReadWrite | 委任 | TeamMate がユーザーのメールを表示し、ユーザーに保存されたメールに返信するために必要Teams | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](https://docs.microsoft.com/microsoft-365-app-certification/azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4) |
>| People.Read | 委任 | TeamMate がユーザーによるメールを検索し、頻繁に連絡しているユーザーを提案するために必要です。 | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](https://docs.microsoft.com/microsoft-365-app-certification/azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4) |
>| User.Read | 委任 | ユーザーが自分のアカウントで TeamMate にサインインし、TeamMate が基本的なユーザー プロファイル情報を表示できる | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](https://docs.microsoft.com/microsoft-365-app-certification/azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4) |
>| User.ReadBasic.All | 委任 | TeamMate がチャット メンバーのメール アドレスを解決するために必要な、チャット メンバーに保存された共有ファイルOneDriveする  | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](https://docs.microsoft.com/microsoft-365-app-certification/azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4) |
