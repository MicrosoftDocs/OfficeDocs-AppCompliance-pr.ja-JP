---
title: harmon.ie による Email TeamMate のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Email TeamMate、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/3ae27f31-ceea-4d13-a212-cdc9d786eae1" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002338" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

harmon.ie から Microsoft に提供される情報:
...
| パートナー会社名 | harmon.ie |
| 会社の Web サイト | [https://harmon.ie](https://harmon.ie) |
| アプリの使用条件 | [https://harmon.ie/legal/teammate-eula](https://harmon.ie/legal/teammate-eula) |
| アプリのコア機能 | Email TeamMate を使用してMicrosoft Teams会話に電子メールを追加する  |
| 会社の本社の場所 | イスラエル |
| アプリ情報ページ | [https://harmon.ie](https://harmon.ie) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する harmon.ie によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.Read | 委任 | TeamMate が特定の会話のチャット メンバーを取得して、SharePoint/One ドライブに保存されたファイルを会話チャット メンバーと共有するために必要です | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| Files.ReadWrite.All | 委任 | SharePoint/Teams/OneDriveにメールの&amp;添付ファイルを保存するために TeamMate で必要 | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| Mail.ReadWrite | 委任 | TeamMate がユーザーのメールを表示し、Teamsに保存されたメールに返信するために必要です | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| People.Read | 委任 | TeamMate は、ユーザーがメールを検索し、頻繁に連絡しているユーザーを提案するために必要です。 | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| User.Read | 委任 | ユーザーが自分のアカウントで TeamMate にサインインし、TeamMate に基本的なユーザー プロファイル情報を表示できるようにします | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
>| User.ReadBasic.All | 委任 | チャット メンバーの電子メール アドレスを解決するために TeamMate がOneDriveに保存した共有ファイルを共有するために必要です  | [74a31d8c-1ee9-4fb8-bc22-640ba5f457f4](../azure/74a31d8c-1ee9-4fb8-bc22-640ba5f457f4.md) |
