...
| パートナー会社名 | Grepsi Software |
| 会社の Web サイト | [https://teamflect.com](https://teamflect.com) |
| アプリの利用規約 | [https://teamflect.com/terms](https://teamflect.com/terms) |
| アプリのコア機能 | Teamflect は、パフォーマンス管理と従業員エンゲージメント ソリューションの 1 つで、このソリューションを使用Microsoft Teams。 これにより、1 対 1 の会議、目標/OKR、フィードバック、認識、タスク モジュールに対する生産性とエンゲージメントが向上します。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | アプリケーション | このアクセス許可を使用してユーザーカレンダーにアクセスし、1 対 1 の会議を識別します。 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](https://docs.microsoft.com/microsoft-365-app-certification/azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0) |
>| Directory.Read.All | 委任 | 会社のディレクトリ - このアクセス許可を使用して、エンド ユーザーが検索を実行するときに、エンド ユーザーの同僚のリストを表示します。 | [c5da92a9-873e-4ea1-86c7-03ec9c1384f0](https://docs.microsoft.com/microsoft-365-app-certification/azure/c5da92a9-873e-4ea1-86c7-03ec9c1384f0) |
