---
title: Ideanote ApS による Ideanote のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Ideanote、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/b18682e5-87f8-413a-9af4-be50bcee1049" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003876" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Ideanote ApS が Microsoft に提供する情報:
...
| パートナー会社名 | Ideanote ApS |
| 会社の Web サイト | [https://ideanote.io](https://ideanote.io) |
| アプリの利用規約 | [https://ideanote.io/legal/terms](https://ideanote.io/legal/terms) |
| アプリのコア機能 | 目標駆動型のイノベーションでアイデアを収集、開発、管理します。 |
| 会社の本社所在地 | デンマーク |
| アプリ情報ページ | [https://ideanote.io](https://ideanote.io) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する情報を Ideanote ApS によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザーから取得した JWT トークンに関する情報。 ユーザー名、ユーザーメール。 |
...
| プライバシー ポリシーの URL | https://ideanote.io/legal/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザーが自分の Ideanote アカウントに自動的にログインするには、ユーザーに関する情報が必要です。 | [d7db1079-6f45-4373-bb2b-ae5d71169b31](../azure/d7db1079-6f45-4373-bb2b-ae5d71169b31.md) |
