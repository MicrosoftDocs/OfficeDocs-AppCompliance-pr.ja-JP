---
title: Stack Overflow による Teams のスタック オーバーフローのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Stack Overflow for Teams で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66656158"
---
# <a name="stack-overflow-for-teams"></a>Teams のスタックオーバーフロー

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 10 月 11 日</p>

* <a href="https://teams.microsoft.com/l/app/4783e622-5303-4ea7-a211-ef0dd405da73" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000739" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Stack Overflow から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://www.stackoverflow.com](https://www.stackoverflow.com) |
| アプリの使用条件 | [https://stackoverflow.com/legal/terms-of-service/teams](https://stackoverflow.com/legal/terms-of-service/teams) |
| アプリのコア機能 | Stack Overflow for Teams は、チームの質問と回答&#8217;プライベートで安全なホームです。 古い Wiki や失われたメールを掘り下げる&#8212;、チームがより良い製品を構築するために必要な時間を取り戻すことができます。 Teams の Stack Overflow&#8217; Microsoft Teams との統合により、Microsoft Teams チャットと内部ナレッジ リポジトリが接続されます。 新しい情報の通知を最新の状態に保ち、既存の回答を検索し、Microsoft Teams プラットフォームから直接質問を開始することもできます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://stackoverflow.co/teams/integrations/microsoft-teams](https://stackoverflow.co/teams/integrations/microsoft-teams) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Stack Overflow によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | MS Teams の情報は、表示されるアプリによって収集および処理され、顧客の Stack Overflow for Teams 環境内で参照されます。 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | MS Teams API のアクセス情報 |
...
| プライバシー ポリシーの URL | https://stackoverflow.com/legal/privacy-policy/integrations/ms-teams/teams-basic-business |
