...
| アプリのコア機能 | Cerkl Broadcast は、従業員の対象ユーザーと組織を結び付&#8217;重要なコミュニケーションを提供します。 動作ベースの個人用設定を使用して、ブロードキャストは適切なチャネルで適切な時間に適切な従業員に適切なメッセージを配信します。 この&#8217;競争から離れているので、精通したコミュニケーターは、努力を重複することなくチャネル間で通信できます。 ブロードキャストには業界をリード&#8217;する指標も用意されています。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザーの電子メールは収集され、ユーザーが現在システムにいて、組織によって追加されたのか確認するために使用されます。 | [74ef25ab-3685-446c-aa43-4e9cc251ed62](https://docs.microsoft.com/microsoft-365-app-certification/azure/74ef25ab-3685-446c-aa43-4e9cc251ed62) |
