...
description: ブロードキャストで使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/cfdaef91-3bae-4545-a571-b86b1685857f" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002697" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Cerkl が Microsoft に提供する情報:
...
| アプリの利用規約 | [https://cerkl.com/terms](https://cerkl.com/terms) |
| アプリのコア機能 | Cerkl Broadcast は、従業員の対象ユーザーと組織を結び付&#8217;重要なコミュニケーションを提供します。 動作ベースの個人用設定を使用して、ブロードキャストは適切なチャネルで適切な時間に適切な従業員に適切なメッセージを配信します。 この&#8217;競争から離れているので、精通したコミュニケーターは、努力を重複することなくチャネル間で通信できます。 また、ブロードキャストには業界をリード&#8217;する指標が用意されています。 |
| 会社の本社所在地 | アメリカ |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Cerkl によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザーの電子メールは収集され、ユーザーが現在システムにいて、組織によって追加されたのか確認するために使用されます。 | [74ef25ab-3685-446c-aa43-4e9cc251ed62](../azure/74ef25ab-3685-446c-aa43-4e9cc251ed62.md) |
