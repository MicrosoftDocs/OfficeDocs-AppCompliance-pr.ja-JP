...
description: ブロードキャストに使用できるすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/cfdaef91-3bae-4545-a571-b86b1685857f" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002697" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Cerkl から Microsoft に提供される情報:
...
| パートナー会社名 | Cerkl |
| 会社の Web サイト | [https://cerkl.com](https://cerkl.com) |
| アプリの使用条件 | [https://cerkl.com/terms](https://cerkl.com/terms) |
| アプリのコア機能 | Cerkl Broadcast は、従業員の対象ユーザーを組織&#8217;重要なコミュニケーションに結び付けます。 ブロードキャストは、動作ベースのパーソナル化を使用して、適切なチャネルで適切なタイミングで適切な従業員に適切なメッセージを配信します。 この&#8217;競合とは大きな違いがあります。精通したコミュニケーターは、手間をかけずにチャネル間で通信できます。 ブロードキャストでは、業界をリードするメトリックも提供され、お客様が対象ユーザーに対してどのような&#8217;機能しているかを把握するのに役立ちます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://cerkl.com/broadcast/microsoft-teams/](https://cerkl.com/broadcast/microsoft-teams/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Cerkl から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザーの電子メールが収集され、ユーザーが現在システム内にあり、組織によって追加されたかどうかを確認するために使用されます。 | [74ef25ab-3685-446c-aa43-4e9cc251ed62](../azure/74ef25ab-3685-446c-aa43-4e9cc251ed62.md) |
