...
description: 会議 i/o、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/8d4f0254-9b00-4a74-a351-b6d6cd7fccef" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001867" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

電話会議 i/o から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://www.conferences.io](https://www.conferences.io) |
| アプリの利用規約 | [https://teamsapp.conferences.io/eula/](https://teamsapp.conferences.io/eula/) |
| アプリのコア機能 | 電話会議 i/o からの対象ユーザー QA&amp;、ポーリングなど |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://www.conferences.io/our-platform/features/](https://www.conferences.io/our-platform/features/) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する電話会議 i/o によって提供されています。
...
| プライバシー ポリシーの URL | https://www.conferences.io/privacy |
