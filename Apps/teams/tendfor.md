---
title: Tendfor by Tendfor のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/16/2022
...
description: Tendfor で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64876184"
---
# <a name="tendfor"></a>Tendfor

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>開発者が最終更新日: 2022 年 2 月 15 日</p>

* <a href="https://teams.microsoft.com/l/app/212fcd92-bc06-4746-85c4-f7b5d39579ba" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002996" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Tendfor から Microsoft に提供される情報:
...
| パートナー会社名 | Tendfor |
| 会社の Web サイト | [https://www.tendfor.com](https://www.tendfor.com) |
| アプリの使用条件 | [https://tendfor.com/tendfor_docs/en/StandardContractMarch20...](https://tendfor.com/tendfor_docs/en/StandardContractMarch2019.pdf) |
| アプリのコア機能 | Microsoft Teams用のフル機能の連絡先センターとアテンダント コンソール。 |
| 会社の本社の場所 | スウェーデン |
| アプリ情報ページ | [https://www.tendfor.com](https://www.tendfor.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Tendfor から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、ユーザー 予定表データ、通話メディア |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ、ユーザー 予定表データ |
...
| プライバシー ポリシーの URL | https://tendfor.com/en/contact/tendfor-privacy-notice/ |
...
| サポートされているポリシーの種類を一覧表示する | Azure でサポートされているすべてとすべて |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザーにサインインできるようにするには | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
>| User.Read.All | アプリケーション | ユーザー情報をインポートできるようにするには | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
>| User.Read.All | 委任 | ユーザー情報をインポートできるようにするには | [b7e8237f-d86d-4874-8f8b-7faa8f768436](../azure/b7e8237f-d86d-4874-8f8b-7faa8f768436.md) |
