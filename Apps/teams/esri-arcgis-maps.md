...
* <a href="https://teams.microsoft.com/l/app/ba4eda44-cd55-4e15-855c-0debafb0490b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002859" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Esri から Microsoft に提供される情報:
...
| アプリの使用条件 | [https://www.esri.com/en-us/legal/terms/master-agreement-pro...](https://www.esri.com/en-us/legal/terms/master-agreement-product) |
| アプリのコア機能 | ArcGIS Online には、何千ものトピックに関する一連のアプリ、権限のあるマップ、データを視覚化するために必要な最新のマッピング ツール、データ内の意味のあるパターンを検出して伝達するための分析、およびユーザーとコンテンツを簡単に管理し、すべてのユーザーがマップを作成して共有できるようにする管理ツールが含まれています。 ArcGIS を使用すると、組織内のすべてのユーザーが、あらゆるデバイス、どこでも、いつでもマップを検出、使用、作成、共有できます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
