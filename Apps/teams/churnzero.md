---
title: ChurnZero by ChurnZero のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/08/2021
...
description: ChurnZero で使用可能なすべてのセキュリティとコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/c2e66b59-725d-4c56-8a0e-ee2587031d9f" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002581" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | ChurnZero |
| 会社の Web サイト | [https://churnzero.net](https://churnzero.net) |
| アプリの使用条件 | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| アプリのコア機能 | ChurnZero は、サブスクリプション 企業がチャーンと戦い、現在のアカウントを拡大し、製品の導入を増やし、カスタマー エクスペリエンスを最適化するのに役立つリアルタイムの Customer Success プラットフォームです。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、ChurnZero によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 今後のボット セッション中にそのユーザーを識別して承認するために、委任するユーザーの Azure オブジェクト ID。 | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
