...
description: ChurnZero で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://churnzero.net/terms-of-use](https://churnzero.net/terms-of-use) |
| アプリのコア機能 | ChurnZero は、サブスクリプション企業がチャーンと戦い、現在のアカウントを拡大し、製品の導入を増やし、カスタマー エクスペリエンスを最適化するのに役立つ、リアルタイムのカスタマーサクセス プラットフォームです。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 今後のボット セッション中にユーザーを識別して承認するために、委任ユーザーの Azure オブジェクト ID を ChurnZero ユーザーと関連付けます。 | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](../azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f.md) |
