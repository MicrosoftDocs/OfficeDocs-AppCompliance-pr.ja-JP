...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 今後のボット セッション中にユーザーを識別して承認するために、委任ユーザーの Azure オブジェクト ID を ChurnZero ユーザーと関連付けます。 | [c2e66b59-725d-4c56-8a0e-ee2587031d9f](https://docs.microsoft.com/microsoft-365-app-certification/azure/c2e66b59-725d-4c56-8a0e-ee2587031d9f) |
