---
title: Goalhub by モメンタム クラウド Pty Ltd のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: Goalhub で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/593a90d6-6630-4376-8745-55d7c2c3f0c9" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002400" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.momentumcloud.com.au](https://www.momentumcloud.com.au) |
| アプリの使用条件 | [https://www.goalhub.com/terms](https://www.goalhub.com/terms) |
| アプリのコア機能 | 接続し、サポートされ、目標を達成します。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://www.goalhub.com/about-1](https://www.goalhub.com/about-1) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、モメンタム クラウド Pty Ltd から提供されています。
