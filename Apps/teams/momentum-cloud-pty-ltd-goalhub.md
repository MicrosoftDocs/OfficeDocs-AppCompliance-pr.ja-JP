...
description: Goalhub で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.goalhub.com/terms](https://www.goalhub.com/terms) |
| アプリのコア機能 | 接続を取得し、サポートされ、目標を達成します。 |
| 会社の本社所在地 | オーストラリア |
