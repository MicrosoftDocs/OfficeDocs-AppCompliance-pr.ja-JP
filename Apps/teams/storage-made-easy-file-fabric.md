---
title: Storageによる File Fabric のアプリケーション情報を簡単に
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: File Fabric で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/bd063a87-1e4d-42cf-baea-8cab71839e35" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003017" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Storage Made Easy to Microsoft から提供される情報:
...
| 会社の Web サイト | [https://storagemadeeasy.com](https://storagemadeeasy.com) |
| アプリの使用条件 | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| アプリのコア機能 | Azure Files、Azure Blob Storage、およびその他のストレージに格納されているファイルを検索、参照、編集、共有します。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://docs.storagemadeeasy.com/microsoft-teams](https://docs.storagemadeeasy.com/microsoft-teams) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | SelfHosted、Azure、AWS、GCP、IBMCloud、ユーザーは、Wasabi、Backblaze、Cloudian、Dropbox、Box.com、Salesforce、S3-Compatible、FTP、WebDAV サービスに接続できます |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Storage Made Easy によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | アプリケーション | ユーザーがアプリを介して指定したファイルをダウンロード、アップロード、または編集するときに読み取りまたは書き込みされるファイル データ。 | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | アプリケーション | すべてのファイル サービス間でフェデレーション ビューを提供するすべてのユーザー&#8217;のファイルとフォルダーに対して収集されたメタデータ。 | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
