...
| アプリのコア機能 | Azure Files、Azure Blob ファイル、その他のストレージに保存されているファイルStorage、参照、編集、共有します。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | アプリケーション | ユーザーがアプリを介して指定したファイルをダウンロード、アップロード、または編集するときに、ファイル データの読み取りまたは書き込み。 | [0752d800-857f-49bd-87eb-e60985516c67](https://docs.microsoft.com/microsoft-365-app-certification/azure/0752d800-857f-49bd-87eb-e60985516c67) |
>| Sites.ReadWrite.All | アプリケーション | すべてのユーザーに対して収集&#8217;ファイルとフォルダーを使用して、すべてのファイル サービス全体でフェデレーション ビューを提供します。 | [0752d800-857f-49bd-87eb-e60985516c67](https://docs.microsoft.com/microsoft-365-app-certification/azure/0752d800-857f-49bd-87eb-e60985516c67) |
