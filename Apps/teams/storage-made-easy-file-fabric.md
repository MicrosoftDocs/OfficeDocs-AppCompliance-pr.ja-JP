...
description: ファイル ファブリック、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.storagemadeeasy.com/terms](https://www.storagemadeeasy.com/terms) |
| アプリのコア機能 | Azure Files、Azure Blob ファイル、その他のストレージに保存されているファイルを検索、参照、編集Storage共有します。 |
...
| アプリで使用するホスティング クラウド プロバイダー | SelfHosted、Azure、AWS、GCP、IBMCloud、ユーザーはわさび、Backblaze、Cloudian、Dropbox、Box.com、Salesforce、S3-Compatible、FTP、WebDAV サービスに接続できます |
...
この情報は、Storage が組織データを収集して格納する方法と、組織がアプリが収集するデータに対して組織が持つコントロールについて、Storage Made Easy によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite | アプリケーション | ユーザーがアプリを介して指定したファイルをダウンロード、アップロード、または編集するときに、ファイル データの読み取りまたは書き込み。 | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
>| Sites.ReadWrite.All | アプリケーション | すべてのユーザーに対して収集&#8217;ファイルとフォルダーを使用して、すべてのファイル サービス全体でフェデレーション ビューを提供します。 | [0752d800-857f-49bd-87eb-e60985516c67](../azure/0752d800-857f-49bd-87eb-e60985516c67.md) |
