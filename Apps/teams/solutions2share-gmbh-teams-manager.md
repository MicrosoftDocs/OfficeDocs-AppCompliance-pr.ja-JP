...
| アプリの利用規約 | [https://www.teams-manager.com/terms-of-use/](https://www.teams-manager.com/terms-of-use/) |
| アプリのコア機能 | 承認ワークフローをTeams複雑でカスタマイズ可能なテンプレートに基づいて、新しいテンプレートを作成します。 Teams マネージャーを使用すると、企業はガバナンス機能を使用して管理されていない成長をMicrosoft Teamsしながら、ユーザーが新しい組織を作成Teams。 |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | 両方とも | テンプレートをマップするために TenantID と TeamId を格納しています。  | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7) |
>| Notes.ReadWrite.All | アプリケーション | なし | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7) |
>| User.Read | 委任 | なし | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7) |
>| User.Read.All | 両方とも | 承認者/管理者セクションに入力されたユーザーの ID を保存します。 | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7) |
>| User.ReadBasic.All | 委任 | なし | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7) |
