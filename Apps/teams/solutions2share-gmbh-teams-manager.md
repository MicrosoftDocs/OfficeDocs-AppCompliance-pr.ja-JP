---
title: Solutions2Share GmbH によるTeams マネージャーのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/27/2021
...
description: Teams マネージャーで使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/87000000-3db9-bb44-5015-0b4a327a6597" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000764" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://teams-manager.com](https://teams-manager.com) |
| アプリの使用条件 | [https://www.teams-manager.com/terms-of-use/](https://www.teams-manager.com/terms-of-use/) |
| アプリのコア機能 | 承認ワークフローを使用して、複雑でカスタマイズ可能なテンプレートに基づいて新しいTeamsを作成します。 Teams マネージャーを使用すると、企業はMicrosoft Teamsを制御し続け、ガバナンス機能を使用して制御できない成長を停止しながら、ユーザーが新しいTeamsを作成できるようになります。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | [https://teams-manager.com](https://teams-manager.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Solutions2Share GmbH によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | 両方とも | TenantID と TeamId を格納して、テンプレートをマップします。  | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| Notes.ReadWrite.All | アプリケーション | なし | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read | 委任 | なし | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.Read.All | 両方とも | 承認者/管理者セクションに入力されたユーザーの ID を保存します。 | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
>| User.ReadBasic.All | 委任 | なし | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
