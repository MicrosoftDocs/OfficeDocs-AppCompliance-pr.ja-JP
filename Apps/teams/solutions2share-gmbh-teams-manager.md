...
| アプリのコア機能 | 承認ワークフローをTeamsカスタマイズ可能なテンプレートに基づいて、新しいテンプレートを作成します。 Teamsマネージャーを使用すると、企業はガバナンス機能を使用して、Microsoft Teamsを制御し、制御不能な成長を止める一方で、ユーザーは新しい組織を作成Teams。 |
| 会社の本社所在地 | ドイツ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.ReadWrite.All | 両方とも | テンプレートをマップするために TenantID と TeamId を格納しています。  | [b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7](../azure/b9a1aaab-e8aa-4b92-b4ce-f13cae74caa7.md) |
