...
description: Live Chat で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.socialintents.com/tos.html](https://www.socialintents.com/tos.html) |
| アプリのコア機能 | ライブ チャットでは、Microsoft Teamsから Web サイトの訪問者とチャットできます。 |
| 会社の本社所在地 | アメリカ |
