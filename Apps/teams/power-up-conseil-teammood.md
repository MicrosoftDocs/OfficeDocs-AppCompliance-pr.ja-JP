...
description: TeamMood で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/670cd639-d430-4972-87b5-4c2eb18af991" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002451" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.teammood.com](https://www.teammood.com) |
| アプリの使用条件 | [https://www.teammood.com/en/terms-of-service/](https://www.teammood.com/en/terms-of-service/) |
| アプリのコア機能 | チームから毎日のフィードバックを簡単に受け取ります。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://help.teammood.com/en/articles/4294405-microsoft-tea...](https://help.teammood.com/en/articles/4294405-microsoft-teams-integration-for-teammood) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Power Up Conseil によって提供されています。
