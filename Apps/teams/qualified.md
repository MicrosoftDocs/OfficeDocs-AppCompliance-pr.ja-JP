...
description: 認定に使用できるすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/d9850897-f8bf-407c-878b-b0cdcbba93ff" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002720" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Microsoft の資格を持つユーザーが提供する情報:
...
| パートナー会社名 | Qualified |
| 会社の Web サイト | [https://www.qualified.com](https://www.qualified.com) |
| アプリの使用条件 | [https://www.qualified.com/legal/terms-of-service](https://www.qualified.com/legal/terms-of-service) |
| アプリのコア機能 | 有資格者は、ホットプロスペクトがサイトに到着したときに営業担当者に即座にアラートを送信します |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.qualified.com/university-guide/microsoft-teams-...](https://www.qualified.com/university-guide/microsoft-teams-integration) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Qualified によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | アプリケーション | 通知するチャネルを選択できます | [2c951ed5-c5c6-493f-9b02-4b42e3ba536c](../azure/2c951ed5-c5c6-493f-9b02-4b42e3ba536c.md) |
>| Team.ReadBasic.All | アプリケーション | すべてのチームからすべてのチャネルを検索し、通知するチャネルを選択できるようにします | [2c951ed5-c5c6-493f-9b02-4b42e3ba536c](../azure/2c951ed5-c5c6-493f-9b02-4b42e3ba536c.md) |
