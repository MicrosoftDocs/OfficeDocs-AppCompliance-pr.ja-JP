...
description: Smartsheet で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f4d81e8e-4500-44c2-8328-9e06cbe037c5" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104380975" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Smartsheet |
| 会社の Web サイト | [https://www.smartsheet.com](https://www.smartsheet.com) |
| アプリの使用条件 | [https://pinpointprod.blob.core.windows.net/marketing/Partne...](https://pinpointprod.blob.core.windows.net/marketing/Partner_21474843641/Product_42949680935/Asset_06f25ae6-b277-42aa-b769-38e17926ebb4/SmartsheetUserAgreementSmartsh.pdf) |
| アプリのコア機能 | Smartsheet は、組織の実績を実現するためのクラウドベースの主要なプラットフォームであり、チームと組織が大規模に作業を計画、キャプチャ、管理、自動化、およびレポートできるようにすることで、より効果的なプロセスとビジネス成果の向上につながります。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://help.smartsheet.com/articles/2476201-interact-with-...](https://help.smartsheet.com/articles/2476201-interact-with-smartsheet-items-in-microsoft-teams) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Smartsheet によって提供されています。
...
| 最新の SOC2 認定日 | 2021-12-06 |
| アプリはサービス組織コントロール (SOC 3) に準拠していますか? | はい |
| 最新の SOC3 認定日 | 2021-12-06 |
...
| プライバシー ポリシーの URL | https://www.smartsheet.com/legal/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | アプリケーション | Smartsheet タブ アプリケーションで、チャネル メンバーを読み取って Smartsheet アセットを共有できるようにする。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Directory.Read.All | 委任 | アプリが組織内のデータ (ユーザーやグループなど) を読み取ることができるようにする。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Group.Read.All | 委任 | これは、グループのメンバーを読み取るために使用されます。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| Group.ReadWrite.All | 委任 | グループに通知を送信する。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| User.Read.All | 委任 | これは、ユーザーのメール アドレスに基づいて通知を送信するために使用されます。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
>| offline_access | 委任 | オフラインでの使用を許可する。 | [c68947ae-a07f-44ce-9a13-7b559251731d](../azure/c68947ae-a07f-44ce-9a13-7b559251731d.md) |
