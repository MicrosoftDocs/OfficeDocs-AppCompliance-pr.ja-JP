...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 電子メール、名、および名 : これらのデータは、beekast アプリケーション内での共同作業に使用されます。 | [4d0997dc-df53-4b18-9df1-bb283f8a0377](https://docs.microsoft.com/microsoft-365-app-certification/azure/4d0997dc-df53-4b18-9df1-bb283f8a0377) |
