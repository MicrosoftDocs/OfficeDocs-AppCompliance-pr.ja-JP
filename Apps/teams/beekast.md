---
title: Beekast by Beekast のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Beekast で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/377da6a7-efc3-4599-887a-1d3eda45120a" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001447" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Beekast から Microsoft に提供される情報:
...
| パートナー会社名 | Beekast |
| 会社の Web サイト | [https://www.beekast.com](https://www.beekast.com) |
| アプリの使用条件 | [https://www.beekast.com/terms/](https://www.beekast.com/terms/) |
| アプリのコア機能 | Beekast は、会議を高速化するための共同作業プラットフォームです。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://www.beekast.com](https://www.beekast.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Beekast によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 電子メール、名、姓: これらのデータは、beekast アプリケーション内での共同作業に使用されます。 | [4d0997dc-df53-4b18-9df1-bb283f8a0377](../azure/4d0997dc-df53-4b18-9df1-bb283f8a0377.md) |
