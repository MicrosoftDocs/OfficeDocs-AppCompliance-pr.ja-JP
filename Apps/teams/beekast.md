...
description: Beekast のすべての利用可能なセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.beekast.com/terms/](https://www.beekast.com/terms/) |
| アプリのコア機能 | Beekast は、会議をスピードアップする共同作業プラットフォームです。 |
| 会社の本社所在地 | フランス |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 電子メール、名、および名 : これらのデータは、beekast アプリケーション内での共同作業に使用されます。 | [4d0997dc-df53-4b18-9df1-bb283f8a0377](../azure/4d0997dc-df53-4b18-9df1-bb283f8a0377.md) |
