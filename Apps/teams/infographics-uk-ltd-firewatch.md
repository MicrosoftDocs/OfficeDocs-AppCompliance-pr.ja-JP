---
title: Infographics UK Ltd による FireWatch のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/30/2021
...
description: FireWatch で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64879324"
---
# <a name="firewatch"></a>FireWatch

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 7 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/822055b4-508e-49c8-b7cc-c891ccb5c4eb" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003303" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Infographics UK Ltd. から Microsoft に提供される情報:
...
| パートナー会社名 | Infographics UK Ltd. |
| 会社の Web サイト | [https://www.infographics.co.uk](https://www.infographics.co.uk) |
| アプリの使用条件 | [https://www.infographics.co.uk/terms-and-conditions/](https://www.infographics.co.uk/terms-and-conditions/) |
| アプリのコア機能 | FireWatch Connectを使用すると、FireWatch アプリケーションとMicrosoft Teamsを統合して、ユーザーがMicrosoft Teams内から直接タスクを完了できるようになります。 現在、Microsoft Teams ボットを介してユーザー サポートとサポートを提供し、Microsoft Teams ユーザー環境内から直接オン/オフの勤務を予約します。 今後のリリースでは、FireWatch の休日の要求、タスクのリマインダーなど、ボットとカードを介した追加のアクションのサポートが含まれます。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://www.firewatch.co.uk](https://www.firewatch.co.uk) |
...
この情報は、Infographics UK Ltd によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
