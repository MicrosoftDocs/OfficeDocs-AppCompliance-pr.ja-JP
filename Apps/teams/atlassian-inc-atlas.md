---
title: Atlassian, Inc. による Atlas のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Atlas で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/69883cee-eb8c-41c2-9533-7fdb0762e913" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003760" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://atlassian.com/legal/cloud-terms-of-service](https://atlassian.com/legal/cloud-terms-of-service) |
| アプリのコア機能 | チーム間のより健全なコミュニケーションのロックを解除する |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | |
...
この情報は Atlassian, Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
