---
title: Green Meadow ApS によるドキュメント 起草者のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/06/2022
...
description: Document Drafter、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "65357086"
---
# <a name="document-drafter"></a>ドキュメントの下書き

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/6b96e77c-08d1-432e-819f-7dc7b6585a1a" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004059" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Green Meadow ApS から Microsoft に提供される情報:
...
| パートナー会社名 | 緑の草 ApS |
| 会社の Web サイト | [https://gmeadow.com](https://gmeadow.com) |
| アプリの使用条件 | [https://tinyurl.com/2p9dw3tm](https://tinyurl.com/2p9dw3tm) |
| アプリのコア機能 | Microsoft Teams内の自動化されたドキュメントを使用して共同作業します。 |
| 会社の本社の場所 | デンマーク |
| アプリ情報ページ | [https://gmeadow.com/document-drafter-inside-microsoft-teams/](https://gmeadow.com/document-drafter-inside-microsoft-teams/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Green Meadow ApS から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 電子メール ID、名前、およびセキュリティ グループ。 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | 電子メール ID、名前、およびセキュリティ グループ。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 両方とも | ユーザーがアプリケーションで生成されたドキュメントを格納するときにフォルダーを参照するために必要なチャネル内のユーザー ライブラリを読み取る。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| Files.ReadWrite.All | 委任 | ユーザーが、アプリケーションで生成されたドキュメントを格納するフォルダーを参照または作成する場合。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| Group.ReadWrite.All | 委任 | アクセス管理の目的でTeamsメンバーを識別する。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| TeamsActivity.Send | 委任 | アンケートやアンケートの更新などに関するメッセージを送信する場合。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| User.Read.All | 委任 | フル プロファイルを読み取って、どのグループ メンバーシップ ユーザーが持っているかを把握するために、アクティビティ フィードにメッセージを送信するために使用Teams。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| メール | 委任 | バックエンド システム内のユーザーを識別するために電子メール ID を使用します。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| openid | 委任 | ユーザー認証。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
>| profile | 委任 | ユーザーのアバターや写真を取得して、ユーザー エクスペリエンスを向上させる (存在する場合)。 | [1c529524-183e-40db-b1d7-1acf275354b4](../azure/1c529524-183e-40db-b1d7-1acf275354b4.md) |
