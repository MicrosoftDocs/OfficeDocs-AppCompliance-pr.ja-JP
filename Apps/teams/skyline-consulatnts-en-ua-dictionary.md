---
title: EN-UA ディクショナリのアプリケーション情報 by Pane Consulatnts
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: EN-UA ディクショナリ、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "66564626"
---
# <a name="en-ua-dictionary"></a>EN-UA ディクショナリ

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 24 日</p>

* <a href="https://teams.microsoft.com/l/app/1a24a3a3-1fda-4f70-abee-40bba8c638e8" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004310" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | 膻舩 |
| 会社の Web サイト | [https://skylineconsultants.com](https://skylineconsultants.com) |
| アプリの使用条件 | [https://skylineconsultants.com/terms-and-conditions/](https://skylineconsultants.com/terms-and-conditions/) |
| アプリのコア機能 | English-Ukrainian、ユーザーが Microsoft Teams で作業中に不明な単語を検索できるように、English-Ukrainian Dictionary Application by Pane Consultants は完全に編成されています。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する、Intelli Consulatnts によって提供されています。
...
| データベースに格納されているデータは何ですか? | このデータベースには、ユーザーがアプリで停止した場所という情報が保持され、ユーザーが次回アプリケーションに入った時点でその場所が復元されます。 Graph ユーザー ID |
...
| 変更要求を運用環境にデプロイする前に、変更要求を確認および承認するために使用される、確立された変更管理プロセスはありますか? | いいえ |
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | Microsoft.Graph;Microsoft.TeamsFx; |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザー プロファイルにアクセスするには | [2da850e4-5b9d-455c-ae32-bec270de4b60](../azure/2da850e4-5b9d-455c-ae32-bec270de4b60.md) |
