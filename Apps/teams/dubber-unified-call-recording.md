---
title: ダバーによるダバー統合通話録音のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 12/09/2021
ms.topic: article
...
description: Bubber 統合通話記録、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "62148794"
---
# <a name="dubber-unified-call-recording"></a>統合通話の録音のダバー
