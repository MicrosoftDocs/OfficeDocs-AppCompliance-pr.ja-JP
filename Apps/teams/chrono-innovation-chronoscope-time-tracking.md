---
title: Chrono Innovation による Chronoscope Time Tracking のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Chronoscope Time Tracking に使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/5b3ded07-fa1a-4fd8-a323-e5fe3f8cf740" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003095" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.chronoinnovation.com](https://www.chronoinnovation.com) |
| アプリの使用条件 | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| アプリのコア機能 | Chronoscope は、データの精度を向上させ、時間入力エラーを減らすインテリジェントな時間管理プラットフォームです。 Chronoscope は、既存のエコシステムと統合するインテリジェント アシスタントを通じて、時間の入力を容易にし、データの可視性を提供して、より良いビジネス上の意思決定を行います。 |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | [https://www.chronoscope.app](https://www.chronoscope.app) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Chrono Innovation によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | アプリケーション | teams tenantId、teams addObjectId、teams ユーザー アカウント情報。 Chronoscope ユーザーをリンクする場合、電子メールがTeams アカウントと一致していることを検証しているため、ユーザーからの手動ステップなしでアカウントをリンクできます | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |
