...
description: CSA STAR レジストリ内の Chronoscope Time Tracking、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、およびセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.chronoscope.app/terms-of-service](https://www.chronoscope.app/terms-of-service) |
| アプリのコア機能 | Chronoscope は、データ精度を向上し、時間入力エラーを削減するインテリジェントな時間管理プラットフォームです。 既存のエコシステムと統合するインテリジェント アシスタントを通じて、Chronoscope は時間の入力を容易にし、より良いビジネス上の意思決定を行うデータを可視化します。 |
| 会社の本社所在地 | カナダ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AccessReview.Read.All | アプリケーション | teams tenantId、teams addObjectId、teams ユーザー アカウント情報。 Chronoscope ユーザーをリンクする場合、電子メールが Teams アカウントと一致することを検証しています。そのため、ユーザーからの手動手順なしでアカウントをリンクできます。 | [9bc8244d-a186-4b12-809e-c47b3eee73c6](../azure/9bc8244d-a186-4b12-809e-c47b3eee73c6.md) |
