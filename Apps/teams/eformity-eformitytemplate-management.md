---
title: eformity |のアプリケーション情報テンプレート管理 (eformity 別)
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/11/2022
...
description: eformity |で使用可能なすべてのセキュリティ情報とコンプライアンス情報テンプレート管理、データ処理ポリシー、そのMicrosoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64771448"
---
# <a name="eformity--template-management"></a>eformity |テンプレート管理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/74843469-2e76-45e6-acdc-b755a4a4adf0" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003519" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

eformity から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | eformity - テンプレート管理 |
| ID | WA200003519 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | eformity |
| 会社の Web サイト | [https://eformity.nl](https://eformity.nl) |
| アプリの使用条件 | [https://eformity.net/policies/terms-of-use](https://eformity.net/policies/terms-of-use) |
| アプリのコア機能 | Microsoft Teamsからドキュメントやプレゼンテーションを作成するために、一元管理されたテンプレートを使用します。 |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する情報によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | 必要 |
| アプリによって処理されるデータは何ですか? | ユーザー メール、ユーザー名、ユーザー名、ユーザー姓 |
| アプリは TLS 1.1 以降をサポートしていますか? | 必要 |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | 必要 |
| データベースに格納されているデータは何ですか? | ユーザー メール、ユーザー名、ユーザー名、ユーザー姓 |
...
| プライバシー ポリシーの URL | https://eformity.net/policies/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委任 | 生成されたテンプレートを保存する | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| User.Read | 委任 | プラットフォームでユーザー プロファイルを更新するためのデータを収集する | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| openid | 委任 | ユーザーのサインイン | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
>| profile | 委任 | ユーザーのサインイン | [ff50870f-b19b-489c-9766-4bcee4e843eb](../azure/ff50870f-b19b-489c-9766-4bcee4e843eb.md) |
