---
title: Summize による Summize アシスタントのアプリケーション情報 (Ltd)
ms.author: elmalova
author: elenamalova
ms.date: 01/11/2022
ms.topic: article
...
description: Summize Assistant、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/24d7e745-c1ed-4f60-a843-ba1629ef3ed4" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003577" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Summize (Ltd) から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Summize Assistant |
| ID | WA200003577 |
| Office 365サポートされているクライアント | Microsoft Teams |
| パートナー会社名 | Summize (Ltd) |
| 会社の Web サイト | [https://www.summize.com](https://www.summize.com) |
| アプリの利用規約 | [https://www.summize.com/terms-and-conditions](https://www.summize.com/terms-and-conditions) |
| アプリのコア機能 | Summize を使用すると、契約書のレビューと作成が簡単になります。 Summize は、企業が契約を理解し、操作する方法を変更しています。 インテリジェントで会話型のソフトウェアを使用して、契約プロセスを超え、契約上の洞察を解き明かします。  ユーザーが契約書 (PDF Teams docx 形式) をアップロードしてレビューを行うのに役立ちます。  ユーザーは、Summize アプリで作成されたテンプレートを使用してコントラクトを作成することもできます。   |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Summize (Ltd) によって提供されています。
...
| データベースに格納されているデータは何ですか? | 元のドキュメントとドキュメントの顧客レビュー |
...
| アプリはサービス組織のコントロール (SOC 1) に準拠していますか? | なし |
| 最新の SOC1 認定日 |   |
...
| プライバシー ポリシーの URL | https://app.summize.com/assets/documents/SummizePrivacyPolicy.pdf |
