---
title: アプリケーション情報 for do!book CB by Digital Office Inc.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/20/2021
...
description: CB、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報を予約してください。
...
* <a href="https://teams.microsoft.com/l/app/92abac76-5f78-472f-8dfa-e7c23564cd92" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002597" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.do-tools.net](https://www.do-tools.net) |
| アプリの使用条件 | [https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf](https://www.do-tools.net/agreements/legal/dobookCB_Terms.pdf) |
| アプリのコア機能 | マテリアル共有ボードを使用して、会議をさらに便利に &quot;しましょう&quot;。 |
| 会社の本社の場所 | 日本 |
| アプリ情報ページ | [https://www.do-tools.net](https://www.do-tools.net) |
...
この情報は、Digital Office Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
