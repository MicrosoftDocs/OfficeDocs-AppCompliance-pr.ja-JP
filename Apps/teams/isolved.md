---
title: isolved によって isolved のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: isolved に使用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/287fab70-2e10-4bc3-9049-8991d7796d81" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004410" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

isolved から Microsoft に提供される情報:
...
| パートナー会社名 | isolved |
| 会社の Web サイト | [https://www.isolvedhcm.com](https://www.isolvedhcm.com) |
| アプリの使用条件 | [https://www.isolvedhcm.com/legal/agreements/employee-terms-...](https://www.isolvedhcm.com/legal/agreements/employee-terms-and-conditions-for-use) |
| アプリのコア機能 | Microsoft Teams 内で、人事に関する質問に対する回答を迅速に得られるようにユーザーを支援する |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.isolvedhcm.com/platform/enhancements/conversati...](https://www.isolvedhcm.com/platform/enhancements/conversational-virtual-assistant) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しました。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | Microsoft Azure テナント ID、Microsoft Azure ユーザー ID  |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | Microsoft Azure テナント ID、Microsoft Azure ユーザー ID  |
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリケーションは、シングル サインオン、API アクセスなどのために Microsoft Identity Platform (Azure AD) と統合されますか? | X |
