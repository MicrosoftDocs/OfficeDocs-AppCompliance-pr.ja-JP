---
title: クローバーズ by クローバー AI のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/22/2022
...
description: クローバーのセキュリティとコンプライアンスに関するすべての情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/1356036b-5fa7-42ce-8079-5741f2acfc5f" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003795" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

クローバーズ AI から Microsoft に提供される情報:
...
| アプリの使用条件 | [https://clovers.ai/terms-of-use/](https://clovers.ai/terms-of-use/) |
| アプリのコア機能 | クローバー - チームがより効率的に採用するのに役立つインタビュー ガイド |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、クローバーズ AI によって提供されています。
