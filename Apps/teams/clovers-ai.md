---
title: Clovers AI によるクローバーのアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 02/22/2022
ms.topic: article
...
description: Clovers で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/1356036b-5fa7-42ce-8079-5741f2acfc5f" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003795" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Clovers AI が Microsoft に提供する情報:
...
| パートナー会社名 | Clovers AI |
| 会社の Web サイト | [https://clovers.ai](https://clovers.ai) |
| アプリの利用規約 | [https://clovers.ai/terms-of-use/](https://clovers.ai/terms-of-use/) |
| アプリのコア機能 | Clovers - チームの採用効率向上に役立つインタビュー ガイド |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Clovers AI によって提供されています。
