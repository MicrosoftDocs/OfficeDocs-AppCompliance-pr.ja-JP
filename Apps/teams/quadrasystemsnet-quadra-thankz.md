...
description: Quadra Thankz、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63539893"
---
# <a name="quadra-thankz"></a>Quadra Thankz

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 1 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/a013c4a4-0683-4125-8c05-4004c2c3cc6f" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003671" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Microsoft に提供 Quadrasystems.net 情報:
...
| パートナー会社名 | Quadrasystems.net |
| 会社の Web サイト | [https://www.quadrasystems.net](https://www.quadrasystems.net) |
| アプリの利用規約 | [https://www.quadrasystems.net/tou](https://www.quadrasystems.net/tou) |
| アプリのコア機能 | Thankz は、より幸せな企業を構築する鍵です。 使い慣れたMicrosoft Teamsインターフェイス上に構築されたこのインターフェイスは、毎日一緒に作業するユーザーと接続するための新しい方法です。  Thankz は、人々が楽しい方法でお互いを認識するのに役立つツールです。&#160; これは、リーダーボード、予算設定、コントロールなどの機能を可能にする豊富なエンド ユーザー機能とエンタープライズ機能を提供します。 Thankz は、従業員が接続され、高く評価され、報われると感じるのに役立ちます。 |
| 会社の本社所在地 | インド |
| アプリ情報ページ | [https://www.quadrasystems.net/what-we-do/intelligent-ip-sol...](https://www.quadrasystems.net/what-we-do/intelligent-ip-solution/thankz) |
...
この情報は、このアプリ Quadrasystems.net 収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールに関する情報を提供しています。
...
| サポートされているポリシーの種類を一覧表示する | すべてのAAD条件付きアクセス ポリシー  |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | アプリケーション | ユーザーのマネージャー情報を取得するには  | [5d8eb1a9-2188-4292-86f6-f4964d49e8b3](../azure/5d8eb1a9-2188-4292-86f6-f4964d49e8b3.md) |
