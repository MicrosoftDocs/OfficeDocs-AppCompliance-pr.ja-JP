...
description: Quadra Thankz、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
Microsoft に提供される Quadrasystems.net 情報:
...
| アプリのコア機能 | Thankz は、より幸せな企業を構築する鍵です。 使い慣れたMicrosoft Teamsインターフェイス上に構築されたこのインターフェイスは、毎日仕事をしているユーザーと接続するための新しい方法です。  Thankz は、人々が楽しい方法でお互いを認識するのに役立つツールです。&#160; これは、リーダーボード、予算設定、コントロールなどの機能を可能にする豊富なエンド ユーザー機能とエンタープライズ機能を提供します。 Thankz は、従業員が接続され、高く評価され、報われると感じるのに役立ちます。 |
| 会社の本社所在地 | インド |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read.All | アプリケーション | ユーザーのマネージャー情報を取得するには  | [5d8eb1a9-2188-4292-86f6-f4964d49e8b3](https://docs.microsoft.com/microsoft-365-app-certification/azure/5d8eb1a9-2188-4292-86f6-f4964d49e8b3) |
