---
title: Eusoft S.r.l による Eusoft Rdp Manager のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Eusoft Rdp Manager で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/cbe80cd5-d89b-45e4-9d24-345b43378b9d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004321" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Eusoft S.r.l から提供される情報。 Microsoft に対して:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | Eusoft Rdp Manager |
| ID | WA200004321 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | Eusoft S.r.l. |
| 会社の Web サイト | [https://www.eusoft.it](https://www.eusoft.it) |
| アプリの使用条件 | [https://www.eusoft.co.uk/privacy-cookies/](https://www.eusoft.co.uk/privacy-cookies/) |
| アプリのコア機能 | Eusoft.Lab RDP Manager は、表示するレポートをテストするために Eusoft によって開発されたアプリです |
| 会社の本社の場所 | イタリア |
| アプリ情報ページ | |
...
この情報は、Eusoft S.r.l によって提供されています。 このアプリが組織のデータを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
...
| プライバシー ポリシーの URL | https://www.eusoft.co.uk/privacy-cookies |
