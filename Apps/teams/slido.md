...
description: Slido、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.sli.do/terms](https://www.sli.do/terms) |
| アプリのコア機能 | Slido は、ライブおよび仮想の会議やイベントの究極の QA&amp; およびポーリング プラットフォームです。 インタラクティブな QA&amp;、ライブ ポーリング、対象ユーザーに関する分析情報を提供します。 |
| 会社の本社所在地 | スロバキア |
