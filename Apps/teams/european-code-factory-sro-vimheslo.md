---
title: 欧州コード ファクトリ s.r.o による vimheslo のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/08/2022
...
* <a href="https://teams.microsoft.com/l/app/73ee6b52-6b68-41c1-a7c5-91919e05b845" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003843" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

欧州コード ファクトリ s.r.o によって提供される情報。 Microsoft に:
...
この情報は、ヨーロッパのコード ファクトリ s.r.o によって提供されています。 このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて。
