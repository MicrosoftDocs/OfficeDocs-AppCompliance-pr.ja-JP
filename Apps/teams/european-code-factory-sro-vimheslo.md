---
title: ヨーロッパ Code Factory s.r.o による vimheslo のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/08/2022
...
description: vimheslo に関するすべての利用可能なセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/73ee6b52-6b68-41c1-a7c5-91919e05b845" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003843" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ヨーロッパ Code Factory s.r.o から提供される情報。 Microsoft に対して:
...
| アプリの使用条件 | [https://ecodef.cz/terms_of_use.html](https://ecodef.cz/terms_of_use.html) |
| アプリのコア機能 | パスワード マネージャー |
| 会社の本社の場所 | チェコ |
| アプリ情報ページ | [https://vimheslo.cz](https://vimheslo.cz) |
...
この情報は、ヨーロッパコード ファクトリ s.r.o によって提供されています。 このアプリが組織のデータを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
...
| 検出から 72 時間以内に、アプリまたはサービスのデータ侵害を監督機関や違反の影響を受けた個人に報告しますか? | いいえ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read.All | 委任 | データはドキュメント ライブラリOneDriveまたはSharePointに格納されます。アプリケーションはデータを読み取る必要があります。 | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| Sites.Read.All | 委任 | Team コンテキストのアプリケーションは、関連するSharePointドキュメント ライブラリにデータを格納します。アプリケーションでは、サイト名を読み取ってセットアップ パスを設定する必要があります。このパスには、データを含むファイルが配置されます。 | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| User.Read | 委任 | アプリケーションは、個人データを格納するために個人のOneDriveを把握する必要があります。 | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
>| メール | 委任 | 共有データを許可する。 | [73ee6b52-6b68-41c1-a7c5-91919e05b845](/microsoft-365-app-certification/azure/73ee6b52-6b68-41c1-a7c5-91919e05b845) |
