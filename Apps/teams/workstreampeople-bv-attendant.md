---
title: WORKSTREAMPEOPLE BV による応答のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 02/18/2022
ms.topic: article
...
description: アテンダントに利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/a7bdb4c6-23d0-4e4a-958a-168b50d67465" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003780" target="_blank">AppSource での表示</a>
...
| アプリのコア機能 | Anywhere365 による応答は、強力な最先端の電話オペレーターのコンソールです。 |
| 会社の本社所在地 | オランダ (the) |
| アプリ情報ページ | |
