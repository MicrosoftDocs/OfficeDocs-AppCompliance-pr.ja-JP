...
>|:------------------------|:--------------------|:------------------------------------|
>| Calendars.ReadWrite | 委任 | ユーザーが次の数週間のアクティビティを設定すると、チーム トラッカーは選択内容に基づいてユーザーの予定表と利用可能時間を更新します。  |
>| メール | 委任 | ユーザーのメールを確認するために使用します。 |
>| MailboxSettings.Read | 委任 | 予定表イベントを作成するためのタイム ゾーンを取得するために使用します。 |
>| openid | 委任 | ユーザーが自分のアカウントでサインインOffice 365する |
>| profile | 委任 | プロファイルに対してユーザーの基本情報を確認する |
>| User.Read | 委任 | プロファイルに対するユーザー情報の確認 |
