---
title: Team Tracker Ltd によるチーム トラッカーのアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 12/10/2021
ms.topic: article
...
description: チーム トラッカー、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "62252209"
---
# <a name="team-tracker"></a>チーム トラッカー

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003572" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Team Tracker Ltd から Microsoft に提供される情報:
...
| パートナー会社名 | チーム トラッカー LTD |
| 会社の Web サイト | [https://team-tracker.com](https://team-tracker.com) |
| アプリの利用規約 | [https://team-tracker.com/terms-and-conditions.html](https://team-tracker.com/terms-and-conditions.html) |
| アプリのコア機能 | チーム トラッカーは、ホット デスクを予約し、作業しているユーザーを確認する最初のアプリです。 |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Team Tracker Ltd によって提供されています。
...
| 環境にサポートされていないオペレーティング システムやソフトウェアはありますか? | はい |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | ユーザーが次の数週間のアクティビティを設定すると、チーム トラッカーは選択内容に基づいてユーザーの予定表と利用可能時間を更新します。  | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
>| MailboxSettings.Read | 委任 | 予定表イベントを作成するためのタイム ゾーンを取得するために使用します。 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
>| User.Read | 委任 | プロファイルに対するユーザー情報の確認 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
>| メール | 委任 | ユーザーのメールを確認するために使用します。 | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
>| openid | 委任 | ユーザーが自分のアカウントでサインインOffice 365する | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
>| profile | 委任 | プロファイルに対してユーザーの基本情報を確認する | [d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d](https://docs.microsoft.com/microsoft-365-app-certification/azure/d1d8d8c3-5199-45c2-afcc-aaab4dd8da5d) |
