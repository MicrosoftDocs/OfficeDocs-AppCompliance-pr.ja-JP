...
* <a href="https://teams.microsoft.com/l/app/762a660d-9fa5-461b-be81-310c102ba820" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002724" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| アプリのコア機能 | アプリは、包括的な Employee Service Desk 機能を提供します 。a) Create and Update tickets b) Answer routine questions c) プロビジョニングやオンボーディングなどの一般的なタスクを自動化する  |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Actionable Science によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | サインインおよびユーザー プロファイルの読み取り | [eb628055-f790-4ef0-9fce-ac95b4c61466](https://docs.microsoft.com/microsoft-365-app-certification/azure/eb628055-f790-4ef0-9fce-ac95b4c61466) |
