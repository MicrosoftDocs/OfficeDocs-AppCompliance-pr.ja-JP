...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| ビジネスごとにキャプチャされた名前と電子メールは、チケットを作成し、他のヘルプデスクの問題を発生する必要があります | 名前、メール | チケットとフローの状態の変更と更新に関するユーザーおよび他の役割ユーザーにメールを送信する。 |
...
>適切に制御、認証、承認される REST API ベースの統合
...
<iframe height='1020' title='Microsoft Cloud App Security情報' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/42195' frameborder='no' style='width: 100%;'></iframe>

<a href="https://appmcasinfoprod.azurewebsites.net/#/dashboard/42195" target="_blank">新しいタブで表示する</a>
