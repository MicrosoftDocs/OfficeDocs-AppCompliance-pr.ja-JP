---
title: Actionable Science による Rezolve.ai のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Rezolve.ai、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/762a660d-9fa5-461b-be81-310c102ba820" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002724" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Actionable Science から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://www.rezolve.ai](https://www.rezolve.ai) |
| アプリの使用条件 | [https://www.rezolve.ai/generalTerms](https://www.rezolve.ai/generalTerms) |
| アプリのコア機能 | アプリは、包括的な Employee Service Desk 機能を提供します。a) チケットを作成および更新する機能を含む b) 日常的な質問に答える c) プロビジョニングやオンボードなどの一般的なタスクを自動化する  |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Actionable Science によって提供されています。
...
| 最新の SOC1 認定日 | 2019-12-31 |
| アプリはサービス組織コントロール (SOC 2) に準拠していますか? | はい |
| 最新の SOC2 認定日 | 2019-12-31 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | サインインおよびユーザー プロファイルの読み取り | [eb628055-f790-4ef0-9fce-ac95b4c61466](../azure/eb628055-f790-4ef0-9fce-ac95b4c61466.md) |
