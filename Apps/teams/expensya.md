---
title: Expensya by Expensya のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/04/2022
...
description: Expensya で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/acbc0cba-5e0a-4bb5-a15c-21bce2863f01" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003924" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Expensya から Microsoft に提供される情報:
...
| パートナー会社名 | Expensya |
| 会社の Web サイト | [https://www.expensya.com](https://www.expensya.com) |
| アプリの使用条件 | [https://www.expensya.com/en/tou](https://www.expensya.com/en/tou) |
| アプリのコア機能 | Expensya は、請求書処理から企業カードまで、エンドツーエンドでビジネス支出を自動化します |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Expensya によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | 必要 |
| アプリによって処理されるデータは何ですか? | 会社プロファイル、ユーザー (従業員) プロファイル、および Business Spend アイテム |
| アプリは TLS 1.1 以降をサポートしていますか? | 必要 |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | 必要 |
| データベースに格納されているデータは何ですか? | Microsoft Graph トークン (Teamsに統合する場合) |
...
| プライバシー ポリシーの URL | https://www.expensya.com/en/legal |
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリケーションは、シングル サインオン、API アクセスなどのために Microsoft Identity Platform (Azure AD) と統合されますか? | 必要 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | アプリケーション | ユーザーの完全な名前と電子メールが必要です | [6ce7c411-d7c9-4c4f-882e-164447c9b44a](../azure/6ce7c411-d7c9-4c4f-882e-164447c9b44a.md) |
