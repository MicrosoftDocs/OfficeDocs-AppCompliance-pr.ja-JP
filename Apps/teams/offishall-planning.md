---
title: Offishall による Offishall 計画のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/17/2022
...
description: Offishall Planning で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "65455076"
---
# <a name="offishall-planning"></a>Offishall Planning

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 31 日</p>

* <a href="https://teams.microsoft.com/l/app/cbdfe641-3e2e-449d-b4f7-7e377c7060aa" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004048" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Offishall から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Offishall Planning |
| ID | WA200004048 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | Offishall |
| 会社の Web サイト | [https://www.offishall.io](https://www.offishall.io) |
| アプリの使用条件 | [https://en.offishall.io/conditions-generales-dutilisation-d...](https://en.offishall.io/conditions-generales-dutilisation-du-compte) |
| アプリのコア機能 | ハイブリッド オフィス向けの柔軟な計画、スケジュール、および職場管理ソリューション |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Offishall から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 予定表イベント (場合。 管理者は Offishall - Outlook カレンダー Integration) を有効にすることを選択します。チャット メンバーのTeams;ユーザー電子メール;ユーザー名 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー電子メール、ユーザー名 |
| 基になるインファ構造が Microsoft 顧客データを処理または格納する場合、このデータは地理的にどこに保存されますか? | ドイツ、オランダ (the)、フランス |
...
| プライバシー ポリシーの URL | https://www.offishall.io/politique-de-confidentialite |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.Read.All | アプリケーション | チャネルのメンバーを 1 に使用します。まだ 2 でない場合はプロビジョニングします。作業モード情報をフェッチして表示します  | [cbdfe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| Directory.Read.All | アプリケーション | ユーザーの電子メールが設定されていない場合は、ID リストにアクセスして取得する必要があります | [cbdfe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| User.Read | 委任 | 上記と同じ | [cbdfe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| メール | 委任 | メインメールに基づいてユーザーを識別します  | [cbdfe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| offline_access | 委任 | ユーザーがオフラインの間にユーザーからデータをフェッチしたい場合があります | [cbdfe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| openid | アプリケーション | ユーザーにサインインするには | [cbdfe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
>| profile | 委任 | ユーザーの基本的なプロファイル情報を取得し、電子メールと名前のみを格納します | [cbdfe641-3e2e-449d-b4f7-7e377c7060aa](../azure/cbdfe641-3e2e-449d-b4f7-7e377c7060aa.md) |
