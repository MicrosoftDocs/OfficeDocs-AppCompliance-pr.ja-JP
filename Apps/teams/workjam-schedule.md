---
title: WorkJam による WorkJam スケジュールのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: WorkJam Schedule で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64880116"
---
# <a name="workjam-schedule"></a>WorkJam Schedule

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 7 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/02cc7d46-7636-4f30-bae2-c5dfde32751c" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003058" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | WorkJam Schedule |
| ID | WA200003058 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | WorkJam |
| 会社の Web サイト | [https://www.workjam.com](https://www.workjam.com) |
| アプリの使用条件 | [https://appcontent.workjam.com/en/terms-of-use/](https://appcontent.workjam.com/en/terms-of-use/) |
| アプリのコア機能 | WorkJam は、Digital Workplace ソリューション業界のリーダーが、現場の生産性プラットフォームとして、またはフロントラインの従業員ソリューション内で&#8212;現場の従業員を調整することを選択します。 WorkJam は、37 以上の言語で利用でき、38 を超える国に展開されています。WorkJam は、市場をリードするタスク管理、シフト管理、アンケート、マイクロラーニング ツールを通じて、ワークフォース オーケストレーション全体を提供します。  |
| 会社の本社の場所 | カナダ |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する WorkJam によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | アプリケーション | エンド ユーザーに通知を送信する。 | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
>| User.Read | 委任 | 識別と認証の場合 | [0b87cb84-073e-4cf6-a1ef-45d864ef2918](../azure/0b87cb84-073e-4cf6-a1ef-45d864ef2918.md) |
