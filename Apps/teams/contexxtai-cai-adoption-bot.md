...
| アプリのコア機能 | 導入スイート全体を使用する場合は、含む。 &quot;パーソナル コーチング ブースター&quot;、分析エンジン (C.AI 導入分析) &amp; 分析は、Graph API の匿名化された使用状況データExchange Teams。 このデータに基づいて、ボット アルゴリズム (C.AI 導入ボット) &amp; は、特定の学習状況を検出し、ユーザーにクイック ヒントを送信します。 たとえば、ユーザーが Teams 投稿に件名を追加したことがない場合、ボットはこれを行う方法を知らないと仮定し、カスタマイズされた学習教材を送信します。 Analytics を使用しない場合は、QA ボットに&amp;すすむ必要があります。 |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | [https://contexxt.ai/cai-adoption-bot/](https://contexxt.ai/cai-adoption-bot/) |
...
| アプリで処理されるデータは何ですか? | ユーザー プロファイルからの匿名化および集約されたメタデータ、ExchangeおよびTeamsデータ |
| アプリは TLS 1.1 以上をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データが格納されていますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー プロファイルからの匿名化および集約されたメタデータ、ExchangeおよびTeamsデータ |
...
| プライバシー ポリシーの URL | https://contexxt.ai/privacy-policy/ |
...
| サポートされているポリシーの種類を一覧表示する | 管理者は MFA を使用するために強制されます |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | アプリケーション | 時間管理のベスト プラクティスに関する予定表の使用状況データの読み取り | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| CallRecords.Read.All | アプリケーション | 会議Teamsのベスト プラクティスに関する通話使用状況データの読み取り | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| ChannelMessage.Read.All | アプリケーション | メッセージTeamsのベスト プラクティスに関するチャネルTeamsデータの読み取り | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Chat.Read.All | アプリケーション | チャットTeamsのベスト プラクティスに関するチャットTeamsデータを読み取る | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Directory.Read.All | 両方とも | ボットとの対話のためのユーザー プロファイル データの読み取り | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Group.Read.All | アプリケーション | 管理Teamsのベスト プラクティスTeamsデータを読み取る | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Group.ReadWrite.All | アプリケーション | オプション: Planners for Planner のベスト プラクティスにサービス ユーザー アカウントを一時的に書き込むには | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Mail.Read | アプリケーション | メール管理のベスト プラクティスに関するメール メタデータの読み取り | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| Tasks.Read | 委任 | Planner のベスト プラクティスの Planner 使用状況データを読み取る方法 | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
>| User.Read.All | アプリケーション | 管理のベスト プラクティスのグループ メンバーシップのようなTeamsメタダデータを読み取る | [abe28a0d-6acc-47d8-9169-cfcc2553bc13](../azure/abe28a0d-6acc-47d8-9169-cfcc2553bc13.md) |
...
|:------------|:---------------------------------------|
| [**アプリケーション のセキュリティ**](../docs/certification-submission-guide.md#application-security) | **PASS** |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;侵入テスト | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;脆弱性評価レビュー (DAST/SAST/侵入テスト) | In Scope |
| [**運用上のセキュリティ**](../docs/certification-submission-guide.md#operational-security) | **PASS** |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;マルウェア保護 - ウイルス対策 | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;マルウェア保護 - アプリケーション制御 | 該当なし |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;パッチ管理 - リスクランキング | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;パッチ管理 - パッチ適用 | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;脆弱性スキャン | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ファイアウォール - ファイアウォール (または同等のテクノロジ) | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;ファイアウォール - Web アプリケーション ファイアウォール (WAF) (オプション) | 該当なし |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;変更コントロール | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Secure Software Development/Deployment | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;アカウント管理 | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;侵入の検出と防止 (オプション) | 該当なし |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;セキュリティ イベント ログ | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;レビュー (ログ データ) | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;セキュリティ イベントの警告 | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;情報セキュリティリスク管理 | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;インシデント対応 | In Scope |
| [**データ処理のセキュリティ &amp; プライバシー**](../docs/certification-submission-guide.md#data-handling-security-and-privacy) | **PASS** |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;転送中のデータ | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;保存中のデータ | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;データの保持と廃棄 | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;データ アクセスの管理 | In Scope |
| &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;GDPR | In Scope |
