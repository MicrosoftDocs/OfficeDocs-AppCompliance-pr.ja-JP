...
description: LTI クライアント、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| 会社の Web サイト | [https://flipick.com](https://flipick.com) |
| アプリの利用規約 | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| アプリのコア機能 | アプリは、コースを起動するための LTI (ラーニング ツール相互運用性) サーバーを備えたシングル サインオン (SSO) を提供します。 これは LTI ツール コンシューマであり、Basic LTI (BLTI) をサポートしています。 |
| 会社の本社所在地 | インド |
| アプリ情報ページ | |
