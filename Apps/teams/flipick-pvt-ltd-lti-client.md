...
description: LTI クライアントで使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/bfed1af2-2c16-4536-9780-8e21d7fc7d79" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003313" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://flipick.com/terms-of-use/](https://flipick.com/terms-of-use/) |
| アプリのコア機能 | このアプリは、コースを起動するための LTI (ラーニング ツールの相互運用性) サーバーを備えたシングル サインオン (SSO) を提供します。 LTI ツール コンシューマーであり、Basic LTI (BLTI) をサポートしています。 |
| 会社の本社の場所 | インド |
| アプリ情報ページ | |
...
この情報は、Flipick Pvt Ltd によって、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
