...
| アプリの利用規約 | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| アプリのコア機能 | Teamhood は、毎日の効率的な共同作業を行うプロジェクトとタスク管理の 1 つのソフトウェアです。 Teamhood は、すべてのプロジェクト マネージャーとチーム メンバーが作業データを計画、実行、レポートするために必要な機能を提供します。 |
| 会社の本社所在地 | リトアニア |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Eylean によって提供されています。
