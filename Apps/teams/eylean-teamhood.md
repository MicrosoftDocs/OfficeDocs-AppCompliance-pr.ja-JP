---
title: Eylean による Teamhood のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Teamhood で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/22372c30-c5de-483e-85b4-8d51db246eda" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002568" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Eylean から Microsoft に提供される情報:
...
| パートナー会社名 | Eylean |
| 会社の Web サイト | [https://teamhood.com](https://teamhood.com) |
| アプリの使用条件 | [https://teamhood.com/terms-of-use/](https://teamhood.com/terms-of-use/) |
| アプリのコア機能 | Teamhood は、毎日の効率的なコラボレーションを実現するプロジェクトとタスク管理のオールインワン ソフトウェアです。 Teamhood は、すべてのプロジェクト マネージャーとチーム メンバーが作業データを計画、実行、レポートするために必要な機能を提供します。 |
| 会社の本社の場所 | リトアニア |
| アプリ情報ページ | [https://teamhood.com/features/teamhood-and-microsoft-teams-...](https://teamhood.com/features/teamhood-and-microsoft-teams-integration/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Eylean から提供されています。
