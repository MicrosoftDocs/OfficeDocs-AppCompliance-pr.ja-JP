...
| アプリの利用規約 | [https://www.kippa.app/terms-of-service/](https://www.kippa.app/terms-of-service/) |
| アプリのコア機能 | 1 回または定期的に個人、共有、またはチャネルのリマインダーを内部からすばやく設定Microsoft Teams |
| 会社の本社所在地 | カナダ |
...
| サポートされているポリシーの種類を一覧表示する | ユーザーが kippa Microsoft Teamsを取得するには、ユーザーがサインインする必要Teamsと同じです。 |
