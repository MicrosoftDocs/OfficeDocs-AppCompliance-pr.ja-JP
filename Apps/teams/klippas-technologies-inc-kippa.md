...
description: Kippa で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/49d0e480-ede2-11ea-85fc-27f7e2c29730" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003327" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.kippa.app](https://www.kippa.app) |
| アプリの使用条件 | [https://www.kippa.app/terms-of-service/](https://www.kippa.app/terms-of-service/) |
| アプリのコア機能 | Microsoft Teams内から 1 回限りの、または定期的な個人用、共有、またはチャネルのリマインダーをすばやく設定する |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | [https://www.kippa.app/kippa-app/](https://www.kippa.app/kippa-app/) |
...
この情報は、KLIPPAS Technologies Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について説明しています。
...
| サポートされているポリシーの種類を一覧表示する | ユーザーが Kippa にアクセスするにはTeamsにサインインする必要があるため、Microsoft Teamsと同じです。 |
