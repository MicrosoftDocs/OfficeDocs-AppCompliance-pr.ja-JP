...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | UPN を使用して Microsoft とのサインインを許可します。 プロファイルの事前入力の名前と姓を指定します。 | [dc171e47-c074-4bc2-9e7b-3856b71e0630](https://docs.microsoft.com/microsoft-365-app-certification/azure/dc171e47-c074-4bc2-9e7b-3856b71e0630) |
