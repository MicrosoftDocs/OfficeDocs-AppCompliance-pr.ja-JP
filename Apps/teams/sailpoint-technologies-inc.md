...
description: Sailpoint で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/ceca14aa-4fd9-4a8b-b51f-ee05bf98accc" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002761" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://sailpoint.com](https://sailpoint.com) |
| アプリの使用条件 | [https://www.sailpoint.com/legal/customer-agreements/](https://www.sailpoint.com/legal/customer-agreements/) |
| アプリのコア機能 | SailPoint の ID セキュリティ ソリューションでは、アクセス管理と ID セキュリティが組み合わされており、ワーカーが自分の仕事を行うための適切なアクセス権を&#8211;できます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
