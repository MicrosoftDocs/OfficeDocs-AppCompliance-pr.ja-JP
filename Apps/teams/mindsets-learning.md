---
title: Mindsets による Mindsets のアプリケーションラーニング
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Mindsets で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.mindsets.com/terms](https://www.mindsets.com/terms) |
| アプリのコア機能 | Mindsets ラーニングは、問い合&amp;わせプロジェクトベースの学習プラットフォームです。 |
| 会社の本社所在地 | アメリカ |
