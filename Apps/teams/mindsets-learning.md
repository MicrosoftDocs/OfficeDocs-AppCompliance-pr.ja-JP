---
title: 考え方別の考え方のアプリケーション情報 ラーニング
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: 考え方、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/fdc91943-4341-41e6-b4e7-b4625ab8c8f7" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003000" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Microsoft にラーニング考え方によって提供される情報:
...
| 会社の Web サイト | [https://www.mindsets.com](https://www.mindsets.com) |
| アプリの使用条件 | [https://www.mindsets.com/terms](https://www.mindsets.com/terms) |
| アプリのコア機能 | 考え方ラーニングは、問い合わせ&amp;プロジェクトベースの学習プラットフォームです。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.mindsets.com](https://www.mindsets.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関するラーニング、考え方によって提供されています。
