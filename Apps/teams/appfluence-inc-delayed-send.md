---
title: Appfluence Inc による遅延送信のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: 遅延送信に使用できるすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66247939"
---
# <a name="delayed-send"></a>遅延送信

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/ae64c32a-0eab-47d9-91e4-b693a99f7fc3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004301" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://delayedsend.com/eula](https://delayedsend.com/eula) |
| アプリのコア機能 | 今後、プライベートチャットまたはグループ チャットにメッセージを送信するようにスケジュールを設定します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://delayedsend.com](https://delayedsend.com) |
...
| アプリによって処理されるデータは何ですか? | ユーザーがメッセージを送信する場所を選択できるように、Teams のグループチャットと個人用チャットの一覧。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.ReadBasic | 委任 | チャットに参加しているユーザーを表示して、メッセージの送信先を把握する | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| ChatMessage.Send | 委任 | ユーザーに代わってメッセージを送信する | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.Read | 委任 | ユーザーにサインインし、ユーザーの名前を確認する | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| User.ReadBasic.All | 委任 | 遅延メッセージの宛先の選択を許可するには、ユーザーのコラボレーターの一覧を参照してください | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
>| offline_access | 委任 | メッセージ配信のスケジュール時にアプリがユーザーとして機能することを許可する | [93b661be-66e3-4468-b802-64bb952f1471](../azure/93b661be-66e3-4468-b802-64bb952f1471.md) |
