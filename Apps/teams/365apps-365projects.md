...
description: 365Projects で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/a9c31598-b014-4e20-b3bd-3d275fa738d3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002160" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

365Apps から Microsoft に提供される情報:
...
| パートナー会社名 | 365Apps |
| 会社の Web サイト | [https://365apps.com.au](https://365apps.com.au) |
| アプリの使用条件 | [https://365projects.app/eula](https://365projects.app/eula) |
| アプリのコア機能 | プロジェクト&amp;Microsoft Teamsまとめる Projectを作成し、既存のチャネルまたは新しいチャネルに接続する |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://365projects.app](https://365projects.app) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する 365Apps によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | いいえ |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | 顧客の電子メール アドレス |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Tasks.ReadWrite | 委任 | Planner タスクの読み取りと更新 | [99a0a9b1-5d28-45df-9f99-792aa32795f4](../azure/99a0a9b1-5d28-45df-9f99-792aa32795f4.md) |
>| User.Read | 委任 | ユーザーのメールを読み取る | [99a0a9b1-5d28-45df-9f99-792aa32795f4](../azure/99a0a9b1-5d28-45df-9f99-792aa32795f4.md) |
