---
title: Edgility による touchSMS のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/12/2022
...
description: touchSMS、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/d4275409-72a2-423e-9557-e088f0e68f20" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003655" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Edgility から Microsoft に提供される情報:
...
| パートナー会社名 | Edgility |
| 会社の Web サイト | [https://touchsms.com.au](https://touchsms.com.au) |
| アプリの使用条件 | [https://www.touchsms.com.au/legal/](https://www.touchsms.com.au/legal/) |
| アプリのコア機能 | touchSMS では、日常のビジネス ツール向けの統合コミュニケーション ソリューションの開発に重点を置きます。 これらのソリューションを使用すると、ユーザーは、Excel、Outlook、Teamsなどの Microsoft 製品から直接、SMS 経由でリマインダー、プロモーション、アラート、通知を送信できます。 ユーザーは、Microsoft OutlookとTeamsで SMS 返信を受信することで、双方向の会話を利用できます。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://www.touchsms.com.au/sms-integrations/microsoft-365/](https://www.touchsms.com.au/sms-integrations/microsoft-365/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Edgility によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | Names |
