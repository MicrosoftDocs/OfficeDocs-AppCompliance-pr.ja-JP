---
title: ConsenSys AG&#8217;s Sobol による Sobol のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
| アプリの使用条件 | [https://sobol.io/terms-of-service/](https://sobol.io/terms-of-service/) |
| アプリのコア機能 | Sobol は、組織が自分の役割、チーム、目標、ユーザー、契約を視覚化してマップするのに役立つ Web アプリケーションです。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
