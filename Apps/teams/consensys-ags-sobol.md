...
* <a href="https://teams.microsoft.com/l/app/659f0ad6-8b3d-4846-8c4c-00ea9dfd64c8" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002999" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ConsenSys AG が提供する情報&#8217;Sobol から Microsoft に提供されます。
...
| 会社の Web サイト | [https://sobol.io](https://sobol.io) |
| アプリの利用規約 | [https://sobol.io/terms-of-service/](https://sobol.io/terms-of-service/) |
| アプリのコア機能 | Sobol は、組織が役割、チーム、目標、ユーザー、および契約を視覚化してマップするのに役立つ Web アプリケーションです。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://sobol.io/features](https://sobol.io/features) |
