---
title: SimplyDo by SimplyDo のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/20/2022
...
description: SimplyDo で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/dbf692fe-35c1-4511-9178-9131e6511712" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004248" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

SimplyDo から Microsoft に提供される情報:
...
| パートナー会社名 | SimplyDo |
| 会社の Web サイト | [https://www.simplydo.co.uk](https://www.simplydo.co.uk) |
| アプリの使用条件 | [https://www.simplydo.co.uk/terms-of-use](https://www.simplydo.co.uk/terms-of-use) |
| アプリのコア機能 | SimplyDo を使用すると、組織はスタッフベース全体からアイデアや洞察を取り込み、継続的な改善とイノベーションに力を入れます。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://www.simplydo.co.uk/product](https://www.simplydo.co.uk/product) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、SimplyDo によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ (名前、部署、役職、電子メール)。 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ (名前、部署、役職、電子メール) |
...
| プライバシー ポリシーの URL | https://www.simplydo.co.uk/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | シングル サインオンのプロファイル データにアクセスするには | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| メール | 委任 | OpenID Connect 機能/ログインをサポートするには | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| offline_access | 委任 | OpenID Connect 機能/ログインをサポートするには | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
>| openid | 委任 | OpenID Connect 機能/ログインをサポートするには | [dbf692fe-35c1-4511-9178-9131e6511712](../azure/dbf692fe-35c1-4511-9178-9131e6511712.md) |
