---
title: Windstream による OfficeSuite のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: OfficeSuite で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/bf9c1c49-a529-451e-a81d-ac94cfdbec3e" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000618" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Windstream から Microsoft に提供される情報:
...
| パートナー会社名 | Windstream |
| 会社の Web サイト | [https://www.windstreamenterprise.com](https://www.windstreamenterprise.com) |
| アプリの利用規約 | [https://www.windstream.com/about/legal/Terms-and-Conditions](https://www.windstream.com/about/legal/Terms-and-Conditions) |
| アプリのコア機能 | 通話、会議、通話通知アプリ |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Windstream によって提供されています。
...
| プライバシー ポリシーの URL | https://www.windstream.com/about/legal/privacy-policy |
