---
title: RowShare by RowShare のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2021
...
description: RowShare で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/88508c59-07a8-42e3-985d-ff0cc4148c85" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002567" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://my.rowshare.com/termsofuse](https://my.rowshare.com/termsofuse) |
| アプリのコア機能 | 共同作業用、セキュリティで保護された視覚的なスプレッドシートを使用して、管理者プロセスを簡略化します。 |
| 会社の本社の場所 | フランス |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する RowShare によって提供されています。
