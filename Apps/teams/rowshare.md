...
| パートナー会社名 | RowShare |
| 会社の Web サイト | [https://www.rowshare.com](https://www.rowshare.com) |
| アプリの利用規約 | [https://my.rowshare.com/termsofuse](https://my.rowshare.com/termsofuse) |
| アプリのコア機能 | 共同作業、セキュリティ保護、視覚的なスプレッドシートを使用して、管理プロセスを簡素化します。 |
| 会社の本社所在地 | フランス |
| アプリ情報ページ | [https://www.rowshare.com/features](https://www.rowshare.com/features) |
