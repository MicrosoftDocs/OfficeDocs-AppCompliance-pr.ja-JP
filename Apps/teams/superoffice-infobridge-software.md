---
title: SuperOffice InfoBridge ソフトウェアによる SuperOffice のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/10/2021
...
description: SuperOffice で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/4f9a1c49-28e3-443c-9007-67c7819407bc" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003364" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

SuperOffice InfoBridge Software から Microsoft に提供される情報:
...
| パートナー会社名 | SuperOffice InfoBridge ソフトウェア |
| 会社の Web サイト | [https://infobridge.com](https://infobridge.com) |
| アプリの利用規約 | [https://msteams.superofficeapps.com/Home/TermsAndConditions](https://msteams.superofficeapps.com/Home/TermsAndConditions) |
| アプリのコア機能 | SuperOffice CRM の顧客、プロジェクト、販売に何が起こっているかを知らせることができます。 |
| 会社の本社所在地 | オランダ (the) |
| アプリ情報ページ | [https://msteams.superofficeapps.com](https://msteams.superofficeapps.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御に関する SuperOffice InfoBridge ソフトウェアによって提供されています。
...
| プライバシー ポリシーの URL | https://msteams.superofficeapps.com/Home/PrivacyPolicy |
