---
title: Pandos Intelligence Inc. による Pandos のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/05/2022
...
Pandos Intelligence Inc から Microsoft に提供される情報:
...
| パートナー会社名 | Pandos Intelligence Inc |
| 会社の Web サイト | [https://pandos.io](https://pandos.io) |
| アプリの使用条件 | [https://app.pandos.io/terms-of-use](https://app.pandos.io/terms-of-use) |
| アプリのコア機能 | Pandos は、チームと人のマネージャー、プロジェクト リーダー、トレーナー、教育インストラクター向けの、ショップでの学習と開発を一気に行うプラットフォームです。 条件 (可用性、性格、スキル、または任意のカスタム条件を含む)、チーム タスク管理、ピア評価に基づくチーム編成などの基本的な機能をサポートします。 プラットフォームは、メンバーのソフト スキルのプロファイルを自動的に生成し、ピアによって検証されます。  |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | [https://pandos.io](https://pandos.io) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Pandos Intelligence Inc から提供されています。
