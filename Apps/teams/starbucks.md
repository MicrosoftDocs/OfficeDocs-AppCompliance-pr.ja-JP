---
title: Starbucks による Starbucks のアプリケーション情報&#174; Coffee Company
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/17/2022
...
description: スターバックスで利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/aa2600a7-aedf-447c-b15b-8ea2daf68a09" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002412" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Starbucks がコーヒー&#174;マイクロソフトに提供する情報:
...
| パートナー会社名 | Starbucks&#174; Coffee Company |
| 会社の Web サイト | [https://www.starbucks.com](https://www.starbucks.com) |
| アプリの利用規約 | [https://www.starbucks.com/gift-cards/manage/card-terms-and-...](https://www.starbucks.com/gift-cards/manage/card-terms-and-conditions) |
| アプリのコア機能 | Starbucks eGift を持つチーム メンバーに感謝、おめでとう、または工藤を言います。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、Starbucks&#174; Coffee Company から、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
