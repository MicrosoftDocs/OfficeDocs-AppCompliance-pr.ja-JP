...
description: Financial Times で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "65357126"
---
# <a name="financial-times"></a>Financial Times

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/53992bb2-b879-45ef-99de-68fc094f7bbf" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004054" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Financial Times から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Financial Times |
| ID | WA200004054 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | Financial Times |
| 会社の Web サイト | [https://www.ft.com](https://www.ft.com) |
| アプリの使用条件 | [https://help.ft.com/legal-privacy/terms-and-conditions/](https://help.ft.com/legal-privacy/terms-and-conditions/) |
| アプリのコア機能 | Microsoft Teamsで Financial Times のニュースを検出、保存、共有します。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Paas |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | Aws、その他 |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Financial Times から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | userId、tenantId |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | userId |
...
| プライバシー ポリシーの URL | https://help.ft.com/legal-privacy/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | シングル サインオンに必要 | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| メール | 委任 | シングル サインオンに必要 | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| offline_access | 委任 | シングル サインオンに必要 | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| openid | 委任 | シングル サインオンに必要 | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
>| profile | 委任 | シングル サインオンに必要 | [50bff4f3-8dcf-4f58-bf77-180988c2dc3d](../azure/50bff4f3-8dcf-4f58-bf77-180988c2dc3d.md) |
