---
title: BrowserStack Inc による BrowserStack のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2022
...
description: BrowserStack で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/180f19aa-1b79-4b4a-b716-068b81cfb145" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004404" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

BrowserStack Inc から Microsoft に提供される情報:
...
| パートナー会社名 | BrowserStack Inc |
| 会社の Web サイト | [https://www.browserstack.com](https://www.browserstack.com) |
| アプリの使用条件 | [https://www.browserstack.com/terms](https://www.browserstack.com/terms) |
| アプリのコア機能 | BrowserStack の分析情報を Microsoft Teams に直接取り込みます。 |
| 会社の本社の場所 | インド |
| アプリ情報ページ | [https://www.browserstack.com/docs/automate/selenium/microso...](https://www.browserstack.com/docs/automate/selenium/microsoft-teams) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて BrowserStack Inc から提供されています。
...
| プライバシー ポリシーの URL | https://www.browserstack.com/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 認証目的でサインインしてユーザー プロファイルを読み取る | [180f19aa-1b79-4b4a-b716-068b81cfb145](../azure/180f19aa-1b79-4b4a-b716-068b81cfb145.md) |
