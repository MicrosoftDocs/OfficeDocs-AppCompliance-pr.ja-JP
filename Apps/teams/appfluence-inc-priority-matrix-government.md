---
title: Appfluence Inc.による Priority Matrix Government のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2022
...
description: Priority Matrix Government で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/ffca97e5-0569-c88c-ac30-7c5717e2e5ae" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004231" target="_blank">AppSource で表示する</a>
...
|:----------------|:-------------|
| アプリ名 | Priority Matrix Government |
| ID | WA200004231 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | Appfluence Inc |
| 会社の Web サイト | [https://appfluence.com](https://appfluence.com) |
| アプリの使用条件 | [https://gov.prioritymatrix.com/eula](https://gov.prioritymatrix.com/eula) |
| アプリのコア機能 | Priority Matrix for Government は、Azure Government インフラストラクチャに格納され、Outlook と Microsoft Teams に深く統合された、フル機能のプロジェクト管理ソフトウェアです。 優先度マトリックスは、チームが優先順位を付け、集中し、よりスマートに作業するのに役立ちます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://appfluence.com/government](https://appfluence.com/government) |
...
この情報は、Appfluence Inc によって、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザーの電子メールと名/姓を最小限に抑えます。 必要に応じて、コラボレーター、電子メール、予定表イベント。 |
...
| プライバシー ポリシーの URL | https://appfluence.com/gdpr/ |
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | social-auth-app-django |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委任 | 1 対 1 のビューで、コラボレーターと共有するイベントをユーザーに表示します | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| Files.Read.All | 委任 | 1 対 1 ビューで、コラボレーターと共有するファイルをユーザーに表示します。 また、必要に応じて、添付ファイルをシステムの代わりに独自の OneDrive に格納することもできます。 | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| Mail.Read | 委任 | 1 対 1 のビューで、共同作業者と共有するメールをユーザーに表示します。 | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| Tasks.Read | 委任 | 1 対 1 のビューで、コラボレーターと共有するタスクをユーザーに表示します | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| TeamsActivity.Send | 委任 | 関連するアラート (期限切れのアイテム、メンションなど) をユーザーの Teams アクティビティ フィードに送信します。 | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| User.Read | 委任 | ユーザーにサインインし、電子メールと名/姓を共有して、適切にメッセージを送信できるようにします。 | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| User.ReadBasic.All | 委任 | 他のコラボレーターに優先度マトリックスへの招待やタスクの割り当てを提案できるように、ユーザーのチームメイトを確認します。 | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| メール | 委任 | ユーザーのメール アドレスを知り、通信でアドレス指定できるようにします。 これは、システム内の ID でもあります。 | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| offline_access | 委任 | ユーザーが接続されていない間にレポートを準備できるように、ユーザーのデータへのアクセスを維持します。 | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| openid | 委任 | シングル サインオンを使用してユーザーにサインインします。 | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
>| profile | 委任 | 適切にアドレス指定できるように、ユーザーの姓名を確認します。 | [8cbdb27d-6b59-402d-a9c0-a588cfb4030c](../azure/8cbdb27d-6b59-402d-a9c0-a588cfb4030c.md) |
