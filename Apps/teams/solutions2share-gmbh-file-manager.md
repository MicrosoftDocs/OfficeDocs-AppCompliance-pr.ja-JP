---
title: Solutions2Share GmbH によるファイル マネージャーのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: ファイル マネージャー、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "64463999"
---
# <a name="file-manager"></a>ファイル マネージャー

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 12 月 30 日</p>

* <a href="https://teams.microsoft.com/l/app/4946e155-584a-412d-aac1-48975e073587" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003770" target="_blank">AppSource での表示</a>
...
| アプリのコア機能 | すべてのチームを通じてファイルを管理Microsoft Teams |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | [https://www.solutions2share.com/file-manager/](https://www.solutions2share.com/file-manager/) |
...
| データベースに格納されているデータは何ですか? | TenantID,User Principal Name |
