---
title: Aimful による Aimful のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/31/2022
...
description: Aimful、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
<p>開発者による最終更新日: 2022 年 1 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/7da7691c-e47a-479e-9bb2-cda07cffd0e5" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003698" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Aimful が Microsoft に提供する情報:
...
| パートナー会社名 | Aimful |
| 会社の Web サイト | [https://aimful.io](https://aimful.io) |
| アプリの利用規約 | [https://aimful.io/terms-and-conditions/](https://aimful.io/terms-and-conditions/) |
| アプリのコア機能 | Aimful は、チームまたは会社での会議文化の変革を奨励します  |
| 会社の本社所在地 | 米国オブアメリカ |
| アプリ情報ページ | [https://aimful.io/how-it-works/](https://aimful.io/how-it-works/) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Aimful によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリで処理されるデータは何ですか? | 予定表、ユーザーメール、タイムゾーンのイベント |
| アプリは TLS 1.1 以上をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データが格納されていますか? | はい |
| データベースに格納されているデータは何ですか? | 予定表、ユーザーメール、タイムゾーンのイベント |
...
| アプリは、ユーザー法 (SOX) Sarbanes-Oxley準拠していますか? | なし |
| アプリは NIST 800-171 に準拠していますか? | なし |
| アプリはクラウド セキュリティ アライアンス (CSA Star) の認定を受けていますか? | なし |
...
| プライバシー ポリシーの URL | https://aimful.io/policy/ |
...
| アプリの個人データの処理に関連するリスクを特定するために、定期的なデータ セキュリティとプライバシーレビュー (データ保護影響評価やプライバシー リスク評価など) が実行されますか? | なし |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | 予定表イベントへのアクセス | [93544582-de9c-42a0-baa5-df3d25e9bd48](../azure/93544582-de9c-42a0-baa5-df3d25e9bd48.md) |
>| MailboxSettings.Read | 委任 | ユーザーのタイムゾーンにアクセスする | [93544582-de9c-42a0-baa5-df3d25e9bd48](../azure/93544582-de9c-42a0-baa5-df3d25e9bd48.md) |
