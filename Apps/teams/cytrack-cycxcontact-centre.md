---
title: CyTrack による CyCX Contact Center のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: CyCX Contact Center で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66656166"
---
# <a name="cycx--contact-centre"></a>CyCX Contact Center

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 27 日</p>

* <a href="https://teams.microsoft.com/l/app/4d7b80a9-d64d-4b54-a1db-259cc204b15d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004350" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

CyTrack から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | CyCX Contact Center |
| ID | WA200004350 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | CyTrack |
| 会社の Web サイト | [https://web.cytrack.com](https://web.cytrack.com) |
| アプリの使用条件 | [https://web.cytrack.com/subscription-service-software-agree...](https://web.cytrack.com/subscription-service-software-agreement/) |
| アプリのコア機能 | CyCX は、会議、チャット、コラボレーション以外の音声通話機能とコンタクト センター機能を使用してカスタマー エクスペリエンスを向上させる必要があるビジネス ユーザーを対象とします。  CyCX は、Microsoft Teams の通信およびコラボレーション プラットフォームです。  CyTrack CyCX は、Microsoft Teams 内の任意のチャネルで顧客に会い、エージェントに単一の統合インターフェイスを提供し、顧客の包括的なビューを使用して、より深い対話を可能にします。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://web.cytrack.com/microsoft-teams/contact-centre-for-...](https://web.cytrack.com/microsoft-teams/contact-centre-for-microsoft-teams/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、CyTrack によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | Teams 通話データ |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | Teams 通話データ |
| 基になるインファ構造が Microsoft 顧客データを処理または格納する場合、このデータは地理的にどこに保存されますか? | オーストラリア、ニュージーランド、イギリス、北アイルランド (the) |
...
| プライバシー ポリシーの URL | https://web.cytrack.com/privacy-policy-teams/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppRoleAssignment.ReadWrite.All | 委任 | これは、顧客テナントの Azure AD アプリで API アクセス許可を付与するために servicePrincipal を作成するために必要です | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |
>| Application.ReadWrite.All | 委任 | このアクセス許可は、Teams の呼び出しに関連するメタデータを取得するために通知サービスを変更するためにサブスクライブするために使用している顧客テナントに Azure AD アプリを作成するために必要です。 | [acafd8f7-a6d3-420e-89d7-7729751b7c04](../azure/acafd8f7-a6d3-420e-89d7-7729751b7c04.md) |
