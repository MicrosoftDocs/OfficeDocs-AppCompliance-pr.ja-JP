---
title: Anaek Inc.による OfficeAmp のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: OfficeAmp で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/b3f65e46-d08c-4ab9-a11d-20836a9dcdda" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381756" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.officeamp.com/adminbot/tos/](https://www.officeamp.com/adminbot/tos/) |
| アプリのコア機能 | 内部ヘルプデスク ボット、堅牢な ITSM システムMicrosoft Teams、チケットを追跡、割り当て、解決するためのかんばんダッシュボードを提供します。 |
| 会社の本社所在地 | アメリカ |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Anaek Inc.によって提供されています。
