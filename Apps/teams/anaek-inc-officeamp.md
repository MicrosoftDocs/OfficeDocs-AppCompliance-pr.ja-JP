---
title: OfficeAmp by Anaek Inc のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/07/2022
...
description: OfficeAmp で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/b3f65e46-d08c-4ab9-a11d-20836a9dcdda" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381756" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.officeamp.com/adminbot/tos/](https://www.officeamp.com/adminbot/tos/) |
| アプリのコア機能 | Microsoft Teams 内の堅牢な ITSM システムである内部ヘルプデスク ボットにより、チケットを追跡、割り当て、解決するためのかんばんダッシュボードが提供されます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.officeamp.com](https://www.officeamp.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Anaek Inc から提供されています。
...
| プライバシー ポリシーの URL | https://www.officeamp.com/adminbot/privacy/ |
