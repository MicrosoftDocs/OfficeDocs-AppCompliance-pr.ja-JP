...
| アプリのコア機能 | PlayQuiz はゲーミフィケーション アプリケーションで、Microsoft 365 エコシステムからデジタル ナレッジ ポイント&#8220;得&#8221; 3 つの質問に回答できます。 ユーザーは、会社のランキングを見て、会社の最高の M365 チャンピオンを見ることができます。 ゲーミフィケーションを会社に組み込むと、ユーザーは、ユーザーがさまざまなツールを使用するためのベスト プラクティスMicrosoft 365します。 また、管理者は、特定のトピックに焦点を当てたキャンペーンを作成するために、カスタム質問をシステムに追加できます。 |
| 会社の本社所在地 | スペイン |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザーの名前、電子メール、およびプロファイル画像 | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| User.ReadBasic.All | 委任 | 名前、電子メール、およびプロファイル画像 | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| openid | 委任 | ユーザーの基本的なプロファイルを表示する | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| profile | 委任 | ユーザーの基本プロファイルの読み取り | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
