...
description: ARGUSnylar、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| 会社の Web サイト | [https://www.argusdatainsights.ch/en/](https://www.argusdatainsights.ch/en/) |
| アプリの利用規約 | [https://portal.nylar.org/terms-of-use](https://portal.nylar.org/terms-of-use) |
| アプリのコア機能 | ARGUSnylar は、アカウントの便利な拡張機能です。 |
| 会社の本社所在地 | スイス |
| アプリ情報ページ | [https://portal.nylar.org/help](https://portal.nylar.org/help) |
...
| アプリはコードに資格情報を保存しますか? |  |
| Microsoft 365 用のアプリとアドインは、Microsoft Graph 以外の追加の Microsoft API を使用する場合があります。 アプリまたはアドインで追加の Microsoft API を使用していますか? | 不要 |

#### <a name="data-access-using-microsoft-graph"></a>Microsoft Graph を使用したデータ アクセス

>|   **グラフのアクセス許可**  | **アクセス許可の種類** |          **妥当性**          | **Azure AD アプリ ID** |
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | アプリケーション | / | [5c1f85d2-d744-4159-8c01-16e9a7b1207b](../azure/5c1f85d2-d744-4159-8c01-16e9a7b1207b.md) |
