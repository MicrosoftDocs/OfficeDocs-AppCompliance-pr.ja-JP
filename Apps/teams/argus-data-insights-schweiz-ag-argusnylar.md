---
title: ARGUS DATA INSIGHTS Schweiz AG による、ARGUSnylar のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/26/2021
...
description: 、そのデータ処理ポリシー、そのMicrosoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f14455f8-5bbe-4da9-8df3-9c5533057569" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003186" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ARGUS DATA INSIGHTS Schweiz AG から Microsoft に提供される情報:
...
| アプリの使用条件 | [https://portal.nylar.org/terms-of-use](https://portal.nylar.org/terms-of-use) |
| アプリのコア機能 | ARGUSnylar は、アカウントに役立つ拡張機能です。 |
| 会社の本社の場所 | スイス |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、ARGUS DATA INSIGHTS Schweiz AG から提供されています。
