---
title: Dontknow Internet S.L による delibera のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: delibera、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "66656523"
---
# <a name="delibera"></a>delibera

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/0c914e60-f699-11ea-b068-b9aff13273d5" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003380" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Dontknow Internet S.L から提供される情報。 Microsoft に対して:
...
| パートナー会社名 | Dontknow Internet S.L. |
| 会社の Web サイト | [https://www.delibera.com](https://www.delibera.com) |
| アプリの使用条件 | [https://www.delibera.com/terms](https://www.delibera.com/terms) |
| アプリのコア機能 | Delibera は、組織の主要な会話の質を向上させ、リーダーがより良い理解、決定、実行を支援します |
| 会社の本社の場所 | スペイン |
| アプリ情報ページ | [https://www.delibera.com](https://www.delibera.com) |
...
この情報は、Dontknow Internet S.L によって提供されています。 このアプリが組織のデータを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
...
| プライバシー ポリシーの URL | https://www.delibera.com/privacy |
