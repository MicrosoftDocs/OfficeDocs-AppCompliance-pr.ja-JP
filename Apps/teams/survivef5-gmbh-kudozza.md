...
description: Kudozza で使用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/61a58a9f-3474-4d14-bda6-6547194a7381" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002599" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://kudozza.com/terms](https://kudozza.com/terms) |
| アプリのコア機能 | Kudozza を使用すると、他のチーム メンバーに Kudos に感謝の意を示すことができます。 絵文字の参加、カテゴリ、ランキングなどのさまざまなツールを提供し、Kudos の提供を促します。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | [https://kudozza.com](https://kudozza.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、surviveF5 GmbH によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、メッセージ データ (ボットにアドレス指定) |
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | MSAL ですが、Teamsの最新バージョンにアップグレードする必要があります |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | チームのチャネルを読んで、ユーザーが kudos を公開するチャネルを選択する可能性を与える | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| Teams.ReadBasic.All | 委任 | ユーザーは、チームと、そのユーザーが kudos を公開するチャネルを選択できます。 チームの読み取りアクセス許可は、読み取りチームに必要です。 | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| User.Read | 委任 | ユーザーが参加しているチームを取得する | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
>| User.ReadBasic.All | 委任 | ユーザー名を読み取る | [69e59100-2fb7-4f6e-a311-987f52b3007b](../azure/69e59100-2fb7-4f6e-a311-987f52b3007b.md) |
