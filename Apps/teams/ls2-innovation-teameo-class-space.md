---
title: LS2 Innovation による Teameo クラススペースのアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 01/03/2022
ms.topic: article
...
description: Teameo Class Space、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
---
# <a name="teameo-class-space"></a>Teameo クラス スペース

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者による最終更新日: 2021 年 11 月 30 日</p>

* <a href="https://teams.microsoft.com/l/app/ec7d1cd2-2a06-4f96-baa5-1cc88026a835" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003630" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

LS2 Innovation から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Teameo クラス スペース |
| ID | WA200003630 |
| Office 365サポートされているクライアント | Microsoft Teams |
| パートナー会社名 | LS2 イノベーション |
| 会社の Web サイト | [https://teameo.io](https://teameo.io) |
| アプリの利用規約 | [https://teameo.io/legal/terms-of-service.html](https://teameo.io/legal/terms-of-service.html) |
| アプリのコア機能 | Teameo Class Space を使用すると、教師はコースの詳細、アプリケーション、リンクを表示できます。 |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する LS2 Innovation によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザー情報 (名前、電子メール)、テナント情報 (ID、名前) |
...
| プライバシー ポリシーの URL | https://teameo.io/legal/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.ReadWrite.All | アプリケーション | Gestion de Teams アプリは Espace Num&#233;リケを注ぐ | [05525b77-8ca6-462f-8902-15788cb405c6](https://docs.microsoft.com/microsoft-365-app-certification/azure/05525b77-8ca6-462f-8902-15788cb405c6) |
