---
title: Solutions2Share GmbH による外部ユーザー マネージャーのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: 外部ユーザー マネージャー、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "64463976"
---
# <a name="external-user-manager"></a>外部ユーザー マネージャー

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 24 日</p>

* <a href="https://teams.microsoft.com/l/app/e41aa305-2f95-4a15-a2b7-026338541850" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003014" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.solutions2share.com/en/terms-and-conditions/](https://www.solutions2share.com/en/terms-and-conditions/) |
| アプリのコア機能 | [外部ユーザーの管理] Microsoft Teams |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | [https://www.solutions2share.com/external-user-manager](https://www.solutions2share.com/external-user-manager) |
...
| データベースに格納されているデータは何ですか? | TenantID,User Principal Name,External User E-Mail |
