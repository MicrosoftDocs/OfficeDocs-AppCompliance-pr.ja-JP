---
title: Groopit by Groopit のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: Groopit で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/1bc34af7-7913-481b-b251-5444ecc06a61" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003818" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Groopit から Microsoft に提供される情報:
...
| パートナー会社名 | Groopit |
| 会社の Web サイト | [https://groopit.co](https://groopit.co) |
| アプリの使用条件 | [https://groopit.co/terms-of-service/](https://groopit.co/terms-of-service/) |
| アプリのコア機能 | クラウドソルブ: 従業員からのリアルタイム データを使用して、より適切で迅速な意思決定を行う |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Groopit によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー ID、電子メール アドレス、および名前 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | User Id |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| profile | アプリケーション | SSO 以外のアカウント登録の名前と電子メールを取得する | [1bc34af7-7913-481b-b251-5444ecc06a61](../azure/1bc34af7-7913-481b-b251-5444ecc06a61.md) |
