---
title: Futureworks AS による Futureworks のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Futureworks で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/80a90c8c-6199-454b-b0ff-bd5fba480275" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003510" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Futureworks AS から Microsoft に提供される情報:
...
| パートナー会社名 | Futureworks AS |
| 会社の Web サイト | [https://app.futureworks.com](https://app.futureworks.com) |
| アプリの利用規約 | [https://www.futureworks.com/terms-of-service](https://www.futureworks.com/terms-of-service) |
| アプリのコア機能 | OKR の目標と主要な結果に基づく目標とパフォーマンスの管理プラットフォーム。 |
| 会社の本社所在地 | ノルウェー |
| アプリ情報ページ | [https://futureworks.no](https://futureworks.no) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Futureworks AS によって提供されています。
