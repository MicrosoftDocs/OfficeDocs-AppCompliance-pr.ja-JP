...
description: Desk365 で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/7656ec6e-c63b-4571-8ab8-95d1c451d1e6" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003323" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.desk365.io](https://www.desk365.io) |
| アプリの使用条件 | [https://www.desk365.io/terms-of-service/](https://www.desk365.io/terms-of-service/) |
| アプリのコア機能 | Desk365 は、Microsoft 365 ワークプレース向けのモダン ヘルプデスクです。 Desk365 Teams アプリを使用すると、サポート チームの他のエージェントと簡単に共同作業できます。 チケットに返信したり、メモを追加したり、状態を確認したり、チケットのプロパティを変更したりできます。すべてMicrosoft Teams残す必要はありません。 Desk365 は、最大 4 つのエージェントで無料です。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.desk365.io/agent-bot/](https://www.desk365.io/agent-bot/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Kani Technologies Inc から提供されています。
