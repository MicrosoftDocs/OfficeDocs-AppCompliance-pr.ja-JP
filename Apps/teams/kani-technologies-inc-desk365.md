...
| アプリの利用規約 | [https://www.desk365.io/terms-of-service/](https://www.desk365.io/terms-of-service/) |
| アプリのコア機能 | Desk365 は、職場の最新のMicrosoft 365です。 Desk365 Teamsを使用すると、サポート チームの他のエージェントと簡単に共同作業できます。 チケットに返信したり、メモを追加したり、ステータスを確認したり、チケットのプロパティを変更Microsoft Teams。 Desk365 は最大 4 つのエージェントで無料です。 |
| 会社の本社所在地 | アメリカ |
