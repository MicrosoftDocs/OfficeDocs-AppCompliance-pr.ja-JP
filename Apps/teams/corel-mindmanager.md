...
description: MindManager で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/cebe4a59-b076-47f3-a7bf-79148daf82f7" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002261" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Corel から Microsoft に提供される情報:
...
| パートナー会社名 | Corel |
| 会社の Web サイト | [https://www.mindmanager.com](https://www.mindmanager.com) |
| アプリの使用条件 | [https://www.mindjet.com/go/mmcloudterms](https://www.mindjet.com/go/mmcloudterms) |
| アプリのコア機能 | マップの共同編集、チーム ダッシュボードの管理、フローチャートの作成、プロジェクトの表示を維持します。 |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Corel から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 委任 | メッセージとして投稿できる MindManager ファイル内で行われた変更に関する情報 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Chat.Send | 委任 | メッセージとして投稿できる MindManager ファイル内で行われた変更に関する情報 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Files.ReadWrite | 委任 | サイトの一覧、フォルダー一覧、ファイル メタデータ、ファイル コンテンツ - ファイル ブラウザーの場合、ユーザーは自分のファイルを参照して MindManager (.mmap) ファイルを開くことができます。 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| Sites.ReadWrite.All | 委任 | サイトの一覧、フォルダー一覧、ファイル メタデータ、ファイル コンテンツ - ファイル ブラウザーの場合、ユーザーは自分のファイルを参照して MindManager (.mmap) ファイルを開くことができます。 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| User.Read | 委任 | プロファイル データ: ユーザーを識別し、プロファイルを表示する | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
>| offline_access | 委任 | これにより、必要に応じて、後でユーザーに代わってファイルを元の場所に保存することができます。 | [51e2b67d-9854-446a-8da1-cdd89ef0b987](../azure/51e2b67d-9854-446a-8da1-cdd89ef0b987.md) |
