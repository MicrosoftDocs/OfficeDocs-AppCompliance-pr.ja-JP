---
title: Adobe Acrobat Sign by Adobe のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Adobe Acrobat Sign で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2021 年 10 月 15 日</p>

* <a href="https://teams.microsoft.com/l/app/0f56a9d1-f502-40f9-a9e8-816d7adbb68b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381233" target="_blank">AppSource で表示する</a>
...
| アプリのコア機能 | ドキュメント署名ワークフローを効率化し、Teamsで Adobe Sign 機能を活用すると、従業員と顧客のすばらしいエクスペリエンスを実現できます。 ドキュメントに署名したり、法的に拘束力のある電子署名や承認を求めて送信したり、Microsoft の優先電子署名ソリューションである Adobe Sign for Teams を使用&#8212;状態をすべて追跡したりできます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.ReadWrite | 委任 | 添付ドキュメント、送信者と受信者の電子メール、および電子メールから Adobe へのメッセージ コンテンツを設定して署名用に送信します。 これは、ユーザーが Adobe Sign でこれらのフィールドを再入力する時間を節約するためです。 契約が署名されると、ユーザーが電子メールを送信するための新しい電子メールが自動的に作成され、トランザクションが完了したことを受信者に通知します。 | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
>| People.Read | 委任 | 署名&quot;の送信エクスペリエンスでメール アドレスを&quot;自動入力するには、最初の文字を入力して、ユーザーがメール全体を入力する必要はありません。 | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
>| User.Read | 委任 | ユーザーのプロファイルを読み取り、Adobe Sign を使用できるように、ユーザーのプロファイル (基本的には、その電子メールと userId) をデータベースに一致させます。 | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
>| offline_access | 委任 | アクセス トークンを更新するには、現在のトークンの有効期限が切れている場合。 たとえば、ユーザーが署名&quot;の送信ウィンドウに&quot;入り、非アクティブな状態にしすぎる場合は、新しいトークンを更新して、ユーザーをアクティブに保つ必要があります。 | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
>| openid | 委任 | 電子メールと UserId。 ユーザーが Adobe Sign アプリを使用するアクセス許可に同意していることを確認するためにサインインする。  | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
