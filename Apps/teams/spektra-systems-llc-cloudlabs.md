...
| アプリの利用規約 | [https://cloudlabs.ai/terms-of-use/](https://cloudlabs.ai/terms-of-use/) |
| アプリのコア機能 | CloudLabs のプラクティス テストを実施して、Microsoft クラウドの基本認定を準備する |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 名前、メール、 - カスタマイズされたエクスペリエンスとサポートを提供するには | [539ffd4e-15ba-4d18-b136-0d73b67d05f0](https://docs.microsoft.com/microsoft-365-app-certification/azure/539ffd4e-15ba-4d18-b136-0d73b67d05f0) |
