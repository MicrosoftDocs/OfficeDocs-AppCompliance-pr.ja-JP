...
description: CloudLabs で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64879174"
---
# <a name="cloudlabs"></a>CloudLabs

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 10 月 14 日</p>

* <a href="https://teams.microsoft.com/l/app/ec483835-4185-4229-a976-32a20138ff9d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003273" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Spektra Systems LLC から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://cloudlabs.ai](https://cloudlabs.ai) |
| アプリの使用条件 | [https://cloudlabs.ai/terms-of-use/](https://cloudlabs.ai/terms-of-use/) |
| アプリのコア機能 | CloudLabs Practice テストを実施して、Microsoft クラウドの基礎認定を準備する |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://cloudlabs.ai/cloudlabs-teams-app](https://cloudlabs.ai/cloudlabs-teams-app) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Spektra Systems LLC から提供されています。
...
| サポートされているポリシーの種類を一覧表示する | Cloud Apps のすべての CA ポリシー |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 名前、電子メール、 - パーソナライズされたエクスペリエンスとサポートを提供できるようにするため | [539ffd4e-15ba-4d18-b136-0d73b67d05f0](../azure/539ffd4e-15ba-4d18-b136-0d73b67d05f0.md) |
