---
title: Startgrid による Startgrid のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/09/2022
...
* <a href="https://teams.microsoft.com/l/app/6624420b-7199-41d2-98ff-90d745e039a7" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003838" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Startgrid が Microsoft に提供する情報:
...
| パートナー会社名 | Startgrid |
| 会社の Web サイト | [https://app.startgrid.com](https://app.startgrid.com) |
| アプリの利用規約 | [https://corp.startgrid.com/terms-of-use](https://corp.startgrid.com/terms-of-use) |
| アプリのコア機能 | テクノロジ ソリューションの検索、共有、評価を行い、課題を迅速に解決します。 |
| 会社の本社所在地 | アメリカ |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する情報を Startgrid によって提供されています。
