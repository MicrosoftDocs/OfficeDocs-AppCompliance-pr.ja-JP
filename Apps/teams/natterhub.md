---
title: Natterhub による Natterhub のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/26/2022
...
ms.locfileid: "63544305"
---
# <a name="natterhub"></a>Natterhub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 1 月 26 日</p>

* <a href="https://teams.microsoft.com/l/app/ba5cb8a1-85ca-426c-99fe-9b73cca34128" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003420" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Natterhub から Microsoft に提供される情報:
...
| パートナー会社名 | Natterhub |
| 会社の Web サイト | [https://natterhub.com](https://natterhub.com) |
| アプリの利用規約 | [https://natterhub.com/legal](https://natterhub.com/legal) |
| アプリのコア機能 | Natterhub は、オンラインの安全性とメディア リテラシーのハブです。 5~11 歳の学生に安全で精通したオンラインを教える目的で設計された Natterhub は、インパクトのあるインタラクティブなレッスンやアクティビティを備えた、ゲート付き、没入型のソーシャルメディアスタイルのプラットフォームを使用しています。 |
| 会社の本社所在地 | 英国英国と北アイルランド (the) |
| アプリ情報ページ | [https://natterhub.com](https://natterhub.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Natterhub によって提供されています。
...
| データベースに格納されているデータは何ですか? | テナント ID、ユーザー名、ユーザー名、ユーザーメール |
...
| プライバシー ポリシーの URL | https://natterhub.com/legal#privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| EduAssignments.ReadWrite | 委任 | 割り当ての申請を作成するために必要 | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
>| User.Read | 委任 | ユーザーの名と名を読み取る場合に必要 | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
>| メール | 委任 | ユーザーがトランザクション電子メールを受信できるよう、このアクセス許可が必要です | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
>| offline_access | 委任 | 割り当ての申請を送信するために必要 | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
>| openid | 委任 | ユーザーを識別するために必須 | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
>| profile | 委任 | ユーザーの名と名を読み取る場合に必要 | [54cd93cb-c60e-43b7-bbee-686a2b241794](../azure/54cd93cb-c60e-43b7-bbee-686a2b241794.md) |
