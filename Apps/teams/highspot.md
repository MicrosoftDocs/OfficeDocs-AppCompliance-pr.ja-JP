---
title: Highspot by Highspot のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Highspot で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/55b7c78e-4768-47e0-97be-e6b953e6a0d0" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002894" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Highspot |
| 会社の Web サイト | [https://www.highspot.com](https://www.highspot.com) |
| アプリの使用条件 | [https://www.highspot.com/terms/](https://www.highspot.com/terms/) |
| アプリのコア機能 | Highspot は、担当者が好む販売有効化プラットフォームです。 私たちは、企業が戦略的な成長を促進する顧客の会話を高める権限を与えます。 直感的なプラットフォームは、インテリジェントなコンテンツ管理、トレーニング、コンテキスト ガイダンス、顧客エンゲージメント、実用的な分析を組み合わせたものです。 市場投入チームは Highspot を使用して、収益、顧客満足度、リテンション期間を向上させる統合された購入エクスペリエンスを提供します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.highspot.com/overview/](https://www.highspot.com/overview/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Highspot から提供されています。
