...
description: Highspot で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.highspot.com/terms/](https://www.highspot.com/terms/) |
| アプリのコア機能 | Highspot は営業担当者が愛する販売有効化プラットフォームです。 企業は戦略的な成長を促進する顧客の会話を高める力を与えています。 直感的なプラットフォームは、インテリジェントなコンテンツ管理、トレーニング、コンテキスト ガイダンス、顧客エンゲージメント、アクション可能な分析を組み合わせたプラットフォームです。 市場に参入するチームは Highspot を使用して、収益、顧客満足度、保持率を向上する統合購入エクスペリエンスを提供します。 |
| 会社の本社所在地 | アメリカ |
