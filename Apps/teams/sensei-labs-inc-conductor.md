...
* <a href="https://teams.microsoft.com/l/app/c5418a24-940a-4bf1-a802-8d9e633838fa" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001951" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Sensei Labs Inc. から Microsoft に提供される情報:
...
| パートナー Web サイトの URL | [https://www.senseilabs.com/conductor/?utm_campaign=msftteam...](https://www.senseilabs.com/conductor/?utm_campaign=msftteamslaunch&amp;utm_source=teamsappsource&amp;utm_medium=createdby&amp;utm_content=conductorlink) |
| [アプリケーション情報Teamsページの URL | [該当なし](N/A) |
| プライバシー ポリシーの URL | [https://www.senseilabs.com/conductor/conductor-privacy-poli...](https://www.senseilabs.com/conductor/conductor-privacy-policy/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Sensei Labs Inc. から提供されています。
...
>|:-------------------|:-------------------|:--------------------------|:--------------------------|:---------------------------------------------------|:--------------------------|
>| ボット フレームワーク | はい | Teams ID | 組織にTeamsアプリケーションのインスタンスにマップする場合  | Teams ID | 組織にTeamsアプリケーションのインスタンスにマップする場合  |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| を使用して、ボットの会話中にユーザーに適切に対処します。 アプリケーション内のユーザーをTeamsユーザーにマップするには | Teams識別子、名前、電子メール アドレス | プラットフォームでユーザー Teamsユーザーにマップする |
...
>Teamsメンバーシップを設定します。 顧客のインスタンスとコンTeamsとの関連付け。 データは、コンダクターの顧客である限り保持されます。 顧客のコンダクター インスタンスが使用停止または要求に応じて削除される
...
この情報は、このアプリが認証、承認、アプリケーション登録のベスト プラクティス、その他の Identity の条件を処理する方法について、Sensei Labs Inc. から提供されています。
