---
title: Foxit Software Incorporated による Foxit PDF エディターのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: Foxit PDF エディターで使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66249783"
---
# <a name="foxit-pdf-editor"></a>Foxit PDF エディター

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 8 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/959a79dd-69d0-4d05-b9a8-b9f02e28c049" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003703" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Foxit Software Incorporated から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | Foxit PDF エディター |
| ID | WA200003703 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | Foxit Software 組み込み |
| 会社の Web サイト | [https://www.foxit.com](https://www.foxit.com) |
| アプリの使用条件 | [https://www.foxit.com/product/terms-of-service.html](https://www.foxit.com/product/terms-of-service.html) |
| アプリのコア機能 | Microsoft Teams 用 Foxit PDF エディターを使用すると、Microsoft Teams を離れることなく、ドキュメントを使用してさらに多くのことを行うことができます。1.Secure collaboration-Share PDF と、チャネル内のすべてのユーザーと共同作業を行い、Microsoft SharePoint または 1 ドライブ&#65307; 2.高品質の視聴 PDF を安全かつ簡単に表示できます。Microsoft Teams&#65307; 3.テキスト マークアップを使用してドキュメントにPDF-Provideフィードバックを注釈を付け、PDF ツールに注釈を付けます。 |
| 会社の本社の場所 | 中国 |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Foxit Software Incorporat によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 電子メールとユーザー名 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | 電子メール、ユーザー名、ユーザー ID |
