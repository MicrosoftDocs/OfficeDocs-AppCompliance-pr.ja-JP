---
title: キタメラキ限定によるチケット発行のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/06/2022
...
description: チケット、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "64879694"
---
# <a name="ticketing"></a>チケット業務

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 4 月 5 日</p>

* <a href="https://teams.microsoft.com/l/app/aa6b770e-6b8c-4096-9648-5239295ecadc" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003945" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

キタメラキが提供する情報は、Microsoft に限定されています。
...
| パートナー会社名 | kitameraki limited |
| 会社の Web サイト | [https://TeamsWork.app](https://TeamsWork.app) |
| アプリの使用条件 | [https://TeamsWork.app/terms](https://TeamsWork.app/terms) |
| アプリのコア機能 | 直感的なシンプルな &amp; UI、モバイル アプリ対応、シングル サインオン、セキュリティ &amp; コンプライアンス、高可用性、分析の準備 |
| 会社の本社の場所 | 香港特別行政区 |
| アプリ情報ページ | [https://www.teamswork.app/ticketingapp](https://www.teamswork.app/ticketingapp) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する制限付きで、キタメラキによって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | SaaS サブスクリプション データ、Teams会話参照データ、チケット データ |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | SaaS サブスクリプション データ、Teams会話参照データ、チケット データ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 委任 | ユーザーにアプリがインストールされているかどうかを確認するには | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| Group.Read.All | 委任 | チームのメンバーと所有者の一覧を取得するには、アプリケーションのユース ケースにとって重要です | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| TeamsAppInstallation.ReadWriteForUser | 委任 | ycan が通知ボットに接続されるようにアプリをユーザーにインストールするには | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| User.Read.All | 委任 | ユーザーの完全なプロファイルを取得するには | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| offline_access | 委任 | オフラインの状況でデータにアクセスするには | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| openid | 委任 | 自分でユーザーにログインするには | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
>| profile | 委任 | ユーザーの基本プロファイルを取得するには | [aa6b770e-6b8c-4096-9648-5239295ecadc](../azure/aa6b770e-6b8c-4096-9648-5239295ecadc.md) |
