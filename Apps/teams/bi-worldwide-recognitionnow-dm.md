---
title: BI WORLDWIDE による RecognitionNow DM のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: RecognitionNow DM、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/af14ac7f-7a33-4d98-9c90-1e31285a5aa9" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003647" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

BI WORLDWIDE から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | RecognitionNow DM |
| ID | WA200003647 |
| Office 365サポートされているクライアント | Microsoft Teams |
| パートナー会社名 | BI WORLDWIDE |
| 会社の Web サイト | [https://www.biworldwide.com](https://www.biworldwide.com) |
| アプリの利用規約 | [https://recognition-now.biw.cloud/terms-and-conditions-dm](https://recognition-now.biw.cloud/terms-and-conditions-dm) |
| アプリのコア機能 | 同じ認識プログラム内のTeams参加者に直接認識を送信できます。 このアドインは、組織の認識プログラムのコンパニオンです。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する BI WORLDWIDE によって提供されています。
...
| プライバシー ポリシーの URL | https://teams.recognitionnow.com/assets/images/privacy-policy.pdf |
| アプリは、法的な影響や同様の影響を与える可能性があるプロファイリングを含む、自動化された意思決定を実行しますか? | はい |
| 個人は処理に対してオブジェクトを指定するオプションを提供されていますか? | 不要 |
