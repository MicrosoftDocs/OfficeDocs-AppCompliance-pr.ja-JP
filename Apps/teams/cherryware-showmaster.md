...
ms.locfileid: "66892040"
---
# <a name="showmaster"></a>Showmaster

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 7 月 5 日</p>

* <a href="https://teams.microsoft.com/l/app/8c9f8e8e-fe2d-4542-84ab-1d30c4a735fc" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004411" target="_blank">AppSource で表示する</a>
...
| アプリのコア機能 | ショーマスターは、待ち時間の間に話の周りに刺激的なフレームを作成し、見出し、カウントダウン、音楽などを使って休憩します。 |
| 会社の本社の場所 | ドイツ |
