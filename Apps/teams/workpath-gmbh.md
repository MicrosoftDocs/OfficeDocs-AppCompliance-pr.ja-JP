---
title: Workpath GmbH による Workpath のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/07/2022
...
description: Workpath で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/8562f79a-0ba8-4555-a967-6e34bdfecca9" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003898" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Workpath GmbH から Microsoft に提供される情報:
...
| パートナー会社名 | Workpath GmbH |
| 会社の Web サイト | [https://www.workpath.com/en/home](https://www.workpath.com/en/home) |
| アプリの使用条件 | [https://www.workpath.com/en/workpath-ms](https://www.workpath.com/en/workpath-ms) |
| アプリのコア機能 | Workpath OKR を使用して、戦略的な目標を達成し続けます。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | [https://workpath.zendesk.com/hc/en-us/articles/455508104360...](https://workpath.zendesk.com/hc/en-us/articles/4555081043602-Using-the-MS-Teams-integration) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Workpath GmbH によって提供されています。
...
| プライバシー ポリシーの URL | https://www.workpath.com/en/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ログインしているユーザーのテナントを読み取るには | [dc8facfc-c606-44b4-a0ad-04f81446845c](../azure/dc8facfc-c606-44b4-a0ad-04f81446845c.md) |
