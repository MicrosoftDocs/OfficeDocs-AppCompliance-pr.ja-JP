---
title: NLSQL による DoctorOnline のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/12/2022
...
description: DoctorOnline で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f9555238-64f3-4ec2-a8fc-3787baa157aa" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004082" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://doctoronline.bsmu.edu.ua/terms](https://doctoronline.bsmu.edu.ua/terms) |
| アプリのコア機能 | 無料の医療オンライン サポートを予約します。 さらに、500 人以上が異なるカテゴリのウクライナ人医師を承認しました。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://doctoronline.bsmu.edu.ua](https://doctoronline.bsmu.edu.ua) |
