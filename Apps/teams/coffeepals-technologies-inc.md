---
title: CoffeePals Technologies Inc. による CoffeePals のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: CoffeePals で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
CoffeePals Technologies Inc. から Microsoft に提供される情報:
...
| パートナー会社名 | CoffeePals Technologies Inc. |
| 会社の Web サイト | [https://coffeepals.co](https://coffeepals.co) |
| アプリの利用規約 | [https://coffeepals.co/terms-of-service](https://coffeepals.co/terms-of-service) |
| アプリのコア機能 | CoffeePals は、人をランダムにペアにし、個人のつながりを形成するために、会ってチャットします。 従業員がよりよい接続を可能にするためのその他の機能が含まれます。 |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | [https://coffeepals.co/product](https://coffeepals.co/product) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Paas |
| アプリで使用するホスティング クラウド プロバイダー | Aws、MongoDB、Heroku |
...
この情報は、CoffeePals Technologies Inc. から、このアプリが組織データを収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ、ユーザー使用状況データ、ユーザーの電子メール アドレス、ユーザー一致履歴、ユーザー 設定、組織 設定、組織名、チーム名、組織アバター、マッチ レポート データ、ユーザー プロファイル写真、ユーザー チーム メンバーシップ、ユーザー フィードバック |
...
| プライバシー ポリシーの URL | https://coffeepals.co/privacy |
