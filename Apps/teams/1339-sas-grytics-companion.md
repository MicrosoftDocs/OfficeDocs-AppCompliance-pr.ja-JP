---
title: 1339 SAS による Grytics Companion のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: Grytics Companion で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66547451"
---
# <a name="grytics-companion"></a>Grytics コンパニオン

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/54ab7c02-a92f-4a87-9f59-764e42009fbc" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004217" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

1339 SAS から Microsoft に提供される情報:
...
| パートナー会社名 | 1339 SAS |
| 会社の Web サイト | [https://grytics.com](https://grytics.com) |
| アプリの使用条件 | [https://grytics.com/terms](https://grytics.com/terms) |
| アプリのコア機能 | ユーザーは、Grytics アカウントに追加されたビジネス ソーシャル ネットワークの傾向&amp;アクティビティの分析を比較&amp;できます |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | |
...
この情報は、1339 SAS によって、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 電子メール、名前 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | アプリのユーザーの名前、電子メール。  |
| 基になるインファ構造が Microsoft 顧客データを処理または格納する場合、このデータは地理的にどこに保存されますか? | アイルランド、フランス |
...
| プライバシー ポリシーの URL | https://grytics.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | アプリケーション | Grytics 管理者が Grytics ユーザーが Teams でアプリを使用し、AAD のユーザー ID と一致することを承認できるようにするために必要です | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read | 委任 | SSO 認証フローに必要 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| User.Read.All | アプリケーション | Grytics 管理者が Grytics ユーザーが Teams でアプリを使用し、AAD のユーザー ID と一致することを承認できるようにするために必要です | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| メール | 委任 | SSO 認証フローに必要 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| offline_access | 委任 | SSO 認証フローに必要 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
>| profile | 委任 | SSO 認証フローに必要 | [94efdec0-aa15-42e4-b45a-cd6437be5752](../azure/94efdec0-aa15-42e4-b45a-cd6437be5752.md) |
