...
description: FloQast、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| パートナー会社名 | FloQast |
| 会社の Web サイト | [https://floqast.com](https://floqast.com) |
| アプリの利用規約 | [https://floqast.com/terms-of-use/](https://floqast.com/terms-of-use/) |
| アプリのコア機能 | FloQast は、会計士が月末の終了を実行するのを支援するように設計された、密接な管理ソリューションとワークフローの自動化を提供します。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://floqast.com](https://floqast.com) |
