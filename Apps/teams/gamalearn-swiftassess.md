...
description: SwiftAssess、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://swiftassess.com/terms-and-conditions](https://swiftassess.com/terms-and-conditions) |
| アプリのコア機能 | 組織内のすべてのレベルで評価の変換戦略を作成、配信、追跡する方法を導く、真の試みと機能に至るまで、すべての評価ニーズに対応するワンストップショップです。 SwiftAssess は、さまざまな教育機関の実際の評価プロセスを合理化および自動化する、複数の主要なソリューション、機能、およびワークフローを提供します。 これは、セキュリティ、アクセシビリティ、分析、アイテム バンキングなどについて業界標準をカバーします。 |
