...
description: Empuls で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64881320"
---
# <a name="empuls"></a>Empuls

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 4 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/7ea47aaa-7c43-4fba-82fb-a81223e7cc2c" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002483" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Empuls から Microsoft に提供される情報:
...
| パートナー会社名 | Empuls |
| 会社の Web サイト | [https://www.xoxoday.com](https://www.xoxoday.com) |
| アプリの使用条件 | [https://www.xoxoday.com/terms-of-use](https://www.xoxoday.com/terms-of-use) |
| アプリのコア機能 | この包括的な従業員エンゲージメント ソリューションを使用して、動機、生産性、および整合を向上させます。 |
| 会社の本社の場所 | インド |
| アプリ情報ページ | [https://www.xoxoday.com/empuls](https://www.xoxoday.com/empuls) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Empuls によって提供されています。
