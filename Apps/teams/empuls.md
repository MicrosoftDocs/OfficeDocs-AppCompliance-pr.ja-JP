...
description: Empuls のすべての利用可能なセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.xoxoday.com/terms-of-use](https://www.xoxoday.com/terms-of-use) |
| アプリのコア機能 | この全体的な従業員エンゲージメント ソリューションを使用して、モチベーション、生産性、および調整を改善します。 |
| 会社の本社所在地 | インド |
