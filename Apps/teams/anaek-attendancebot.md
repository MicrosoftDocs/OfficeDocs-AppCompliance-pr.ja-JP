...
| パートナー会社名 | Anaek |
| 会社の Web サイト | [https://www.harmonizehq.com](https://www.harmonizehq.com) |
| アプリの使用条件 | [https://www.attendancebot.com/attendance/tos/](https://www.attendancebot.com/attendance/tos/) |
| アプリのコア機能 | 最新の人事:時間、出席、性、休暇、ハイブリッド作業、 &amp; シフト計画を追跡する |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.attendancebot.com](https://www.attendancebot.com) |
...
| データベースに格納されているデータは何ですか? | アクセス トークン、テナント データ (テナント ID、名前、チームの詳細)、ユーザー データ (名前、電子メール) |
...
| プライバシー ポリシーの URL | https://www.attendancebot.com/attendance/privacy/ |
