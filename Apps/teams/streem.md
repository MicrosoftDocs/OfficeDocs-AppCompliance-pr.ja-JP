...
description: Streem のすべての利用可能なセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.streem.com.au/terms](https://www.streem.com.au/terms) |
| アプリのコア機能 | Streem は、印刷、オンライン、テレビ、ラジオ、およびオーストラリアとニュージーランドのソーシャル メディア ソースからコンテンツを収集および分析することによって、リアルタイムのメディア監視サービスを提供します。 各新しいコンテンツ&amp;は、顧客が気にしているキーワードと一致し、関連するアラートとレポートは、電子メール、モバイル デスクトップ アプリケーション、または Slack および Microsoft Teams との統合を介して送信されます。 |
| 会社の本社所在地 | オーストラリア |
| アプリ情報ページ | |
