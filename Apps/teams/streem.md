---
title: Streem by Streem のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/09/2022
...
description: Streem で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/608c5480-b3aa-4a0f-8f26-b97715313f4a" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000197" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Streem から Microsoft に提供される情報:
...
| パートナー会社名 | Streem |
| 会社の Web サイト | [https://www.streem.com.au](https://www.streem.com.au) |
| アプリの使用条件 | [https://www.streem.com.au/terms](https://www.streem.com.au/terms) |
| アプリのコア機能 | Streem は、オーストラリアとニュージーランドの印刷、オンライン、テレビ、ラジオ、ソーシャル メディアのソースからコンテンツを収集して分析することで、リアルタイムのメディア監視サービスを提供します。 各新しいコンテンツは、顧客が関心を持つキーワードと照合され、関連するアラートやレポートは電子メール、モバイル &amp; デスクトップ アプリケーション、または Slack とMicrosoft Teamsとの統合を介して送信されます。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Streem から提供されています。
