...
| アプリのコア機能 | Streem は、印刷、オンライン、テレビ、ラジオ、およびオーストラリアとニュージーランドのソーシャル メディア ソースからコンテンツを収集および分析することによって、リアルタイムのメディア監視サービスを提供します。 各新しいコンテンツ&amp;は、お客様が気にしているキーワードと一致し、関連するアラートとレポートは、メール、モバイル デスクトップ アプリケーション、または Slack および Microsoft Teams との統合を介して送信されます。 |
| 会社の本社所在地 | オーストラリア |
| アプリ情報ページ | |
