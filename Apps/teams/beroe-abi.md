---
title: Beroe による Abi のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Abi で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/55560ea0-ae82-48b2-b71e-a45356f56bb1" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003862" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Beroe から Microsoft に提供される情報:
...
| パートナー会社名 | Beroe |
| 会社の Web サイト | [https://www.beroeinc.com](https://www.beroeinc.com) |
| アプリの使用条件 | [https://www.beroeinc.com/terms/](https://www.beroeinc.com/terms/) |
| アプリのコア機能 | Abi &#8211; AI を活用したデジタル調達アシスタント |
| 会社の本社の場所 | インド |
| アプリ情報ページ | [https://www.beroeinc.com/beroe-live-ai](https://www.beroeinc.com/beroe-live-ai) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Beroe によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 名、姓 &amp; 仕事用メール ID |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | 名、姓、仕事用メール ID &amp; 会話 ID |
...
| プライバシー ポリシーの URL | https://www.beroeinc.com/privacy-policy/ |
