...
| アプリのコア機能 | Microsoft Teams 向けの Kuban Visitors を使用すると、訪問者を非常に簡単に招待できます。 訪問者を招待し、サインインしてすぐにサインアウトできます。 また、今日の訪問者リストを表示することもできます。  注: このアプリを使用するには、ユーザーがアクティブな Kuban アカウントを持っている必要があります。詳細については、サポート チームにお問い合わせください。  |
| 会社の本社の場所 | 中国 |
| アプリ情報ページ | |
