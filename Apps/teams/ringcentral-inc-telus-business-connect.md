...
description: TELUS Business Connect、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://telus.com/BusinessConnect/ServiceTerms](https://telus.com/BusinessConnect/ServiceTerms) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 |  アプリケーションが予定表を介して会議出席依頼イベントを送信できます | [e601bd6e-0476-4d66-bd57-a9d13c207f0b](../azure/e601bd6e-0476-4d66-bd57-a9d13c207f0b.md) |
>| User.Read | 委任 |  アプリは、連絡先の一致を行&#8217;の基本的なプロファイル (メール、名前) を読み取るアプリを許可します。 ユーザーがサインインし、O365 アカウントを RingCentral アカウントにリンクできます。 | [e601bd6e-0476-4d66-bd57-a9d13c207f0b](../azure/e601bd6e-0476-4d66-bd57-a9d13c207f0b.md) |
>| User.Read.All | 委任 | アプリケーションは、サービスで電話をかかするために、電話番号を使用してユーザーの完全なプロファイルを読み取るを許可します。 | [e601bd6e-0476-4d66-bd57-a9d13c207f0b](../azure/e601bd6e-0476-4d66-bd57-a9d13c207f0b.md) |
>| offline_access | 委任 |  アプリケーションが oauth トークンを取得および更新できます | [e601bd6e-0476-4d66-bd57-a9d13c207f0b](../azure/e601bd6e-0476-4d66-bd57-a9d13c207f0b.md) |
