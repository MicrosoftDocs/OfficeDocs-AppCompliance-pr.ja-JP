---
title: RingCentral, Inc. による TELUS Business Connect のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
description: TELUS Business Connect で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
| 会社の Web サイト | [https://www.telus.com](https://www.telus.com) |
| アプリの使用条件 | [https://www.telus.com/en/bc/business/support/article/busine...](https://www.telus.com/en/bc/business/support/article/business-connect-terms) |
| アプリのコア機能 | クイック ボット コマンドとメッセージング機能を使用して、Telus のビデオ通話または音声通話を開始して参加します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザー プロファイル データを取得するには | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
>| User.Read.All | 委任 | ユーザー プロファイル データを取得するには | [0dd4bfdf-dc86-4f05-9991-a14bc0144ebf](../azure/0dd4bfdf-dc86-4f05-9991-a14bc0144ebf.md) |
