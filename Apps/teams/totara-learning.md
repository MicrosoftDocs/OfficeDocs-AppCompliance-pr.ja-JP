...
| アプリのコア機能 | Totara app for Microsoft Teamsは、Totara Cloud の購読者が学習にアクセスし、ユーザー内の他のユーザーと共同作業Microsoft Teams。 このアプリを使用すると、ユーザーは割り当てられた学習、学習コンテンツの探索、プレイリストやリソースの作成、操作、共有を行Microsoft Teams。 |
| 会社の本社所在地 | ニュージーランド |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | メール アドレスを使用して Teams ユーザーをローカル システム ユーザーに接続するには | [5022e09d-d2f9-499f-8925-554c324ad23a](https://docs.microsoft.com/microsoft-365-app-certification/azure/5022e09d-d2f9-499f-8925-554c324ad23a) |
