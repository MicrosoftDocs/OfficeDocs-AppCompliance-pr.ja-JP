...
| アプリの利用規約 | [https://www.totaralearning.com/en/solutions/totara-cloud/te...](https://www.totaralearning.com/en/solutions/totara-cloud/terms-of-service) |
| アプリのコア機能 | Totara app for Microsoft Teamsは、Totara Cloud の購読者が学習にアクセスし、ユーザー内の他のユーザーと共同作業を行Microsoft Teams。 このアプリを使用すると、ユーザーは割り当てられた学習、学習コンテンツの探索、プレイリストやリソースの作成、操作、共有を行Microsoft Teams。 |
| 会社の本社所在地 | ニュージーランド |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | メール アドレスを使用して Teams ユーザーをローカル システム ユーザーに接続するには | [5022e09d-d2f9-499f-8925-554c324ad23a](../azure/5022e09d-d2f9-499f-8925-554c324ad23a.md) |
