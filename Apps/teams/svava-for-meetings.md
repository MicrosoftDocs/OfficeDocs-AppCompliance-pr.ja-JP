---
title: Svava による会議用 Svava のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Svava for Meetings、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/6291175d-3832-4c33-baea-10eb4b9ff1c4" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001723" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Svava が Microsoft に提供する情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Svava for Meetings |
| ID | WA200001723 |
| Office 365サポートされているクライアント | Microsoft Teams |
| パートナー会社名 | Svava |
| 会社の Web サイト | [https://svava.io](https://svava.io) |
| アプリの利用規約 | [https://svava.io/legal/terms-of-service/](https://svava.io/legal/terms-of-service/) |
| アプリのコア機能 | 会議をより魅力的で効果的に行います。 |
| 会社の本社所在地 | スウェーデン |
| アプリ情報ページ | [https://svava.io](https://svava.io) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて Svava によって提供されています。
...
| プライバシー ポリシーの URL | https://svava.io/legal/privacy-policy |
