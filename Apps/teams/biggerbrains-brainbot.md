...
description: BrainBot で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://brainbot.ai/terms/](https://brainbot.ai/terms/) |
| アプリのコア機能 | BrainBot は、トレーニング コースの知識を保持するために、短い定期的なやり取りを送信します。 |
| 会社の本社所在地 | アメリカ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | アプリケーション | 認証プロセスの一環として &amp; 、電子メール アドレスのフルネームを使用します。 また、電子メール アドレスは、ユーザーが 1 つを購読するときに、ユーザーに学習シーケンスを送信するために使用されます。 | [b256b34a-b377-4fc2-b25a-a8f5f0594e86](../azure/b256b34a-b377-4fc2-b25a-a8f5f0594e86.md) |
