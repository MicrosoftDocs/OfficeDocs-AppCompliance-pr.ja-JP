...
description: BrainBot で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/3c95872f-ca12-456e-84b9-c717fe93330c" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381981" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://brainbot.ai/terms/](https://brainbot.ai/terms/) |
| アプリのコア機能 | BrainBot は、トレーニング コースからの知識を保持するために、短い定期的な対話を送信します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://brainbot.ai](https://brainbot.ai) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | アプリケーション | 認証プロセスの一環として、 &amp; 電子メール アドレスの完全な名前を使用します。 また、電子メール アドレスは、ユーザーが 1 つにサブスクライブしたときに学習シーケンスを送信するために使用されます。 | [b256b34a-b377-4fc2-b25a-a8f5f0594e86](../azure/b256b34a-b377-4fc2-b25a-a8f5f0594e86.md) |
