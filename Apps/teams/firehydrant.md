...
description: FireHydrant で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/c18f3920-4098-4907-bc92-43c8559b5e18" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003794" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://app.firehydrant.io/legal/ssa](https://app.firehydrant.io/legal/ssa) |
| アプリのコア機能 | インシデントを管理するには、FireHydrant.io。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する FireHydrant によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.Create | 委任 | FireHydrant は、インシデントを管理するためにユーザーに代わってチャネルを作成します | [00485db5-81b3-4299-833a-8d6c366d0ac0](../azure/00485db5-81b3-4299-833a-8d6c366d0ac0.md) |
