---
title: 有形 IT メキシコによる ACV のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: ACV で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/0a3b1cc0-1cda-4373-90b9-7740e604c5e3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004237" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

有形 IT メキシコから Microsoft に提供される情報:
...
| パートナー会社名 | 有形 IT メキシコ |
| 会社の Web サイト | [https://www.tangibleit.com](https://www.tangibleit.com) |
| アプリの使用条件 | [https://www.acv.app/terms](https://www.acv.app/terms) |
| アプリのコア機能 | 出席管理を管理し、ダッシュボードを通じてエグゼクティブの可視性を提供し、ホワイトボードを使用して教育エクスペリエンスを容易にします。 学校を反映するソリューション内のすべて。 |
| 会社の本社の場所 | メキシコ |
| アプリ情報ページ | [https://www.acv.app](https://www.acv.app) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、有形 IT メキシコから提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、認証用のユーザー 電子メール データ。 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー名、ユーザー電子メール、ユーザー ロール、学校の電話、学校の住所、学校名、件名、クラス、レッスン。 |
...
| プライバシー ポリシーの URL | https://www.acv.app/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 両方 | ホワイトボード コラボレーション (機能) リンクをチャネルに投稿する。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| Group.ReadWrite.All | 両方 | ホワイトボード コラボレーション (機能) リンクをチャネルに投稿する。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| User.Read | 両方 | 認証プロセスが実行され、グループに属する学生のプロファイルでデータが取得されます。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| メール | 両方 | 認証プロセスが実行され、グループに属する学生のプロファイルでデータが取得されます。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| openid | 両方 | 認証プロセスが実行され、グループに属する学生のプロファイルでデータが取得されます。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
>| profile | 両方 | 認証プロセスが実行され、グループに属する学生のプロファイルでデータが取得されます。 | [317696dd-0e3b-4117-9694-ca65942c02f3](../azure/317696dd-0e3b-4117-9694-ca65942c02f3.md) |
