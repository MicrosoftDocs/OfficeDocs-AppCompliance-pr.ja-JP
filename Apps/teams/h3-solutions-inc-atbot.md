---
title: AtBot by H3 Solutions, Inc. のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: AtBot で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/7c01af81-ae7d-416e-98a3-c139cae8cfb0" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381219" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://atbot.io](https://atbot.io) |
| アプリの使用条件 | [https://admin.atbot.io/terms](https://admin.atbot.io/terms) |
| アプリのコア機能 | 会話型 UI を迅速に構築し、コーディングエクスペリエンスは必要ありません。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://admin.atbot.io/Docs/GettingStarted](https://admin.atbot.io/Docs/GettingStarted) |
...
この情報は、H3 Solutions, Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | アプリケーション | AAD グループ名、AAD グループ GUID、UPN | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| Directory.Read.All | 委任 | AAD グループ名、AAD グループ GUID、UPN | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| People.Read | 委任 | いいえ | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| User.Read | 委任 | テナント ID、UPN | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| メール | 委任 | メール アドレスは、サポート システムを通じてサポートに問い合わせるために使用されます。 | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| offline_access | 委任 | アクセス/更新トークン。 | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| openid | 委任 | UPN:システム内のユーザーを識別します | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
>| profile | 委任 | UPN | [066a6b3a-f7a0-450a-98c7-34db1da31594](../azure/066a6b3a-f7a0-450a-98c7-34db1da31594.md) |
