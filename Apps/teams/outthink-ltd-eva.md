---
title: OutThink Ltd による Eva のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Eva で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/eddbe35e-8260-4878-99d2-946c4aac73f4" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004345" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

OutThink Ltd から Microsoft に提供される情報:
...
| パートナー会社名 | OutThink Ltd |
| 会社の Web サイト | [https://www.outthink.io](https://www.outthink.io) |
| アプリの使用条件 | [https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-...](https://outthink.io/wp-content/uploads/OutThink-SaaS-Terms-and-Conditions.pdf) |
| アプリのコア機能 | Eva は、組織内のサイバーセキュリティの人間のリスクを管理しようとしている OutThink クライアントに仮想サポートを提供する AI アシスタントです。  トレーニングの進行状況に関する定期的な更新を従業員に提供し、パフォーマンスに関する効果的なフィードバックを提供し、サイバーセキュリティの知識を向上させます。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://docs.outthink.io/integration-with-microsoft-teams/](https://docs.outthink.io/integration-with-microsoft-teams/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて OutThink Ltd から提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー メール データ、ユーザー 予定表の空き時間情報 |
...
| プライバシー ポリシーの URL | https://outthink.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | ユーザーの予定表で次に使用可能な空きスロットを検索し、Teams アプリを使用してサイバーセキュリティ トレーニング用のスロットを予約できるようにします。 | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
>| User.Read | 委任 | 特定の会社のメール アドレスを持つユーザーにメッセージを送信するために、電子メール アドレスでユーザーを識別します。 | [07c3de2f-6e55-4fae-8c97-90964ff2b934](../azure/07c3de2f-6e55-4fae-8c97-90964ff2b934.md) |
