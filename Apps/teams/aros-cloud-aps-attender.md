---
title: Aros Cloud ApS によるアテインダーのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
ms.locfileid: "63553495"
---
# <a name="attender"></a>アトラー

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 18 日</p>

* <a href="https://teams.microsoft.com/l/app/30b8d518-2535-4919-ab8b-d0fab193380f" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003856" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Aros Cloud ApS から Microsoft に提供される情報:
...
| パートナー会社名 | Aros Cloud ApS |
| 会社の Web サイト | [https://www.attender.uk](https://www.attender.uk) |
| アプリの利用規約 | [https://www.attender.uk/wp-content/uploads/2022/02/Terms-of...](https://www.attender.uk/wp-content/uploads/2022/02/Terms-of-use.pdf) |
| アプリのコア機能 | 学生の中学生を削減し、教育時間を節約する学校の迅速な出席登録。 |
| 会社の本社所在地 | デンマーク |
| アプリ情報ページ | [https://www.attender.uk](https://www.attender.uk) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Aros Cloud ApS によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザー UPN 名, ユーザー 表示名, 学生出席データ, 学生プロファイル画像, 教師と学生の時刻表データ |
| 基になるインファ構造が Microsoft 顧客データを処理または保存する場合、このデータは地理的にどこに保存されますか? | デンマーク |
...
| プライバシー ポリシーの URL | https://www.attender.uk/wp-content/uploads/2022/02/Privacy-Statement.pdf |
...
| サポートされているポリシーの種類を一覧表示する | すべてのサポートは、Azure AD |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 委任 | ユーザー の役割を決定する | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| GroupMember.Read.All | 委任 | ユーザー の役割を決定する | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| User.Read | 委任 | サインイン | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| メール | 委任 | ユーザーのログイン名を取得します。 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| openid | 委任 | シングル サインオン | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
>| profile | 委任 | ユーザー情報 | [3741153e-2490-463c-aff7-5283fb1bd1b4](../azure/3741153e-2490-463c-aff7-5283fb1bd1b4.md) |
