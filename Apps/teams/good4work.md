...
| アプリの利用規約 | [https://good4work.com/good4work-terms/](https://good4work.com/good4work-terms/) |
| アプリのコア機能 | Good4work は、チームワークを向上させるために、分散チーム用のチーム エンゲージメント ツールです。 同時に、チームとユーザーに関する分析情報も提供します。 この機能は、現在の場所から動作します(Microsoft Teams)。 チーム メンバーは、チーム メンバーに&#8217;を送信することで、強みとプラスの影響を認識できます。 Good4work は、信頼と共感の文化を広め、やる気のある仮想環境を促進します。 |
| 会社の本社所在地 | アメリカ |
