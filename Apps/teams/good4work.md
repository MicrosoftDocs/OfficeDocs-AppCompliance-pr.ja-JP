---
title: Good4work by Good4work のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Good4work で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/d1493af7-8634-4b6a-8cbe-eeb23c6724f4" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002962" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Good4work |
| 会社の Web サイト | [https://good4work.com/#product](https://good4work.com/#product) |
| アプリの使用条件 | [https://good4work.com/good4work-terms/](https://good4work.com/good4work-terms/) |
| アプリのコア機能 | Good4work は、分散チームがチームワークを向上させるためのチームエンゲージメント ツールです。 同時に、チームとユーザーに関する分析情報も提供します。 Microsoft Teamsを含め、元の場所から機能します。 チーム メンバーは、自分のチーム メンバー&#8217;長所とポジティブな影響を認識できます。 Good4work は、信頼と共感の文化を広めることで、やる気のある仮想環境を促進することを目的としています。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://good4work.com/support/](https://good4work.com/support/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Good4work によって提供されています。
