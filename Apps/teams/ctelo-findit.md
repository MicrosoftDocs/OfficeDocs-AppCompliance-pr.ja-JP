---
title: CTELO による Findit のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/14/2022
...
description: Findit で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64881369"
---
# <a name="findit"></a>Findit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 1 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/ccb8d21c-9c7b-492f-b372-438621384db8" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003849" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

CTELO から Microsoft に提供される情報:
...
| パートナー会社名 | CTELO |
| 会社の Web サイト | [https://www.ctelo.com](https://www.ctelo.com) |
| アプリの使用条件 | [https://www.ctelo.com/terms-conditions](https://www.ctelo.com/terms-conditions) |
| アプリのコア機能 | 同僚の無料の予定表スロット、Teams状態、連絡先情報を検索します。 |
| 会社の本社の場所 | ノルウェー |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つ制御について CTELO から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 予定表のエントリと連絡先情報。 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委任 | アプリがユーザー カレンダーでイベントを読み取ることを許可します。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Contacts.Read | 委任 | アプリでユーザーの連絡先の読み取りを許可します。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Group.Read.All | 委任 | アプリでユーザー グループの読み取りを許可します。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Presence.Read.All | 委任 | アプリがすべてのユーザーのプレゼンス情報を読み取ることができるようにします。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| User.Read | 委任 | アプリにユーザー プロファイルの読み取りを許可します。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| User.Read.All | 委任 | アプリですべてのユーザー プロファイルの読み取りを許可します。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
