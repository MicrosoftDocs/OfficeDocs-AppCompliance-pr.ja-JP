...
description: Findit、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63553485"
---
# <a name="findit"></a>Findit

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者による最終更新日: 2022 年 1 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/ccb8d21c-9c7b-492f-b372-438621384db8" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003849" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

CTELO が Microsoft に提供する情報:
...
| アプリの利用規約 | [https://www.ctelo.com/terms-conditions](https://www.ctelo.com/terms-conditions) |
| アプリのコア機能 | 同僚の無料の予定表スロット、Teams連絡先情報を検索します。 |
| 会社の本社所在地 | ノルウェー |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する CTELO によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委任 | アプリがユーザーカレンダーのイベントを読み取るのを許可します。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Contacts.Read | 委任 | アプリでユーザー連絡先の読み取りを許可します。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Group.Read.All | 委任 | アプリにユーザー グループの読み取りを許可します。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
>| Presence.Read.All | 委任 | アプリがすべてのユーザーのプレゼンス情報を読み取るのを許可します。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
...
>| User.Read.All | 委任 | アプリがすべてのユーザー プロファイルを読み取るのを許可します。 | [2e57054c-4326-46ed-8482-40d9a6d20e79](../azure/2e57054c-4326-46ed-8482-40d9a6d20e79.md) |
