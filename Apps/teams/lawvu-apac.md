---
title: LawVu による LawVu APAC のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: LawVu APAC、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63545975"
---
# <a name="lawvu-apac"></a>LawVu APAC

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 9 日</p>

* <a href="https://teams.microsoft.com/l/app/fbd624a5-8d34-495d-a68c-a1101997a8a2" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003796" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

LawVu から Microsoft に提供される情報:
...
| パートナー会社名 | LawVu |
| 会社の Web サイト | [https://lawvu.com](https://lawvu.com) |
| アプリの利用規約 | [https://lawvu.com/wp-content/uploads/Std-Saas-Agreement-202...](https://lawvu.com/wp-content/uploads/Std-Saas-Agreement-2021.pdf) |
| アプリのコア機能 | ビジネス ユーザーは、ビジネス ユーザーから法的要求をTeams。  統合により、元のメッセージのコンテンツや添付ファイルを含むすべての関連フィールドがキャプチャされ、LawVu に問題が作成され、法務チーム&#8217;&#8217;のレコード システムの一部として処理されます。 |
| 会社の本社所在地 | ニュージーランド |
| アプリ情報ページ | [https://help.lawvu.com/en/articles/5953276-microsoft-teams-...](https://help.lawvu.com/en/articles/5953276-microsoft-teams-integration-coming-soon) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する LawVu によって提供されています。
...
| データベースに格納されているデータは何ですか? | MS チームの添付ファイルは、データ ストアに取得されます。 |
| 基になるインファ構造が Microsoft 顧客データを処理または保存する場合、このデータは地理的にどこに保存されますか? | オーストラリア |
...
| プライバシー ポリシーの URL | https://lawvu.com/trust-center/privacy/gdpr |
