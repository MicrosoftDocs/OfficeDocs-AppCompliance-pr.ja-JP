---
title: Expert Systems IVR(Asia) Co.Ltd による ecBooking のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/19/2022
...
description: ecBooking で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/fe9627db-f23e-42b1-b454-d4d1ca5af33e" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002096" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Expert Systems IVR(Asia) Co.Ltd から提供される情報。Microsoft に対して:
...
| 会社の Web サイト | [https://www.esi-asia.com](https://www.esi-asia.com) |
| アプリの使用条件 | [https://www.esi-asia.com/product/intelligent-room-booking-s...](https://www.esi-asia.com/product/intelligent-room-booking-system/#1598241760681-29d114e0-5c2b) |
| アプリのコア機能 | 会議スペースを最適化するインテリジェント システムを使用した効果的な予約エクスペリエンス。 |
| 会社の本社の場所 | 香港特別行政区 |
| アプリ情報ページ | [https://www.esi-asia.com/product/intelligent-room-booking-s...](https://www.esi-asia.com/product/intelligent-room-booking-system/) |
...
この情報は、Expert Systems IVR(Asia) Co.Ltd から提供されています。このアプリが組織のデータを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
...
| 基になるインファ構造が Microsoft 顧客データを処理または格納する場合、このデータは地理的にどこに保存されますか? | 香港特別行政区 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | アプリケーション | 予定表の読み取り書き込み | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| Calendars.ReadWrite | 委任 | 予定表の読み取り書き込み | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| Mail.Send | 委任 | メールを送信する | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| Mail.Send | アプリケーション | メールを送信する | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| User.Read | 委任 | ユーザーの読み取り | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
>| User.Read.All | アプリケーション | ユーザーの読み取り | [00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d](../azure/00ee4a74-9dc3-4bd9-9a6d-f18b640fd69d.md) |
