---
title: Firewall Assistant by DewMaker Design, Inc. のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/27/2022
...
description: ファイアウォール アシスタントで使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "65122676"
---
# <a name="firewall-assistant"></a>ファイアウォール アシスタント

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 4 月 26 日</p>

* <a href="https://teams.microsoft.com/l/app/40b745ad-16a8-4eda-bf1c-5b48b0dc947d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003363" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | ファイアウォール アシスタント |
| ID | WA200003363 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | DewMaker Design, Inc. |
| 会社の Web サイト | [https://dewmaker.com](https://dewmaker.com) |
| アプリの使用条件 | [https://firewallassistant.com/terms](https://firewallassistant.com/terms) |
| アプリのコア機能 | Microsoft Teamsを使用したAzure SQL サーバー ファイアウォール規則のセルフサービス管理。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://firewallassistant.com](https://firewallassistant.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、AltoMaker Design, Inc. から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | 電子メール アドレスと Azure サブスクリプション URL の |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | 電子メール アドレス (MS ログインの場合) と Azure サブスクリプション エンドポイントのデータ |
...
| パッチを適用するためのサービス レベル アグリーメント (SLA) を管理するポリシーはありますか? | なし |
...
| アプリは Cloud Security Alliance (CSA Star) の認定を受けていますか? | なし |
