---
title: DewMaker Design, Inc. によるファイアウォール アシスタントのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/08/2022
...
description: ファイアウォール アシスタント、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/40b745ad-16a8-4eda-bf1c-5b48b0dc947d" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003363" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

DewMaker Design, Inc. から Microsoft に提供される情報:
...
| アプリの利用規約 | [https://teamwell.services/terms.html](https://teamwell.services/terms.html) |
| アプリのコア機能 | サーバーを使用した Azure SQL Serverファイアウォール ルールのセルフサービスMicrosoft Teams。 |
| 会社の本社所在地 | アメリカ |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、DewMaker Design, Inc. から提供されています。
...
| データベースに格納されているデータは何ですか? | メール アドレス (MS ログイン用) と Azure サブスクリプション エンドポイント データ |
