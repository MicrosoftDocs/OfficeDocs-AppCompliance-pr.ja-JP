---
title: Read AI, Inc. によるダッシュボードの読み取りのためのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/15/2022
...
description: ダッシュボードの読み取り、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "64881858"
---
# <a name="read-dashboard"></a>ダッシュボードの読み取り
