...
description: トリビュートで使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/cfb46a87-a75b-4045-9f22-a0ae0614fd60" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002589" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

トリビュート社から Microsoft に提供される情報:
...
| パートナー会社名 | Tribute Co. |
| 会社の Web サイト | [https://www.tributementorship.com](https://www.tributementorship.com) |
| アプリの使用条件 | [https://www.tributementorship.com/terms](https://www.tributementorship.com/terms) |
| アプリのコア機能 | トリビュートは、従業員の成長、コラボレーション、つながりを促進する組織向けの最新のメンタリング アプリです。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.tributementorship.com/how-it-works](https://www.tributementorship.com/how-it-works) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、トリビュート Co.から提供されています。
...
| 最新の SOC2 認定日 | 2020-07-10 |
| アプリはサービス組織コントロール (SOC 3) に準拠していますか? | はい |
| 最新の SOC3 認定日 | 2020-07-10 |
