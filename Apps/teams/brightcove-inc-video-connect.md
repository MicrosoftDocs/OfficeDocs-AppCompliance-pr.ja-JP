...
description: Brightcove Video Connect、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.brightcove.com/en/terms-and-conditions/](https://www.brightcove.com/en/terms-and-conditions/) |
| アプリのコア機能 | Brightcove Video Connectは、ビデオアセットとメディアアセットに関するコラボレーション オプションを直接サポートMicrosoft Teams |
| 会社の本社所在地 | アメリカ |
