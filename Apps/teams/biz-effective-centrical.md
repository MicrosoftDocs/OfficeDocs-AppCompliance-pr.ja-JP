---
title: Biz-Effectiveによる Centrical のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/08/2021
...
description: Centrical で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/7a70b8e4-43ca-46a7-b7c3-eb31b33de397" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001531" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Biz-Effectiveから Microsoft に提供される情報:
...
| 会社の Web サイト | [https://centrical.com](https://centrical.com) |
| アプリの使用条件 | [https://centrical.com/terms](https://centrical.com/terms) |
| アプリのコア機能 | Centrical プラットフォームは、従業員が実行する必要がある作業と、重要な方法に焦点を当て続けます。 測定された作業のデータを使用して、習熟度を構築するマイクロラーニングを促します。 人工知能を利用して、従業員のエンゲージメント、パフォーマンス、マイクロラーニングを向上させます。 Centrical プラットフォームは、Web アプリケーション、モバイル アプリ、Microsoft Teams アプリ、Salesforce、SuccessFactors アプリを介して利用できます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://centrical.com/solutions/solutions-by-use-case-2/mic...](https://centrical.com/solutions/solutions-by-use-case-2/microsoft-teams-gamification/) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関するBiz-Effectiveによって提供されています。
