...
| アプリのコア機能 | セントリック プラットフォームは、従業員が必要な作業に集中し、重要なことに、その方法に集中します。 測定された作業のデータを使用して、熟練度を構築するマイクロリーダーを促します。 人工知能を利用して、従業員のエンゲージメント、パフォーマンス、マイクロリーダーを改善します。 セントリック プラットフォームは、Web アプリケーション、モバイル アプリ、アプリ、Salesforce、SuccessFactors Microsoft Teamsを介して利用できます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
