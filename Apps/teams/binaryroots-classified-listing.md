---
title: BinaryRoots による分類リストのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/01/2022
...
description: 分類リスト、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "65938722"
---
# <a name="classified-listing"></a>分類済みリスト

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/0c824060-9c8c-11ec-a1de-3143e9005d6a" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004155" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

BinaryRoots から Microsoft に提供される情報:
...
| パートナー会社名 | BinaryRoots |
| 会社の Web サイト | [https://binaryroots.com](https://binaryroots.com) |
| アプリの使用条件 | [https://binaryroots.com/classifiedapp-terms-and-conditions](https://binaryroots.com/classifiedapp-terms-and-conditions) |
| アプリのコア機能 | 組織の内部の Buy/Sell Marketplace を作成/ホストするチーム アプリ。..  |
| 会社の本社の場所 | インド |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する BinaryRoots によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | いいえ |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ID - テナント ID、管理者ユーザー ID、サイト URL とサイト ID、リスト/ライブラリ ID のみ |
...
| プライバシー ポリシーの URL | https://binaryroots.com/classified-app-privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | 共有機能を使用しているときにチャネルを表示するには | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| ChannelMessage.Send | 委任 | 共有機能が使用されている場合に、ユーザーに代わってユーザー/チャネルにメッセージを送信するには | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Chat.ReadWrite | 委任 | 共有機能が使用されている場合に、ユーザーに代わってユーザー/チャネルにメッセージを送信するには | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| ChatMessage.Send | 委任 | 共有機能が使用されている場合に、ユーザーに代わってユーザー/チャネルにメッセージを送信するには | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Sites.FullControl.All | 委任 | ターゲット サイト コレクションに必要なリスト ライブラリを作成します。これは、テナント管理者に初めてインストールする場合にのみ必要です | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Sites.Manage.All | 委任 | ターゲット サイト コレクションに必要なリスト ライブラリを作成します。これは、テナント管理者に初めてインストールする場合にのみ必要です | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| Team.ReadBasic.All | 委任 | 共有機能が使用されている場合にチームとチャネルのドロップダウンを設定する。 | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| TeamsActivity.Send | 委任 | 不適切なフラグ機能のためにアクティビティ フィード通知を管理者に送信し、作成者を投稿するには  | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| User.Read | 委任 | ユーザーの基本情報を読み、管理者/投稿者、写真、登録カードに電子メールの名前を表示する | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
>| User.ReadBasic.All | 委任 | ユーザーの基本情報を読み、管理者/投稿者、写真、登録カードに電子メールの名前を表示する | [e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3](../azure/e8a37d29-e4be-4ce1-ae06-bbd1ad1968e3.md) |
