---
title: Pajat Solutions Oy による Poimapper のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Poimapper に関して利用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f2dac71d-b558-496b-be58-b28980e2cfd9" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004353" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Pajat Solutions Oy から提供される情報。 Microsoft に対して:
...
| パートナー会社名 | Pajat Solutions Oy. |
| 会社の Web サイト | [https://poimapper.com](https://poimapper.com) |
| アプリの使用条件 | [https://portal.poimapper.com/termofservice.jsp](https://portal.poimapper.com/termofservice.jsp) |
| アプリのコア機能 | Poimapper は、組織がフィールド データを収集および分析する方法を変更します。 |
| 会社の本社の場所 | フィンランド |
| アプリ情報ページ | |
...
この情報は、Pajat Solutions Oy によって提供されています。 このアプリが組織のデータを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
...
| プライバシー ポリシーの URL | https://portal.poimapper.com/privacy.jsp |
