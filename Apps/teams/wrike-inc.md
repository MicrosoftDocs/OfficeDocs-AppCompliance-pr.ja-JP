...
description: Wrike で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64879151"
---
# <a name="wrike"></a>Wrike

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 10 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/05274a45-7312-4c23-8f64-d57fe4a28d6d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381390" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Wrike Inc. |
| 会社の Web サイト | [https://wrike.com](https://wrike.com) |
| アプリの使用条件 | [https://www.wrike.com/security/terms/](https://www.wrike.com/security/terms/) |
| アプリのコア機能 | すべての Wrike プロジェクトを管理し、タスクで共同作業を行い、Teamsで通知を受け取ります。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://wrike.com](https://wrike.com) |
