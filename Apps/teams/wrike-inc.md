...
| [アプリケーション情報Teamsページの URL | [https://wrike.com](https://wrike.com) |
...
>|:-----------------------------------------------------|:------------------------------|:----------------------------------------|
>| https://learn.wrike.com/subprocessor-list/ | ユーザー連絡先データ、会社名、会社のサイズ | Wrike でのアカウント登録に必要なデータ |
...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| 権限を持つメンションの Wrike ユーザーとタスク タイトルの名前を指定します。 | 上記と同じ | 上記と同じ |
