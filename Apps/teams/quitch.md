---
title: Quitch による Quitch のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/21/2022
...
description: Quitch、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f2125454-678c-4f97-90cc-dfe4742f4711" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003683" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Quitch が Microsoft に提供する情報:
...
| パートナー会社名 | Quitch |
| 会社の Web サイト | [https://quitch.com](https://quitch.com) |
| アプリの利用規約 | [https://quitch.com/user-terms-of-service/](https://quitch.com/user-terms-of-service/) |
| アプリのコア機能 | 会議の対話型Microsoft Teamsクイズ |
| 会社の本社所在地 | オーストラリア |
| アプリ情報ページ | [https://quitch.com/microsoft-teams/](https://quitch.com/microsoft-teams/) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Quitch によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザーの電子メールだけが収集される |
...
| プライバシー ポリシーの URL | https://quitch.com/privacy-policy/ |
