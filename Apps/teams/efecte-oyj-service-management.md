---
title: Efecte Oyj による Efecte サービス管理のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: Efecte Service Management、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63553561"
---
# <a name="efecte-service-management"></a>Efecte サービス管理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 1 月 24 日</p>

* <a href="https://teams.microsoft.com/l/app/1c20b1ea-7f9f-496a-a577-8b1bb1a28228" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003830" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Efecte Oyj から Microsoft に提供される情報:
...
| パートナー会社名 | Efecte Oyj |
| 会社の Web サイト | [https://www.efecte.com](https://www.efecte.com) |
| アプリの利用規約 | [https://www.efecte.com/terms-of-service](https://www.efecte.com/terms-of-service) |
| アプリのコア機能 | Efecte Service Management (ESM) の新しいチケットに通知を受信する |
| 会社の本社所在地 | フィンランド |
| アプリ情報ページ | [https://www.efecte.com/ms-teams-integration](https://www.efecte.com/ms-teams-integration) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Efecte Oyj によって提供されています。
...
| プライバシー ポリシーの URL | https://www.efecte.com/privacy-policy |
