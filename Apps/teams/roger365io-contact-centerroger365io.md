...
description: 連絡先センター のセキュリティとコンプライアンスに関する情報|ROGER365.io、そのデータ処理ポリシー、Microsoft Cloud App Securityカタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
Microsoft に提供される ROGER365.io 情報:
