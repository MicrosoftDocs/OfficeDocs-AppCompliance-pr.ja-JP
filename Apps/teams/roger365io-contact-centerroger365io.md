---
title: Contact Center | のアプリケーション情報ROGER365.io による ROGER365.io
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/24/2022
...
description: Contact Center |で使用可能なすべてのセキュリティとコンプライアンス情報ROGER365.io、そのデータ処理ポリシー、そのMicrosoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2022 年 6 月 24 日</p>

* <a href="https://teams.microsoft.com/l/app/f24f4679-05a5-4073-b5f7-0e1916fbd858" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003333" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ROGER365.io から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | コンタクト センター - ROGER365.io |
| ID | WA200003333 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | ROGER365.io |
| 会社の Web サイト | [https://www.roger365.com](https://www.roger365.com) |
| アプリの使用条件 | [https://www.roger365.io/tos](https://www.roger365.io/tos) |
| アプリのコア機能 | エージェントを使用した Omnichannel Contact Center、レポート機能のスーパーバイザー。 |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | [https://doc.roger365.io](https://doc.roger365.io) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する ROGER365.io によって提供されています。
...
| プライバシー ポリシーの URL | https://www.roger365.io/privacy-statement |
