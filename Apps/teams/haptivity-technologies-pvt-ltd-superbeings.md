...
description: SuperBeings で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| 会社の Web サイト | [https://www.superbeings.ai](https://www.superbeings.ai) |
| アプリの利用規約 | [https://www.superbeings.ai/terms-of-use](https://www.superbeings.ai/terms-of-use) |
| アプリのコア機能 | チームを継続的にスーパーチャージするためのツール/学習/インサイトをリーダーに提供します。 |
| 会社の本社所在地 | インド |
| アプリ情報ページ | [https://www.superbeings.ai](https://www.superbeings.ai) |
