---
title: Gfacility による Gfacility のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
description: Gfacility、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/0f553268-ba1c-4bb0-953c-def3e00aac7d" target="_blank">Teams ストアでの表示</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003474" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Gfacility が Microsoft に提供する情報:
...
| パートナー会社名 | Gfacility |
| 会社の Web サイト | [https://gfacility.com](https://gfacility.com) |
| アプリの利用規約 | [https://gfacility.com/terms-of-use](https://gfacility.com/terms-of-use) |
| アプリのコア機能 | Microsoft Teams で Gfacility を使用して会議を追跡する |
| 会社の本社所在地 | ベルギー |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Gfacility によって提供されています。
...
| プライバシー ポリシーの URL | https://gfacility.com/privacy-policy |
