...
description: CSA STAR レジストリ内のチームワーク、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、およびセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.teamwork.com/legal/terms-of-service/](https://www.teamwork.com/legal/terms-of-service/) |
| アプリのコア機能 | チームワークを自分のチャネルに直接埋め込Teamsしてください。  |
| 会社の本社所在地 | アイルランド |
