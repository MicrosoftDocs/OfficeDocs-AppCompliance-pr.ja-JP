---
title: Teamwork による Teamwork のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/24/2021
...
description: Teamwork で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f051cf68-e4e7-45d8-960c-a17f52cc4b52" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001552" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Teamwork から Microsoft に提供される情報:
...
| パートナー会社名 | Teamwork |
| 会社の Web サイト | [https://www.teamwork.com](https://www.teamwork.com) |
| アプリの使用条件 | [https://www.teamwork.com/legal/terms-of-service/](https://www.teamwork.com/legal/terms-of-service/) |
| アプリのコア機能 | Teams チャネルに直接チームワークを埋め込むことで、最新の状態を維持できます。  |
| 会社の本社の場所 | アイルランド |
| アプリ情報ページ | [https://support.teamwork.com/projects/microsoft-teams/conne...](https://support.teamwork.com/projects/microsoft-teams/connecting-to-teamwork-in-microsoft-teams) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Teamwork によって提供されています。
