...
<p>開発者による最終更新日: 2021 年 4 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/6d7f01cb-cfa5-48d9-beed-363d381ae32b" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002829" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Smarter Business Solution GmbH から Microsoft に提供される情報:
...
| パートナー会社名 | Smarter Business Solution GmbH |
| 会社の Web サイト | [https://www.smarterbusiness.at](https://www.smarterbusiness.at) |
| アプリの利用規約 | [https://www.smarterbusiness.at/en/terms-of-use-for-tagteam](https://www.smarterbusiness.at/en/terms-of-use-for-tagteam) |
| アプリのコア機能 | チームがチャネル内の会話をカラフルなタグで分類し、適切な情報の検索に費やす時間を減らします。 彼らは特に、1 クリックで指先に関連する情報を提供するのが好きです。 |
| 会社の本社所在地 | オーストリア |
| アプリ情報ページ | |
...
この情報は、Smarter Business Solution GmbH によって、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.All | 委任 | このデータは収集されません。タグ付き会話を表示する場合にのみ使用します。 検索 API に変更する必要がありますが、API Graphサポートしていない場合。  | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
>| User.Read | 委任 | タブにUser-Information (名前など) を表示する | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
>| User.ReadBasic.All | 委任 | タブにUser-Avatarsを表示する | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
>| openid | 委任 | SignIn の場合のみ - データは保存されません | [6d7f01cb-cfa5-48d9-beed-363d381ae32b](https://docs.microsoft.com/microsoft-365-app-certification/azure/6d7f01cb-cfa5-48d9-beed-363d381ae32b) |
