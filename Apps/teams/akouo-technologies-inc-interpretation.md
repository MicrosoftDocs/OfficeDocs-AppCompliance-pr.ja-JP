---
title: Akouo Technologies Inc. による Akouo の解釈に関するアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/25/2022
...
description: Akouo Interpretation、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "64480606"
---
# <a name="akouo-interpretation"></a>Akouo の解釈

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 8 日</p>

* <a href="https://teams.microsoft.com/l/app/d863a24b-7cdd-46c9-8309-a15878f4f7bf" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003814" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Akouo Technologies Inc. から Microsoft に提供される情報:
...
| パートナー会社名 | Akouo Technologies Inc. |
| 会社の Web サイト | [https://akouo.io](https://akouo.io) |
| アプリの利用規約 | [https://akouo.io/terms](https://akouo.io/terms) |
| アプリのコア機能 | 同時解釈で会議を多言語にする。 |
| 会社の本社所在地 | アラブ首長国連邦 (the) |
| アプリ情報ページ | [https://akouo.io](https://akouo.io) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Akouo Technologies Inc.によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザーの電子メール アドレス。 |
...
| プライバシー ポリシーの URL | https://akouo.io/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OnlineMeetings.Read | 委任 | 開始終了時刻などの会議の詳細を取得するために使用されます。会議の開催者にのみ要求されます。 | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
>| offline_access | アプリケーション | Microsoft のシングル サインオン&#8217;によって自動的に必要になります。 https://docs.microsoft.com/en-us/graph/permissions-reference#remarks-15  | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
>| openid | アプリケーション | Microsoft/Azure ログイン セッションでユーザーを認証する | [d863a24b-7cdd-46c9-8309-a15878f4f7bf](../azure/d863a24b-7cdd-46c9-8309-a15878f4f7bf.md) |
