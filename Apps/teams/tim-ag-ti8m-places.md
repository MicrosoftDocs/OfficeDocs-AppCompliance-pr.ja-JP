---
title: tim AG による&amp; ti8m の場所のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/04/2021
...
description: ti8m の場所、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/9e384ce2-2db2-412e-8da7-08c5cf4c418e" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003311" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

tim&amp; AG から Microsoft に提供される情報:
...
| パートナー会社名 | ti&amp;m AG |
| 会社の Web サイト | [https://www.ti8m.com/places](https://www.ti8m.com/places) |
| アプリの使用条件 | [https://ti8m.com/products/places/places-nutzungsbedingungen](https://ti8m.com/products/places/places-nutzungsbedingungen) |
| アプリのコア機能 | 場所は、ハイブリッド ワークプレースのセットアップで職場を予約するためのアプリです。 マップまたは予定表ベースのビューで予約を提供しています。 このアプリは、Microsoft Teams内で完全に統合されており、Microsoft Services に基づくすべての認証を使用します。 |
| 会社の本社の場所 | スイス |
| アプリ情報ページ | [https://www.ti8m.ch/places](https://www.ti8m.ch/places) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する tim&amp; AG によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite.Shared | 委任 | Workplaces とユーザーの予定表でイベントをキャンセルする  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| Directory.ReadWrite.All | 委任 | 管理AAD グループのインストールと作成 - セキュリティ グループ  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| Place.ReadWrite.All | 委任 | Workplaces とマップ名の一覧  | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
>| User.Read | 委任 | ユーザー名、電子メール、表示名、アプリケーションで Userdata を表示するために必要 | [43134ae0-301f-4762-b7a9-aa9f2ff77b38](../azure/43134ae0-301f-4762-b7a9-aa9f2ff77b38.md) |
