---
title: timeghost のアプリケーション情報 - timeghost.io による時間追跡
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: timeghost - 時間追跡、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "66540826"
---
# <a name="timeghost---time-tracking"></a>timeghost - 時間管理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/e3956558-7399-4ec1-848a-c61a2aa95bc1" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001532" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

timeghost.io から Microsoft に提供される情報:
...
| パートナー会社名 | timeghost.io |
| 会社の Web サイト | [https://timeghost.io](https://timeghost.io) |
| アプリの使用条件 | [https://timeghost.io/terms-and-conditions/](https://timeghost.io/terms-and-conditions/) |
| アプリのコア機能 | Timeghost は、Office 365向けに特別に設計された時間追跡ツールです。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | [https://timeghost.io](https://timeghost.io) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する timeghost.io によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、ユーザー メール データ、ユーザー 予定表データ |
...
| 多要素認証 (MFA) が有効になっているのは次のとおりです。 | DNSManagement、CodeRepositories、Credential |
...
| プライバシー ポリシーの URL | https://timeghost.io/privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委任 | Microsoft 365 アプリを timeghost に統合し、timeghost フィード内の特定のOutlook カレンダー イベントなどを表示するために使用します。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| People.Read | 委任 | Microsoft 365 アプリを timeghost に統合し、たとえば、Microsoft 365 プロファイルにリンクされているユーザーアバターを表示します。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| User.Read | 委任 | Microsoft 365 アプリを timeghost に統合し、たとえば、会社の他のユーザーも timeghost を使用していることをユーザーに示します。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| User.ReadBasic.All | 委任 | Microsoft 365 アプリを timeghost に統合し、たとえば、Microsoft 365 プロファイルにリンクされているユーザーアバターを表示します。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| openid | 委任 | 内部ユーザー ID  | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
>| profile | 委任 | Microsoft 365 アプリを timeghost に統合し、たとえば、Microsoft 365 プロファイルにリンクされているユーザーアバターを表示します。 | [f6f894ce-5b44-4c9b-aff4-253d2fbe8a99](../azure/f6f894ce-5b44-4c9b-aff4-253d2fbe8a99.md) |
