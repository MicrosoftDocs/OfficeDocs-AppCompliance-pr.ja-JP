---
title: Timewax による Timewax のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/21/2022
...
description: Timewax で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/0d3bddff-8ca4-4f41-ae48-5aad1ef26e0d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004428" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Timewax から Microsoft に提供される情報:
...
| パートナー会社名 | Timewax |
| 会社の Web サイト | [https://www.timewax.com](https://www.timewax.com) |
| アプリの使用条件 | [https://www.timewax.com/tc/](https://www.timewax.com/tc/) |
| アプリのコア機能 | Timewax プラットフォームから Teams に直接通知を受け取ります。 |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | [https://www.docs.timewax.com/en/knowledgebase/microsoft-tea...](https://www.docs.timewax.com/en/knowledgebase/microsoft-teams/) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Timewax によって提供されています。
...
| プライバシー ポリシーの URL | https://www.timewax.com/privacynotice/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委任 | ユーザーの予定表イベントをフェッチして、Outlook 統合によって同期されているかどうかを判断して、タブに表示できるようにする必要があります。 | [c6557591-6b74-430d-b25e-87ab28766f32](../azure/c6557591-6b74-430d-b25e-87ab28766f32.md) |
>| User.Read | 委任 | チームの統合をカスタマイズするために必要です。 | [c6557591-6b74-430d-b25e-87ab28766f32](../azure/c6557591-6b74-430d-b25e-87ab28766f32.md) |
