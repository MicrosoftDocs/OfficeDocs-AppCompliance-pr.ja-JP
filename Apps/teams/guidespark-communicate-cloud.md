...
description: GuideSpark Communicate Cloud、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.guidespark.com/terms/](https://www.guidespark.com/terms/) |
| アプリのコア機能 | GuideSpark コミュニケーション クラウドを通じて、対象ユーザーをターゲットにし、エンゲージメント データを追跡することで組織の変化を促進します。 効果的な内部コミュニケーションを促進するために、配信チャネルを拡大し、ユーザーに連絡します。 |
| 会社の本社所在地 | アメリカ |
