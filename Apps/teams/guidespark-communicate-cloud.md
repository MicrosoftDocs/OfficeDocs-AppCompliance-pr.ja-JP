---
title: GuideSpark による GuideSpark コミュニケーション クラウドのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: GuideSpark Communicate Cloud、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/34b870ca-2417-4660-b835-ebb18ee7ccf9" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003348" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | GuideSpark |
| 会社の Web サイト | [https://guidespark.com](https://guidespark.com) |
| アプリの使用条件 | [https://www.guidespark.com/terms/](https://www.guidespark.com/terms/) |
| アプリのコア機能 | GuideSpark Communicate Cloud を使用して対象ユーザーをターゲットにし、エンゲージメント データを追跡することで、組織の変更を促進します。 配信チャネルを拡大し、効果的な内部コミュニケーションを促進するために、そのユーザーに連絡します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.guidespark.com/change-communications-software/](https://www.guidespark.com/change-communications-software/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する GuideSpark によって提供されています。
