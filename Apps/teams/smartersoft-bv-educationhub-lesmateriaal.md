---
title: Smartersoft B.V による EducationHUB Lesmateriaal のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: EducationHUB Lesmateriaal で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f5558ae7-a166-41bd-997b-f8cc1eddebac" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004326" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Smartersoft B.V から提供される情報。 Microsoft に対して:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | EducationHUB Lesmateriaal |
| ID | WA200004326 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | Smartersoft B.V. |
| 会社の Web サイト | [https://smartersoft.nl](https://smartersoft.nl) |
| アプリの使用条件 | [https://content.educationhub.nl/terms](https://content.educationhub.nl/terms) |
| アプリのコア機能 | 学校が、学生を別の Web サイトに強制的にアクセスさせるのではなく、学校が提供するデジタル コンテンツに直接アクセスできるようにします。 |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | [https://content.educationhub.nl](https://content.educationhub.nl) |
...
この情報は、Smartersoft B.V によって提供されています。 このアプリが組織のデータを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー ID、グループ メンバーシップ、アプリケーションに追加された個人用コンテンツ |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー ID、グループ ID、デジタル 学校コンテンツへのユーザー指定のリンク |
...
| サポートされているポリシーの種類を一覧表示する | すべて、Microsoft プラットフォームは、ユーザーのトークンを提供する責任があります。 管理者は、ユーザーが MFA を検証または強制的に使用する方法を決定します |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 委任 | グループ拡張属性に保存された情報にアクセスする | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| Team.ReadBasic.All | 委任 | ユーザー チームに関する情報 | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
>| User.Read | 委任 | ログイン | [d3c78487-7def-49e1-9d17-40e94d66ac5b](../azure/d3c78487-7def-49e1-9d17-40e94d66ac5b.md) |
