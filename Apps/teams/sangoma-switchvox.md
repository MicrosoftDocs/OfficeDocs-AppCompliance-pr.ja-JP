---
title: Sangoma による Switchvox のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
ms.locfileid: "63549305"
---
# <a name="switchvox"></a>Switchvox

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 12 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/eb668aa5-abb2-445c-81b4-3c174db84fe2" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001535" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Sangoma から Microsoft に提供される情報:
...
| パートナー会社名 | Sangoma |
| 会社の Web サイト | [https://www.sangoma.com](https://www.sangoma.com) |
| アプリの利用規約 | [https://cdn.sangoma.com/wp-content/uploads/digium_end_user_...](https://cdn.sangoma.com/wp-content/uploads/digium_end_user_license_agreement.pdf) |
| アプリのコア機能 | Switchvox 電話の通話を、デバイス内の任意の場所からシームレスにMicrosoft Teams。 |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | [https://support.digium.com/community/s/article/How-do-I-use...](https://support.digium.com/community/s/article/How-do-I-use-Switchvox-for-Microsoft-Teams) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Sangoma によって提供されています。
...
| データベースに格納されているデータは何ですか? | アプリケーション経由で開始された通話の通話履歴レコード (番号、名前、連絡先の電子メールを含む) |
...
| プライバシー ポリシーの URL | https://cdn.sangoma.com/wp-content/uploads/Privacy-Policy.pdf |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Chat.Read | 委任 | チャット メンバーの解決を実行する | [eb668aa5-abb2-445c-81b4-3c174db84fe2](../azure/eb668aa5-abb2-445c-81b4-3c174db84fe2.md) |
>| Group.Read.All | 委任 | グループ メンバーの解決を実行する | [eb668aa5-abb2-445c-81b4-3c174db84fe2](../azure/eb668aa5-abb2-445c-81b4-3c174db84fe2.md) |
>| User.Read.All | 委任 | ディレクトリ連絡先の参照を実行する | [eb668aa5-abb2-445c-81b4-3c174db84fe2](../azure/eb668aa5-abb2-445c-81b4-3c174db84fe2.md) |
