---
title: Klaxoon by Klaxoon のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2022
...
description: Klaxoon で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66548106"
---
# <a name="klaxoon"></a>Klaxoon

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/6adc8d55-eb37-4537-a66d-743b3cd4511b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104382058" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

クラクスーンから Microsoft に提供される情報:
...
| パートナー会社名 | Klaxoon |
| 会社の Web サイト | [https://klaxoon.com](https://klaxoon.com) |
| アプリの使用条件 | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| アプリのコア機能 | クラクスーンでは、チームワークの効率を高めるために設計された共同作業ツール (ホワイトボード、アンケート、クイズ、ライブ ポーリングなど) の完全なスイートにアクセスできます。 Klaxoon スイートは、Web アプリ、モバイル アプリ (Apple/Android) として、または Microsoft Teams から直接 (タブ統合を介して) アクセスできます。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://klaxoon.com](https://klaxoon.com) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | ハイブリッド |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | Azure、Aws、その他 |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、クラクスーンから提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | email、firstname、lastname、avatar |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | email、firstname、lastname、avatar |
| 基になるインファ構造が Microsoft 顧客データを処理または格納する場合、このデータは地理的にどこに保存されますか? | アメリカ、フランス、ドイツの米国 |
...
| プライバシー ポリシーの URL | https://static.klaxoon.com/website/pdf/privacy-policy.pdf |
...
| サポートされているポリシーの種類を一覧表示する | 詳細については、お問い合わせください |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザー識別とアカウントの作成 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| メール | 委任 | ユーザー識別とアカウントの作成 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| offline_access | 委任 | ユーザー識別とアカウントの作成 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| openid | 委任 | ユーザー識別とアカウントの作成 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
>| profile | 委任 | ユーザー識別とアカウントの作成 | [ef685106-cba6-4374-a250-a89d51df6e34](../azure/ef685106-cba6-4374-a250-a89d51df6e34.md) |
