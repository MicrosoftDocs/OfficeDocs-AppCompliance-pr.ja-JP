...
| アプリの利用規約 | [https://static.klaxoon.com/website/pdf/eula.pdf](https://static.klaxoon.com/website/pdf/eula.pdf) |
| アプリのコア機能 | Klaxoon は、チームワークの効率を高めるために設計された共同作業ツール (ホワイトボード、アンケート、クイズ、ライブ ポーリングなど) の完全なスイートにアクセスできます。 Klaxoon スイートは、Web アプリ、モバイル アプリ (Apple/Android) として、または (タブ統合を介して) Microsoft Teamsから直接アクセスできます。 |
| 会社の本社所在地 | フランス |
| アプリ情報ページ | [https://klaxoon.com](https://klaxoon.com) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダー | AWS、Azure、クララネット |
