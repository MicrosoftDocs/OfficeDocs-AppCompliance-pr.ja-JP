...
| アプリのコア機能 | クラクスーンでは、チームワークの効率を高めるために設計された共同作業ツール (ホワイトボード、アンケート、クイズ、ライブ ポーリングなど) の完全なスイートにアクセスできます。 Klaxoon スイートは、Web アプリ、モバイル アプリ (Apple/Android) として、または (タブ統合を介して) Microsoft Teamsから直接アクセスできます。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://klaxoon.com](https://klaxoon.com) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | AWS、Azure、クラネット |
