---
title: Gensys ソリューション BV による Gensys のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Gensys で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/bc1e8e2d-bb5c-47d7-a9e6-f0be9eb83c5a" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003044" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://gensys.nl/terms-of-use/](https://gensys.nl/terms-of-use/) |
| アプリのコア機能 | Gensys Anywhere と Microsoft Teamsを統合するための Gensys アプリ |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Gensys Solutions BV から提供されています。
