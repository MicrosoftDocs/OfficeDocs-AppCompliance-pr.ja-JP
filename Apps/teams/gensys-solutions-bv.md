...
| 会社の Web サイト | [https://gensys.nl](https://gensys.nl) |
| アプリの利用規約 | [https://gensys.nl/terms-of-use/](https://gensys.nl/terms-of-use/) |
| アプリのコア機能 | Gensys Anywhere とアプリケーションを統合する Gensys Microsoft Teams |
| 会社の本社所在地 | オランダ (the) |
| アプリ情報ページ | |
