...
| アプリの利用規約 | [https://www.effency.fr/conditions-generales/](https://www.effency.fr/conditions-generales/) |
| アプリのコア機能 | TeamGether は、EFFENCY によって開発された集合効率における主要なデジタル コーチング アプリケーションです。 |
| 会社の本社所在地 | フランス |
