...
description: TeamGether で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/5a0547cc-ea63-4425-acc8-08b89a8fc1a1" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002660" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

EFFENCY から Microsoft に提供される情報:
...
| パートナー会社名 | EFFENCY |
| 会社の Web サイト | [https://www.effency.fr](https://www.effency.fr) |
| アプリの使用条件 | [https://www.effency.fr/conditions-generales/](https://www.effency.fr/conditions-generales/) |
| アプリのコア機能 | TeamGether は、EFFENCY によって開発された集合的な効率における主要なデジタル コーチング アプリケーションです |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://www.effency.fr/teams/](https://www.effency.fr/teams/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、EFFENCY によって提供されています。
