...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMember.ReadWrite.All | 両方とも | OAuth 2.0 の暗黙的な承認に対してテナント アプリケーション ID とアプリケーション パスワードが収集され、ユーザー情報が同期されます。 | [3407e97c-3eed-4eca-add5-2549ed881269](../azure/3407e97c-3eed-4eca-add5-2549ed881269.md) |
