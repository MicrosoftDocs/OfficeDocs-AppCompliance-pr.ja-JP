...
| 会社の Web サイト | [https://www.teamsuite.biz](https://www.teamsuite.biz) |
| アプリの利用規約 | [https://www.teamsuite.biz/terms/](https://www.teamsuite.biz/terms/) |
...
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ (メール/名前/aad オブジェクト ID/ユーザー プロファイル イメージ) |
