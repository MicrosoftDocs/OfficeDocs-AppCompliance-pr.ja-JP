...
| パートナー会社名 | Sine.co |
| 会社の Web サイト | [https://www.sine.co](https://www.sine.co) |
| アプリの利用規約 | [https://www.sine.co/terms/](https://www.sine.co/terms/) |
| アプリのコア機能 | 訪問者と従業員の安全、セキュリティ、コンプライアンスを強化する正弦ワークプレース ソフトウェア。 |
| 会社の本社所在地 | オーストラリア |
| アプリ情報ページ | [https://www.sine.co](https://www.sine.co) |
