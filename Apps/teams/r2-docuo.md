---
title: R2 Docuo による Docuo のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: Docuo で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/2b4ebe4e-7500-4aa5-be83-3857bb2bff2e" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002937" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

R2 Docuo から Microsoft に提供される情報:
...
| パートナー会社名 | R2 Docuo |
| 会社の Web サイト | [https://www.r2docuo.com](https://www.r2docuo.com) |
| アプリの使用条件 | [https://www.r2docuo.com/en/legal-advice](https://www.r2docuo.com/en/legal-advice) |
| アプリのコア機能 | Teamsを離れることなくチームとConnectし、アジャイルかつ効果的な方法でワークフローを管理します。 |
| 会社の本社の場所 | スペイン |
| アプリ情報ページ | [https://www.r2docuo.com](https://www.r2docuo.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、R2 Docuo によって提供されています。
