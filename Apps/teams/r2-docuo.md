...
description: CSA STAR レジストリの Docuo、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、およびセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/2b4ebe4e-7500-4aa5-be83-3857bb2bff2e" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002937" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.r2docuo.com/en/legal-advice](https://www.r2docuo.com/en/legal-advice) |
| アプリのコア機能 | Connectを離れることなくチームとTeamsし、迅速かつ効果的な方法でワークフローを管理します。 |
| 会社の本社所在地 | スペイン |
...
この情報は、R2 Docuo によって、このアプリが組織データを収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールについて提供されています。
