...
| アプリのコア機能 | ドキュメント署名ワークフローを合理化し、Adobe Sign の機能を利用して、従業員と顧客の優れたエクスペリエンスを提供Teams。 ドキュメントに署名し、法的拘束力のある電子署名と承認のためにドキュメントを送信し、Microsoft の優先電子署名ソリューションである Teams 用 Adobe Sign を使用して、その状態 &#8212; を追跡できます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>| offline_access | 委任 | アクセス トークンを更新するには、現在のトークンの有効期限が切れています。 たとえば、ユーザーが署名ウィンドウの送信中で非アクティブな状態を長くする場合は、ユーザーをアクティブに保つために新しいトークンを更新 &quot; &quot; する必要があります。 | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](https://docs.microsoft.com/microsoft-365-app-certification/azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b) |
