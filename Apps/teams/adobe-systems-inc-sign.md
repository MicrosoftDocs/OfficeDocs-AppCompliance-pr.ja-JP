...
ms.locfileid: "53282090"
---
# <a name="adobe-sign"></a>Adobe Sign

<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>開発者による最終更新日: 2021 年 3 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/0f56a9d1-f502-40f9-a9e8-816d7adbb68b" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381233" target="_blank">AppSource での表示</a>
...
| [アプリケーション情報Teamsページの URL | [https://helpx.adobe.com/sign/help/adobesign_microsoft_teams...](https://helpx.adobe.com/sign/help/adobesign_microsoft_teams.html) |
| プライバシー ポリシーの URL | [https://www.adobe.com/privacy/policy.html](https://www.adobe.com/privacy/policy.html) |
| 利用規約の URL | [https://www.adobe.com/legal/terms.html](https://www.adobe.com/legal/terms.html) |
...
>| offline_access | 委任 | アクセス トークンを更新するには、現在のトークンの有効期限が切れています。 たとえば、ユーザーが署名ウィンドウの送信中で非アクティブな状態を長くする場合は、ユーザーをアクティブに保つために新しいトークンを更新 &quot; &quot; する必要があります。 | アクセス トークンを更新するには、現在のトークンの有効期限が切れています。 たとえば、ユーザーが署名用の送信ウィンドウに表示され、非アクティブなままにしすぎる場合は、ユーザーをアクティブに保つために新しいトークンを更新 &quot; &quot; する必要があります。 | 72d5ac5d-a427-408b-907d-72da3f33ddd1 |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| チャット メッセージと認証のカスタマイズ | UserPrincipalName、名前、電子メール、および objectId | この情報は、非同期応答と認証目的のカスタマイズ用に保存されます。 |
...
この情報は、このアプリが認証、承認、アプリケーション登録のベスト プラクティス、その他の ID 基準を処理する方法について Adobe Systems Inc. から提供されています。
