---
title: アドビシステムズ株式会社によるアドビサインの申込情報
ms.author: elmalova
author: elenamalova
ms.date: 03/01/2021
ms.topic: article
...
description: Adobe Sign の利用可能なセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、そのMicrosoft Cloud App Securityアプリカタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/0f56a9d1-f502-40f9-a9e8-816d7adbb68b" target="_blank">Teams店舗で表示</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381233" target="_blank">アプリソースで表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

アドビシステムズ社がマイクロソフトに提供する情報:
...
| パートナーウェブサイトのURL | [https://acrobat.adobe.com/us/en/sign.html](https://acrobat.adobe.com/us/en/sign.html) |
| アプリケーション情報ページTeams URL | [https://helpx.adobe.com/sign/help/adobesign_microsoft_teams...](https://helpx.adobe.com/sign/help/adobesign_microsoft_teams.html) |
| プライバシーポリシーの URL | [https://www.adobe.com/privacy/policy.html](https://www.adobe.com/privacy/policy.html) |
...
この情報は、このアプリが組織データを収集して保存する方法、およびアプリが収集するデータに対する組織のコントロールに関する Adobe Systems Inc. によって提供されています。
...
>| offline_access | 委任 | 現在のトークンが期限切れになったときにアクセス トークンを更新します。 たとえば、ユーザーが &quot; 署名の送信ウィンドウに長時間アクティブな状態を維持している場合 &quot; 、ユーザーをアクティブに保つために新しいトークンを更新する必要があります。 | 現在のトークンが期限切れになったときにアクセス トークンを更新します。 たとえば、ユーザーが &quot; 署名の送信 &quot; ウィンドウで、そのウィンドウをあまり長く非アクティブにした場合、ユーザーをアクティブに保つために新しいトークンを更新する必要があります。 | 72d5ac5d-a427-408b-907d-72da3f33dd1 |
...
>|:--------------------------------|:---------------------|:--------------------------|
>| チャットメッセージと認証のカスタマイズのため | ユーザープリンシパル名、名前、電子メール、およびオブジェクト ID | 非同期応答および認証の目的でカスタマイズするために、この情報を保存します。 |
...
この情報は、このアプリが認証、承認、アプリケーション登録のベストプラクティス、およびその他のID基準を処理する方法について、Adobe Systems Inc.によって提供されています。
