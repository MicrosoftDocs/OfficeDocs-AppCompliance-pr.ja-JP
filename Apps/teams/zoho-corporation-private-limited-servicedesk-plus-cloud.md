...
* <a href="https://teams.microsoft.com/l/app/04fdcea1-3511-499c-966d-099d59aef45f" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000037" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| アプリのコア機能 | ServiceDesk Plus は SaaS IT ヘルプ デスク管理ソフトウェアです。 IT サービス管理の機能が充実し、IT 管理者が組織内のヘルプ デスク操作を効果的に整理するのに役立ちます。 既定では、ServiceDesk Plus (クラウド) は既定でAzure AD。 開始するには、サービス インスタンスのアカウントを使用して ServiceDesk Plus (Cloud) にサインアップAzure AD。 |
| 会社の本社所在地 | アメリカ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | サインインおよびユーザー プロファイルの読み取り | [127e5be9-da2c-4335-a284-da367379428a](../azure/127e5be9-da2c-4335-a284-da367379428a.md) |
>| offline_access | 委任 | アクセス許可を付与したデータへのアクセスの維持 | [127e5be9-da2c-4335-a284-da367379428a](../azure/127e5be9-da2c-4335-a284-da367379428a.md) |
