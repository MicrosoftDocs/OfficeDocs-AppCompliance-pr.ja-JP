...
description: ServiceDesk Plus Cloud で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/04fdcea1-3511-499c-966d-099d59aef45f" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000037" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.manageengine.com/products/service-desk](https://www.manageengine.com/products/service-desk) |
| アプリの使用条件 | [https://ondemand.manageengine.com/terms.html](https://ondemand.manageengine.com/terms.html) |
| アプリのコア機能 | ServiceDesk Plus は、SaaS IT ヘルプ デスク管理ソフトウェアです。 IT サービス管理の機能が数多く用意されているため、IT マネージャーは組織内のヘルプ デスク業務を効果的に整理するのに役立ちます。 既定では、ServiceDesk Plus (Cloud) はAzure ADで動作します。 開始するには、Azure AD のインスタンス内のアカウントを使用して ServiceDesk Plus (Cloud) にサインアップします。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://help.sdpondemand.com/servicedeskplus_cloud_for_teams](https://help.sdpondemand.com/servicedeskplus_cloud_for_teams) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | サインインおよびユーザー プロファイルの読み取り | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
>| offline_access | 委任 | アクセス許可を付与したデータへのアクセスの維持 | [127e5be9-da2c-4335-a284-da367379428a](/microsoft-365-app-certification/azure/39cb9f28-b9d0-4bf7-a4f4-d9e38508a0db) |
