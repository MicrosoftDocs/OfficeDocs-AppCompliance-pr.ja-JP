...
description: Spatial Standup、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| 会社の Web サイト | [https://www.highfidelity.com](https://www.highfidelity.com) |
| アプリの利用規約 | [https://www.highfidelity.com/terms-of-service](https://www.highfidelity.com/terms-of-service) |
| アプリのコア機能 | スタンドアップ会議の空間オーディオ、ビデオ、画面共有 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
