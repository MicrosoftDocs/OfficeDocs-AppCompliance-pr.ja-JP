---
title: ボット プラットフォームによるトレーニング アシスタントのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/07/2021
...
description: トレーニング アシスタント、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63541565"
---
# <a name="training-assistant"></a>Training Assistant

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 8 月 2 日</p>

* <a href="https://teams.microsoft.com/l/app/40049dbc-3781-491d-ad2e-d59009538e45" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003547" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ボット プラットフォームから Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Training Assistant |
| ID | WA200003547 |
| Office 365サポートされているクライアント | Microsoft Teams |
| パートナー会社名 | The Bot Platform |
| 会社の Web サイト | [https://thebotplatform.com](https://thebotplatform.com) |
| アプリの利用規約 | [https://thebotplatform.com/wp-content/uploads/2021/11/TBP-T...](https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Customer-Terms-of-Use.pdf) |
| アプリのコア機能 | このデジタル アシスタントは、ユーザーの設定と作業を行う上で知る必要があるすべてをカバーする一連のトレーニング モジュールをTeams。 各モジュールには、特定のチュートリアル ビデオとトレーニング コンテンツが含まれているので、スタッフが Microsoft Teams で使用できる機能の広さ、およびそれらを使用する方法を十分に認識できます。 |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関するボット プラットフォームによって提供されています。
...
| プライバシー ポリシーの URL | https://thebotplatform.com/wp-content/uploads/2021/11/TBP-Training-Assistant-Privacy-Statement.pdf |
