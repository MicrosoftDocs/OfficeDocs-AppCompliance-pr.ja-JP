---
title: Workboard Inc. の Workboard のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/21/2021
...
Workboard Inc. から Microsoft に提供される情報:
...
| パートナー会社名 | Workboard Inc. |
| 会社の Web サイト | [https://www.workboard.com](https://www.workboard.com) |
| アプリの使用条件 | [https://www.workboard.com/license/terms_of_use_v1.php](https://www.workboard.com/license/terms_of_use_v1.php) |
| アプリのコア機能 | 組織を通じて戦略的な優先順位を調整し、目標と主要な結果 (OKR) を部門間のチームや個人にローカライズします。 主要な結果と成功メトリックをグラフ化し、計算し、進行状況を共有します。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.workboard.com/microsoft/](https://www.workboard.com/microsoft/) |
...
この情報は Workboard Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
...
| 最新の SOC1 認定日 | 2020-07-31 |
| アプリはサービス組織コントロール (SOC 2) に準拠していますか? | はい |
| 最新の SOC2 認定日 | 2020-10-30 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 電子メール アドレスとユーザーの ID。  ユーザーを WorkBoard のユーザー ID にマップするために使用されます | [](../azure/.md) |
