...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 電子メール アドレスとユーザーの ID。  ユーザーを WorkBoard のユーザー ID にマップするために使用されます。 | [User.Read](https://docs.microsoft.com/microsoft-365-app-certification/azure/User.Read) |
