...
>|:---------------------------------------|:-----------------------------------|:------------------------------------|
>| ユーザー ID は、WorkBord によってユーザーに送信Teamsに使用されます。 | ユーザーの電子メール アドレスと ID | ユーザーを WorkBoard のユーザー ID にマップするために使用します。 |
...
この情報は、このアプリが認証、承認、アプリケーション登録のベスト プラクティス、その他の IDENTITY 条件を処理する方法について、Workboard Inc. から提供されています。
