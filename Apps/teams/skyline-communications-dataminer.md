---
title: スカイライン コミュニケーションによる DataMiner のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/22/2021
...
description: DataMiner で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/9a09d087-5d07-4481-b34f-cd053eab7925" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003501" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

スカイライン コミュニケーションから Microsoft に提供される情報:
...
| パートナー会社名 | Skyline Communications |
| 会社の Web サイト | [https://www.skyline.be](https://www.skyline.be) |
| アプリの利用規約 | [https://dataminer.services/terms/terms-of-service.html](https://dataminer.services/terms/terms-of-service.html) |
| アプリのコア機能 | スカイライン コミュニケーションは、ICT メディアおよびブロードバンド業界向けのエンドツーエンドのマルチベンダー NMS、OSS、オーケストレーション ソフトウェア ソリューションの世界をリードするサプライヤーです。 さまざまな権威ある賞を受賞した当社のフラッグシップ DataMiner ネットワーク管理プラットフォームは、最も複雑な技術エコシステムのエンドツーエンドの統合を可能にし、世界中の主要なオペレーターによって展開されています。 |
| 会社の本社所在地 | ベルギー |
| アプリ情報ページ | [https://www.skyline.be/dataminer/cloud-services](https://www.skyline.be/dataminer/cloud-services) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する情報を、スカイライン コミュニケーションズから提供されています。
...
| プライバシー ポリシーの URL | https://dataminer.services/terms/privacy.html |
