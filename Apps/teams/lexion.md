...
description: Lexion で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/e2b7f512-12eb-4ba7-8705-b512fb3c05ee" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003176" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://lexion.ai/terms](https://lexion.ai/terms) |
| アプリのコア機能 | Microsoft Teams Lexion AI を搭載したコントラクト ライフサイクル管理用ボット。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Lexion によって提供されています。
