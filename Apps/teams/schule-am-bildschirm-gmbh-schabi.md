---
title: Schule am Bildschirm GmbH による Schabi のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/03/2022
...
description: Schabi の利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/8ddc9e63-e032-4639-afa6-b7c806303212" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003728" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Schule am Bildschirm GmbH から Microsoft に提供される情報:
...
| パートナー会社名 | Schule am Bildschirm GmbH |
| 会社の Web サイト | [https://web.schabi.ch](https://web.schabi.ch) |
| アプリの利用規約 | [https://www.schabi.ch/Info/AGB](https://www.schabi.ch/Info/AGB) |
| アプリのコア機能 | Deine Schabi-Hausaufgaben und Schabi-Seiten direkt in Microsoft Teams! |
| 会社の本社所在地 | スイス |
| アプリ情報ページ | [https://web.schabi.ch](https://web.schabi.ch) |
...
この情報は、Schule am Bildschirm GmbH によって、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| プライバシー ポリシーの URL | https://www.schabi.ch/Info/Datenschutz |
