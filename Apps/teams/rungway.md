---
title: Rungway by Rungway のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/27/2022
...
description: Rungway で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/4bea8f81-966b-45fe-8c33-4c8843fda977" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004123" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Rungway から Microsoft に提供される情報:
...
| パートナー会社名 | Rungway |
| 会社の Web サイト | [https://app.rungway.com](https://app.rungway.com) |
| アプリの使用条件 | [https://support.rungway.com/terms-conditions.html](https://support.rungway.com/terms-conditions.html) |
| アプリのコア機能 | 匿名で質問し、問題を提起します。 共有のアドバイスに追いつきます。   |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://www.rungway.com/product-overview](https://www.rungway.com/product-overview) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Rungway によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザーの電子メール アドレス、ユーザー プロファイル情報 (クライアントごとにカスタマイズ可能で、ユーザーが入力) |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザーの電子メール アドレス、ユーザー プロファイル情報 (クライアントごとにカスタマイズ可能で、ユーザーが入力) |
...
| プライバシー ポリシーの URL | https://support.rungway.com/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 読み取りユーザー プロファイルに &amp; サインインするには | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| メール | 委任 | ユーザーの認証を識別 &amp; するには | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| offline_access | 委任 | データへのアクセスを維持する | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| openid | 委任 | ユーザーにサインインするには | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
>| profile | 委任 | ユーザーの基本プロファイルを表示するには | [4bea8f81-966b-45fe-8c33-4c8843fda977](../azure/4bea8f81-966b-45fe-8c33-4c8843fda977.md) |
