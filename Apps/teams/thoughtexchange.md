---
title: ThoughtExchange による ThoughtExchange のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 12/01/2021
ms.topic: article
...
description: ThoughtExchange、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/56e9692f-606b-45ef-8c1f-12e1ea5e27db" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003378" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ThoughtExchange から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | ThoughtExchange |
| ID | WA200003378 |
| Office 365サポートされているクライアント | Microsoft Teams |
| パートナー会社名 | ThoughtExchange |
| 会社の Web サイト | [https://thoughtexchange.com](https://thoughtexchange.com) |
| アプリの利用規約 | [https://www.thoughtexchange.com/participant-leader-terms-of...](https://www.thoughtexchange.com/participant-leader-terms-of-use/) |
| アプリのコア機能 | &#8220;ThoughtExchange は、リーダーが場所に関係なく、従業員やコミュニティの全員から率直で偏りのない意見を得るのを支援します。 10&#8217;10,000 グループの場合でも、ThoughtExchange を使用すると、重要な議論を容易に進め、スケールで意思決定を行&#8221; |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する ThoughtExchange によって提供されています。
...
| プライバシー ポリシーの URL | https://www.thoughtexchange.com/privacy-policy/ |
