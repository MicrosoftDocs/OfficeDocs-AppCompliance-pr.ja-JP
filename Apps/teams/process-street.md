---
title: プロセス ストリート別のプロセス ストリートのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/13/2022
...
description: Process Street で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64838806"
---
# <a name="process-street"></a>プロセス ストリート

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/6910821c-1244-4a0b-9d64-f0fc396b8e7c" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003933" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Process Street から Microsoft に提供される情報:
...
| パートナー会社名 | プロセス ストリート |
| 会社の Web サイト | [https://www.process.st](https://www.process.st) |
| アプリの使用条件 | [https://www.process.st/terms/](https://www.process.st/terms/) |
| アプリのコア機能 | コア プロセスを構築、共有、自動化するための最新のプロセス管理プラットフォーム。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Process Street によって提供されています。
...
| プライバシー ポリシーの URL | https://www.process.st/help/docs/gdpr-statement/ |
