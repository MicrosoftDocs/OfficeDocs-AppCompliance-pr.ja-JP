---
title: Unit4 Business Software による「中庴」のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/15/2022
...
description: 中のセキュリティとコンプライアンスに関するすべての情報、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/73642721-0f64-4d3a-ab6c-2c1fe053aa80" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004038" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Unit4 Business Software から Microsoft に提供される情報:
...
| パートナー会社名 | Unit4 Business Software |
| 会社の Web サイト | [https://www.unit4.com](https://www.unit4.com) |
| アプリの使用条件 | [https://www.unit4.com/terms-and-conditions](https://www.unit4.com/terms-and-conditions) |
| アプリのコア機能 | 最も日常的な ERP タスクを処理するのに役立ちます。 |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | [https://get-wanda-help.u4pp.com](https://get-wanda-help.u4pp.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、Unit4 Business Software によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ボット固有のMicrosoft Teamsユーザー ID |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ボット固有のMicrosoft Teamsユーザー ID |
...
| プライバシー ポリシーの URL | https://info.unit4.com/rs/400-HYB-295/images/Unit4-People-Platform-Service-Description-v.1.1-September-2021-%28EN%29-%281%29.pdf |
