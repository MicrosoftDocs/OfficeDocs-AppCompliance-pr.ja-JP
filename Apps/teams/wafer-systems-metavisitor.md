---
title: MetaVisitor のアプリケーション情報 (ワセア システム別)
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/23/2021
...
description: MetaVisitor で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/372038ea-2ebb-4da0-836e-ae31318fa8c9" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003588" target="_blank">AppSource で表示する</a>
