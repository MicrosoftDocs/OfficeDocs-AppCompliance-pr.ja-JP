...
| アプリの利用規約 | [https://www.xmatters.com/policy/terms-conditions](https://www.xmatters.com/policy/terms-conditions) |
| アプリのコア機能 | ツールチェーン間の通信を自動化して、IT の問題を防止、管理、解決する |
| 会社の本社所在地 | アメリカ |
