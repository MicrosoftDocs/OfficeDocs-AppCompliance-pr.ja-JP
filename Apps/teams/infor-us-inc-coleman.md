...
| アプリの利用規約 | [https://www.infor.com/about/legal](https://www.infor.com/about/legal) |
| アプリのコア機能 | Infor Coleman デジタル アシスタントは、自然言語の拡張性と Infor Cloudsuites へのアクセシビリティを可能にすることで、人間の仕事の可能性を最大限に引き出す会話インターフェイスを提供します。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
