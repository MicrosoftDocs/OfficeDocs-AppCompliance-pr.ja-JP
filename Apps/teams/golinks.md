---
title: GoLinks による GoLinks のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/18/2022
...
description: GoLinks、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/c1abaf93-e823-4e9a-a810-34a47e77ef71" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003853" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

GoLinks から Microsoft に提供される情報:
...
| パートナー会社名 | GoLinks |
| 会社の Web サイト | [https://www.golinks.io](https://www.golinks.io) |
| アプリの利用規約 | [https://www.golinks.io/terms.php](https://www.golinks.io/terms.php) |
| アプリのコア機能 | GoLinks は、golinks、golinks、go/links、または go-links と呼ばれる、直感的で覚えやすい短いリンクで、チームが共有します。 これは、長く醜い URL を、ブラウザー、電子メール、チャット、会話で直接使用できる、人間が読み取り可能な移動リンクに変換します。 GoLinks を使用すると、企業は大規模な作業情報やリソースに効果的かつ効率的にアクセスして共有できます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://www.golinks.io/golinks.php](https://www.golinks.io/golinks.php) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する GoLinks によって提供されています。
...
| データベースに格納されているデータは何ですか? | Microsoft のテナント ID のみを保存します。 |
...
| プライバシー ポリシーの URL | https://www.golinks.io/privacy.php |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Read.Group | アプリケーション | パブリック チャネル内のメッセージにアクセスして、メッセージに go/link が含まれているか確認する必要があります。 | [c1abaf93-e823-4e9a-a810-34a47e77ef71](../azure/c1abaf93-e823-4e9a-a810-34a47e77ef71.md) |
