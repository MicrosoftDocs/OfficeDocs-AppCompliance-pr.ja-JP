---
title: ORCA SECURITY LTD による Orca のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: Orca で使用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/50423b81-408b-4699-a850-9a0514ee42c3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004132" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ORCA SECURITY LTD から Microsoft に提供される情報:
...
| パートナー会社名 | ORCA SECURITY LTD |
| 会社の Web サイト | [https://orca.security](https://orca.security) |
| アプリの使用条件 | [https://orca.security/terms-of-use](https://orca.security/terms-of-use) |
| アプリのコア機能 | Orca Security for Microsoft Teamsでは、クラウド環境のセキュリティ状態をリアルタイムで把握できます。 ユーザーは、1 つのビューで組み合わされた両方のツールを使用して、クラウド環境のセキュリティの問題に関する生産性の高いディスカッションを作成できます。Orca アラートでは、セキュリティ リスクの結果や、リスクをもたらす接続されたクラウド リソースを含む特定のクラウド リスクの詳細が示されます。 |
| 会社の本社の場所 | イスラエル |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について ORCA SECURITY LTD から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | Teams ユーザー ID、チーム ID、チーム名 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | Teams ユーザー ID、チーム ID、チーム名 |
...
| プライバシー ポリシーの URL | https://orca.security/privacy-policy/ |
