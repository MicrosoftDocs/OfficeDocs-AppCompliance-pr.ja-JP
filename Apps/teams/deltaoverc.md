---
title: DELTAoverC による DELTAoverC のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/30/2021
...
description: DELTAoverC で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/01b1eb1e-cb02-4a41-bb8d-6811bc514606" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003286" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

DELTAoverC から Microsoft に提供される情報:
...
| パートナー会社名 | DELTAoverC |
| 会社の Web サイト | [https://DELTAoverC.into](https://DELTAoverC.into) |
| アプリの使用条件 | [https://go.microsoft.com](https://go.microsoft.com) |
| アプリのコア機能 | DELTAoverC は、変更イニシアチブ中に内部リーダーに実用的なチーム レベルのデータを提供することで、組織の変更と変革をサポートするように設計されています。これにより、変更に対する抵抗やエンゲージメントの低い領域に効果的に対処できます。 エンゲージメントを最大化する - 中断中にチームが成功するように、リアルタイムでエンゲージメント スコアを追跡します。 リスクと労力を減らす - スタッフ レベルのデータを分析して、これらの問題が大きな課題に陥る前に、問題を予測します。 |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | [https://DELTAoverC.info/change-application](https://DELTAoverC.info/change-application) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて DELTAoverC から提供されています。
...
| 多要素認証 (MFA) が有効になっているのは次のとおりです。 | DNSManagement |
...
| プライバシー ポリシーの URL | https://DELTAoverC.info/terms |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 両方とも | すべてのグループを読み取る | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| Group.ReadWrite.All | 両方とも | すべてのグループの読み取りと書き込み | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.Read | 委任 | サインインおよびユーザー プロファイルの読み取り | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.Read.All | アプリケーション | すべてのユーザーのフル プロファイルを読み取る | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.ReadWrite | 委任 | ユーザーのプロファイルの読み取りおよび書き込みアクセス許可 | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
>| User.ReadWrite.All | 両方とも | すべてのユーザーのフル プロファイルの読み取りと書き込み | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
