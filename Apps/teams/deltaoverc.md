...
description: DELTAoverC で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/01b1eb1e-cb02-4a41-bb8d-6811bc514606" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003286" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

DELTAoverC が Microsoft に提供する情報:
...
| アプリの利用規約 | [https://go.microsoft.com](https://go.microsoft.com) |
| アプリのコア機能 | DELTAoverC は、変更イニシアチブ中に内部のリーダーにアクション可能なチーム レベルのデータを提供することで、組織の変化と変革をサポートするように設計されています。これにより、変更抵抗や低エンゲージメントの領域に効果的に対処できます。 エンゲージメントの最大化 - リアルタイムでエンゲージメント スコアを追跡し、中断中にチームが成功することを確認します。 リスクと労力の削減 - スタッフ レベルのデータを分析して、これらの問題が大きな課題に陥る前に問題を予測します。 |
| 会社の本社所在地 | カナダ |
...
この情報は、DELTAoverC によって、このアプリが組織データを収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| アプリをサポートしているすべてのシステム コンポーネントにイベント ログが設定されていますか? | 不要 |
...
>| User.ReadWrite.All | 両方とも | すべてのユーザーのフル プロファイルの読み取りおよび書き込み | [8b893db3-8c29-4983-b905-ee0b3daa6a46](../azure/8b893db3-8c29-4983-b905-ee0b3daa6a46.md) |
