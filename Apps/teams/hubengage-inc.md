---
title: HubEngage, Inc. による HubEngage のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/17/2022
...
description: HubEngage で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66549481"
---
# <a name="hubengage"></a>HubEngage

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 1 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/d96b4f99-e4b8-4af8-ba3d-36675f9a5353" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003668" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

HubEngage, Inc. から Microsoft に提供される情報:
...
| パートナー会社名 | HubEngage, Inc. |
| 会社の Web サイト | [https://www.hubengage.com](https://www.hubengage.com) |
| アプリの使用条件 | [https://www.hubengage.com/privacy-policy/](https://www.hubengage.com/privacy-policy/) |
| アプリのコア機能 | HubEngage Teams アプリを使用すると、Teams 内から組織の通信やその他の関連情報にアクセスできます。 独自の投稿を送信したり、他の投稿に対していいね、コメントを付けることもできます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、HubEngage, Inc. から提供されています。
...
| プライバシー ポリシーの URL | https://www.hubengage.com/platform-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 両方 | ユーザーを把握する | [63e17eec-6b5f-476b-a26b-54fde8bd2c83](../azure/63e17eec-6b5f-476b-a26b-54fde8bd2c83.md) |
