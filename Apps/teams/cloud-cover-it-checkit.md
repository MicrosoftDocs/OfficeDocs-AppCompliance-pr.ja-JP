---
title: クラウド カバー IT check.it アプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/21/2022
...
description: check.it、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63698867"
---
# <a name="checkit"></a>check.it

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者による最終更新日: 2021 年 9 月 30 日</p>

* <a href="https://teams.microsoft.com/l/app/b5107b74-70ca-443e-be2a-61b14ba5341d" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003604" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

クラウド カバー IT から Microsoft に提供される情報:
...
| パートナー会社名 | クラウド カバー IT |
| 会社の Web サイト | [https://www.cloudcoverit.co.uk](https://www.cloudcoverit.co.uk) |
| アプリの利用規約 | [https://www.cloudcoverit.co.uk/terms](https://www.cloudcoverit.co.uk/terms) |
| アプリのコア機能 | テンプレート化されたチェックリストを作成し、グループ、チーム、または自分自身に共有します。 |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Cloud Cover IT によって提供されています。
...
| データベースに格納されているデータは何ですか? | テナント、チャネル、および会話 ID |
...
| プライバシー ポリシーの URL | https://www.cloudcoverit.co.uk/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | Active Directory ID にアクセスする | [898cccfe-ed44-4140-ad2f-c5dd98a12820](../azure/898cccfe-ed44-4140-ad2f-c5dd98a12820.md) |
