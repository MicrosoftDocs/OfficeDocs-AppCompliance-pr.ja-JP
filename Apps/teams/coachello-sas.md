---
title: Coachello SAS による Coachello のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/29/2022
...
description: Coachello で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "67096675"
---
# <a name="coachello"></a>Coachello

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/b6b8f190-e24d-4387-937f-8683cc78a6d4" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003997" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Coachello SAS から Microsoft に提供される情報:
...
| パートナー会社名 | Coachello SAS |
| 会社の Web サイト | [https://coachello.io](https://coachello.io) |
| アプリの使用条件 | [https://www.coachello.io/terms-and-conditions](https://www.coachello.io/terms-and-conditions) |
| アプリのコア機能 | MS Teamsを通じて質の高いオンデマンド コーチングを通じて、タレントの成功を支援します。 Coachello アプリでは、評価を受け、コーチを選択し、1:1 のコーチング セッション中に一緒に作業できます。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://resources.coachello.io/teams-client-manual](https://resources.coachello.io/teams-client-manual) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Paas |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | Aws、netlify |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Coachello SAS から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー名、セッションの満足度、評価結果 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー名、セッションの満足度、評価結果 |
...
| プライバシー ポリシーの URL | https://coachello.io/privacy-policy/ |
...
| サポートされているポリシーの種類を一覧表示する | Freemium + Premium プラン |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| OnlineMeetings.ReadWrite | アプリケーション | 選択したトピックに関する任意の監督と一緒に予定表に直接会議を予約できるようにするために | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| User.Read | アプリケーション | ユーザーの言語と場所にアプリ エクスペリエンスを適応させるために  | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| メール | アプリケーション | 1:1 のコーチング セッションをコーチと共に促進するために (予約確認) | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| openid | アプリケーション | ユーザーを Coachello に安全にサインインするには | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
>| profile | アプリケーション | Coachello のアプリケーションでユーザー エクスペリエンスをカスタマイズするには | [0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016](../azure/0b1d36f2-4057-42a1-bfdd-5b7b6b3b8016.md) |
