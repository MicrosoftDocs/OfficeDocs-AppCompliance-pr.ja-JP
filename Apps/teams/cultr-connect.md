---
title: Connect by 升卉升のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Connect、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべてのセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/3b1655d0-505a-4b03-a01f-519a91f77625" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003008" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Microsoft に対して、以下の情報を提供します。
...
| パートナー会社名 | Cultr |
| 会社の Web サイト | [https://cultr.works](https://cultr.works) |
| アプリの使用条件 | [https://cultr.works/terms-of-use/](https://cultr.works/terms-of-use/) |
| アプリのコア機能 | 同僚が「卉卉」で何をしているか確認する |
| 会社の本社の場所 | ルクセンブルク |
| アプリ情報ページ | [https://cultr.works/how-it-works/](https://cultr.works/how-it-works/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Intellir から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | アプリケーション | ユーザー情報を更新し、関連するデータを送信するユーザーを特定します。 | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| GroupMember.Read.All | アプリケーション | ユーザー情報を更新し、関連するデータを送信するユーザーを特定します。 | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| Organization.Read.All | アプリケーション | ユーザー情報を更新し、関連するデータを送信するユーザーを特定します。 | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| TeamMember.Read.All | アプリケーション | ユーザー情報を更新し、関連するデータを送信するユーザーを特定します。 | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| User.Read | アプリケーション | ユーザー情報を更新し、関連するデータを送信するユーザーを特定します。 | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| User.Read.All | アプリケーション | ユーザー情報を更新し、関連するデータを送信するユーザーを特定します。 | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| User.ReadBasic.All | アプリケーション | 関連するデータを送信するユーザーを特定します。 | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
>| openid | アプリケーション | ユーザー情報を更新し、関連するデータを送信するユーザーを特定します。 | [3b1655d0-505a-4b03-a01f-519a91f77625](../azure/3b1655d0-505a-4b03-a01f-519a91f77625.md) |
