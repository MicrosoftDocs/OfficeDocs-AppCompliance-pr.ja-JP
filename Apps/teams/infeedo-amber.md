---
title: InFeedo によるアンバーのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/10/2021
...
description: アンバーで使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/a4d418db-2e4a-4fe7-978c-5f28e85d6307" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003432" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

inFeedo から Microsoft に提供される情報:
...
| パートナー会社名 | inFeedo |
| 会社の Web サイト | [https://infeedo.com](https://infeedo.com) |
| アプリの利用規約 | [https://infeedo.com/terms-and-conditions](https://infeedo.com/terms-and-conditions) |
| アプリのコア機能 | 従業員エクスペリエンス プラットフォーム |
| 会社の本社所在地 | インド |
| アプリ情報ページ | [https://help.infeedo.com/docs](https://help.infeedo.com/docs) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて inFeedo によって提供されています。
...
| プライバシー ポリシーの URL | https://infeedo.com/privacy-policy |
