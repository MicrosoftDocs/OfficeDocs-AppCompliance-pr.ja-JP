---
title: Clixie Media LLC による Clixie のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: Clixie、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "64463928"
---
# <a name="clixie"></a>Clixie

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者による最終更新日: 2022 年 3 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/3ff43e1b-180b-4aab-916e-e49aaaefbccb" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003880" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Clixie Media LLC から Microsoft に提供される情報:
...
| パートナー会社名 | Clixie Media LLC |
| 会社の Web サイト | [https://clixiemedia.com](https://clixiemedia.com) |
| アプリの利用規約 | [https://clixiemedia.com/terms-and-conditions/](https://clixiemedia.com/terms-and-conditions/) |
| アプリのコア機能 | Clixie は、ライブまたはハイブリッド会議セッションの記録を受け取り、それらを便利で魅力的で思い出深いオンデマンドトレーニング モジュールに変え、Clixie はリアルタイムで自動的に更新します。認定とデータを一目で確認し、実際に意思決定を行う場合に使用できます。 マイクロラーニング、ロックによるチャプター、ビデオ内評価/ポーリング、アダプティブ学習、ゲーミフィケーションは、エンゲージメントを促進するために設計された強力な機能のほんの一部です。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://clixiemedia.com](https://clixiemedia.com) |
...
この情報は、Clixie Media LLC によって、このアプリが組織データを収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| プライバシー ポリシーの URL | https://clixiemedia.com/privacy-policy/ |
