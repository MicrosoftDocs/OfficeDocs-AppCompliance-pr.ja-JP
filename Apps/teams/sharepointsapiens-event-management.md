...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | 委任 | [電子メール アドレス] と [Exchangeとリソースの名前] を使用して、会議室とリソースの予約を有効にする | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |
