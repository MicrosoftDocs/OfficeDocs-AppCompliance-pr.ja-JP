...
| アプリの利用規約 | [https://presentations.ai/terms_teams.html](https://presentations.ai/terms_teams.html) |
| アプリのコア機能 | Presentations.AI は、すばらしいプレゼンテーションを作成するためのベスト デザイン プラクティスを備え、スマート ツールです。 |
| 会社の本社所在地 | インド |
| アプリ情報ページ | |
