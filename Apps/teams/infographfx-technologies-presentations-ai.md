---
title: Infographfx テクノロジによる Presentations AI のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/28/2021
...
description: Presentations AI で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/1f510555-b518-4084-84e0-18c7bebc807c" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001352" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Infographfx テクノロジから Microsoft に提供される情報:
...
| 会社の Web サイト | [https://presentations.ai](https://presentations.ai) |
| アプリの使用条件 | [https://presentations.ai/terms_teams.html](https://presentations.ai/terms_teams.html) |
| アプリのコア機能 | Presentations.AI は、優れたプレゼンテーションを作成するためのベスト デザイン プラクティスを備えたスマート ツールです。 |
| 会社の本社の場所 | インド |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Infographfx テクノロジによって提供されています。
...
| アカウントの終了後、データはどのくらいの期間保持されますか? | 3months 内で削除済み |
