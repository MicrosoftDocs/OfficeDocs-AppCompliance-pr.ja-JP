---
title: Creately による Creately のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Creately で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66656222"
---
# <a name="creately"></a>Creately

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/dddf988d-00af-480f-b419-76a357a72460" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004335" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Creately から Microsoft に提供される情報:
...
| パートナー会社名 | Creately |
| 会社の Web サイト | [https://creately.com](https://creately.com) |
| アプリの使用条件 | [https://creately.com/tos](https://creately.com/tos) |
| アプリのコア機能 | Creately を使用すると、これまでにないビジュアル コラボレーションを体験できます。 次に、Microsoft Teams を離れることなく、すべての作業を計画、分析、実行します。 Creately は、アイデアを整理し、ソリューションをブレーンストーミングし、プロセスを設計し、リアルタイムでチームメイトと共同作業するための自由形式の無限のビジュアル キャンバスを提供します。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Creately によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザーの電子メール、ユーザーの完全な名前 |
...
| プライバシー ポリシーの URL | https://creately.com/privacy/ |
