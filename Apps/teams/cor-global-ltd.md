---
title: COR Global Ltd による COR のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/16/2022
...
description: COR で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2021 年 9 月 6 日</p>

* <a href="https://teams.microsoft.com/l/app/1ff72075-1e25-4b42-bd88-3fdbc9d6d34e" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004235" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

COR Global Ltd. から Microsoft に提供される情報:
...
| パートナー会社名 | COR Global Ltd. |
| 会社の Web サイト | [https://projectcor.com](https://projectcor.com) |
| アプリの使用条件 | [https://projectcor.com/cor-terms-of-service/](https://projectcor.com/cor-terms-of-service/) |
| アプリのコア機能 | リアルタイムの可視性。 COR は、人工知能を使用してプロジェクト、チーム、財務を管理する方法をスマートに提案するプロフェッショナルとクリエイティブ チームを対象とした管理ソリューションです。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://cor.zendesk.com/hc/en-us](https://cor.zendesk.com/hc/en-us) |
...
この情報は COR Global Ltd によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
...
| プライバシー ポリシーの URL | https://projectcor.com/cor-privacy-and-personal-data/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.Read.All | アプリケーション | One Drive との統合 | [e73458d3-c732-4460-bfb2-9da9086fc714](../azure/e73458d3-c732-4460-bfb2-9da9086fc714.md) |
