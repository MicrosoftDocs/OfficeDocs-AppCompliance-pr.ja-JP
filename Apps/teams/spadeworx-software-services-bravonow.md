---
title: SpadeWorx Software Services による BravoNow のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: BravoNow で使用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/272032ad-0c2e-4928-910e-5d52b19f70d5" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200000157" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

SpadeWorx Software Services から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://www.spadeworx.com](https://www.spadeworx.com) |
| アプリの使用条件 | [https://docs.pozitive.io/BRAVO_TermsOfService.pdf](https://docs.pozitive.io/BRAVO_TermsOfService.pdf) |
| アプリのコア機能 | Bravo はピアツーピアの従業員認識プラットフォームです。 |
| 会社の本社の場所 | インド |
| アプリ情報ページ | [https://bravo.pozitive.io](https://bravo.pozitive.io) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する SpadeWorx Software Services によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザーの電子メール アドレス。 | [272032ad-0c2e-4928-910e-5d52b19f70d5](../azure/272032ad-0c2e-4928-910e-5d52b19f70d5.md) |
