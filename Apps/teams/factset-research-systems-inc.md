...
| アプリの利用規約 | [https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%...](https://www.factset.com/hubfs/Misc/FactSet%20Teams%20Terms%20of%20Use.pdf) |
| アプリのコア機能 | FactSet for Microsoft Teamsでは、グローバル 市場に影響を与える主要なストーリーのトップに立て続けできるよう、StreetAccount から詳細なニュースサマリーを受け取る必要があります。 FactSet&#8217;業界をリードするコンテンツに対して詳細な会社情報を照会し、同僚やグループと共有することで、アプリケーションを切り替えることなく簡単なコラボレーションを実現できます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | アプリケーション | 検証とログ記録用の名前と電子メール、プロアクティブ メッセージ送信用の会話 ID | [95fb5da0-6ced-4247-9d62-294f8fcb75df](https://docs.microsoft.com/microsoft-365-app-certification/azure/95fb5da0-6ced-4247-9d62-294f8fcb75df) |
