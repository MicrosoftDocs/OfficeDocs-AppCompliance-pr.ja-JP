---
title: Happyforce by Happyforce による Hero のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/26/2022
...
description: Hero by Happyforce で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "65749441"
---
# <a name="hero-by-happyforce"></a>Happyforce によるヒーロー

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 24 日</p>

* <a href="https://teams.microsoft.com/l/app/de22bf49-b60e-44e7-a583-050a6e1918b5" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002078" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Happyforce から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Happyforce によるヒーロー |
| ID | WA200002078 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | Happyforce |
| 会社の Web サイト | [https://www.myhappyforce.com](https://www.myhappyforce.com) |
| アプリの使用条件 | [https://www.myhappyforce.com/en/terms-conditions](https://www.myhappyforce.com/en/terms-conditions) |
| アプリのコア機能 | フィードバックを通じて組織を変革することで、ユーザーの声に耳を傾け、人々を成功に導きます。 |
| 会社の本社の場所 | スペイン |
| アプリ情報ページ | [https://www.myhappyforce.com](https://www.myhappyforce.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Happyforce によって提供されています。
...
| プライバシー ポリシーの URL | https://myhappyforce.com/es/politica-de-privacidad/ |
