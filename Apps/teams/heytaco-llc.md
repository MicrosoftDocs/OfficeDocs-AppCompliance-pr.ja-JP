---
title: HeyTaco,LLC による HeyTaco のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 01/11/2022
ms.topic: article
...
description: HeyTaco のすべての利用可能なセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
HeyTaco、 LLC から Microsoft に提供される情報:
...
| パートナー会社名 | HeyTaco, LLC |
| 会社の Web サイト | [https://www.heytaco.chat](https://www.heytaco.chat) |
| アプリの利用規約 | [https://www.heytaco.chat/terms](https://www.heytaco.chat/terms) |
| アプリのコア機能 | HeyTaco! 肯定的なコミュニケーションを刺激し、認識、感謝、報酬を通じて人々を結び付け、より強い企業文化を構築するのに役立ちます。 毎日、各ユーザーは他のチーム メンバーに 5 つのタコスを与える必要があります。 タコスは感謝の気持ちを示し、小さな勝利から大きな成果まですべてを認識するために与えられる。 その後、ユーザーは発生したタコスを使用して、作成したエキサイティングな個人またはチームベースのリワードを引き換えできます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する HeyTaco LLC によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | 不要 |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データが格納されていますか? | はい |
| データベースに格納されているデータは何ですか? | 名前、メール、アバター |
...
| プライバシー ポリシーの URL | https://www.heytaco.chat/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| メール | 委任 | ユーザー データを整理する場合 | [be8d11cf-265a-4974-9912-4ff28c29fc21](https://docs.microsoft.com/microsoft-365-app-certification/azure/be8d11cf-265a-4974-9912-4ff28c29fc21) |
>| openid | 委任 | ユーザーがタブにサインインを許可する | [be8d11cf-265a-4974-9912-4ff28c29fc21](https://docs.microsoft.com/microsoft-365-app-certification/azure/be8d11cf-265a-4974-9912-4ff28c29fc21) |
>| profile | 委任 | ユーザーのプロファイル情報を保存するには | [be8d11cf-265a-4974-9912-4ff28c29fc21](https://docs.microsoft.com/microsoft-365-app-certification/azure/be8d11cf-265a-4974-9912-4ff28c29fc21) |
