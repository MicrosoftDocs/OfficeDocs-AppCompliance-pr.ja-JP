...
| アプリの利用規約 | [https://www.postbeyond.com/terms-of-use/](https://www.postbeyond.com/terms-of-use/) |
| アプリのコア機能 | PostBeyond を利用した従業員の支援により、ソーシャルメディアの支持者をアクティブ化して、ブランドの可視性、エンゲージメント、測定可能な結果を高める。 従業員のソーシャル ネットワーク全体で最高のコンテンツを増幅し、ブランドにそれに値する注目を与える。 スケーリングする従業員のアドボカシーは、マーケティング担当者に強力で、従業員が楽しく簡単に行います。  |
| 会社の本社所在地 | カナダ |
