...
description: Mediatheque+ で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/d546d064-6146-4341-b997-3a83855cafb3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003099" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | CEMEQ inc. |
| 会社の Web サイト | [https://www.cemeq.qc.ca](https://www.cemeq.qc.ca) |
| アプリの使用条件 | [https://www.cemeq.qc.ca/data/themes/cemeq/viewerJS/Conditio...](https://www.cemeq.qc.ca/data/themes/cemeq/viewerJS/ConditionsUtilisationMEDPLUS.pdf) |
| アプリのコア機能 | Acc&#233;dez au mat&#233;riel p&#233;dagogique du CEMEQ |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | |
...
この情報は CEMEQ inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について説明しています。
