...
* <a href="https://teams.microsoft.com/l/app/8cd35615-e306-4b3d-8e93-17520129b60a" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003160" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://projectmigrator.com](https://projectmigrator.com) |
| アプリの使用条件 | [https://projectmigrator.com/terms-of-use](https://projectmigrator.com/terms-of-use) |
| アプリのコア機能 | Project Migrationor は自動データ移行ソフトウェアです。 Microsoft Planner、Trello、Asana、Microsoft Project Online、Web、Monday.com、Smartsheets 移行のProjectなど、最も一般的なプロジェクト管理システムを使用して、複数の移行シナリオをサポートしています。 Project Migrateor は、企業が最も一般的なプロジェクト管理ツール間でプロジェクトを移行するのに役立つ、完全に自動化され、使いやすく、クラウドベースで、超高速のソフトウェアです。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://help.fluentpro.com/147404-project-migrator](https://help.fluentpro.com/147404-project-migrator) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | 他のテナントに移行するために、グループとそのメンバーシップを読み取る。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| Group.ReadWrite.All | 委任 | グループ名、メンバー、プラン、タスク。 Planner データの移行には、グループ、プラン、タスクの情報を使用します。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| Sites.ReadWrite.All | 委任 | MS Planner タスクの添付ファイルのSharePointドキュメントを移行します。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.Read | 委任 | アカウントにリンクされた MS Planner 移行の概要情報を格納する UPN。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.ReadBasic.All | 委任 | ユーザー情報を使用して、MS Planner タスクの割り当てとグループ メンバーシップを移行します。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| offline_access | 委任 | 更新トークンとアクセス トークンは、MS Planner データにアクセスするために使用されます。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](../azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa.md) |
>| User.Read | 委任 | 名、姓、会社名、電話、会社の電子メール。 登録プロセスと認証プロセスに使用されるこのデータ。 | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](../azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04.md) |
