...
| アプリの利用規約 | [https://projectmigrator.com/terms-of-use](https://projectmigrator.com/terms-of-use) |
| アプリのコア機能 | Projectは、自動データ移行ソフトウェアです。 Microsoft Planner、Trello、Asana、Microsoft Project Online、Project for Web、Monday.com、Smartsheets の移行など、最も一般的なプロジェクト管理システムで複数の移行シナリオをサポートします。 Project移行ツールは、企業が最も一般的なプロジェクト管理ツール間でプロジェクトを移行するのに役立つ、完全に自動化された、使いやすい、クラウドベースの、および雷の速いソフトウェアです。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | 他のテナントに移行するために、グループとそのメンバーシップを読み取る。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](https://docs.microsoft.com/microsoft-365-app-certification/azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa) |
>| Group.ReadWrite.All | 委任 | グループ名、メンバー、プラン、タスク。 Planner データ移行には、グループ、計画、タスクの情報を使用します。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](https://docs.microsoft.com/microsoft-365-app-certification/azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa) |
>| Sites.ReadWrite.All | 委任 | MS Planner タスクSharePointドキュメントを移行します。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](https://docs.microsoft.com/microsoft-365-app-certification/azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa) |
>| User.Read | 委任 | アカウントにリンクされた MS Planner 移行の概要情報を格納する UPN。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](https://docs.microsoft.com/microsoft-365-app-certification/azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa) |
>| User.ReadBasic.All | 委任 | ユーザー情報を使用して、MS Planner タスクの割り当てとグループ メンバーシップを移行します。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](https://docs.microsoft.com/microsoft-365-app-certification/azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa) |
>| offline_access | 委任 | 更新トークンとアクセス トークンは、MS Planner データにアクセスするために使用されます。 | [77b31e8c-65d0-484d-a72f-9404ec9dfcfa](https://docs.microsoft.com/microsoft-365-app-certification/azure/77b31e8c-65d0-484d-a72f-9404ec9dfcfa) |
>| User.Read | 委任 | 名、名、会社名、電話メール。 登録および認証プロセスに使用されるこのデータ。 | [c36d31a2-8de1-4eb5-9e7d-01da45244c04](https://docs.microsoft.com/microsoft-365-app-certification/azure/c36d31a2-8de1-4eb5-9e7d-01da45244c04) |
