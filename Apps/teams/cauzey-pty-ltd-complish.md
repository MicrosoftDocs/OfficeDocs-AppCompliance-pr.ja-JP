...
description: Complish、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/e840a6b7-6a38-4404-baa5-e404eb0c98b3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001641" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.complish.app](https://www.complish.app) |
| アプリの使用条件 | [https://www.complish.app/privacy-and-terms](https://www.complish.app/privacy-and-terms) |
| アプリのコア機能 | Complish を使用すると、作業を目に見えるようにし、目標に接続し、集中したディスカッションを促進することで、優れたリモートの習慣を簡単に構築できます。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://www.complish.app](https://www.complish.app) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Cauzey Pty Ltd から提供されています。
