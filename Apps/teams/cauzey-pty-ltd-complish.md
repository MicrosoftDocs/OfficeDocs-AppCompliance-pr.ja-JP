...
description: CSA STAR レジストリの Complish、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、およびセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.complish.app/privacy-and-terms](https://www.complish.app/privacy-and-terms) |
| アプリのコア機能 | Complish を使用すると、作業を見やすくし、目的に関連付け、集中したディスカッションを促進することで、リモートの習慣を簡単に構築できます。 |
| 会社の本社所在地 | オーストラリア |
