---
title: Skedda Pty Ltd による Skedda のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/11/2022
...
description: Skedda で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2022 年 5 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/6a3ea4b3-7e59-44b7-b668-ec5264c03fc8" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004065" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Skedda Pty Ltd から Microsoft に提供される情報:
...
| パートナー会社名 | Skedda Pty Ltd |
| 会社の Web サイト | [https://www.skedda.com](https://www.skedda.com) |
| アプリの使用条件 | [https://support.skedda.com/en/articles/663213-terms-and-con...](https://support.skedda.com/en/articles/663213-terms-and-conditions-for-venues) |
| アプリのコア機能 | Skedda は、オフィスのデスクと部屋のエレガントなスケジューリング プラットフォームです。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://support.skedda.com/en/articles/6165941-microsoft-te...](https://support.skedda.com/en/articles/6165941-microsoft-teams-app) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Skedda Pty Ltd から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、予約データ |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ、予約データ |
...
| プライバシー ポリシーの URL | https://support.skedda.com/en/articles/663173-privacy-policy-for-venue-users |
...
| サポートされているポリシーの種類を一覧表示する | デバイス プラットフォーム、場所、クライアント アプリ、デバイスのフィルター |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | アプリケーション | Skedda は予約プラットフォームであり、Microsoft 365カレンダーと統合してイベントを同期できます。https://support.skedda.com/en/articles/6125677-direct-integration-with-microsoft-365-and-google-workspace | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
>| Contacts.Read | アプリケーション | Skedda の予約に出席者を追加すると、ユーザーは追加する連絡先の一覧を検索できます。 | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
>| Mail.Read | アプリケーション | で説明されているように、イベント RSVP 通知の転送に使用されます。 https://support.skedda.com/en/articles/6125677-direct-integration-with-microsoft-365-and-google-workspace | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
>| Mail.Send | アプリケーション | で説明されているように、イベント RSVP 通知の転送に使用されます。 https://support.skedda.com/en/articles/6125677-direct-integration-with-microsoft-365-and-google-workspace | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
>| People.Read.All | アプリケーション | Skedda の予約に出席者を追加すると、ユーザーは追加する連絡先とディレクトリのユーザーのリストを検索できます。 | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
>| User.Read.All | アプリケーション | Skedda の予約に出席者を追加すると、ユーザーは追加する連絡先とディレクトリのユーザーのリストを検索できます。 | [0f198a3c-ad80-44d5-af34-61cfd28e022e](../azure/0f198a3c-ad80-44d5-af34-61cfd28e022e.md) |
