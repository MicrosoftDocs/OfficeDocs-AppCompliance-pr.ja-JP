---
title: Contextere AVA by Contextere のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Contextere AVA で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64877734"
---
# <a name="contextere-ava"></a>Contextere AVA

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 8 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/be5caee0-f2bc-11ea-b597-ef970e2f5141" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003167" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Contextere から Microsoft に提供される情報:
...
| アプリの使用条件 | [https://contextere.com/wp-primary/wp-content/uploads/Contex...](https://contextere.com/wp-primary/wp-content/uploads/Contextere-End-User-License-Agreement-Microsoft-Challenge.pdf) |
| アプリのコア機能 | Contextere Advanced Virtual Assistant (AVA) は、産業ワーカーに対してオン-the-job 分析情報を提供します。 |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Contextere によって提供されています。
