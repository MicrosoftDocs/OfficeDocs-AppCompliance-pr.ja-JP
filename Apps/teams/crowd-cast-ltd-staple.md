...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Organization.Read.All | アプリケーション | テナント ID の収集に使用されます。ユーザーがプラットフォームで認証を行うユーザーが特定のテナントのメンバーである必要がある場合に使用します。 | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | アプリケーション | Teamsユーザーのチームに自己インストールする | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| AppCatalog.Read.All | 委任 | ユーザーのアプリ カタログを読み取り、Teams アプリがインストールされているのを確認します。 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| User.Read | 委任 | 正しいユーザーにメッセージが送信されていることを確認するために、ユーザーの ID を読み取る場合に使用します。 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
