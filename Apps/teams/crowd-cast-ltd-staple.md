---
title: ステープルズ by クラウド キャスト (Ltd) のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/27/2021
...
description: Staple で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/ac9ca94a-e666-4f61-959a-12c063e13e69" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003281" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

クラウド キャスト社から Microsoft に提供される情報:
...
| アプリのコア機能 | リアルタイムの経費管理を使用して、作業スタイルを変更します。 ステープルズを使用すると、会社の経費の提出、承認、追跡を簡単に行うことができます。 Microsoft サービスとリンクして、製品と簡単にやり取りできます。 |
| 会社の本社の場所 | 日本 |
| アプリ情報ページ | [https://intercom.help/staple/ja](https://intercom.help/staple/ja) |
...
この情報は、クラウド キャスト社から提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Organization.Read.All | アプリケーション | テナント ID の収集に使用されます。プラットフォームで認証するユーザーが特定のテナントのメンバーであることを確認するために使用されます。 | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | アプリケーション | Teams アプリがユーザーのチームに自己インストールする | [ac9ca94a-e666-4f61-959a-12c063e13e69](../azure/ac9ca94a-e666-4f61-959a-12c063e13e69.md) |
>| AppCatalog.Read.All | 委任 | ユーザーのアプリ カタログを読み取り、Teams アプリがインストールされているかどうかを確認します。 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| User.Read | 委任 | ユーザーの ID を読み取って、メッセージが正しいユーザーに送信されるようにするために使用します。 | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
>| openid | 委任 | ユーザーにサインインして、基本的なプロファイル情報を読み取る | [bbdcd676-7448-453c-bec7-70e5384bc290](../azure/bbdcd676-7448-453c-bec7-70e5384bc290.md) |
