...
| 会社の Web サイト | [https://crowdcast.jp/ja/](https://crowdcast.jp/ja/) |
| アプリの利用規約 | [https://go.microsoft.com](https://go.microsoft.com) |
| アプリのコア機能 | リアルタイムの経費管理で作業スタイルを変更します。 ステープルを使用すると、会社の経費申請、承認、追跡を簡単に行います。 製品とMicrosoft サービスリンクして、製品と簡単にやり取りできます。 |
| 会社の本社所在地 | 日本 |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Organization.Read.All | アプリケーション | テナント ID の収集に使用されます。ユーザーがプラットフォームで認証を行うユーザーが特定のテナントのメンバーである必要がある場合に使用します。 | [ac9ca94a-e666-4f61-959a-12c063e13e69](https://docs.microsoft.com/microsoft-365-app-certification/azure/ac9ca94a-e666-4f61-959a-12c063e13e69) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | アプリケーション | Teamsのチームに自己をインストールする | [ac9ca94a-e666-4f61-959a-12c063e13e69](https://docs.microsoft.com/microsoft-365-app-certification/azure/ac9ca94a-e666-4f61-959a-12c063e13e69) |
>| AppCatalog.Read.All | 委任 | ユーザーのアプリ カタログを読み取り、Teams アプリがインストールされているのを確認します。 | [bbdcd676-7448-453c-bec7-70e5384bc290](https://docs.microsoft.com/microsoft-365-app-certification/azure/bbdcd676-7448-453c-bec7-70e5384bc290) |
>| User.Read | 委任 | 正しいユーザーにメッセージが送信されていることを確認するために、ユーザーの ID を読み取る場合に使用します。 | [bbdcd676-7448-453c-bec7-70e5384bc290](https://docs.microsoft.com/microsoft-365-app-certification/azure/bbdcd676-7448-453c-bec7-70e5384bc290) |
>| openid | 委任 | ユーザーにサインインして、基本的なプロファイル情報を読み取る | [bbdcd676-7448-453c-bec7-70e5384bc290](https://docs.microsoft.com/microsoft-365-app-certification/azure/bbdcd676-7448-453c-bec7-70e5384bc290) |
