---
title: Read AI, Inc. による会議ナビゲーターの読み取りのためのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/15/2022
...
description: 会議ナビゲーターの読み取り、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "65357118"
---
# <a name="read-meeting-navigator"></a>会議ナビゲーターの読み取り

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 4 月 15 日</p>

* <a href="https://teams.microsoft.com/l/app/18eb20ae-cd59-48c6-8060-fbe171a917e5" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003896" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Read AI, Inc. から Microsoft に提供される情報:
...
| パートナー会社名 | Read AI, Inc. |
| 会社の Web サイト | [https://read.ai](https://read.ai) |
| アプリの使用条件 | [https://read.ai/tos](https://read.ai/tos) |
| アプリのコア機能 | ダッシュボードメジャー会議のセンチメント、エンゲージメント、および全体的なパフォーマンスに関する記事を参照してください。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.read.ai/product](https://www.read.ai/product) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Read AI, Inc. から提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、会議オーディオ データ、会議ビデオ データ  |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ、オーディオ データとビデオ データから派生したユーザー メトリックの集計 |
...
| プライバシー ポリシーの URL | https://read.ai/privacy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委任 | ユーザーが自分の予定表をサービスにリンクして、Azure メディア ボットの自動ディスパッチを有効にすることを許可します | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.AccessMedia.All | アプリケーション | 会議の音声データとビデオ データにアクセスしてアプリケーション処理を行う | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| Calls.JoinGroupCall.All | アプリケーション | 進行中のTeams会議に参加するには、Azure メディア ボットの参加アクセス許可が必要です | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| User.Read | 委任 | SSO プロセスの一環として、ユーザー プロファイルに読み取りアクセス許可を要求することで、必要なユーザー データにアクセスします。 | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| メール | 委任 | アカウント作成プロセスの一環として電子メール アドレスが必要です  | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| openid | 委任 | ユーザーが SSO 経由でサインインできるようにする | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
>| profile | 委任 | ユーザー アカウント (名と姓、具体的には) を作成するには、ユーザー プロファイル データが必要です。 | [35e7f5d2-9978-464f-8710-c7a05d5b9fdf](../azure/35e7f5d2-9978-464f-8710-c7a05d5b9fdf.md) |
