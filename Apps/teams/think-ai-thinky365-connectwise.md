---
title: Think AI によるThinky365-ConnectWiseのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/27/2022
...
description: Thinky365-ConnectWise で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/1191b3d5-ea1d-4605-9a94-ac4523b85c06" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004299" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Think AI から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | Thinky365-ConnectWise |
| ID | WA200004299 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | AI について考える |
| 会社の Web サイト | [https://www.thinky365.com](https://www.thinky365.com) |
| アプリの使用条件 | [https://thinky365.com/terms-of-use/](https://thinky365.com/terms-of-use/) |
| アプリのコア機能 | 全体的なカスタマー エクスペリエンスを向上しながら、新しい革新的な方法で顧客と関わる |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Think AI によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | 不要 |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | Microsoft Graph、CRM、Azure などのサービスのエンドポイント |
...
| サポートされているポリシーの種類を一覧表示する | カスタム ポリシー |
