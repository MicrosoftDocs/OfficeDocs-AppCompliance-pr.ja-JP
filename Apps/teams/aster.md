...
description: Aster で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64877814"
---
# <a name="aster"></a>Aster

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 9 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/2d8e8042-66df-4605-8c3a-9ca8962f3e99" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002379" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Aster |
| 会社の Web サイト | [https://asterapp.co](https://asterapp.co) |
| アプリの使用条件 | [https://asterapp.co/conditions-generales/](https://asterapp.co/conditions-generales/) |
| アプリのコア機能 | 会議の議事録を使用すると、時間を節約できます。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://asterapp.co/solution/](https://asterapp.co/solution/) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | Azure、OVH Cloud (フランス) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Aster から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | Sharepoint ドキュメントの Planner タスクを送信するためのディレクトリの一覧 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Group.ReadWrite.All | 委任 | 既存または作成されたグループで Sharepoint ドキュメントの Planner タスクを送信するためのグループの一覧 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Notes.ReadWrite.All | 委任 | OneNoteで書き込むためのメモの内容 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| Tasks.ReadWrite.Shared | 委任 | タスク、割り当て、期限 | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| User.Read | 委任 | ユーザーを識別するためのユーザー電子メール | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
>| offline_access | 委任 | トークンを一見更新するだけで、データは収集されません | [27c89ce8-b449-4959-b801-988d8b727512](../azure/27c89ce8-b449-4959-b801-988d8b727512.md) |
