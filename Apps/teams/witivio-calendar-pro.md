---
title: Witivio による予定表Proのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/03/2021
...
description: 予定表Pro、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/19a29a41-cbca-4152-a2af-dd9728ea35f1" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002152" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Witivio から Microsoft に提供される情報:
...
| アプリの使用条件 | [https://www.teams-pro.com/en/terms-of-use/](https://www.teams-pro.com/en/terms-of-use/) |
| アプリのコア機能 | 予定表Proは、Microsoft Teamsの共同作業用の予定表です。 チャネルまたはチャットに予定表Proを追加して、そのメンバーと共有予定表を作成します。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Witivio によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | データが使用されます | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
>| User.ReadBasic.All | 委任 | データが使用されます | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
>| メール | 委任 | 電子メールが使用されます | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
>| offline_access | 委任 | データが使用されます | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
>| openid | 委任 | 認証 | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
>| profile | 委任 | データが使用されます | [fb507a6d-2eaa-4f1f-b43a-140f388c4445](../azure/fb507a6d-2eaa-4f1f-b43a-140f388c4445.md) |
