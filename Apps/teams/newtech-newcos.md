...
| アプリの利用規約 | [https://newtech.com.ar/termsofservice](https://newtech.com.ar/termsofservice) |
| アプリのコア機能 | インテリジェントな通信ソリューションを迅速、簡単、かつサービス モードで展開します。 NewCOS プラットフォームを使用すると、IT の介入なしに、インストールの実行、管理、監視、サポートを迅速かつ簡単に行うことができます。  テクノロジの採用プロセスが成功した場合に、お客様と一緒に行きます。 今日の共同作業ワークスペースの変更の適応を容易にしています。 この機能を導入Microsoft 365、組織内のデジタル変換プロセスを加速できます。  |
| 会社の本社所在地 | アルゼンチン |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| profile | 両方とも | このデータは、アプリのアクセス許可の認証に使用されます。 | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](https://docs.microsoft.com/microsoft-365-app-certification/azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e) |
>| openid | 両方とも | Microsoft Teams、レポートとガバナンス | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](https://docs.microsoft.com/microsoft-365-app-certification/azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200) |
