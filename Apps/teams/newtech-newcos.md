---
title: NewCOS by Newtech のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/27/2022
...
description: NewCOS で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "67053099"
---
# <a name="newcos"></a>NewCOS

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 7 月 26 日</p>

* <a href="https://teams.microsoft.com/l/app/205214d0-e04b-11e9-9332-5b5c97b60069" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001104" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Newtech から Microsoft に提供される情報:
...
| パートナー会社名 | Newtech |
| 会社の Web サイト | [https://newtech.com.ar](https://newtech.com.ar) |
| アプリの使用条件 | [https://newtech.com.ar/termsofservice](https://newtech.com.ar/termsofservice) |
| アプリのコア機能 | インテリジェントな通信ソリューションを迅速かつ簡単に、サービス モードでデプロイします。 NewCOS プラットフォームを使用すると、IT の介入なしに、インストールをすばやく簡単に実行、管理、監視、サポートできます。  テクノロジを採用するプロセスが成功するように、Microsoft は皆様と共に取り組みます。 今日のコラボレーション ワークスペースの変更の適応を容易にします。 Microsoft 365 の導入により、組織内のデジタル変革のプロセスを加速させることができます。  |
| 会社の本社の場所 | アルゼンチン |
| アプリ情報ページ | [https://newtech.com.ar/newcosnt/](https://newtech.com.ar/newcosnt/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Newtech から提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、通話レコード |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ、通話レコード |
| 基になるインファ構造が Microsoft 顧客データを処理または格納する場合、このデータは地理的にどこに保存されますか? | ブラジル |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | サインインおよびユーザー プロファイルの読み取り | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| offline_access | 委任 | アクセス許可を付与したデータへのアクセスの維持 | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | 委任 | ユーザーのサインイン | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| profile | 委任 | ユーザーの基本プロファイルの表示 | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
