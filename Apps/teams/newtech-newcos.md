...
| アプリのコア機能 | インテリジェントな通信ソリューションを迅速かつ簡単に、サービス モードでデプロイします。 NewCOS プラットフォームを使用すると、IT の介入なしに、インストールをすばやく簡単に実行、管理、監視、サポートできます。  テクノロジを採用するプロセスが成功するように、Microsoft は皆様と共に取り組みます。 今日のコラボレーション ワークスペースの変更の適応を容易にします。 Microsoft 365を導入することで、組織内のデジタル変革のプロセスを加速させることができます。  |
| 会社の本社の場所 | アルゼンチン |
| アプリ情報ページ | [https://N.A](https://N.A) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| profile | 両方とも | このデータは、アプリのアクセス許可に対する認証に使用されます | [07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e](../azure/07d4a8e0-3d1d-4f70-bdc2-f46593d7fa0e.md) |
>| openid | 両方とも | 使用状況をMicrosoft Teamsし、レポートとガバナンスを行う | [ea4de024-dd5f-4d3e-a092-3b8de6c64200](../azure/ea4de024-dd5f-4d3e-a092-3b8de6c64200.md) |
