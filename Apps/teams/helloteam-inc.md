---
title: HelloTeam Inc. による HelloTeam のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 11/10/2021
ms.topic: article
...
description: HelloTeam のすべての利用可能なセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/58426e2f-12cd-4b86-bae3-37feb09bf146" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003448" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.helloteam.com/index.php/terms-and-conditions/](https://www.helloteam.com/index.php/terms-and-conditions/) |
| アプリのコア機能 | モダン ワークフォース向け一人一人の成功プラットフォーム |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、HelloTeam Inc. から、このアプリが組織データを収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールについて提供されています。
