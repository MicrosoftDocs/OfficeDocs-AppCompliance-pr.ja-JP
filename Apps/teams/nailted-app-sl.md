---
title: NAILTED APP S.L. による Nailted のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/21/2021
...
description: Nailted で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003375" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

NAILTED APP S.L によって提供される情報。 Microsoft に対して:
...
| パートナー会社名 | NAILTED APP S.L. |
| 会社の Web サイト | [https://nailted.com](https://nailted.com) |
| アプリの使用条件 | [https://nailted.com/legal/terms](https://nailted.com/legal/terms) |
| アプリのコア機能 | 現代の People &amp; 人事チーム向けの従業員エンゲージメント プラットフォーム。 |
| 会社の本社の場所 | スペイン |
| アプリ情報ページ | |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Paas |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | Heroku |
...
この情報は、NAILTED APP S.L によって提供されています。 このアプリが組織のデータを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明します。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | tenantId と電子メール |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | tenantId と電子メール |
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | Microsoft 認証ライブラリの最新バージョンを使用しています |
...
>| TeamsAppInstallation.ReadWriteForUser | アプリケーション | ユーザーは、アプリをインストールするユーザーを選択できます。 そのため、このアクセス許可を使用してアプリを分割します。 | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| User.Read.All | アプリケーション | ユーザー情報の読み取りに使用します | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| メール | アプリケーション | 従業員を同期するために従業員のメールにアクセスする | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
>| offline_access | アプリケーション | このアクセス許可は、ユーザーが従業員を同期してアプリケーションをインストールできるようにするためにオンラインでない場合に API にアクセスするために使用します。 | [52b2da9b-4cd6-4334-be22-4a3b1b99bac7](../azure/52b2da9b-4cd6-4334-be22-4a3b1b99bac7.md) |
