...
ms.locfileid: "60545942"
---
# <a name="nailted"></a>釘付け

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 9 月 23 日</p>

* <a href="https://teams.microsoft.com/l/app/1a199d17-c299-4634-a124-075e0c119d71" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003375" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

NAILTED APP S.L によって提供される情報。 Microsoft に:
...
| アプリの利用規約 | [https://nailted.com/legal/terms](https://nailted.com/legal/terms) |
| アプリのコア機能 | 最新の People 人事チームの従業員エンゲージメント &amp; プラットフォーム。 |
| 会社の本社所在地 | スペイン |
| アプリ情報ページ | |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Paas |
| アプリで使用するホスティング クラウド プロバイダー | Heroku |
...
この情報は、NAILTED APP S.L によって提供されています。 このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて。
...
| データベースに格納されているデータは何ですか? | tenantId とメール |
...
>|:------------------------|:--------------------|:------------------------------------|
>| User.Read.All | アプリケーション | ユーザー情報の読み取りに使用される |
>| メール | アプリケーション | 従業員のメールにアクセスして同期する |
>| offline_access | アプリケーション | このアクセス許可を使用して、従業員を同期してアプリケーションをインストールするためにユーザーがオンラインではない場合に API にアクセスする |
>| TeamsAppInstallation.ReadWriteForUser | アプリケーション | ユーザーは、アプリをインストールするユーザーを選択できます。 そのため、アプリをインストールするには、このアクセス許可を使用します。 |
>| Directory.Read.All | アプリケーション | グループにアクセスするために使用します。 |
