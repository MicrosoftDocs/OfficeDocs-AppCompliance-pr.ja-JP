...
description: BlackBerry AtHoc で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003065" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://www.athoc.com/pss/terms.html#](https://www.athoc.com/pss/terms.html#) |
| アプリのコア機能 | BlackBerry AtHoc とTeamsを統合すると、既に認証&#8217;1 つの使い慣れた UI から、組織全体&#8211;シームレスで重要なイベント管理が提供されます。 BlackBerry AtHoc 統合により、Teamsを離れることなく、緊急およびインシデント マネージャーは、ワンクリックでアラートを&#8226;発行&#8226;、Teams &#8226;内で事前に確立された配布グループをターゲットにし、リアルタイムでインシデントを管理Teams内で共同作業できます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
...
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | Azure、AWS、SelfHosted |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、BlackBerry から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| ChannelMessage.Send | 委任 | ユーザー&#8217;プリンシパル名などの基本的な詳細にアクセスし、チームにアラート カードを送信するためのチームの一般的なチャネル (サインインしているユーザーが承認されているチャネル) にリンクします。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| Group.Read.All | 委任 | ユーザー&#8217;プリンシパル名などの基本的な詳細にアクセスし、チームにアラート カードを送信するためのチームの一般的なチャネル (サインインしているユーザーが承認されているチャネル) にリンクします。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| User.Read | 委任 | ユーザー&#8217;プリンシパル名などの基本的な詳細にアクセスし、チームにアラート カードを送信するためのチームの一般的なチャネル (サインインしているユーザーが承認されているチャネル) にリンクします。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| メール | 委任 | ユーザー&#8217;プリンシパル名などの基本的な詳細にアクセスし、チームにアラート カードを送信するためのチームの一般的なチャネル (サインインしているユーザーが承認されているチャネル) にリンクします。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| openid | 委任 | ユーザー&#8217;プリンシパル名などの基本的な詳細にアクセスし、チームにアラート カードを送信するためのチームの一般的なチャネル (サインインしているユーザーが承認されているチャネル) にリンクします。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
>| profile | 委任 | ユーザー&#8217;プリンシパル名などの基本的な詳細にアクセスし、チームにアラート カードを送信するためのチームの一般的なチャネル (サインインしているユーザーが承認されているチャネル) にリンクします。 | [f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7](../azure/f18b3ce0-a7a9-4fb7-96be-9b4a7dee68f7.md) |
