...
description: SmileBack で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002623" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://smileback.com/terms](https://smileback.com/terms) |
| アプリのコア機能 | SmileBack は、マネージ サービス プロバイダー、ヘルプ デスク、IT サポート チーム向けに設計された顧客満足度プラットフォームです。 CSAT + NPS&#174;は、IT 担当者が顧客からのフィードバックを収集、報告、および行動するのに役立ちます。 CSAT (顧客満足度調査) は、現在の顧客満足度を理解する上で役立ち、すべての顧客とのやり取り (サポート チケット) を瞬時に直接測定できます。 NPS&#174; (Net Promoter Score) を使用すると、全体的な顧客関係に関する分析情報が得られる。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダー | AWS、 Heroku |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する SmileBack によって提供されています。
