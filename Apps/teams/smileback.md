---
title: SmileBack by SmileBack のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: SmileBack で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64880560"
---
# <a name="smileback"></a>SmileBack

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 4 月 12 日</p>

* <a href="https://teams.microsoft.com/l/app/273e3385-93c3-4054-8c03-328b8c3fd9af" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002623" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

SmileBack から Microsoft に提供される情報:
...
| パートナー会社名 | SmileBack |
| 会社の Web サイト | [https://smileback.com](https://smileback.com) |
| アプリの使用条件 | [https://smileback.com/terms](https://smileback.com/terms) |
| アプリのコア機能 | SmileBack は、マネージド サービス プロバイダー、ヘルプ デスク、IT サポート チーム向けに設計された顧客満足度プラットフォームです。 CSAT + NPS&#174; ツールは、IT 担当者が顧客からのフィードバックを収集、報告、および操作するのに役立ちます。 CSAT (Customer Satisfaction Survey) を使用すると、現在の顧客満足度を把握し、すべての顧客のやりとり (サポート チケット) を瞬時に直接測定できます。 NPS&#174; (Net プロモータリング スコア) を使用すると、全体的な顧客関係に関する分析情報が得られます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | AWS、Heroku |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、SmileBack によって提供されています。
