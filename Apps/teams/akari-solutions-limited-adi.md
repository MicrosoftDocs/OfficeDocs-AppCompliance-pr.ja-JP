...
description: ADI で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/de5717a1-6884-4b96-8b1e-ee17b5d778f3" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002615" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Akari Solutions Limited to Microsoft が提供する情報:
...
| 会社の Web サイト | [https://akari.io](https://akari.io) |
| アプリの利用規約 | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
| アプリのコア機能 | ADI は、すべてのアクセシビリティニーズをサポートし、変更管理プログラムを強化するためにここにいます。 Microsoft Teams 内でアクセシビリティ機能を使用する方法に関する回答、アドバイス、情報を提供するために、ADI に問い合わせてください。隠された障害や状況に関する障がい、どのようなツールやヒントに適したツールやヒントが役立つのかを学習できます。 ADI は、テキスト ベースの会話の回答、バイト サイズのビデオ、さまざまなソースからの概念的なリンクを混合して回答します。 |
| 会社の本社所在地 | 英国英国と北アイルランド (the) |
| アプリ情報ページ | [https://akari.io/adi](https://akari.io/adi) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Akari Solutions Limited によって提供されています。
