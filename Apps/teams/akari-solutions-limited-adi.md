...
description: ADI で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64879834"
---
# <a name="adi"></a>ADI

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 4 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/de5717a1-6884-4b96-8b1e-ee17b5d778f3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002615" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

マイクロソフト限定のアカリ ソリューションによって提供される情報:
...
| アプリの使用条件 | [https://akari.io/adi-terms-and-conditions/](https://akari.io/adi-terms-and-conditions/) |
| アプリのコア機能 | ADI は、すべてのアクセシビリティニーズを支援し、変更管理プログラムを強化するためにここにいます。 ADI に対して、Microsoft Teams内でアクセシビリティ機能を使用する方法に関する回答、アドバイス、情報を提供するように依頼できます。隠れた障穣や状況に障穣があり、どのようなツールやヒントに適しているかについて学ぶことができます。 ADI は、テキスト ベースの会話形式の回答、バイト サイズのビデオ、さまざまなソースからの概念リンクを組み合わせて回答します。 |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Aカリ ソリューションズ によって提供されています。
