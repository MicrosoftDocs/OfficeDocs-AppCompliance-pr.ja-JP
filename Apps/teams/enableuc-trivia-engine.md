---
title: EnableUC によるトリビア エンジンのアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 11/09/2021
ms.topic: article
...
description: トリビア エンジンで使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
ms.locfileid: "60923066"
---
# <a name="trivia-engine"></a>トリビア エンジン

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 10 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/3bd813fa-a19a-4c06-b130-450b24b8ee08" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003412" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.triviaengine.com/termsofuse.html](https://www.triviaengine.com/termsofuse.html) |
| アプリのコア機能 | ゲーミフィケーション サービスを使用して、既存のトレーニングを強化し、&#8220;を向上&#8221;。 |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する EnableUC によって提供されています。
