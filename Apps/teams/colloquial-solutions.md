---
title: Colloquial Solutions による Colloquial のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/25/2022
...
description: Colloquial で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "67016910"
---
# <a name="colloquial"></a>口語

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 30 日</p>

* <a href="https://teams.microsoft.com/l/app/79b08482-6a09-41ff-a303-7ad2fd9c3531" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004395" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Colloquial Solutions から Microsoft に提供される情報:
...
| パートナー会社名 | Colloquial Solutions |
| 会社の Web サイト | [https://www.colloquial.io](https://www.colloquial.io) |
| アプリの使用条件 | [https://app.colloquial.io/terms](https://app.colloquial.io/terms) |
| アプリのコア機能 | 組織内の機能、プロセス、アプリ、テクノロジの知識を収集して共有するための簡単なアプリケーション。 一般的にポートフォリオまたはカタログと呼ばれます。 このアプリは、ポートフォリオの収集と管理に役立ちます。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://www.colloquial.io/solutions](https://www.colloquial.io/solutions) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Colloquial Solutions によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ - 名と姓、電子メール |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | ユーザー プロファイル データ - 名と姓、電子メール |
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | 次のライブラリでは、OAuth2 承認コード フローを使用します。 https://github.com/RIPAGlobal/omniauth-azure-activedirectory-v2 |
