...
description: Taskworld で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリのコア機能 | タスクワールドの通知を受け取りTeams効果的に共同作業を行います。 |
| 会社の本社所在地 | シンガポール |
| アプリ情報ページ | |
