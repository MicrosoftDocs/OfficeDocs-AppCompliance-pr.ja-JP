...
description: リンク スポットター、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリのコア機能 | Link Spotter を使用すると、チャネル間で共有Microsoft Teams見つけるのに役立ちます。 |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | [https://communardo.atlassian.net/wiki/spaces/LINK/overview](https://communardo.atlassian.net/wiki/spaces/LINK/overview) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | 現在のユーザーのチャネル メンバーシップの確認 | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| ChannelMessage.Read.All | アプリケーション | メッセージ内の URL、messageid、返信先メッセージ ID、チャネル ID、作成者 ID.。。これらの情報は、Graph がチャネル上のメッセージに投稿されたすべてのリンクを取得するためのパフォーマンスの高い方法を提供しないので必要です。 したがって、Teams タブでリンク機能を提供するには、メッセージをアクティブに分析する必要があります。 | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| User.Read | 委任 | サインインおよびユーザー プロファイルの読み取り | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| User.Read.All | アプリケーション | Teams ライセンスを持つユーザーの数を決定します。 顧客テナントの有料アプリ ソース サブスクリプションのシート サイズを更新するために使用します。 | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
>| User.ReadBasic.All | 委任 | アプリ内のメッセージ作成者のプロファイル画像と名前を表示する | [a4c28379-0840-42c5-9407-f088a7f54048](../azure/a4c28379-0840-42c5-9407-f088a7f54048.md) |
