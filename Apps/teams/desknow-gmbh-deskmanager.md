---
title: DeskNow GmbH による DeskManager のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/16/2022
...
description: DeskManager で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/a6076464-2435-4fa2-b087-895274867ac8" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003831" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

DeskNow GmbH から Microsoft に提供される情報:
...
| パートナー会社名 | DeskNow GmbH |
| 会社の Web サイト | [https://desk-now.com](https://desk-now.com) |
| アプリの利用規約 | [https://desk-now.com/en/useful/terms-conditions/](https://desk-now.com/en/useful/terms-conditions/) |
| アプリのコア機能 | オフィス、会議室、その他を完全に制御できます。 HybridWork は、国、オフィス、部屋、デスク、またはユーザーの数に関係なく、すべて 1 つで構成されます。  |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Iaas |
| アプリで使用するホスティング クラウド プロバイダー | Aws、その他 |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する DeskNow GmbH によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザーの予約の詳細。 ユーザー プロファイル データ、ユーザー権限 |
...
| プライバシー ポリシーの URL | https://desk-now.com/en/useful/general-privacy-policy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite.Shared | 両方とも | 予定表の同期 | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
>| GroupMember.ReadWrite.All | 両方とも | ユーザー権限、予約権 | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
>| TeamMember.ReadWrite.All | 両方とも | ユーザー権利、予約権、  | [e5d4c7df-50aa-4c15-aa06-c108d0225832](../azure/e5d4c7df-50aa-4c15-aa06-c108d0225832.md) |
