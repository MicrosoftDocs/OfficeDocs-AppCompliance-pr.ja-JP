...
description: PlayQuiz - Aprende &amp; Juega、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
<p>開発者が最終更新日: 2022 年 6 月 10 日</p>

* <a href="https://teams.microsoft.com/l/app/d36eac22-ff28-4392-9ba7-6e32151b9894" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002820" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

TeamsChamp から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | PlayQuiz - Aprende &amp; Juega |
| ID | WA200002820 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | TeamsChamp |
| 会社の Web サイト | [https://www.encamina.com](https://www.encamina.com) |
| アプリの使用条件 | [https://www.teamsquiz.com/en/terms/](https://www.teamsquiz.com/en/terms/) |
| アプリのコア機能 | PlayQuiz は、ユーザーがMicrosoft 365エコシステムから 1 日に 3 つの質問に答え、デジタルナレッジ ポイント&#8221;獲得&#8220;できる Gamification アプリケーションです。 ユーザーは、会社のランキングを見て、会社の最高の M365 チャンピオンであるユーザーを検出できます。 ユーザーは、会社にゲーミフィケーションを含めることで、Microsoft 365 ツールを使用するためのベスト プラクティスに関する分析情報を得ることができます。 また、管理者は、特定のトピックに焦点を当てたキャンペーンを構築するために、カスタムの質問をシステムに追加できます。 |
| 会社の本社の場所 | スペイン |
| アプリ情報ページ | [https://www.teamsquiz.com](https://www.teamsquiz.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて TeamsChamp によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | いいえ |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | direcci&#243;n de correo electr&#243;nico, nombre y apellido |
| 基になるインファ構造が Microsoft 顧客データを処理または格納する場合、このデータは地理的にどこに保存されますか? | スペイン |
...
| プライバシー ポリシーの URL | https://www.theplayquiz.com/procesamiento-de-datos/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | Acceder a los datos del usuarios (email, nombre y apellido) | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| User.ReadBasic.All | 委任 | Acceder a los datos de los compa&#241;eros del usuario principal (email, nombre y apellido) | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| openid | 委任 | Recibir identificador del usuario | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
>| profile | 委任 | obtener la foto a la hora de compartirlo en teams (nombre de imagen y nombre de usuario) | [f3277edf-4f66-4e94-853b-cc1f1e2914f8](../azure/f3277edf-4f66-4e94-853b-cc1f1e2914f8.md) |
