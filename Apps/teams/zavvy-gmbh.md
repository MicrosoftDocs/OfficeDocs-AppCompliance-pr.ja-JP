---
title: Zavvy GmbH による Zavvy のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/30/2022
...
description: Zavvy で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/15562290-1f82-4829-9638-452633a217d8" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003965" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Zavvy GmbH から Microsoft に提供される情報:
...
| パートナー会社名 | Zavvy GmbH |
| 会社の Web サイト | [https://www.zavvy.io](https://www.zavvy.io) |
| アプリの使用条件 | [https://www.zavvy.io/terms-conditions](https://www.zavvy.io/terms-conditions) |
| アプリのコア機能 | Microsoft Teams 内で直接、ユーザーのオンボード、開発、接続を行います。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Zavvy GmbH によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル情報、チーム情報 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | アプリがインストールされているチームのユーザー、テナント ID、名前、ID の ID。 |
...
| プライバシー ポリシーの URL | https://www.zavvy.io/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 委任 | アプリがチームに既にインストールされているかどうかを確認できるようにするには | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| Channel.Create | アプリケーション | 組織のユーザーにグループ メッセージを送信する必要がある場合に備えてチャネルを作成できるようにするには、 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| ChannelMember.ReadWrite.All | アプリケーション | ユーザーとチャネルにメッセージを送信するには  | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| Group.Read.All | アプリケーション | 管理者がアプリをインストールするチームを選択できるように、テナント内のすべてのチームを一覧表示します。 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| TeamMember.Read.All | アプリケーション | アプリがチームにインストールされた後、特定のチームからユーザーとその Bot Framework ID を検索する。 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
>| TeamsAppInstallation.ReadWriteForTeam.All | アプリケーション | チームに Zavvy Microsoft Teams アプリをインストールするには。 | [54a3aa2f-d1de-4565-800e-82f950e26306](../azure/54a3aa2f-d1de-4565-800e-82f950e26306.md) |
