---
title: SMART by SMART Technologies ULC による Lumio のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: SMART による Lumio の利用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64877134"
---
# <a name="lumio-by-smart"></a>SMART による Lumio

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 4 月 19 日</p>

* <a href="https://teams.microsoft.com/l/app/e0ffcbc7-f3f2-46b7-a189-afd01c545782" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001874" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://smarttech.com](https://smarttech.com) |
| アプリの使用条件 | [https://www.smarttech.com/legal/sls-terms](https://www.smarttech.com/legal/sls-terms) |
| アプリのコア機能 | アクティビティ、評価、学生コラボレーションを使用してレッスンを変革します。 |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | [https://www.smarttech.com/smart-learning-suite/](https://www.smarttech.com/smart-learning-suite/) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | AWS、GCP |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、SMART Technologies ULC から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | データは、データが収集されないグループのアクセス許可を確認するために使用されます。  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
>| Group.Read.All | 委任 | 機能を決定するための学生または教師グループの一部であることを確認するために使用されます。 データは収集されません。  | [14cf575a-fae2-48e2-af39-e3448d3a48bb](../azure/14cf575a-fae2-48e2-af39-e3448d3a48bb.md) |
