---
title: ハネウェルによる BGA 通知のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/11/2022
...
description: BGA Notify、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/33f1ff9f-5910-4036-9927-e09b90c64518" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003820" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ハネウェルから Microsoft に提供される情報:
...
| パートナー会社名 | ハネウェル |
| 会社の Web サイト | [https://bga.honeywellforge.com](https://bga.honeywellforge.com) |
| アプリの利用規約 | [https://www.honeywell.com/us/en/terms-and-conditions](https://www.honeywell.com/us/en/terms-and-conditions) |
| アプリのコア機能 | このボットは、主に、自分の好みと航空機からのイベントに応じ、ハネウェル ビジネス航空のお客様へのプロアクティブ メッセージング用です。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://bga.honeywellforge.com](https://bga.honeywellforge.com) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについてハネウェルによって提供されています。
...
| プライバシー ポリシーの URL | https://www.honeywell.com/us/en/privacy-statement |
