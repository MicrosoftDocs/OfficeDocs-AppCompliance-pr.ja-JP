...
| アプリの利用規約 | [https://nimbella.com/terms](https://nimbella.com/terms) |
| アプリのコア機能 | カスタム コマンドをビルド、実行、および共有します。 |
| 会社の本社所在地 | アメリカ |
...
| アプリで使用するホスティング クラウド プロバイダー | Azure、GCP、DigitalOcean |
