---
title: HQuadro による Semplisio e コマース マネージャーのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
<p>開発者が最終更新日: 2022 年 5 月 4 日</p>

* <a href="https://teams.microsoft.com/l/app/9aa7a790-c743-4436-a4ba-1d540cbad3fe" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004286" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | HQuadro |
| 会社の Web サイト | [https://www.hquadro.it](https://www.hquadro.it) |
| アプリの使用条件 | [https://www.semplisio.it/tc](https://www.semplisio.it/tc) |
| アプリのコア機能 | Gestisci il tuo ecommerce su Microsoft Teams: automatizza i processi, integrando i tuoi software e Microsoft 365 |
| 会社の本社の場所 | イタリア |
| アプリ情報ページ | [https://www.semplisio.it/ecommerce-manager](https://www.semplisio.it/ecommerce-manager) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | Iaas |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | Azure、GCP |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて HQuadro によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | email profile Channel.ReadBasic.All Files.ReadWrite.AppFolder Files.ReadWrite.All Files.Read.All User.Read Team.ReadBasic.All sites.Read.All openid offline_access Contacts.ReadWrite |
...
| 多要素認証 (MFA) が有効になっているのは次のとおりです。 | CodeRepositories |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | これを使用して、チャネルの一覧をアプリに表示します | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Contacts.ReadWrite | 委任 | Outlook で連絡先を作成するために使用します | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Files.Read.All | 委任 | これを使用して、お客様の One ドライブ上のファイルを読み取る | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Files.ReadWrite.All | 委任 | これを使用して、お客様の One Drive にファイルを書き込み/作成します | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Files.ReadWrite.AppFolder | 委任 | これを使用して、お客様の One Drive 上のフォルダーの読み取りと書き込み/作成を行います | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Sites.Read.All | 委任 | アプリにドキュメントと顧客の One Drive からのアイテムの一覧を読み取らせる | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| Team.ReadBasic.All | 委任 | これを使用して、チームの一覧をアプリに表示します | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| User.Read | 委任 | これを使用して、トークンを生成します。 | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| メール | 委任 | シングル サインオンに使用します | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| offline_access | 委任 | これを使用して、トークンを生成します。 | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| openid | 委任 | これを使用して、トークンを生成します。 | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
>| profile | 委任 | これを使用して顧客を歓迎します | [a44c880f-f691-4553-9855-4b256721933c](../azure/a44c880f-f691-4553-9855-4b256721933c.md) |
