---
title: Micromate by Paixon GmbH のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Micromate で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/4112cc9a-d683-4ffd-b0bc-2013af7c7497" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002981" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Paixon GmbH から Microsoft に提供される情報:
...
| パートナー会社名 | Paixon GmbH |
| 会社の Web サイト | [https://paixon.ch](https://paixon.ch) |
| アプリの使用条件 | [https://micromate.ai/de/nutzungsbedingungen/](https://micromate.ai/de/nutzungsbedingungen/) |
| アプリのコア機能 | Micromate vermittelt durch personalisierte Lerneinheiten direkt im Chat nachhaltig Wissen. Micromate setzt dabei auf Microlearning durch die Ausspieスラング von Quizzes in Form von Adaptive Cards. ダイ pers&#246;nliche Ansprache des Lernenden, ein Tutorial zur Funktionsweise der App und die Integration spannification Elemente motivieren den Lernenden zur nachhaltigen Nutzung. |
| 会社の本社の場所 | スイス |
| アプリ情報ページ | [https://micromate.ai/de/produkt/](https://micromate.ai/de/produkt/) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | Cloudscale |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Paixon GmbH によって提供されています。
