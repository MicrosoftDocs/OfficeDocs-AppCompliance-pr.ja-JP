---
title: Gtmhub by Gtmhub のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/29/2022
...
description: Gtmhub で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66564543"
---
# <a name="gtmhub"></a>Gtmhub

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 28 日</p>

* <a href="https://teams.microsoft.com/l/app/5fdd80e2-4d58-4c5c-ac85-356c1b2a0bba" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001164" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Gtmhub |
| 会社の Web サイト | [https://www.gtmhub.com](https://www.gtmhub.com) |
| アプリの使用条件 | [https://gtmhub.com/terms-of-service](https://gtmhub.com/terms-of-service) |
| アプリのコア機能 | MS Teams を離れることなく、OKR を表示、共有、更新できます。 OKR の表示、チャネルでの共有、および主要な結果の更新は、これまで以上に迅速に行えるようになります。 更新のエクスペリエンスは、Gtmhub と同じくらいシームレスです。 Gtmhub タブから、すべての OKR とタスクを表示するハブにアクセスできます。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://help.gtmhub.com/en/articles/3558083-how-to-view-and...](https://help.gtmhub.com/en/articles/3558083-how-to-view-and-update-okrs-from-ms-teams) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Gtmhub から提供されています。
...
| プライバシー ポリシーの URL | https://help.gtmhub.com/en/articles/633973-privacy-policy |
