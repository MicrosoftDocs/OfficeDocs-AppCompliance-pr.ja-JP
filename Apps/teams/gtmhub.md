...
description: Gtmhub で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://gtmhub.com/terms-of-service](https://gtmhub.com/terms-of-service) |
| アプリのコア機能 | MS を離れることなく、OKRs を表示、共有、更新Teams。 OKR の表示、チャネルでの共有、主要な結果の更新が、今まで以上に速く行えます。 更新のエクスペリエンスは、Gtmhub と同じシームレスです。 [Gtmhub] タブからハブにアクセスすると、すべての OKRs とタスクが表示されます。  |
| 会社の本社所在地 | アメリカ |
