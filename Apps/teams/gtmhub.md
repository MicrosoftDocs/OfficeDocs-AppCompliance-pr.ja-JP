...
| アプリのコア機能 | MS Teamsを離れることなく、OKR を表示、共有、更新できます。 OKR の表示、チャネルでの共有、および主要な結果の更新は、これまで以上に迅速に行えるようになります。 更新のエクスペリエンスは、Gtmhub と同じくらいシームレスです。 Gtmhub タブから、すべての OKR とタスクを表示するハブにアクセスできます。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
