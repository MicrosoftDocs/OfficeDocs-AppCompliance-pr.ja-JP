...
* <a href="https://teams.microsoft.com/l/app/861228c3-eefd-462f-9b13-24dae6530ac3" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002712" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Rubius が Microsoft に提供する情報:
...
| パートナー会社名 | Rubius |
| 会社の Web サイト | [https://rubius.com](https://rubius.com) |
| アプリの利用規約 | [https://planyway.com/legal/terms-of-use](https://planyway.com/legal/terms-of-use) |
| アプリのコア機能 | Planyway は、スケジュールの管理、プロジェクトの追跡、リソースの計画を行う Trello のチーム カレンダー、タイムライン、および時間追跡ツールです。 Planyway を使用すると、今後のタスクの計画と優先順位付け、予定表またはタイムラインでのタスクの割り当てとスケジュール、プロジェクト全体のチームワークロードの追跡、チームの可用性の管理、タスクとプロジェクトに費やされた時間の追跡、仕事と個人のスケジュールの同期など、すべてのチーム作業を視覚的に整理して合理化できます。 |
| 会社の本社所在地 | ロシア連邦 (the) |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Rubius によって提供されています。
...
| アプリはサービス組織のコントロール (SOC 1) に準拠していますか? | Na |
| 最新の SOC1 認定日 |   |
...
| アプリは国際標準化機構 (ISO 27018) に準拠していますか? | Na |
