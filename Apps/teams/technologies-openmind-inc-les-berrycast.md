...
description: Berrycast のすべての利用可能なセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| People.Read | 委任 | すべてのユーザー連絡先を取得するには | [094f3986-3951-4f0c-88fa-514d117c8dd0](../azure/094f3986-3951-4f0c-88fa-514d117c8dd0.md) |
>| User.Read | 委任 | 基本情報 (姓と名と画像) を使用してユーザーを識別するには | [094f3986-3951-4f0c-88fa-514d117c8dd0](../azure/094f3986-3951-4f0c-88fa-514d117c8dd0.md) |
