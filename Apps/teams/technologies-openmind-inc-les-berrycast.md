...
description: Berrycast で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "67032481"
---
# <a name="berrycast"></a>Berrycast

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 7 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/c7cde650-1e32-11eb-af14-639b3a7d6491" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002798" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Technologies Openmind Inc, Les to Microsoft から提供される情報:
...
| 会社の Web サイト | [https://www.berrycast.com](https://www.berrycast.com) |
| アプリの使用条件 | [https://www.berrycast.com/terms-of-use](https://www.berrycast.com/terms-of-use) |
| アプリのコア機能 | Berrycast を使用して、同僚やクライアントとのコミュニケーションとコラボレーションを向上させます。 |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | |
...
この情報は、Technologies Openmind Inc から提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関するレスを参照してください。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | 不要 |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | email, firstname, lastname, microsoftid |
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | passport-microsoft による直接 oauth2 認証 |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| People.Read | 委任 | 共有エクスペリエンスを向上させるために、ユーザーの連絡先を知ることができる | [094f3986-3951-4f0c-88fa-514d117c8dd0](../azure/094f3986-3951-4f0c-88fa-514d117c8dd0.md) |
>| User.Read | 委任 | ユーザーの電子メール、名、姓を知ることができる | [094f3986-3951-4f0c-88fa-514d117c8dd0](../azure/094f3986-3951-4f0c-88fa-514d117c8dd0.md) |
>| メール | 委任 | Microsoft Oauth2 を使用してユーザーを思い出して未来のログインを行えるようにする | [094f3986-3951-4f0c-88fa-514d117c8dd0](../azure/094f3986-3951-4f0c-88fa-514d117c8dd0.md) |
>| offline_access | 委任 | 連絡先を更新してエクスペリエンスを向上させるには、アクセス権を維持する必要があります | [094f3986-3951-4f0c-88fa-514d117c8dd0](../azure/094f3986-3951-4f0c-88fa-514d117c8dd0.md) |
>| openid | 委任 | Microsoft Oauth2 を使用してユーザーを思い出して未来のログインを行えるようにする | [094f3986-3951-4f0c-88fa-514d117c8dd0](../azure/094f3986-3951-4f0c-88fa-514d117c8dd0.md) |
