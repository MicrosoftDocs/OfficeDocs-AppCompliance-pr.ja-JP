---
title: CyTrack による CyDesk のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/23/2022
...
description: CyDesk で使用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66547322"
---
# <a name="cydesk"></a>CyDesk

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 26 日</p>

* <a href="https://teams.microsoft.com/l/app/14888773-cbfd-439f-91e3-227947655a47" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004281" target="_blank">AppSource で表示する</a>
...
| アプリのコア機能 | CyDesk は、Microsoft Teams 電話 System と CRM ソリューションを統合する必要があるビジネス ユーザーを対象とします。  CyDesk は、ビジネスが既に依存しているソフトウェアを通信システムに統合します。  100 を超える主要なビジネス アプリ&#8211;だけでなく、会社&#8217;既存の社内ソリューション&#8211;すぐに統合できます。 または、ビジネス&#8217;固有のニーズに合わせてカスタマイズされた統合とアプリを作成します。  |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://web.cytrack.com/microsoft-teams/crm-integration-for...](https://web.cytrack.com/microsoft-teams/crm-integration-for-microsoft-teams/) |
