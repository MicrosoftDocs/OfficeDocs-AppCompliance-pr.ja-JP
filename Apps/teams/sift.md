---
title: Sift by Sift のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/26/2022
...
description: Sift で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2022 年 4 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002545" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Sift から Microsoft に提供される情報:
...
| パートナー会社名 | Sift |
| 会社の Web サイト | [https://www.justsift.com](https://www.justsift.com) |
| アプリの使用条件 | [https://www.justsift.com/sift-msteams-eula](https://www.justsift.com/sift-msteams-eula) |
| アプリのコア機能 | 組織のユーザーを検索、検出、接続する |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.justsift.com/integrating-sift/with-microsoft-te...](https://www.justsift.com/integrating-sift/with-microsoft-teams) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Sift によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | Teams アプリは、基本的なプロファイル情報を要求し、Azure AD のユーザーからの会議データを表示することに同意します。 また、プラットフォーム内でプロファイルを強化するために、ユーザーから追加のプロファイル情報を自主的に収集します。 |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | Microsoft Graph のユーザー プロファイル情報は、管理者ユーザーから同意が付与された場合に収集されます。 |
...
| プライバシー ポリシーの URL | https://www.justsift.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Group.Read.All | 委任 | 取得したユーザーをグループ別にフィルター処理する目的で、Graph からグループ情報を取得します。 | [270b510a-7cfb-4a9a-8071-5ceab03cf357](../azure/270b510a-7cfb-4a9a-8071-5ceab03cf357.md) |
>| User.Read.All | 委任 | 製品の従業員プロファイルのプロビジョニングと一貫した更新を目的として、Graph からユーザー オブジェクトを取得します。 | [270b510a-7cfb-4a9a-8071-5ceab03cf357](../azure/270b510a-7cfb-4a9a-8071-5ceab03cf357.md) |
>| OnlineMeetingArtifact.Read.All | 委任 | Teams アプリの会議拡張機能では、会議参加者に関する情報を取得するためのアクセス許可が必要です | [d2a1ed44-6cca-44d2-9b9c-1c9c1d597093](../azure/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093.md) |
>| OnlineMeetings.Read | 委任 | Teams アプリの会議拡張機能では、会議参加者に関する情報を取得するためのアクセス許可が必要です | [d2a1ed44-6cca-44d2-9b9c-1c9c1d597093](../azure/d2a1ed44-6cca-44d2-9b9c-1c9c1d597093.md) |
