---
title: Optmyzr による Optmyzr のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/26/2021
...
description: Optmyzr、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/a8aefb12-8635-4f30-9759-e889fee14d28" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003395" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Optmyzr が Microsoft に提供する情報:
...
| パートナー会社名 | Optmyzr |
| 会社の Web サイト | [https://www.optmyzr.com](https://www.optmyzr.com) |
| アプリの利用規約 | [https://www.optmyzr.com/information/terms-of-use/](https://www.optmyzr.com/information/terms-of-use/) |
| アプリのコア機能 | https://www.optmyzr.com/information/terms-of-use/ |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://www.optmyzr.com/capabilities/reporting/](https://www.optmyzr.com/capabilities/reporting/) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Optmyzr によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザー プロファイル - 識別子として使用される電子メール アドレス |
...
| プライバシー ポリシーの URL | https://www.optmyzr.com/information/privacy-policy/ |
