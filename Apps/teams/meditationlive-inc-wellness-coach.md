---
title: Meditation.live, Inc. による、ウエルネス Coach のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべてのセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/9913e2ed-5c17-4d66-b9e7-439290238f29" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003037" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Meditation.live, Inc. から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://welllnesscoach.live](https://welllnesscoach.live) |
| アプリの使用条件 | [https://www.wellnesscoach.live/terms-of-service](https://www.wellnesscoach.live/terms-of-service) |
| アプリのコア機能 | 一日を通して動き、やる気を引き出し続ける、迅速な心と体の練習。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://wellnesscoach.live/teams-app](https://wellnesscoach.live/teams-app) |
...
この情報は、Meditation.live, Inc. によって提供されています。このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
