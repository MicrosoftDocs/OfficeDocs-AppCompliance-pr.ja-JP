...
description: Verto 365 で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/b27c082b-9d45-490a-b8bb-8dcda46c73f3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003230" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://vertocloud.co.uk/terms-and-conditions/](https://vertocloud.co.uk/terms-and-conditions/) |
| アプリのコア機能 | Verto365 を使用すると、Microsoft Teamsを完全なプロジェクト管理ツールにできます |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、TMI Systems から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 一般的なユーザー情報、名、姓 &amp; の電子メール。 アカウントの作成に使用します。 | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| メール | 委任 | 一般的なユーザー情報、名、姓 &amp; の電子メール。 アカウントの作成に使用します。 | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| offline_access | 委任 | 更新トークンを取得し、ログインを保持するために使用されます | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| openid | 委任 | 一般的なユーザー情報、名、姓 &amp; の電子メール。 アカウントの作成に使用します。 | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
>| profile | 委任 | 一般的なユーザー情報、名、姓 &amp; の電子メール。 アカウントの作成に使用します。 | [d8843264-a57b-41e3-aea6-b83ea56f6bd6](../azure/d8843264-a57b-41e3-aea6-b83ea56f6bd6.md) |
