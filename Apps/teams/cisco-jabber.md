...
description: Jabber で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/ed754df9-2e28-48ef-9f0f-e0909ce4f320" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001496" target="_blank">AppSource での表示</a>
...
| アプリのコア機能 | Jabber アプリを使用して、MS Teams直接 Cisco Voice およびビデオ通話を行います。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
