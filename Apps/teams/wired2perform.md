---
title: Wired2Perform by Wired2Perform のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/03/2021
...
description: Wired2Perform で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/b08f369e-4927-4c66-b997-e1086df7970d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002935" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://wired2perform.com/terms-conditions](https://wired2perform.com/terms-conditions) |
| アプリのコア機能 | 目的主導型の企業である Wired2Perform&#174;は、行動科学と高度な分析を組み合わせて、利用可能な最良の機会と人を同期させ、人材リーダーがより適応性の高い従業員の成長、最適化、アクセスを支援します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Wired2Perform によって提供されています。
