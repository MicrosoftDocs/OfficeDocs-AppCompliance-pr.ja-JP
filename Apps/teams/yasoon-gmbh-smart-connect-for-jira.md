---
title: yasoon GmbH による Jira のスマート Connectのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/22/2021
...
description: Jira 用のスマート Connect、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/6402de97-ce33-4386-bf28-b37e9e139c09" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002055" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://pinpointprod.blob.core.windows.net/marketing/Partne...](https://pinpointprod.blob.core.windows.net/marketing/Partner_21474846970/Product_42949680957/Asset_3f25ec80-eacb-454f-8cc2-eeee583b65c6/170825EULAOfficeaddinEN.doc) |
| アプリのコア機能 | yasoon では、Atlassian と Microsoft サービスの間にスマートで安全&amp;な統合を提供することに重点を置いている。 Atlassian Jira でOutlookとTeamsを接続するツールを提供しています。 Microsoft Teams用の Jira アプリは、Teamsチャットや会話を Jira の問題に結び付けることで、ソフトウェアとビジネス チームの連携を強化するのに役立ちます。 |
| 会社の本社の場所 | ドイツ |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、yasoon GmbH によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | このアクセス許可は、ユーザーが Jira で参加しているチャネルのいずれかを選択できるようにするために使用されます。 | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| ChannelMessage.Read.Group | アプリケーション | アプリが Jira にリンクされたチャネル メッセージを表示できるようにします。 | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| ChannelMessage.Send | 委任 | データは使用されません。この API は、ユーザーが Jira からのチャネル メッセージに返信できるようにするために使用されます。 | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
...
>| Chat.ReadWrite | 委任 | ユーザーがチャットに新しい返信を追加し、Jira からのチャット メッセージを表示できるようにするために使用されます。 | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| Member.Read.Group | アプリケーション | アクセス許可チェックに使用され、アプリはユーザーのチーム メンバーシップを検証できます。 | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| Team.ReadBasic.All | 委任 | このアクセス許可は、ユーザーが Jira で参加しているチームのいずれかを選択できるようにするために使用されます。 | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| TeamSettings.Read.Group | アプリケーション | アプリが特定の既定値を尊重するようにチーム設定を読み取ることができます。 | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
>| User.ReadBasic.All | 委任 | ユーザーがチャネル メッセージで @-メンションする同僚を選択できるようにします | [89d5ca9f-d63b-4885-bd30-6e7433c1540c](../azure/89d5ca9f-d63b-4885-bd30-6e7433c1540c.md) |
