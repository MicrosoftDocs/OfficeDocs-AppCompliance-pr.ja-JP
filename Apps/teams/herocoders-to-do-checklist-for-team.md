---
title: Team by HeroCoders の To Do チェックリストのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: To-Do チェックリスト for Team で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66656109"
---
# <a name="to-do-checklist-for-team"></a>チームの To Do チェックリスト

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 6 月 16 日</p>

* <a href="https://teams.microsoft.com/l/app/b08b0225-1f4b-4e82-879e-d4ef15b5bbda" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004362" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

HeroCoders から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | チームの To Do チェックリスト |
| ID | WA200004362 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | HeroCoders |
| 会社の Web サイト | [https://herocoders.com](https://herocoders.com) |
| アプリの使用条件 | [https://herocoders.com/legal/checklist-for-team#EULA](https://herocoders.com/legal/checklist-for-team#EULA) |
| アプリのコア機能 | あらゆる規模のチームの高度なチェックリスト。 |
| 会社の本社の場所 | ポーランド |
| アプリ情報ページ | [https://herocoders.com](https://herocoders.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する HeroCoders によって提供されています。

| **Information** | **Response** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | Azure AD ID |
| アプリは TLS 1.1 以降をサポートしていますか? | はい |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | Azure AD ID |
...
| プライバシー ポリシーの URL | https://herocoders.com/legal/checklist-for-team#Privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| メール | 委任 | シングル Sign-On (SSO) を使用するには | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| offline_access | 委任 | ユーザーがログインしていない間にチェックリスト アイテムに関する情報を他のユーザーに表示できるようにする。 | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| openid | 委任 | 自分の Azure Ad アカウントでユーザーにサインインするには | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
>| profile | 委任 | チェックリストの履歴にユーザーの名前を表示します。 | [777d9a9f-feef-48dd-b62d-562ff21aeda2](../azure/777d9a9f-feef-48dd-b62d-562ff21aeda2.md) |
