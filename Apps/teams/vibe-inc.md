---
title: Vibe by Vibe Inc. のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 01/20/2022
ms.topic: article
...
description: Vibe で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f6179d94-de34-4c1b-9303-519fdf048c7e" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001721" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Vibe Inc から Microsoft に提供される情報:
...
| パートナー会社名 | Vibe Inc |
| 会社の Web サイト | [https://vibe.us](https://vibe.us) |
| アプリの利用規約 | [https://vibe.us/term/](https://vibe.us/term/) |
| アプリのコア機能 | 無制限のキャンバスでのリアルタイムのコラボレーションで、ユーザーのファイルに簡単にOneDriveできます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Vibe Inc によって提供されています。
...
| データベースに格納されているデータは何ですか? | 顧客の表示名、電子メール アドレス、およびプロファイル イメージ |
...
| プライバシー ポリシーの URL | https://vibe.us/privacy/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザーの基本的な ID 情報 (名前、電子メール、プロファイル イメージなど) を取得します。 | [71a7c2ef-6e5f-4d3d-8665-119a2bef0035](https://docs.microsoft.com/microsoft-365-app-certification/azure/71a7c2ef-6e5f-4d3d-8665-119a2bef0035) |
