...
| アプリのコア機能 | 無制限のキャンバスでのリアルタイムの共同作業で、ユーザーのファイルに簡単にOneDriveできます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ユーザーの基本的な ID 情報 (名前、電子メール、プロファイル イメージなど) を取得します。 | [71a7c2ef-6e5f-4d3d-8665-119a2bef0035](../azure/71a7c2ef-6e5f-4d3d-8665-119a2bef0035.md) |
