...
description: フローリッシュ ゲーム、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報によるニックネームに関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.room6.net/eula](https://www.room6.net/eula) |
...
| 会社の本社所在地 | 日本 |
| アプリ情報ページ | [https://nickname-server.azurewebsites.net/help.html](https://nickname-server.azurewebsites.net/help.html) |
