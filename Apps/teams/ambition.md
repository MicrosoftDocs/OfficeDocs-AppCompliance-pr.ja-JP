...
description: そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/250ef61a-9fa3-434b-ae2a-0ecbe3f8116b" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003159" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

マイクロソフトに対するアンビトから提供される情報:
...
| パートナー会社名 | Ambition |
| 会社の Web サイト | [https://ambition.com](https://ambition.com) |
| アプリの使用条件 | [https://ambition.com/pages/terms/](https://ambition.com/pages/terms/) |
| アプリのコア機能 | 営業チーム向けのゲーミフィケーションおよびコーチング ソフトウェア。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://ambition.com](https://ambition.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、この情報を持っています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Channel.ReadBasic.All | 委任 | チャネルに野心の通知を送信する | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| Group.Read.All | 委任 | チーム内の特定のチャネルに対するアチービション ワークフロー通知を設定します。 | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| User.Read | 委任 | アンビト アプリを承認した管理者を特定するには | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| User.ReadBasic.All | 委任 | ユーザーの名前 &amp; の電子メール。ユーザーを自分の剹心アカウントと同期します。 | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| offline_access | 委任 | ユーザーがオフラインのときにMicrosoft Teamsデータを同期する。 | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
>| openid | 委任 | これは、Microsoft のサインイン機能を使用するために必要です | [24a9cf21-407c-41f9-8cc6-e7015f4e02af](../azure/24a9cf21-407c-41f9-8cc6-e7015f4e02af.md) |
