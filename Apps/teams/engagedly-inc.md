---
title: Engagedly Inc.による Engagedly のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/10/2021
...
description: Engagedly で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
ms.locfileid: "63552646"
---
# <a name="engagedly"></a>Engagedly

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者による最終更新日: 2021 年 8 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/d794bf4c-ef30-4d92-9e2e-6944e9f1512e" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003446" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Engagedly Inc から Microsoft に提供される情報:
...
| パートナー会社名 | Engagedly Inc |
| 会社の Web サイト | [https://engagedly.com](https://engagedly.com) |
| アプリの利用規約 | [https://engagedly.com/terms/](https://engagedly.com/terms/) |
| アプリのコア機能 | Engagedly は、継続的なパフォーマンス管理と魅力的なパフォーマンス レビューを提供し、ゲーミフィケーション システムとの従業員のエンゲージメントを促進し、分析および人員計画ツールのホストを提供する人材管理ソリューションです。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関して Engagedly Inc によって提供されています。
...
| プライバシー ポリシーの URL | https://engagedly.com/privacy/ |
