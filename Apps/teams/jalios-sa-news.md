---
title: ニュースのアプリケーション情報 - じゃりおs by じゃりおs SA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: News - Sentinelios、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/a8662bd0-31c6-4254-b48f-0f54d0b92fcb" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003889" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Jalios SA |
| 会社の Web サイト | [https://www.jalios.com](https://www.jalios.com) |
| アプリの使用条件 | [https://jalios.com/msteams-app/termsofuse](https://jalios.com/msteams-app/termsofuse) |
| アプリのコア機能 | 動的でカスタマイズ可能なデジタル会社の新聞  |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、この情報が提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー プロファイル データ、ユーザー 電子メール データ |
...
| プライバシー ポリシーの URL | https://jalios.com/msteams-app/privacy |
...
| アプリで上記のライブラリのいずれかを使用していない場合、どの認証ライブラリまたはライブラリが使用されますか? | Microsoft Teams JavaScript クライアント SDK |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | カスタム スキーマ拡張機能プロパティを読み取る  | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| User.Read | 委任 | ユーザー データを読み取って、ユーザーを自分の職場にサインインさせる | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| offline_access | 委任 | SSO: データへのアクセスを維持する | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| openid | 委任 | ユーザーのサインイン | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
