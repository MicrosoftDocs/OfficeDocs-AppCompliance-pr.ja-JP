---
title: ニュースのアプリケーション情報 - Jalios by Jalios SA
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: ニュースで利用可能なすべてのセキュリティおよびコンプライアンス情報 - Jalios、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64602588"
---
# <a name="news---jalios"></a>ニュース - Jalios

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 12 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/a8662bd0-31c6-4254-b48f-0f54d0b92fcb" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003889" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Jalios SA から Microsoft に提供される情報:
...
| アプリの利用規約 | [https://jalios.com/msteams-app/termsofuse](https://jalios.com/msteams-app/termsofuse) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Jalios SA によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | カスタム スキーマ拡張プロパティの読み取り  | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
>| User.Read | 委任 | ユーザー データを読み取り、Jalios Workplace にサインインする | [5159b699-a8c3-4170-ae49-c22ccb76cdde](../azure/5159b699-a8c3-4170-ae49-c22ccb76cdde.md) |
