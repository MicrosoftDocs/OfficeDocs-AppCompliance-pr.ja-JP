---
title: Vonage Business Communications by Vonage のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/05/2021
...
description: Vonage Business Communications で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/47c6b242-a067-426c-9a02-0f680a42c488" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002988" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Vonage |
| 会社の Web サイト | [https://www.vonage.com](https://www.vonage.com) |
| アプリの使用条件 | [https://www.vonage.com/legal/unified-communications/tos/glo...](https://www.vonage.com/legal/unified-communications/tos/global-vbc-tos/) |
| アプリのコア機能 | vonage Business Communications for Teamsでは、Vonage ダイレクト ルーティングを使用して通話、SMS、MMS を有効にします。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.vonage.com/unified-communications/](https://www.vonage.com/unified-communications/) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Vonage によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | アプリケーション | このアクセス許可を持つデータは格納されません | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
>| User.Read | 委任 | 後でこのユーザーに通知を送信できるように、Azure ユーザー ID とテナント ID を取得します。 | [1d8a304e-ea67-4aa2-9345-2793419cf83f](../azure/1d8a304e-ea67-4aa2-9345-2793419cf83f.md) |
