...
| アプリのコア機能 | 意味のある接続コンテンツで目標を &amp; 達成する。 メンタリング、ピアコーチング、コミュニティ学習、ネットワーキングを通じて、人々を有意義なつながりとコンテンツで囲む。 Qooper は、さまざまなサイズの企業、大学、非営利団体とパートナーを組み、メンタリング プログラム管理作業を自動化し、対話的なメンター学習プラットフォームでユーザーを接続し、プログラム分析を表示します。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
