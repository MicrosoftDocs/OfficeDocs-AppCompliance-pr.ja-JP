...
* <a href="https://teams.microsoft.com/l/app/fadca663-cc96-4756-8a3b-271000082238" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002964" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| アプリのコア機能 | 意味のある接続コンテンツで目標を達成 &amp; する。 メンタリング、ピアコーチング、コミュニティ学習、ネットワーキングを通じて、人々を有意義なつながりとコンテンツで囲む。 Qooper は、さまざまなサイズの企業、大学、非営利団体とパートナーを組み、メンタリング プログラム管理作業を自動化し、対話的なメンター学習プラットフォームでユーザーを接続し、プログラム分析を表示します。 |
| 会社の本社所在地 | アメリカ |
...
この情報は、COGNATA TECHNOLOGIES LLC によって、このアプリが組織データを収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールについて提供されています。
