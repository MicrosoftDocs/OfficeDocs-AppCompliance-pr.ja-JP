---
title: COGNATA TECHNOLOGIES LLC による Qooper のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: Qooper で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/fadca663-cc96-4756-8a3b-271000082238" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002964" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | COGNATA TECHNOLOGIES, LLC |
| 会社の Web サイト | [https://qooper.io](https://qooper.io) |
| アプリの使用条件 | [https://qooper.io/terms-of-use](https://qooper.io/terms-of-use) |
| アプリのコア機能 | 意味のある接続 &amp; コンテンツを使用して目標を達成します。 メンタリング、ピア コーチング、コミュニティラーニング、ネットワークを通じて、有意義なつながりとコンテンツで人々を囲み込む。 Qooper は、あらゆる規模の企業、大学、非営利団体と提携して、メンタリング プログラム管理作業を自動化し、対話型のメンタリングラーニング プラットフォームでユーザーを接続し、プログラム分析を表示します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://qooper.io](https://qooper.io) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、COGNATA TECHNOLOGIES LLC によって提供されています。
