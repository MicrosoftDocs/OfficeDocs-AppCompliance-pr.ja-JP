...
* <a href="https://teams.microsoft.com/l/app/c5312ffd-d146-4515-89e0-b43fa5282368" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003675" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

SightCall から Microsoft に提供される情報:
...
| パートナー会社名 | SightCall |
| 会社の Web サイト | [https://sightcall.com](https://sightcall.com) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて、SightCall によって提供されています。
