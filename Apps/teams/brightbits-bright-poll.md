---
title: BrightBits による明るいポーリングのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/17/2021
...
| アプリの利用規約 | [https://brightbits.app/terms/](https://brightbits.app/terms/) |
| アプリのコア機能 | チャット内のポーリングを通じてチームメイトからのフィードバックを収集します。 |
| 会社の本社所在地 | アメリカ |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関して、BrightBits によって提供されています。
