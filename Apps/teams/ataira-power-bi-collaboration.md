...
description: Power BI コラボレーション、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
---
# <a name="power-bi-collaboration-overview"></a>Power BI コラボレーションの概要

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 6 月 14 日</p>

* <a href="https://teams.microsoft.com/l/app/90381cb0-998f-4ba3-9699-130201de5ddb" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA104381384" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Ataira |
| 会社の Web サイト | [https://www.ataira.com](https://www.ataira.com) |
| アプリの使用条件 | [https://www.ataira.com/TermsofUse](https://www.ataira.com/TermsofUse) |
| アプリのコア機能 | Ataira アドインを使用すると、Power BIダッシュボードとレポートを表示できます。 企業グループやチームに通知を送信したり、フォローアップ アクションを追加したり、パブリック リンクPower BI埋め込んだり、レポート内のデータ ポイントにコメントを追加したり、データ ソースとしてデータ ファイルをPower BI レポートに追加したり、リアルタイムで更新したりできます。 ビジネス インテリジェンス チームが 1 か所でビジネス インテリジェンスの取り組みについてより緊密に共同作業できるようにします。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.ataira.com/Microsoft/PowerBI/Collaboration](https://www.ataira.com/Microsoft/PowerBI/Collaboration) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Ataira から提供されています。
...
| サポートされているポリシーの種類を一覧表示する | 多要素認証 登録されたデバイスのみをIntune特定のサービスへのアクセスを許可する ユーザーの場所と IP 範囲を制限する |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ChannelMessage.Send Team.ReadBasic.All User.Read のアクセス許可も付与されます。 これらは、ユーザーが通知のTeams グループとチャネルを選択できるようにするために使用されます。 | [00738e07-f9a4-4bf5-b6f9-851ec7ea31d5](../azure/00738e07-f9a4-4bf5-b6f9-851ec7ea31d5.md) |
