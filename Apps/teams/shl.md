...
description: SHL で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.shl.com/en/terms-of-service/](https://www.shl.com/en/terms-of-service/) |
| アプリのコア機能 | SHL は、人事技術と精神分析科学のグローバル リーダーであり、企業がビジネス結果を推進する強力なワークフォース ソリューションの作成を支援します。 SHL は、強力で透明な AI テクノロジ、データ サイエンス、および客観性を提供し、企業がデジタル時代に成功するために必要な人材を引き付け、開発し、成長させるのに役立ちます。 |
