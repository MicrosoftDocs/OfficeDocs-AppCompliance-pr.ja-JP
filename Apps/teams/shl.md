...
description: SHL で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/0c52adc0-18a0-45ca-b6ee-154cf1ef87e2" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002887" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | SHL |
| 会社の Web サイト | [https://shl.com](https://shl.com) |
| アプリの使用条件 | [https://www.shl.com/en/terms-of-service/](https://www.shl.com/en/terms-of-service/) |
| アプリのコア機能 | SHL は、人事テクノロジとサイコメトリック サイエンスのグローバル リーダーであり、深い人の洞察を導き、企業がビジネスの成果を促進する強力な人材ソリューションを作成するのに役立ちます。 SHL は、強力で透過的な AI テクノロジ、データ サイエンス、および客観性を提供し、企業がデジタル時代に成功するために必要な従業員を引き付け、開発し、成長できるようにします。 |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://www.shl.com/en/about/](https://www.shl.com/en/about/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて SHL から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read.Shared | 委任 | 使用可能な共有 Calander スロット | [afd2c390-8b78-40fa-913b-7fc5911e884a](../azure/afd2c390-8b78-40fa-913b-7fc5911e884a.md) |
