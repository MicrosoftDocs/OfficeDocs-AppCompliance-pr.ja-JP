...
description: SmartWork で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.intumit.com/english/TermsOfUse.html](https://www.intumit.com/english/TermsOfUse.html) |
| アプリのコア機能 | SmartWork は、ユーザーに関連する質問に答える対話Microsoft Office 365 |
| 会社の本社所在地 | 台湾 (中国) |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | userPrincipalName を使用して、ユーザーのメールが有効なメールから送信されたかどうかAAD識別する | [a938ae1e-a791-4751-9e6a-178c991fa0fa](../azure/a938ae1e-a791-4751-9e6a-178c991fa0fa.md) |
