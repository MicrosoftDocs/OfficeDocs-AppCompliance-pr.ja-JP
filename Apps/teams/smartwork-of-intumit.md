...
description: SmartWork で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/a938ae1e-a791-4751-9e6a-178c991fa0fa" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001149" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

SmartWork of Intumit から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://www.intumit.com/english/](https://www.intumit.com/english/) |
| アプリの使用条件 | [https://www.intumit.com/english/TermsOfUse.html](https://www.intumit.com/english/TermsOfUse.html) |
| アプリのコア機能 | SmartWork は、Microsoft Office 365に関連する質問に回答できるダイアログ ロボットです。 |
| 会社の本社の場所 | 台湾 (中国) |
| アプリ情報ページ | |
...
この情報は、SmartWork of Intumit によって、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | userPrincipalName を使用して、ユーザーのメールが有効なAADから送信されたかどうかを識別する | [a938ae1e-a791-4751-9e6a-178c991fa0fa](../azure/a938ae1e-a791-4751-9e6a-178c991fa0fa.md) |
