---
title: Powell Software による Powell Teamsのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: Powell Teams、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
<p>開発者が最終更新日: 2021 年 8 月 9 日</p>

* <a href="https://teams.microsoft.com/l/app/423d394a-892e-44d1-b9f0-ff382643df42" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001585" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Powell Software から Microsoft に提供される情報:
...
| アプリの使用条件 | [https://powell-software.com/en/powell-teams-terms-of-use/](https://powell-software.com/en/powell-teams-terms-of-use/) |
| アプリのコア機能 | Powell Teams アプリは、すべての会社の従業員にスマート ダッシュボードを提供し、すべてのチームのタグを簡単に整理&amp;し、最も重要な昇格された会社のチームを見つけ、最後に定義済みのロールベースのチーム テンプレートを使用して時間を節約するのに役立ちます。 API は、Powell Teams データベースでデータ セットを取得して操作することもできます (https://docapiteams.powell-software.com)最後に、Logic Apps とPower Automate用のコネクタも使用できます (https://docs.microsoft.com/en-us/connectors/powellteams) |
| 会社の本社の場所 | フランス |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Powell Software によって提供されています。
