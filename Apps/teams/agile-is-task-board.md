...
description: Agile Task Board で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2022 年 4 月 8 日</p>

* <a href="https://teams.microsoft.com/l/app/6021779f-643c-48c0-9f80-8e41ea801be7" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002162" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Agile-IS から Microsoft に提供される情報:
...
| パートナー会社名 | Agile-IS |
| 会社の Web サイト | [https://www.agile-is.de](https://www.agile-is.de) |
| アプリの使用条件 | [https://www.agile-is.de/en/termsofuse](https://www.agile-is.de/en/termsofuse) |
| アプリのコア機能 | アジャイル タスク ボードは、お客様とチームがアジャイル プロジェクトの概要を把握するのに役立ちます。 物理ボードをデジタル バージョンに変換します。 プロセスを、状態表示用の列、任意の数のスイムレーン、マップのメタデータ主導の色分け、責任の割り当て、ドラッグ アンド ドロップ編集、その他多くの設定などの機能を使用してマップできます。 すべてのデータは、M365 テナント内に残ります。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | [https://www.agile-is.de/en/agiletaskboard](https://www.agile-is.de/en/agiletaskboard) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Agile-IS によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | いいえ |
| アプリまたは基になるインフラストラクチャには、Microsoft の顧客データは格納されますか? | はい |
| データベースに格納されているデータは何ですか? | UPN の zur Lizenzverwal東;Unternehmensdaten zur Rechnungslegung |
...
| プライバシー ポリシーの URL | https://www.agile-is.de/en/telemetry |
...
| アプリには、要求に応じて個人の個人データを削除する機能はありますか? | N/A |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| AppCatalog.Read.All | 委任 | アプリが現在インストールされているアプリのバージョンに対してクエリを実行できるようにします。 適切なアプリ リソースを提供するために使用されます。 | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| GroupMember.Read.All | 委任 | グループ メンバーを読み取って planner タスクを割り当てる  | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| Tasks.ReadWrite | 委任 | Planner プランとタスクの操作   | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsActivity.Send | 委任 | チーム アクティビティにメッセージを送信する | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| TeamsAppInstallation.ReadForTeam | 委任 | アプリが現在インストールされているアプリのバージョンに対してクエリを実行できるようにします。 適切なアプリ リソースを提供するために使用されます。 | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.Read | 委任 | ユーザーがサインインし、基本的なプロファイル情報を読み取る | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
>| User.ReadBasic.All | 委任 | ユーザーが他のユーザーの基本的なプロファイル情報を読み取る | [ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5](../azure/ed6cb2ac-21e8-4e9c-a917-6a2d5f03e3a5.md) |
