---
title: SOE Technologies による huminos のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/05/2021
...
description: フミノ、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/c0b70874-2c95-4be7-a0cb-0d893e25a2a3" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003308" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.myokr.co](https://www.myokr.co) |
| アプリの使用条件 | [https://www.myokr.co/terms](https://www.myokr.co/terms) |
| アプリのコア機能 | パフォーマンスを高速化する |
| 会社の本社の場所 | インド |
| アプリ情報ページ | [https://www.myokr.co](https://www.myokr.co) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する SOE Technologies によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | ユーザー予定表の詳細を取得して、ユーザー予定表で 1:1 の会議を作成し、myOKR プラットフォームによって作成された更新または削除を行い、空き時間スロットを表示する | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| User.Read | 委任 | ユーザー Azure オブジェクト ID を使用して、電子メールに対する Microsoft 認証を使用してユーザーを myOKR アプリにログインさせます | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| User.Read.All | アプリケーション | ユーザー情報を myOKR プラットフォームと同期し、場所、部署 &amp; マネージャーなどのさまざまなユーザーカットに基づいて、myOKR アプリケーション分析を管理者に表示します | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| offline_access | 委任 | ユーザーの Azure active directory ID | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
>| openid | 委任 | Microsoft 認証を使用してユーザーを myOKR アプリにログインさせるには、ユーザー Azure オブジェクト ID を使用します。 | [5f5ab403-96ae-46a9-b78e-a06d60cc9e4e](../azure/5f5ab403-96ae-46a9-b78e-a06d60cc9e4e.md) |
