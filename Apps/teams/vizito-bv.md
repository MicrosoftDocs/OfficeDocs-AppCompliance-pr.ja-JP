...
| アプリのコア機能 | SaaS の訪問者登録とTeamsの通知を受け取る。 |
| 会社の本社所在地 | ベルギー |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 両方とも | ボットがインストールされているテナントを確認するために、テナント ID を取得Teams保存します。 | [b6e2ef19-7612-4ab7-a700-9669d49b88b9](https://docs.microsoft.com/microsoft-365-app-certification/azure/b6e2ef19-7612-4ab7-a700-9669d49b88b9) |
