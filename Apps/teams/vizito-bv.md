...
| アプリの利用規約 | [https://www.vizito.be/terms-conditions](https://www.vizito.be/terms-conditions) |
| アプリのコア機能 | 訪問者の到着に関する通知Teams SaaS 訪問者登録。 |
| 会社の本社所在地 | ベルギー |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 両方とも | テナント ID を取得して保存し、ボットがインストールされているテナントTeams確認します。 | [b6e2ef19-7612-4ab7-a700-9669d49b88b9](../azure/b6e2ef19-7612-4ab7-a700-9669d49b88b9.md) |
