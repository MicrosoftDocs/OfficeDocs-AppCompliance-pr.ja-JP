---
title: アプリケーション情報 for Vizito by Vizito BV
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/25/2021
...
description: すべての利用可能なセキュリティ情報とコンプライアンス情報は、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報です。
...
* <a href="https://teams.microsoft.com/l/app/b6e2ef19-7612-4ab7-a700-9669d49b88b9" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003170" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Vizito BV |
| 会社の Web サイト | [https://www.vizito.be](https://www.vizito.be) |
| アプリの使用条件 | [https://www.vizito.be/terms-conditions](https://www.vizito.be/terms-conditions) |
| アプリのコア機能 | 訪問者の到着に関するTeams通知を含む SaaS 訪問者の登録。 |
| 会社の本社の場所 | ベルギー |
| アプリ情報ページ | [https://www.vizito.be](https://www.vizito.be) |
...
この情報は、このアプリが組織のデータを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Intelliito BV によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 両方とも | Teams ボットがインストールされているテナントを把握できるように、テナント ID をフェッチして格納します。 | [b6e2ef19-7612-4ab7-a700-9669d49b88b9](../azure/b6e2ef19-7612-4ab7-a700-9669d49b88b9.md) |
