...
| アプリのコア機能 | デジタル変換戦略を強化し、問題を迅速に調査して解決するために必要なコンテンツ、人、スマート データ、ガイダンスに即座にアクセスできる従業員と顧客を支援します。 Onsight 拡張現実プラットフォームは、グローバルに展開され、製造、航空、エネルギー、重機、自動車などの業界での運用効率がフィールド サービス。 |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | |
