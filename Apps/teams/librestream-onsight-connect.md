---
title: Librestream による Onsight Connectのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 04/29/2021
...
description: Onsight Connect、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "64876334"
---
# <a name="onsight-connect"></a>Onsight Connect

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 4 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/c01f5608-4ade-4749-aafa-9e5449a5bcb4" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002769" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://librestream.com](https://librestream.com) |
| アプリの使用条件 | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| アプリのコア機能 | デジタル変革戦略を強化して、問題を迅速に調査して解決するために必要なコンテンツ、人、スマート データ、ガイダンスにすぐにアクセスできるように、従業員と顧客を支援します。 Onsight 拡張現実プラットフォームは、グローバルに展開され、製造、航空、エネルギー、重機、フィールド サービスなどの業界での運用効率を向上させます。 |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Librestream によって提供されています。
