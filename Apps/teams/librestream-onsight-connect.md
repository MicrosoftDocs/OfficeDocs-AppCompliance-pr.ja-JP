...
description: Onsight Connect、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://librestream.com/support-archives/software-eula/](https://librestream.com/support-archives/software-eula/) |
| アプリのコア機能 | デジタル変換戦略を強化し、問題を迅速に調査して解決するために必要なコンテンツ、人、スマート データ、ガイダンスに即座にアクセスできる従業員と顧客を支援します。 Onsight 拡張現実プラットフォームは、グローバルに展開され、製造、航空、エネルギー、重機、自動車などの業界での運用効率をフィールド サービス。 |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | |
