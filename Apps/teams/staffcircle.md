...
description: StaffCircle で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| 会社の Web サイト | [https://www.staffcircle.com](https://www.staffcircle.com) |
| アプリの利用規約 | [https://www.staffcircle.com/terms](https://www.staffcircle.com/terms) |
| アプリのコア機能 | リモート ワーカー向け内部コミュニケーション、カルチャ、エンゲージメント、パフォーマンス管理プラットフォーム。 |
| 会社の本社所在地 | 英国英国と北アイルランド (the) |
| アプリ情報ページ | [https://www.staffcircle.com/integrations/microsoft-teams-in...](https://www.staffcircle.com/integrations/microsoft-teams-integration/) |
