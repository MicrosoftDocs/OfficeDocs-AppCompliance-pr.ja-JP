---
title: UKG, Inc. による UKG Proのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/12/2021
...
description: UKG Pro、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/f2120944-5201-4c71-8314-770f7806fff0" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003173" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | UKG, Inc. |
| 会社の Web サイト | [https://ukg.com](https://ukg.com) |
| アプリの使用条件 | [https://ukg.com](https://ukg.com) |
| アプリのコア機能 | 従業員情報に簡単にアクセスし、支払いの詳細を表示し、必要に応じて他の人事アクションを完了します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://ukg.com](https://ukg.com) |
...
この情報は UKG, Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
