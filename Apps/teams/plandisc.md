---
title: Plandisc による Plandisc のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/29/2022
...
description: Plandisc、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
<p>開発者による最終更新日: 2022 年 3 月 29 日</p>

* <a href="https://teams.microsoft.com/l/app/0d794393-0f87-4c37-ac82-1d2822794372" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003869" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Plandisc が Microsoft に提供する情報:
...
| パートナー会社名 | Plandisc |
| 会社の Web サイト | [https://plandisc.com](https://plandisc.com) |
| アプリの利用規約 | [https://plandisc.com/en/terms-and-conditions-of-use-4/](https://plandisc.com/en/terms-and-conditions-of-use-4/) |
| アプリのコア機能 | プランと共同作業を計画し、年次プランナーアクセシブルでMicrosoft Teams |
| 会社の本社所在地 | デンマーク |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Plandisc によって提供されています。
...
| データベースに格納されているデータは何ですか? | customer tenantId、customer userId、Outlookカレンダー データ |
...
| プライバシー ポリシーの URL | https://plandisc.com/en/personal-data-policy-4/ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | 予定表の同期 | [08da38c2-089b-4c58-9995-60bc2ca54561](../azure/08da38c2-089b-4c58-9995-60bc2ca54561.md) |
>| Calendars.ReadWrite.Shared | 委任 | 予定表の同期 | [08da38c2-089b-4c58-9995-60bc2ca54561](../azure/08da38c2-089b-4c58-9995-60bc2ca54561.md) |
>| User.Read | 委任 | ユーザー プロファイルの読み取り | [08da38c2-089b-4c58-9995-60bc2ca54561](../azure/08da38c2-089b-4c58-9995-60bc2ca54561.md) |
>| openid | 委任 | ユーザーにサインインする | [08da38c2-089b-4c58-9995-60bc2ca54561](../azure/08da38c2-089b-4c58-9995-60bc2ca54561.md) |
