---
title: Alevate AP Approval by Serrala Group GmbH のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/05/2022
...
description: Alevate AP 承認、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "66656217"
---
# <a name="alevate-ap-approval"></a>AP の承認を Alevate する

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 25 日</p>

* <a href="https://teams.microsoft.com/l/app/43fba60e-6ec6-4f68-b601-79a598a6643e" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200004348" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Serrala Group GmbH から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | AP の承認を Alevate する |
| ID | WA200004348 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | セララ グループ GmbH |
| 会社の Web サイト | [https://www.serrala.com](https://www.serrala.com) |
| アプリの使用条件 | [https://www2.serrala.com/rs/275-EMU-744/images/Serrala-Paym...](https://www2.serrala.com/rs/275-EMU-744/images/Serrala-Payment-Solutions-GmbH-AGB-Softwaremiete-Cash-Management-pro.pdf) |
| アプリのコア機能 | Microsoft Teams で AP 請求書を簡単に確認および承認し、現在の状態を確認します。 |
| 会社の本社の場所 | ドイツ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Serrala Group GmbH によって提供されています。
