...
description: CSA STAR レジストリ内の、Amplify by Hootsuite、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、およびセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.hootsuite.com/legal/eula](https://www.hootsuite.com/legal/eula) |
| アプリのコア機能 | Hootsuite のMicrosoft Teamsを利用して、チームのソーシャル チャネルにコンテンツを共有します。 |
| 会社の本社所在地 | カナダ |
