...
description: ホームスイートによって、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリのコア機能 | Microsoft Teamsのコンテンツを、Hootsuite Bandwidth を利用してチームのソーシャル チャネルに共有します。 |
| 会社の本社の場所 | カナダ |
