---
title: Hootsuite Inc. によって Hootsuite によって増幅するためのアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/07/2022
...
description: ホームスイートによって、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/08d9aab9-a8f3-4f65-91e2-a33ef9bad6bb" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003153" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.hootsuite.com](https://www.hootsuite.com) |
| アプリの使用条件 | [https://www.hootsuite.com/legal/eula](https://www.hootsuite.com/legal/eula) |
| アプリのコア機能 | Microsoft Teams のコンテンツをチームのソーシャル チャネルに共有します。Hootsuite ズートを利用します。 |
| 会社の本社の場所 | カナダ |
| アプリ情報ページ | [https://www.hootsuite.com/about/contact-us](https://www.hootsuite.com/about/contact-us) |
...
この情報は Hootsuite Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsActivity.Send | 委任 | ユーザー アクティビティ通知フィードにアクセスする場合 | [e308040f-41b5-4b8c-8f08-c2c38056f7e2](../azure/e308040f-41b5-4b8c-8f08-c2c38056f7e2.md) |
