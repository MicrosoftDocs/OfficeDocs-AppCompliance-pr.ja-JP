---
title: Semos CloudOultions による JobPts のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: JobPts で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/601a47bc-f201-4398-a0cb-593ea081f265" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001849" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Semos CloudOultions から Microsoft に提供される情報:
...
| アプリの使用条件 | [https://semoscloud.com/terms-of-use/](https://semoscloud.com/terms-of-use/) |
| アプリのコア機能 | MsTeams を離れることなく、仕事がうまくいったことで同僚を簡単に認識する |
| 会社の本社の場所 | 米国 オブ アメリカ |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Semos CloudOultions によって提供されています。
...
>| openid | 委任 | ユーザーが自分の職場アカウントでサインインできるようにするには | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
>| profile | 委任 | JobPts がユーザーの基本情報 (ユーザー名) を表示できるようにするには | [1ac9e5c6-4850-4864-96c5-b91e4512334e](../azure/1ac9e5c6-4850-4864-96c5-b91e4512334e.md) |
