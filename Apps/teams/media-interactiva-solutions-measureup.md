---
title: MeasureUp by Media Interactiva Solutions のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: MeasureUp で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/bb1f94be-57aa-452c-9073-7fbb6b8b1797" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003111" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | Media Interactiva Solutions |
| 会社の Web サイト | [https://www.measureup.com](https://www.measureup.com) |
| アプリの使用条件 | [https://www.measureup.com/legal-notice](https://www.measureup.com/legal-notice) |
| アプリのコア機能 | MeasureUp を使用して、チームのスキルをより効率的に評価します。 |
| 会社の本社の場所 | スペイン |
| アプリ情報ページ | [https://docs.measureup.com](https://docs.measureup.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Media Interactiva Solutions によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 登録してログインを許可するプロファイル情報。 ユーザーがアプリケーションにアクセスする場合、Microsoft プロファイルのデータをプラットフォームでユーザー プロファイルを作成する必要があります。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| openid | 委任 | 登録してログインを許可するプロファイル情報。 ユーザーがアプリケーションにアクセスする場合、Microsoft プロファイルのデータをプラットフォームでユーザー プロファイルを作成する必要があります。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| profile | 委任 | 登録してログインを許可するプロファイル情報。 ユーザーがアプリケーションにアクセスする場合、Microsoft プロファイルのデータをプラットフォームでユーザー プロファイルを作成する必要があります。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
