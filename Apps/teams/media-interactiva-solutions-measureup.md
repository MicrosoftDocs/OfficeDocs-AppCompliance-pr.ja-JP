...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | 登録してログインを許可するプロファイル情報。 ユーザーがアプリケーションにアクセスする場合、Microsoft プロファイルのデータがプラットフォームでユーザー プロファイルを作成する必要があります。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| openid | 委任 | 登録してログインを許可するプロファイル情報。 ユーザーがアプリケーションにアクセスする場合、Microsoft プロファイルのデータがプラットフォームでユーザー プロファイルを作成する必要があります。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
>| profile | 委任 | 登録してログインを許可するプロファイル情報。 ユーザーがアプリケーションにアクセスする場合、Microsoft プロファイルのデータがプラットフォームでユーザー プロファイルを作成する必要があります。 | [481280f4-a4ed-4862-a5a1-4de59da9dca5](../azure/481280f4-a4ed-4862-a5a1-4de59da9dca5.md) |
