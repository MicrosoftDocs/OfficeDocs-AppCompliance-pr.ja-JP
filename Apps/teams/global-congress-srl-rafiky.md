---
title: Global GOVERNANCE SRL によるRaiky のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/20/2021
...
description: 使用可能なすべてのセキュリティ情報とコンプライアンス情報は、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報です。
...
* <a href="https://teams.microsoft.com/l/app/c4661f80-2c9c-42d4-aec5-5ed6d64adb4d" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003263" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://rafiky.net/en/](https://rafiky.net/en/) |
| アプリの使用条件 | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| アプリのコア機能 | ラフィキは、オンライン イベントに対してリモート同時解釈を実行するように設計された、非常に柔軟でアクセスしやすいクラウド プラットフォーム ソリューションです。 リモート解釈&#8217;独自の革新的なビジョンです。これにより、プロのインタープリターはいつでもどこからでも作業できます。 |
| 会社の本社の場所 | イタリア |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する GLOBAL GOVERNANCE SRL によって提供されています。
