...
description: Rafiky、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://rafiky.net/en/terms-conditions/](https://rafiky.net/en/terms-conditions/) |
| アプリのコア機能 | Rafiky は、オンライン イベントのリモート同時解釈を実行するように設計された、非常に柔軟でアクセスしやすいクラウド プラットフォーム ソリューションです。 これは&#8217;解釈のユニークで革新的なビジョンです。これにより、プロの通訳者は、いつでもどこからでも作業できます。 |
| 会社の本社所在地 | イタリア |
| アプリ情報ページ | |
