...
description: MyWorkDrive で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
ms.locfileid: "63550065"
---
# <a name="myworkdrive"></a>MyWorkDrive

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 3 日</p>

* <a href="https://teams.microsoft.com/l/app/f4170c12-ec5c-47b9-834a-a4186cf27ec1" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002325" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

MyWorkDrive から Microsoft に提供される情報:
...
| 会社の Web サイト | [https://www.myworkdrive.com](https://www.myworkdrive.com) |
| アプリの利用規約 | [https://www.myworkdrive.com/terms-of-service/](https://www.myworkdrive.com/terms-of-service/) |
| アプリのコア機能 | MyWorkDrive アプリを使用すると、ファイル共有に保存されている会社のファイルMicrosoft Teamsをリモートで編集、共有、およびアクセスすることで、ファイル共有フォルダーにアクセスできます。   |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://www.myworkdrive.com/support/myworkdrive-teams-integ...](https://www.myworkdrive.com/support/myworkdrive-teams-integration/) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? | ハイブリッド |
| アプリで使用するホスティング クラウド プロバイダー | Azure、Aws、その他 |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、MyWorkDrive によって提供されています。
