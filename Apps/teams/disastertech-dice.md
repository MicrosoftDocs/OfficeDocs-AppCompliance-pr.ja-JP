...
description: DisasterTech DICE に使用できるすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
<p>開発者が最終更新日: 2022 年 5 月 31 日</p>

* <a href="https://teams.microsoft.com/l/app/7df3e67b-ed62-48e9-a950-c95bd7ebce80" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001909" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.disastertech.com](https://www.disastertech.com) |
| アプリの使用条件 | [https://dice.disastertech.com/tos.html](https://dice.disastertech.com/tos.html) |
| アプリのコア機能 | Disaster Tech Data Science Integrated Collaboration Environment (DICE) は、Web ベースのデータ視覚化とデータ探索ソフトウェアに、ユーザー定義およびセルフサービスの分析ツールとデータ サイエンス ツールを提供します。 DICE では、最も包括的なディザスター リスク データ インベントリにアクセスして、災害の前、中、後のリアルタイムで探索できます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、DisasterTech から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | Microsoft Teams シングル サインオン | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| メール | 委任 | Microsoft Teams シングル サインオン | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| offline_access | 委任 | Microsoft Teams シングル サインオン | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| openid | 委任 | Microsoft Teams シングル サインオン | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
>| profile | 委任 | Microsoft Teams シングル サインオン | [7df3e67b-ed62-48e9-a950-c95bd7ebce80](../azure/7df3e67b-ed62-48e9-a950-c95bd7ebce80.md) |
