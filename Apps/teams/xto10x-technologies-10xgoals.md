...
description: 10xGoals で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.xto10x.com/security/terms-of-use/](https://www.xto10x.com/security/terms-of-use/) |
| アプリのコア機能 | 10xGoals は、チーム全体のフォーカス、配置、コラボレーション、可視性を備え、戦略を実行に追い込むツールです。 10xGoals &lt;&gt; Microsoft Teams統合により、ここで実行全体を管理できます。 まず、ユーザーは自分に割り当てられた目標に対する受け入れ/辞退/コメントを受け入れ、時間をよりよく管理できます。 このアプリを使用するには、ユーザーがアクティブな 10xGoals サブスクリプションを持っている必要があります。 |
| 会社の本社所在地 | インド |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | アプリケーション | ユーザーのメールと azure ID がフェッチされ、組織のすべてのユーザーに対してアプリをプロアクティブにインストールできます。  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
>| TeamsAppInstallation.ReadWriteSelfForUser.All | アプリケーション | アプリが管理者用にインストールされた teamsAppDefinition をフェッチし、組織のすべてのユーザーに対してプロアクティブにインストールするために必要です。  | [950aa4fb-0583-4b13-9b5f-bbc92b9cc376](../azure/950aa4fb-0583-4b13-9b5f-bbc92b9cc376.md) |
