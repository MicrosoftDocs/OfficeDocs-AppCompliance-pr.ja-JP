---
title: Lucidspark Whiteboard by Lucid Software のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 06/14/2021
...
description: Lucidspark Whiteboard で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64875394"
---
# <a name="lucidspark-whiteboard"></a>Lucidspark Whiteboard

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 5 月 13 日</p>

* <a href="https://teams.microsoft.com/l/app/e9ab21fa-5fd5-48bb-a85d-4de7ced89cd1" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002583" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Lucidspark Whiteboard |
| ID | WA200002583 |
| サポートされているOffice 365 クライアント | Microsoft Teams |
| パートナー会社名 | Lucid Software |
| 会社の Web サイト | [https://lucid.co](https://lucid.co) |
| アプリの使用条件 | [https://lucid.co/tos](https://lucid.co/tos) |
| アプリのコア機能 | Lucidspark は、チームが最善のアイデアを明るくするクラウドベースの仮想ホワイトボードです。 リモートでも対人でも、チームとしてのブレインストーミングと共同作業をリアルタイムで行&#8217;。 Lucidspark は、ユーザーがノートや落書きを整理し、プレゼンテーション対応の概念に変えるのに役立ちます。 次の手順に&#8217;場合、チームはワークフローを開発し、ドキュメントを処理してアイデアを現実のものにすることができます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://lucidchart.zendesk.com](https://lucidchart.zendesk.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Lucid Software によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| メール | 委任 | 名前と電子メール アドレス。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| openid | 委任 | 名前と電子メール アドレス。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
>| profile | 委任 | 名前と電子メール アドレス。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](../azure/3557d5c0-bcab-410b-8a03-f7045aa48de0.md) |
