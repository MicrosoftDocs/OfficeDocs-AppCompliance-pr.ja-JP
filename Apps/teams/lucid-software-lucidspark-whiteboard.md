---
title: Lucidspark ホワイトボードのアプリケーション情報 by Lucid Software
ms.author: elmalova
author: elenamalova
ms.date: 06/14/2021
ms.topic: article
...
description: Lucidspark ホワイトボード、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://lucid.co/tos](https://lucid.co/tos) |
| アプリのコア機能 | Lucidspark は、チームが最高のアイデアを明るいものにできるクラウドベースの仮想ホワイトボードです。 リモートまたは対人で作業する場合でも、リアルタイムでチーム&#8217;し、共同作業を行います。 Lucidspark は、ユーザーがメモや落書きを整理し、プレゼンテーション対応の概念に変換するのに役立ちます。 次の&#8217;を開始すると、チームはワークフローを開発し、ドキュメントを処理してアイデアを現実に変えます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| メール | 委任 | 名前と電子メール アドレス。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](https://docs.microsoft.com/microsoft-365-app-certification/azure/3557d5c0-bcab-410b-8a03-f7045aa48de0) |
>| openid | 委任 | 名前と電子メール アドレス。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](https://docs.microsoft.com/microsoft-365-app-certification/azure/3557d5c0-bcab-410b-8a03-f7045aa48de0) |
>| profile | 委任 | 名前と電子メール アドレス。 | [3557d5c0-bcab-410b-8a03-f7045aa48de0](https://docs.microsoft.com/microsoft-365-app-certification/azure/3557d5c0-bcab-410b-8a03-f7045aa48de0) |
