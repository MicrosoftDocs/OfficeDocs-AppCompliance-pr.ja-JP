---
title: 分析情報によるProjectインサイトProject情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/22/2022
...
description: Project Insight、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63753856"
---
# <a name="project-insight"></a>Projectインサイト

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 21 日</p>

* <a href="https://teams.microsoft.com/l/app/57a8236b-4ed2-453e-b785-02a887e16a5b" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003171" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Microsoft へのインサイトProject提供される情報:
...
| パートナー会社名 | Projectインサイト |
| 会社の Web サイト | [https://projectinsight.com](https://projectinsight.com) |
| アプリの利用規約 | [https://projectinsight.com/legal/license-agreement](https://projectinsight.com/legal/license-agreement) |
| アプリのコア機能 | Projectインサイトを使用すると、チームは自分の仕事、プロジェクト、時間、経費を直接管理Teams。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://projectinsight.com/features/microsoft-teams-integra...](https://projectinsight.com/features/microsoft-teams-integration) |
...
この情報は、Project インサイトによって、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザー アカウント ID |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteForUser.All | 委任 | テナント内のユーザーに対してアプリをインストールMicrosoft Teamsするには | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| User.Read.All | 委任 | システムとテナント間のユーザーの照合Microsoft Teamsする | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
>| offline_access | 委任 | 更新トークンの要求に使用される | [2201df78-1d70-41da-ba2b-c19b00da1215](../azure/2201df78-1d70-41da-ba2b-c19b00da1215.md) |
