---
title: BrainCore Solutions GmbH による不在のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/07/2022
...
<p>開発者による最終更新日: 2022 年 3 月 1 日</p>

* <a href="https://teams.microsoft.com/l/app/fbd349eb-146f-4e94-af76-df4754f40749" target="_blank">ストアでの表示Teamsする</a>
* <a href="https://appsource.microsoft.com/product/office/WA200003833" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

BrainCore Solutions GmbH から Microsoft に提供される情報:
...
| パートナー会社名 | BrainCore Solutions GmbH |
| 会社の Web サイト | [https://braincore.solutions](https://braincore.solutions) |
| アプリの利用規約 | [https://absentify.com/terms-and-conditions](https://absentify.com/terms-and-conditions) |
| アプリのコア機能 | 従業員の休み時間を処理する最も簡単な方法は、Microsoft Teams |
| 会社の本社所在地 | スイス |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する BrainCore Solutions GmbH によって提供されています。
