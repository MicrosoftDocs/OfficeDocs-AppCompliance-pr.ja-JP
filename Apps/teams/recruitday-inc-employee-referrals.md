---
title: Recruitday Inc. による従業員紹介のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/18/2021
...
description: 従業員紹介、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべてのセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/c179cdf6-f93d-4aa3-9e2d-e934e5a81846" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200002708" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://www.recruitday.com](https://www.recruitday.com) |
| アプリの使用条件 | [https://www.recruitday.com/terms-of-use](https://www.recruitday.com/terms-of-use) |
| アプリのコア機能 | フレンドを参照して、会社で仕事を開き、Microsoft Teamsを使用して報酬を追跡します。 |
| 会社の本社の場所 | フィリピン (the) |
| アプリ情報ページ | [https://employer.recruitday.com/solutions/employee-referral...](https://employer.recruitday.com/solutions/employee-referrals/microsoft-teams) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Recruitday Inc.から提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 両方とも | 名と姓 (アプリ ユーザー 、つまり従業員) は主に人事ユーザーによって使用され、紹介アプリケーションの追跡と報酬の支払いの候補を参照した従業員を簡単に識別します。 また、システムによって生成された電子メール通知が送信されたときに、従業員に適切に対処するためにも使用されます。 | [7414b436-87d1-4904-9d52-ff47885b89f1](../azure/7414b436-87d1-4904-9d52-ff47885b89f1.md) |
