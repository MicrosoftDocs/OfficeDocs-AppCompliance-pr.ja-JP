---
title: Engage Squared によるボード Connectのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/15/2021
...
description: ボード Connect、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/e8f06a4e-cefe-4b1e-a24b-c97bea471130" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001955" target="_blank">AppSource で表示する</a>
...
| 会社の Web サイト | [https://engagesq.com](https://engagesq.com) |
| アプリの使用条件 | [https://boardconnect.app/terms](https://boardconnect.app/terms) |
| アプリのコア機能 | ボード Connectは、組織がより効率的に会議を実行するのに役立ちます。 Microsoft チームに関連付けられたMicrosoft Teams アプリを使用すると、組織は会議の作成、議題の管理、投票、ドキュメントなどを行うことができます。 また、このアプリケーションは、Outlook予定表と Office 365 グループと統合して、新しい予定表イベントを作成し、イベントの整理と管理を行うボード の幹事を支援します。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://boardconnect.app](https://boardconnect.app) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Engage Squared によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.ReadWrite | 委任 | アプリが、アプリを介して送信されたボード会議出席応答を反映するようにユーザー 予定表を更新できるようにする。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| Group.ReadWrite.All | 委任 | アプリでグループ 予定表イベントを作成、更新、削除できるようにするには、 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| Sites.Manage.All | 委任 | アプリでリストとライブラリを作成できるようにするには、リスト アイテムを管理し、チーム サイト コレクションでドキュメントを管理します。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| User.Read | 委任 | ユーザーがアプリにサインインし、アプリが現在サインインしているユーザーのプロファイルを読み取ることができるようにするため。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| User.ReadBasic.All | 委任 | アプリでこれをアプリに表示するために、サインインしているユーザーに代わって他のユーザーのプロファイル プロパティの基本セットを読み取ることをアプリに許可します。 これには、表示名、名と姓、電子メール アドレス、写真が含まれます。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
>| offline_access | 委任 | アプリが更新トークンを取得できるようにするには、現在のアクセス トークンの有効期限が切れたときに新しいアクセス トークンを取得するために使用できます。 | [4a6873f6-8360-4023-bd6f-2923d1eb2e94](../azure/4a6873f6-8360-4023-bd6f-2923d1eb2e94.md) |
