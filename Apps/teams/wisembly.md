...
description: Wisembly で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| アプリのコア機能 | シンプルで魅力的な仮想イベントとハイブリッド イベントの作成 セミナー、会議、ワークショップ...。Wisembly は、カスタマイズ可能なホームページ、登録、ワークショップと全体セッションの組織、ビデオ ツール、対話型機能など、必要に応じてイベント プロジェクトを最初から最後までガイドします。 |
| 会社の本社所在地 | フランス |
