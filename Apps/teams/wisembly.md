...
description: Wisembly で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://teams.microsoft.com/l/app/b63d5c73-8c76-4d8b-b0dc-ca35c6e37a90" target="_blank">Teams ストアで表示する</a>
* <a href="https://appsource.microsoft.com/product/office/WA200001554" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Wisembly から Microsoft に提供される情報:
...
| パートナー会社名 | Wisembly |
| 会社の Web サイト | [https://wisembly.com](https://wisembly.com) |
| アプリの使用条件 | [https://wisembly.com/en/condition-of-sale.html](https://wisembly.com/en/condition-of-sale.html) |
| アプリのコア機能 | シンプルで魅力的な仮想イベントとハイブリッド イベントのセミナー、会議、ワークショップを作成します。..Wisembly では、カスタマイズ可能なホームページ、登録、ワークショップと全体セッションの編成、ビデオ ツール、対話型機能など、ニーズに合わせてイベント プロジェクトを最初から最後まで案内します。 |
| 会社の本社の場所 | フランス |
| アプリ情報ページ | [https://wisembly.com](https://wisembly.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Wisembly によって提供されています。
