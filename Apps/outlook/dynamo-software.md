---
title: Dynamo ソフトウェアによる Dynamo のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/09/2022
...
description: Dynamo で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "65312291"
---
# <a name="dynamo"></a>ダイナモ

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 9 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004007" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Dynamo Software から Microsoft に提供される情報:
...
| パートナー会社名 | Dynamo ソフトウェア |
| 会社の Web サイト | [https://www.dynamosoftware.com](https://www.dynamosoftware.com) |
| アプリの使用条件 | [https://www.dynamosoftware.com/End-User-Terms](https://www.dynamosoftware.com/End-User-Terms) |
| アプリのコア機能 | Outlook用の Dynamo&#8217;Office アドインは、既存のダイナモ ユーザーがデスクトップ Outlook アプリケーションを介して Windows Outlook および Web (Office 365およびOutlook.com) で Dynamo を操作できるようにするサポート プログラムです。 差し込み印刷の下書きを送信したり、予定やアクティビティを添付ファイルと共に Dynamo に追加したり、Dynamo を開かずに連絡先、会社、取引、および資金の種類の新しいアイテムを作成したりできます。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://help.dynamosoftware.com/about-dynamo-web-add-in-for...](https://help.dynamosoftware.com/about-dynamo-web-add-in-for-outlook/) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Dynamo Software によって提供されています。
...
| プライバシー ポリシーの URL | https://www.dynamosoftware.com/privacy-policy/ |
