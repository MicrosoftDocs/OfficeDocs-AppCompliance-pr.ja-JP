---
title: XQ メッセージによる XQ セキュリティで保護された電子メールのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/10/2021
...
description: XQ Secure Email に使用できるすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200000090" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

XQ メッセージから Microsoft に提供される情報:
...
| パートナー会社名 | XQ メッセージ |
| 会社の Web サイト | [https://xqmsg.co](https://xqmsg.co) |
| アプリの使用条件 | [https://xqmsg.com/terms.html](https://xqmsg.com/terms.html) |
| アプリのコア機能 | メールからファイルへのすべての通信&#8212;を保護します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://xqmsg.co/about](https://xqmsg.co/about) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する XQ メッセージによって提供されています。
