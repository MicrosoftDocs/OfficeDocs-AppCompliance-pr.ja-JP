---
title: Adobe Inc. による Adobe Acrobat Sign for Microsoft Outlook のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Adobe Acrobat Sign for Microsoft Outlook、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA104381158" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Adobe Acrobat Sign for Microsoft Outlook |
| ID | WA104381158 |
...
| アプリのコア機能 | Adobe Sign をOutlookに追加するときに、ドキュメント署名ワークフローを高速に移動し続けます。 これで、Outlookで、ドキュメントに署名し、法的に拘束力のある電子署名と承認のために送信&#8212;すべて、Microsoft の優先電子署名ソリューションを使用できます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
...
>| offline_access | 委任 | アクセス トークンを更新するには、現在のトークンの有効期限が切れている場合。 たとえば、ユーザーが署名&quot;の送信ウィンドウに&quot;いて、非アクティブな状態を長すぎる場合、ユーザーがアクティブになっているときに新しいトークンを更新する必要があります。 | [a9b0c190-bafb-49ca-a61a-dab99cf2c43b](../azure/a9b0c190-bafb-49ca-a61a-dab99cf2c43b.md) |
