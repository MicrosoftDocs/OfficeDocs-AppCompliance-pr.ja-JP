---
title: Outreach によるOutlookの Outreach Sales Engagement のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/19/2021
...
description: outreach Sales Engagement for Outlook、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "64879474"
---
# <a name="outreach-sales-engagement-for-outlook"></a>Outlookの Outreach Sales Engagement

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 6 月 14 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381052" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Outlookの Outreach Sales Engagement |
| ID | WA104381052 |
| サポートされているOffice 365 クライアント | Windows Outlook 2013 以降、Mac Outlook 2016 以降、Outlook on the web |
| パートナー会社名 | アウトリーチ |
| 会社の Web サイト | [https://www.outreach.io](https://www.outreach.io) |
| アプリの使用条件 | [https://www.outreach.io/terms](https://www.outreach.io/terms) |
| アプリのコア機能 | Outreach は、企業が生産性を大幅に向上させ、顧客とのよりスマートで洞察に満ちたエンゲージメントを促進するのに役立つ、最大かつ最も急速に成長している販売エンゲージメント プラットフォームです。 営業の自動化から会話インテリジェンス、バイヤーセンチメント分析、チームのパフォーマンス レポート&#8212;など、さまざまな&#8212;アウトリーチは、営業担当者とリーダーが生産性を向上させ、より多くの販売機会を生み出し、売上目標を達成するのに役立つ統合販売エンゲージメント プラットフォームです。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.outreach.io/product](https://www.outreach.io/product) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | Azure、GCP、AWS |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて Outreach から提供されています。
