...
description: Outlook の Outreach Sales Engagement、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリの利用規約 | [https://www.outreach.io/terms](https://www.outreach.io/terms) |
| アプリのコア機能 | Outreach は、企業が生産性を劇的に向上させ、顧客とのスマートで洞察力のあるエンゲージメントを促進するのに役立つ、最大かつ最も急成長している販売エンゲージメント プラットフォームです。 営業オートメーション、会話インテリジェンス、バイヤーセンチメント分析、チームパフォーマンスレポート&#8212; など、&#8212; Outreach は、営業担当者とリーダーが生産性を高め、販売機会を増やし、販売目標を達成するのに役立つ統合された販売エンゲージメント プラットフォームです。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://www.outreach.io/product](https://www.outreach.io/product) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダー | Azure、GCP、AWS |
