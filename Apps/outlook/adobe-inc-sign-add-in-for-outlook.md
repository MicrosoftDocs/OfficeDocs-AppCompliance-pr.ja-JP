---
title: Adobe Inc. によるOutlookの Adobe Sign Add-In のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Outlook、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する Adobe Sign Add-Inで利用可能なすべてのセキュリティとコンプライアンス情報。
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Adobe Sign Add-In for Outlook |
| ID | WA104381158 |
