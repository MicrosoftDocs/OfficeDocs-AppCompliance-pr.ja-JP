...
| ID | WA104381158 |
| Office 365 クライアントがサポートされている | Outlook 2013 以降の Windows、Outlook 2016 以降の Mac、Outlook on the web |
| パートナー会社名 | Adobe Inc. |
...
| 利用規約の URL | [https://go.microsoft.com/fwlink/?LinkID=521715&amp;omkt=en](https://go.microsoft.com/fwlink/?LinkID=521715&amp;omkt=en) |
...
>Microsoft Outlook アプリケーション用のシステムでは、お客様の管理者とのやり取りは一切行われなかっています。
