---
title: Wrike 社による Wrike Outlookアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2020
...
| ID | WA104381120 |
| Office 365サポートされているクライアント | Outlook 2013 以降の mac Windows、Outlook 2016 以降、iOS、Outlook on the web、Android Outlook on the web、Outlook の Outlook |
| パートナー会社名 | Wrike Inc. |
