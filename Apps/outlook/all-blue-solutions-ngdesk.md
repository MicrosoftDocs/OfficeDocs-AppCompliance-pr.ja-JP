---
title: すべてのブルーソリューションによるngDeskのアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 03/08/2021
ms.topic: article
...
description: NGDeskの利用可能なセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、そのMicrosoft Cloud App Securityアプリカタログ情報、CSA STARレジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200002505" target="_blank">アプリソースで表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

マイクロソフトに提供されるすべてのブルー ソリューションによって提供される情報:
...
| プライバシーポリシーの URL | [https://ngdesk.com/privacy-policy-office-365](https://ngdesk.com/privacy-policy-office-365) |
...
この情報は、このアプリが組織のデータを収集して格納する方法と、アプリが収集するデータに対する組織のコントロールに関する All Blue Solutions によって提供されています。
...
この情報は、このアプリが認証、承認、アプリケーション登録のベストプラクティス、およびその他のID基準を処理する方法について、All Blue Solutionsによって提供されています。
