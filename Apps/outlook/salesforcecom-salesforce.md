...
description: Salesforce で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
| 会社の Web サイト | [https://www.salesforce.com](https://www.salesforce.com) |
| アプリの利用規約 | [https://www.salesforce.com/content/dam/web/en_us/www/docume...](https://www.salesforce.com/content/dam/web/en_us/www/documents/legal/Agreements/software-order-form-supplements/Salesforce_Outlook_TOU_Order_Form_Addendum.pdf) |
| アプリのコア機能 | Salesforce を簡単にOutlook。 統合は 100% クラウド ベースで、プッシュ、インストール、または保守するソフトウェアはありません。 Salesforce と Outlook を切り替えることなく、メールや予定に関連付けられているすべての連絡先、見込み客、取引先、商談、ケースを表示します。Salesforce データは Outlook に直接表示されます。 カスタム オブジェクト レコードを含む新しい Salesforce レコードを直接作成Outlook。 作成中でも、メールと予定を 1 回のクリックで Salesforce レコードに追加する |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
