...
description: CI-Signature、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200002458" target="_blank">AppSource での表示</a>
...
| アプリの利用規約 | [https://www.ci-solution.com/agb](https://www.ci-solution.com/agb) |
| アプリのコア機能 | CI-Sign によってサーバー側で生成された Outlook と OWA に表示される署名と、CI-Disclaimer によってサーバー側に署名が追加された場合のプレビューを追加して、企業の ID 要件と法的に必要な要件を満たします。  |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | [https://www.ci-solution.com/support/de/](https://www.ci-solution.com/support/de/) |
