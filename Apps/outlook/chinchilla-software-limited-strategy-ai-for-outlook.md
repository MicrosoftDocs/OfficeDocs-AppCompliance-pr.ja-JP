---
title: Chinchilla Software Limited による戦略-AI Outlookアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 12/14/2021
ms.topic: article
...
description: Outlook の Strategy-AI、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "62155412"
---
# <a name="strategy-ai-for-outlook"></a>企業向け Strategy-AI Outlook
