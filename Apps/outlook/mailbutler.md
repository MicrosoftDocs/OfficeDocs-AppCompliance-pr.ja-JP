---
title: Mailbutler による Mailbutler のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 12/09/2021
...
description: Mailbutler、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63540925"
---
# <a name="mailbutler"></a>Mailbutler

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 4 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001031" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Mailbutler が Microsoft に提供する情報:
...
| パートナー会社名 | Mailbutler |
| 会社の Web サイト | [https://www.mailbutler.io](https://www.mailbutler.io) |
| アプリの利用規約 | [https://www.mailbutler.io/terms-and-conditions](https://www.mailbutler.io/terms-and-conditions) |
| アプリのコア機能 | Mailbutler は、生産性を最大限に高め、メールを常に維持するために必要なすべてを提供するメール プラグインです。 Mailbutler には、多数の便利で生産性を高める機能が用意されています。この機能は、受信トレイから直接アクセスできます。 その機能は、顧客とのコミュニケーションを改善し、ブランドにとどまり、電子メール ゲームを最適化するのに役立ちます。 |
| 会社の本社所在地 | ドイツ |
| アプリ情報ページ | [https://www.mailbutler.io](https://www.mailbutler.io) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Mailbutler によって提供されています。
...
| データベースに格納されているデータは何ですか? | 電子メール ID、電子メール メタデータ (サブジェクト、送信者/受信者、顧客が承認した場合)、連絡先データ (ユーザーがインポートした場合) |
...
| プライバシー ポリシーの URL | https://www.mailbutler.io/privacy-policy-mailbutler/ |
