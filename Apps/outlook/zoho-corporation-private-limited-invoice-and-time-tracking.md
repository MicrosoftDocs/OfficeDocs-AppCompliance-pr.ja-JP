---
title: 請求書と時間の追跡のためのアプリケーション情報 - Zoho株式会社株式会社のZoho請求書
ms.author: elmalova
author: elenamalova
ms.date: 12/16/2019
ms.topic: article
...
description: 請求書および時間追跡 - Zoho Invoice、そのデータ処理ポリシー、そのMicrosoft Cloud App Securityアプリカタログ情報、CSA STARレジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティおよびコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA104381067" target="_blank">アプリソースで表示</a>
...
| プライバシーポリシーの URL | [https://zoho.com/privacy.html](https://zoho.com/privacy.html) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Contacts.Read | 委任 |  |  ユーザーが Office365 連絡先を Zoho 請求書と同期できるようにします。 | f6d7187a-b437-4eca-bbc5-c1331609fe07 |
>| Mail.Read | 委任 |  |  | f6d7187a-b437-4eca-bbc5-c1331609fe07 |
>| Mail.Send | 委任 |  |  | f6d7187a-b437-4eca-bbc5-c1331609fe07 |
>| User.Export.All | 委任 |  | ユーザーがすべてのユーザー関連情報をエクスポートできるようにします。 | f6d7187a-b437-4eca-bbc5-c1331609fe07 |
>| User.Read.All | 委任 |  | ユーザーがサインインしてユーザー プロファイルを読み取ることができるようにします。 | f6d7187a-b437-4eca-bbc5-c1331609fe07 |
>| User.ReadBasic.All | 委任 |  | ユーザーが Office365 ユーザーを Zoho にインポートできるようにします。 | f6d7187a-b437-4eca-bbc5-c1331609fe07 |
...
>テレメトリとログでEUII / PIIを収集しません。

#### <a name="organizational-controls-for-data-stored-by-partner"></a>パートナーが保存するデータの組織的な統制

組織の管理者がパートナー システムの情報を制御する方法について説明する。削除、保存、監査、アーカイブ、エンドユーザーポリシーなど

>データはユーザーの同意を得た後にのみ取得されます。 サーバーへの論理的なアクセスは、独立した専用ネットワークを介して提供 &amp; され、高度にセキュリティ保護され、監視されます。 このネットワークはファイアウォール、2 要素認証、および Kerberos 認証で保護されています。
