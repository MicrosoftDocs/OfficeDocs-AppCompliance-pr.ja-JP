---
title: DocuSign, Inc. によるOutlookの DocuSign のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/25/2022
...
description: docuSign for Outlook、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "65688582"
---
# <a name="docusign-for-outlook"></a>Outlookの DocuSign

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 24 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104218067" target="_blank">AppSource で表示する</a>
...
| アプリのコア機能 | Outlookで電子メールの添付ファイルの署名を署名または取得する |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://www.docusign.com/solutions/microsoft/outlook](https://www.docusign.com/solutions/microsoft/outlook) |
