---
title: Outlook by Impression Signatures のインプレッション 署名のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/04/2021
...
description: Outlook、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報について、Impression Signatures で利用可能なすべてのセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "64879874"
---
# <a name="impression-signatures-for-outlook"></a>Outlookのインプレッション シグネチャ

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 7 月 2 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003199" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Impression Signatures から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Outlookのインプレッション シグネチャ |
| ID | WA200003199 |
| サポートされているOffice 365 クライアント | Windows Outlook 2016以降、Mac ではOutlook 2016以降、Outlook on the web |
| パートナー会社名 | Impression Signatures |
| 会社の Web サイト | [https://www.impression-signatures.com](https://www.impression-signatures.com) |
| アプリの使用条件 | [https://www.iubenda.com/terms-and-conditions/8039352](https://www.iubenda.com/terms-and-conditions/8039352) |
| アプリのコア機能 | Impression Signatures は、ECT 法に準拠した eSignatures とセキュリティで保護されたドキュメント配信を提供します。 署名ワークフローを管理し、署名されたドキュメントに追加された安全な保管チェーンを返します。  |
| 会社の本社の場所 | 南アフリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Impression Signatures によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | 両方とも | 認証データとディレクトリ データ。 | [be181d9c-9060-40a0-a692-b29f2e314d16](../azure/be181d9c-9060-40a0-a692-b29f2e314d16.md) |
