...
| アプリの利用規約 | [https://www.quantumworkplace.com/terms-of-use](https://www.quantumworkplace.com/terms-of-use) |
| アプリのコア機能 | 従業員が Quantum Workplace の通知と通知を使用して成功を手伝います。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| TeamsAppInstallation.ReadWriteSelfForUser.All | アプリケーション | ChatId が使用されます。 | [be93046b-63ab-4216-9bcc-78faa55eeaa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/be93046b-63ab-4216-9bcc-78faa55eeaa7) |
>| User.Read.All | アプリケーション | User.Id (ストアド) - ボット エンドポイントに送信されるユーザーを関連付ける場合に使用します。User.UserPrincipalName (保存されません) - 現在使用されていない。User.Mail (Not Stored) - システム内のユーザーと、保存する AzureAD ID を一致するために使用されます。 | [be93046b-63ab-4216-9bcc-78faa55eeaa7](https://docs.microsoft.com/microsoft-365-app-certification/azure/be93046b-63ab-4216-9bcc-78faa55eeaa7) |
