---
title: Achievers による Outlook の Achievers のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/20/2022
...
description: Achievers for Outlook で利用可能なすべてのセキュリティおよびコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66912932"
---
# <a name="achievers-for-outlook"></a>Outlook の達成者

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 10 月 28 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104381896" target="_blank">AppSource で表示する</a>
...
| アプリ名 | Outlook の達成者 |
| ID | WA104381896 |
| サポートされているOffice 365 クライアント | Windows ではOutlook 2016以降、Mac では Outlook 2016 以降、Outlook on the web |
| パートナー会社名 | 成績 |
...
| データベースに格納されているデータは何ですか? | テナント ID、ユーザー ID、ユーザー電子メール |
