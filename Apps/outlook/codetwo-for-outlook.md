---
title: CodeTwo による Outlook 用 CodeTwo のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: codeTwo for Outlook、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003022" target="_blank">AppSource で表示する</a>
...
| アプリのコア機能 | メールの自動署名、メッセージ内の &amp; 法的免責事項のマーケティング バナー。 |
| 会社の本社の場所 | ポーランド |
