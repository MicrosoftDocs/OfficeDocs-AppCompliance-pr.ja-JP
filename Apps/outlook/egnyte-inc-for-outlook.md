---
title: Egnyte, Inc. による Outlook 用 Egnyte のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 07/01/2022
...
description: Egnyte for Outlook で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "66656531"
---
# <a name="egnyte-for-outlook"></a>Outlook 用 Egnyte

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 8 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200004177" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Egnyte, Inc. から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | Outlook 用 Egnyte |
| ID | WA200004177 |
| サポートされているOffice 365 クライアント | Windows では Outlook 2013 以降、Mac では Outlook 2016 以降、Outlook on the web |
| パートナー会社名 | Egnyte, Inc. |
| 会社の Web サイト | [https://www.egnyte.com](https://www.egnyte.com) |
| アプリの使用条件 | [https://www.egnyte.com/terms-and-conditions/01-2020](https://www.egnyte.com/terms-and-conditions/01-2020) |
| アプリのコア機能 | Egnyte から Outlook 内のメールにファイルを簡単に共有したり、受信トレイを離れることなく Outlook から直接 Egnyte フォルダーにメールや添付ファイルを保存したりできます |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125](https://helpdesk.egnyte.com/hc/en-us/articles/4427124922125) |
...
この情報は Egnyte, Inc. によって提供されています。このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて説明しています。
...
| データベースに格納されているデータは何ですか? | 電子メール アドレス、テナント ID、トークン、メッセージと添付ファイルの ID とその内容 |
...
| プライバシー ポリシーの URL | https://www.egnyte.com/privacy-policy |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Mail.Read.Shared | 委任 | ユーザーがアクセスできる電子メールの詳細を読み取るために必要です | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| User.Read | 委任 | 承認目的でユーザーを検証するために必要 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| メール | 委任 | 検証アクセス トークンに必要 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| offline_access | 委任 | OAuth 2.0 を使用するときに更新トークンを明示的に要求するために必要です | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| openid | 委任 | ユーザーの基本情報を読み取るために必要 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
>| profile | 委任 | 基本的なユーザー情報を読み取るために必要 | [092aa7d1-522d-4d9d-90b6-7186e28eaf4a](../azure/092aa7d1-522d-4d9d-90b6-7186e28eaf4a.md) |
