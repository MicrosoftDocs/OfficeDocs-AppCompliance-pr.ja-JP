---
title: iGlobe による Office2SharePoint for Outlook のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/28/2021
...
description: Office2SharePoint for Outlook、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA104380689" target="_blank">AppSource で表示する</a>
...
| ID | WA104380689 |
| サポートされているOffice 365 クライアント | Outlook 2013 以降(Windows、Mac のOutlook 2016以降、iOS でのOutlook、Android でのOutlook、Outlook on the web |
| パートナー会社名 | iGlobe |
