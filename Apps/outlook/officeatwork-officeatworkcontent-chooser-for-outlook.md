---
title: officeatwork |officeatwork による Outlook のコンテンツ選択
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: officeatwork サービスで使用可能なすべてのセキュリティおよびコンプライアンス情報|Outlook のコンテンツ選択機能、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "63548075"
---
# <a name="officeatwork--content-chooser-for-outlook"></a>officeatwork |Outlook のコンテンツ選択
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | officeatwork - Outlook のコンテンツ選択 |
| ID | WA104380690 |
| Office 365 クライアントのサポート | Outlook 2013 以降の Windows、Outlook 2016 以降の Mac、Outlook on the web |
...
| アプリのコア機能 | Word、Excel、PowerPoint、Outlook、Browser、その他のアプリで集中共有されたコンテンツにアクセスします。 |
| 会社の本社所在地 | スイス |
...
| Microsoft 365 用のアプリとアドインは、Microsoft Graph 以外の追加の Microsoft API を使用する場合があります。 アプリまたはアドインで追加の Microsoft API を使用していますか? | はい |

#### <a name="data-access-using-microsoft-graph"></a>Microsoft Graph を使用したデータ アクセス

>|   **グラフのアクセス許可**  | **アクセス許可の種類** |          **妥当性**          | **Azure AD アプリ ID** |
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委任 | お気に入りおよび OneDrive 機能を有効にする | [edb24f8f-38af-4b3e-9475-0da243678d5a](../azure/edb24f8f-38af-4b3e-9475-0da243678d5a.md) |
>| Group.ReadWrite.All | 委任 | Teams 機能を有効にする | [edb24f8f-38af-4b3e-9475-0da243678d5a](../azure/edb24f8f-38af-4b3e-9475-0da243678d5a.md) |
>| GroupMember.Read.All | 委任 | Teams 機能を有効にする | [edb24f8f-38af-4b3e-9475-0da243678d5a](../azure/edb24f8f-38af-4b3e-9475-0da243678d5a.md) |
>| Sites.Read.All | 委任 | SharePoint に格納されているユーザー テンプレート ファイルを読み取る | [edb24f8f-38af-4b3e-9475-0da243678d5a](../azure/edb24f8f-38af-4b3e-9475-0da243678d5a.md) |
...
>| offline_access | 委任 | 古いホストの自動サインインをOfficeする | [edb24f8f-38af-4b3e-9475-0da243678d5a](../azure/edb24f8f-38af-4b3e-9475-0da243678d5a.md) |
