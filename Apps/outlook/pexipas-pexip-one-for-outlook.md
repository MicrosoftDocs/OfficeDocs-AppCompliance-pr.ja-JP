---
title: PexipAS によるOutlook用の Pexip One のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Pexip One for Outlook、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003137" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

PexipAS から Microsoft に提供される情報:
...
| パートナー会社名 | PexipAS |
| 会社の Web サイト | [https://www.pexip.com](https://www.pexip.com) |
| アプリの使用条件 | [https://www.pexip.com/terms](https://www.pexip.com/terms) |
| アプリのコア機能 | Pexip One を使用すると、ユーザーは既存の会議の配置ワークフローを使用しながら、セキュリティで保護された会議を簡単に作成できます。 Pexip 1 では、画面共有、音声、ビデオ チャット機能が提供されます。 |
| 会社の本社の場所 | ノルウェー |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、PexipAS によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委任 | ユーザーのイベント データは、プラットフォームで会議をスケジュールし、会議メタデータの変更を追跡するために使用されます | [69609b5a-e416-4d72-b10b-8903e84780c3](../azure/69609b5a-e416-4d72-b10b-8903e84780c3.md) |
