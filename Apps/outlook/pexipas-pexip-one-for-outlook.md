...
| アプリの利用規約 | [https://www.pexip.com/terms](https://www.pexip.com/terms) |
| アプリのコア機能 | Pexip One を使用すると、ユーザーは既存の会議の配置ワークフローを使用しながら、安全な会議を簡単に作成できます。 Pexip 1 は、画面共有、音声、ビデオ チャット機能を提供します。 |
| 会社の本社所在地 | ノルウェー |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | 委任 | ユーザーのイベント データは、プラットフォーム上の会議をスケジュールし、会議のメタデータに対する変更を追跡するために使用されます。 | [69609b5a-e416-4d72-b10b-8903e84780c3](https://docs.microsoft.com/microsoft-365-app-certification/azure/69609b5a-e416-4d72-b10b-8903e84780c3) |
