---
title: officeatwork |のアプリケーション情報をExcelするOfficeatwork 別のOffice用イメージ 選択子
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/25/2022
...
description: Excelは、セキュリティ、コンプライアンス、およびデータ処理のプラクティスに関する業界標準と制御に対して Microsoft によってレビューされています。 このページには、officeatwork |で使用できるセキュリティとコンプライアンスの情報が表示されます。Office用の Image Chooser、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64784377"
---
# <a name="excel-information-for-officeatwork--image-chooser-for-office"></a>officeatwork |のExcel情報Office用のイメージ選択子


<p></p><a href="https://aka.ms/appcertification" alt="This Microsoft 365 Certified app has been reviewed by Microsoft against industry standards and controls for security, compliance, and data handling practices. Where applicable, Microsoft has verified the developer's claims of compliance with reasonable and effective practices." target="_blank"><img alt="Click here for more information on the Microsoft Certified app program." src="../media/certified.png" width="650" /></a>
<p>開発者が最終更新日: 2022 年 1 月 24 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002683" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|---|---|
| アプリ名 | officeatwork - Office用の画像選択子 |
| ID | WA200002683 |
...
| アプリのコア機能 | Image Bank for M365 \| Word、Excel、PowerPoint、その他のアプリで一元的に共有された画像にアクセスする |
| 会社の本社の場所 | スイス |
...
>| Sites.Read.All | 委任 | SharePointに格納されているユーザー テンプレート ファイルを読み取る | [e8bea835-c6b0-45aa-9c39-889d3c77d5a3](../azure/e8bea835-c6b0-45aa-9c39-889d3c77d5a3.md) |
...
>| offline_access | 委任 | 古いOffice ホストの自動サインインを有効にする | [e8bea835-c6b0-45aa-9c39-889d3c77d5a3](../azure/e8bea835-c6b0-45aa-9c39-889d3c77d5a3.md) |
