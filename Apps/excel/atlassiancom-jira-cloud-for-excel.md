...
description: Jira Cloud for Excel、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリのコア機能 | ソフトウェアを計画、追跡、リリースします。 サポート、顧客サービス、プロジェクトを管理します。 |
| 会社の本社所在地 | オーストラリア |
| アプリ情報ページ | |
