---
title: AnalysisPlace による Excelから Word へのドキュメントオートメーションのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/28/2022
...
description: Excel-to-Word ドキュメントオートメーション、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63536585"
---
# <a name="excel-to-word-document-automation"></a>Excelから Word へのドキュメントの自動化
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Excelから Word へのドキュメントの自動化 |
| ID | WA104380955 |
| Office 365サポートされているクライアント | Excel 2016 mac の Excel 2016 以降、Windows、Word 2016 以降、Windows、PowerPoint 2016 以降の mac、PowerPoint 2016 以降の Word 2016 以降Windows、Excel on the web、Word on the web、PowerPoint on the web |
| パートナー会社名 | AnalysisPlace |
| 会社の Web サイト | [https://analysisplace.com](https://analysisplace.com) |
| アプリの利用規約 | [https://analysisplace.com/Terms](https://analysisplace.com/Terms) |
| アプリのコア機能 | AnalysisPlace は、ドキュメントの更新を自動化するMicrosoft Officeします。 |
| 会社の本社所在地 | アメリカ |
