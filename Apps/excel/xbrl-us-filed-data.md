---
title: XBRL US による XBRL ファイル データのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: XBRL Filed Data、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
---
# <a name="xbrl-filed-data"></a>XBRL Filed Data

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 8 月 2 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002591" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| アプリのコア機能 | XBRL US は、米国における無料でオープンで非プロパティなビジネス 報告基準を構築し、サポートする非営利団体です。XBRL 米国は、政府機関 (証券およびExchange委員会 (SEC)、連邦エネルギー規制委員会 (FERC)、エネルギー省のデータ標準の開発と実装を主導してきました。 XBRL US はデータを監視し、公開企業が高品質の XBRL 財務明細書を作成するのに役立つ SEC で使用されるデータ品質基準を構築するのに役立ちます。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダーはどれですか? | GitHub |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、XBRL US から提供されています。
