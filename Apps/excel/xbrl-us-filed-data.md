---
title: XBRL によってファイルされる XBRL データのアプリケーション情報 US
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/10/2021
...
description: XBRL Filed Data、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63543485"
---
# <a name="xbrl-filed-data"></a>XBRL ファイルデータ

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 8 月 2 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002591" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

XBRL US から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | XBRL ファイルデータ |
| ID | WA200002591 |
| Office 365サポートされているクライアント | Excel 2016 Mac の場合は、Excel 2016以降の場合Windows、Excel on the web |
| パートナー会社名 | XBRL US |
| 会社の Web サイト | [https://xbrl.us](https://xbrl.us) |
| アプリの利用規約 | [https://xbrl.us/terms-of-agreement](https://xbrl.us/terms-of-agreement) |
| アプリのコア機能 | XBRL US は、米国の自由でオープンで非プロプリエティなビジネスレポート標準を構築し、サポートする非営利コンソーシアムです。XBRL US は、政府機関 (証券および Exchange 委員会 )、連邦エネルギー規制委員会 (FERC)、エネルギー省のデータ標準の開発と実装を主導しています。 XBRL US はデータを監視し、SEC が使用するデータ品質基準の構築を支援し、公開企業が高品質の XBRL 財務諸表を作成するのに役立ちます。  |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://xbrl.us/xbrl-api-community](https://xbrl.us/xbrl-api-community) |
| アプリの実行に使用されるホスティング環境またはサービス モデルは何ですか? |  |
| アプリで使用するホスティング クラウド プロバイダー | GitHub |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する XBRL US によって提供されています。
