...
| アプリのコア機能 | XBRL US は、米国の自由でオープンな非プロプリエティビジネスレポート標準を構築し、サポートする非営利コンソーシアムです。XBRL US は、政府機関 (証券および Exchange 委員会)、連邦エネルギー規制委員会 (FERC)、エネルギー省のデータ標準の開発と実装を主導しています。 XBRL US はデータを監視し、SEC が使用するデータ品質基準の構築を支援し、公開企業が高品質の XBRL 財務諸表を作成するのに役立ちます。  |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
