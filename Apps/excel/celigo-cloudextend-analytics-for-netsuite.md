...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 両方とも | ユーザーがサイトを通じて共有されるブックの情報を取得できるアクセス権を持つサイトのコレクションを読み取る | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| Files.ReadWrite.All | 両方とも | テーブルやシートのようなブックのコンテンツを読み取り、それらのテーブルにコンテンツを書き込む | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
