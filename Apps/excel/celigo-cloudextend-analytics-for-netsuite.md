...
| アプリの利用規約 | [https://www.cloudextend.io/agreements/ssa/2019-12/](https://www.cloudextend.io/agreements/ssa/2019-12/) |
| アプリのコア機能 | NetSuite ユーザーの場合、CloudExtend Analytics for NetSuite(CEAN) はデータを視覚化し、適切な時期に適切なビジネス上の意思決定を行う上で必要なすべての分析情報を提供します。 CEAN は、NetSuite データに関する分析情報を取得するために、データをカスタマイズおよび制御する柔軟性を提供する必要なすべてのツールを提供するツールです。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 両方とも | ユーザーがサイトを通じて共有されるブックの情報を取得できるアクセス権を持つサイトのコレクションを読み取る | [7040f194-bf08-400e-acb1-69df7939416a](https://docs.microsoft.com/microsoft-365-app-certification/azure/7040f194-bf08-400e-acb1-69df7939416a) |
>| Files.ReadWrite.All | 両方とも | テーブルやシートのようなブックのコンテンツを読み取り、それらのテーブルにコンテンツを書き込む | [7040f194-bf08-400e-acb1-69df7939416a](https://docs.microsoft.com/microsoft-365-app-certification/azure/7040f194-bf08-400e-acb1-69df7939416a) |
