...
description: CloudExtend Analytics for NetSuite で利用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200002784" target="_blank">AppSource で表示する</a>
...
| ID | WA200002784 |
| サポートされているOffice 365 クライアント | Mac のExcel 2016以降、WindowsでExcel 2016以降、Excel on the web |
| パートナー会社名 | Celigo CloudExtend |
| 会社の Web サイト | [https://www.cloudextend.io](https://www.cloudextend.io) |
| アプリの使用条件 | [https://www.cloudextend.io/agreements/ssa/2019-12/](https://www.cloudextend.io/agreements/ssa/2019-12/) |
| アプリのコア機能 | NetSuite ユーザーの場合、CloudExtend Analytics for NetSuite(CEAN) はデータを視覚化して、適切なビジネス上の決定を適切なタイミングで行うために必要なすべての分析情報を提供します。 CEAN は、NetSuite データに関する分析情報を取得するために、データをカスタマイズおよび制御するための柔軟性を提供するすべての必要なツールを提供するツールです。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Celigo CloudExtend によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 両方とも | ユーザーがアクセス権を持つサイトのコレクションを読み取り、サイトを介して共有されたブックの情報を取得できます | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
>| Files.ReadWrite.All | 両方とも | テーブルやシートなどのブックコンテンツを読み取り、それらのテーブルにコンテンツを書き込む | [7040f194-bf08-400e-acb1-69df7939416a](../azure/7040f194-bf08-400e-acb1-69df7939416a.md) |
