---
title: Forbury プロパティによる Forbury のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 11/19/2021
...
description: Forbury で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200002916" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Forbury プロパティから Microsoft に提供される情報:
...
| パートナー会社名 | Forbury プロパティ |
| 会社の Web サイト | [https://www.forbury.com](https://www.forbury.com) |
| アプリの利用規約 | [https://www.forbury.com/terms-of-use](https://www.forbury.com/terms-of-use) |
| アプリのコア機能 | Forbury ソフトウェアで商用の不動産評価 (分析) に最も速く電力を供給する方法。 |
| 会社の本社所在地 | ニュージーランド |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Forbury プロパティによって提供されています。
...
| プライバシー ポリシーの URL | https://www.forbury.com/privacy-policy |
