---
title: RocketDocs による RocketDocs LaunchPad のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/24/2022
...
description: RocketDocs LaunchPad で利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003648" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

RocketDocs から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | RocketDocs LaunchPad |
| ID | WA200003648 |
| Office 365サポートされているクライアント | Excel 2016 Mac、Excel 2016 以降の mac、Windows Excel 2016、Excel on the web、Word 2016 以降の Mac、Word on the web、Word 2016 以降Windows |
| パートナー会社名 | RocketDocs |
| 会社の Web サイト | [https://rocketdocs.com](https://rocketdocs.com) |
| アプリの利用規約 | [https://rocketdocs.com/end-user-license-agreement/](https://rocketdocs.com/end-user-license-agreement/) |
| アプリのコア機能 | ユーザーが RocketDocs プラットフォームでコンテンツを検索し、ドキュメントに挿入できます。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://rocketdocs.com/platform/](https://rocketdocs.com/platform/) |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、RocketDocs によって提供されています。
