...
| ID | WA104381787 |
| Office 365サポートされているクライアント | Excel 2016、Excel 2016 以降の Mac、Windows、Excel on the web、Word 2016 以降の Mac、Word on the web、Word 2016 以降、WindowsPowerPoint 2016 Mac、PowerPoint on the web、PowerPoint 2016以降の mac でWindows |
| パートナー会社名 | iGlobe |
...
>| Mail.ReadWrite | 委任 | アプリケーション データベースにデータは格納されません。 | [5971c986-9d39-409c-a6f8-1385b1f690ef](https://docs.microsoft.com/microsoft-365-app-certification/azure/5971c986-9d39-409c-a6f8-1385b1f690ef) |
