---
title: Canon EMEA による B2B パートナー向け、Canon EMEA サービス コスト計算ツールのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 08/01/2022
...
description: B2B パートナー向けのCanon EMEA サービス コスト計算ツール、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
---
# <a name="canon-emea-service-cost-calculator-for-b2b-partners"></a>B2B パートナー向けの Canon EMEA サービス コスト計算ツール

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 7 月 27 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003098" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Canon EMEA から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | B2B パートナー向けの Canon EMEA サービス コスト計算ツール |
| ID | WA200003098 |
| サポートされているOffice 365 クライアント | Mac ではExcel 2016以降、Windows では Excel 2013 以降、Excel on the web |
| パートナー会社名 | Canon EMEA |
| 会社の Web サイト | [https://www.canon-europe.com](https://www.canon-europe.com) |
| アプリの使用条件 | [https://partners.canon-europe.com/partners/s/Terms%20and%20...](https://partners.canon-europe.com/partners/s/Terms%20and%20Conditions%20-%20English%20(Partner%20Portal)) |
| アプリのコア機能 | Canon プリンターのサービス コストの正確で透過的で生産性の高い計算 (B2B) |
| 会社の本社の場所 | オランダ (the) |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、Canon EMEA から提供されています。
...
| プライバシー ポリシーの URL | https://www.canon-europe.com/privacy-policy/business/ |
