...
| パートナー会社名 | インプレッション署名 |
| 会社の Web サイト | [https://www.impression-signatures.com](https://www.impression-signatures.com) |
| アプリの利用規約 | [https://www.iubenda.com/terms-and-conditions/8039352](https://www.iubenda.com/terms-and-conditions/8039352) |
| アプリのコア機能 | インプレッション署名は、ECT Act 準拠の eSignatures と Secure Document Delivery を提供します。 署名ワークフローを管理し、署名されたドキュメントに追加された安全な保管チェーンを返します。  |
| 会社の本社所在地 | 南アフリカ |
| アプリ情報ページ | |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| openid | 両方とも | Auth データとディレクトリ データ。 | [be181d9c-9060-40a0-a692-b29f2e314d16](https://docs.microsoft.com/microsoft-365-app-certification/azure/be181d9c-9060-40a0-a692-b29f2e314d16) |
