...
description: Report Builder、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
| アプリ名 | Report Builder |
| ID | WA200003101 |
| Office 365サポートされているクライアント | Excel 2016 2013 以降の Mac では、Excel 2013 以降のWindows、Excel on the web |
| パートナー会社名 | Adobe Inc. |
| 会社の Web サイト | [https://experiencecloud.adobe.com](https://experiencecloud.adobe.com) |
| アプリの利用規約 | [https://wwwimages.adobe.com/content/dam/acom/en/legal/licen...](https://wwwimages.adobe.com/content/dam/acom/en/legal/licenses-terms/pdf/EULA-en_US-20190910_1413.pdf) |
| アプリのコア機能 | Adobe Customer Journey analytics Excelデータを使用して、新しいレポートを作成します。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | |
