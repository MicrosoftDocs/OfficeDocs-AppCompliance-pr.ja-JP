---
title: Adobe Inc. によるReport Builderのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/02/2021
...
description: Report Builder、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003101" target="_blank">AppSource で表示する</a>
...
| アプリの使用条件 | [https://wwwimages.adobe.com/content/dam/acom/en/legal/licen...](https://wwwimages.adobe.com/content/dam/acom/en/legal/licenses-terms/pdf/EULA-en_US-20190910_1413.pdf) |
| アプリのコア機能 | Adobe Customer Journey Analytics データを使用してExcelレポートを作成します。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | |
