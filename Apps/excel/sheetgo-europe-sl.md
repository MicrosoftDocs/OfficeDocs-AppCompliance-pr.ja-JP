...
| アプリのコア機能 | Sheetgo は、ユーザーがオンライン スプレッドシートを接続し、自動データ管理システムを構築できるワークフロー自動化プラットフォームです。 Sheetgo Web アプリは、さまざまなテンプレートと共に、ワークフローを作成および管理するためのプラットフォームを提供します。 Google スプレッドシート用の Excel およびアドオン用の Sheetgo アドインを使用すると、ユーザーはスプレッドシート内で直接接続して自動化できます。また、Teams アプリを使用すると、ワークフロー作成者は、チャネルやグループ チャットの同僚と接続したファイルを共有できます。 |
| 会社の本社所在地 | スペイン |
| アプリ情報ページ | |
