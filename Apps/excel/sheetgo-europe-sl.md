...
description: Sheetgo で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64784546"
---
# <a name="sheetgo-application-information"></a>SHEETGO アプリケーション情報

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 1 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002128" target="_blank">AppSource で表示する</a>
...
| アプリ名 | Sheetgo |
| ID | WA200002128 |
| サポートされている Office 365 クライアント | Mac では Excel 2016 以降、Windows では Excel 2016 以降、Excel on the web |
| パートナー会社名 | SHEETGO EUROPE SL |
| 会社の Web サイト | [https://www.sheetgo.com](https://www.sheetgo.com) |
| アプリの使用条件 | [https://www.sheetgo.com/legal/terms/](https://www.sheetgo.com/legal/terms/) |
| アプリのコア機能 | Sheetgo は、ユーザーがオンライン スプレッドシートを接続し、自動化されたデータ管理システムを構築できるようにするワークフロー自動化プラットフォームです。 Sheetgo Web アプリは、さまざまなテンプレートと共にワークフローを作成および管理するためのプラットフォームを提供します。 Excel 用 Sheetgo アドインと Google スプレッドシート用アドオンを使用すると、ユーザーはスプレッドシート内から直接接続して自動化でき、Teams アプリを使用すると、ワークフロー作成者は、チャネルやグループ チャットで接続されたファイルを同僚と共有できます。 |
| 会社の本社の場所 | スペイン |
| アプリ情報ページ | [https://www.sheetgo.com](https://www.sheetgo.com) |
...
| データベースに格納されているデータは何ですか? | ファイル サイズ、スプレッドシート所有者、スプレッドシート ユーザー、最終更新日、ファイル名などのスプレッドシート メタデータ。スプレッドシート データは保存しません |
...
| プライバシー ポリシーの URL | https://www.sheetgo.com/legal/privacy |
