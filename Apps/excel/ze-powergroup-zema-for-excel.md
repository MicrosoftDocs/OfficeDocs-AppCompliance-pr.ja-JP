---
title: ZE PowerGroup による ZEMA Excelアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/17/2022
...
description: Excel の ZEMA で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
ms.locfileid: "63543495"
---
# <a name="zema-for-excel"></a>ZEMA for Excel

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 17 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002229" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ZE PowerGroup から Microsoft に提供される情報:
...
| パートナー会社名 | ZE PowerGroup |
| 会社の Web サイト | [https://www.ze.com](https://www.ze.com) |
| アプリの利用規約 | [https://www.ze.com/terms-of-use/](https://www.ze.com/terms-of-use/) |
| アプリのコア機能 | ZEMA データと分析をユーザーのブックにすばやく簡単Excelインポートします。 |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する ZE PowerGroup によって提供されています。
