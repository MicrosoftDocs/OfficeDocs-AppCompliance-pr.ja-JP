...
* <a href="https://appsource.microsoft.com/product/office/WA104381807" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Supermetrics が Microsoft に提供する情報:
...
| アプリのコア機能 | Supermetrics を使用すると、企業は、Facebook 広告、Google Analytics、Instagram などの 70 以上のマーケティングおよび販売プラットフォームからサイロ化されたデータを集計し、レポートの目的でデータを Excel に直接転送できます。 これにより、次の操作を実行できます。 - 手動データ インポート タスクを自動化します。- マーケティング データを分析および視覚化するには、Excel使用できる数式とツールを使用します。- データ ソースを複数のデータ ソースで直接表示して、Excel。 |
| 会社の本社所在地 | フィンランド |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Supermetrics によって提供されています。
...
| データベースに格納されているデータは何ですか? | 名前、電子メール アドレス、連絡先情報 |
