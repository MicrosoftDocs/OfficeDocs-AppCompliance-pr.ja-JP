---
title: Foxit Software Inc. Microsoft Word、Excel、PowerPoint Foxit PDF Editor のアプリケーション情報。
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: foxit PDF Editor for Microsoft Word、Excel、PowerPoint、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "64602535"
---
# <a name="foxit-pdf-editor-for-microsoft-word-excel-and-powerpoint"></a>Foxit PDF Editor for Microsoft Word、Excel、およびPowerPoint

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 17 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003206" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Foxit Software Inc. から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Foxit PDF Editor for Microsoft Word、Excel、およびPowerPoint |
| ID | WA200003206 |
| Office 365サポートされているクライアント | Excel 2016 2013 以降、Excel Windows、Excel on the web、Word 2016 以降の Mac、Word on the web、Word 2013 以降の Windows、PowerPoint 2016、または後で Mac、PowerPoint on the web、PowerPoint 2013 以降のWindows |
| パートナー会社名 | Foxit Software Inc. |
| 会社の Web サイト | [https://www.foxit.com](https://www.foxit.com) |
| アプリの利用規約 | [https://www.foxit.com/product/terms-of-service.html](https://www.foxit.com/product/terms-of-service.html) |
| アプリのコア機能 | foxit PDF Editor for Microsoft Teams を使用すると、Microsoft Teams を離れることなくドキュメントを操作できます。1.Secure collaboration-Share PDF を作成し、チャネル内のすべてのユーザーと共同作業を行い、Microsoft SharePoint または 1 ドライブ&#65307; 2.高品質の表示でドキュメントを保存します。高品質の表示 PDF を安全かつ簡単に使用できます。Microsoft Teams&#65307; 3.テキスト マークアップPDF-Provide PDF ツールを使用してドキュメントへのフィードバックに注釈を付ける。 |
| 会社の本社所在地 | 中国 |
| アプリ情報ページ | |
...
この情報は、Foxit Software Inc. から、このアプリが組織データを収集および保存する方法、およびアプリが収集するデータに対して組織が持つコントロールについて提供されています。
...
| データベースに格納されているデータは何ですか? | メール、ユーザー名、ユーザー ID |
...
| 多要素認証 (MFA) が有効になっているのは、次の場合です。 | CodeRepositories |
...
| プライバシー ポリシーの URL | https://www.foxit.com/company/privacy-policy.html |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | 委任 | ユーザー ドキュメントを読み取り、ドキュメントを保存します。 | [959a79dd-69d0-4d05-b9a8-b9f02e28c049](../azure/959a79dd-69d0-4d05-b9a8-b9f02e28c049.md) |
