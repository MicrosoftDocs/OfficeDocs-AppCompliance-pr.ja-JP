---
title: Content Chooser のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 06/23/2021
ms.topic: article
...
description: Content Chooser で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "65225017"
---
# <a name="application-information-for-content-chooser-by-officeatwork"></a>Officeatwork による Content Chooser のアプリケーション情報

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 6 月 23 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.content-chooser" target="_blank">AppSource で表示する</a>
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.ReadWrite.All | 委任 | データは格納されません。 | お気に入り: ユーザーがOneDriveにデータを読み書きできるようにする。 | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| Files.ReadWrite.All | 委任 | データは格納されません。 | OneDrive: OneDriveユーザーに対してデータの読み取りと書き込みを行うことができる。 | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| Group.ReadWrite.All | 委任 | データは格納されません。 | Teams: グループに対してデータの読み取りと書き込みを行うことができる。 | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| GroupMember.Read.All | 委任 | データは格納されません。 | SharePoint オンライン - セキュリティ グループのサポート: アプリでグループの一覧表示、基本的なグループ プロパティの読み取り、サインインしているユーザーがアクセス権を持つすべてのグループのメンバーシップの読み取りを許可する | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| Sites.Read.All | 委任 | データは格納されません。 | オンラインSharePoint: SharePoint Online からデータの読み取りを有効にします。 | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| User.Read | 委任 | データは格納されません。 | Sing-In: officeatwork アプリがユーザーの基本プロパティを読み取られるようにします。 | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| User.Read.All | 委任 | データは格納されません。 | Teams: ユーザーが属しているグループを確認します。 | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| offline_access | 委任 | データは格納されません。 | Sing-In: 更新トークンを使用して自動サインインを有効にするには、ユーザーが officeatwork アプリを起動するたびに手動でサインインする必要があります。 このスコープは、SSO が有効でないホスト アプリケーションでのみ必要です。 | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| openid | 委任 | データは格納されません。 | Sing-In: ユーザーが組織または Microsoft アカウントを使用して officeatwork アプリにサインインできるようにします。 | edb24f8f-38af-4b3e-9475-0da243678d5a |
>| profile | 委任 | データは格納されません。 | Sing-In: Officeatwork アプリでサインインしているユーザーを表示します。 これにより、Officeatwork アプリへのサインインに使用されたアカウントをユーザーに保証/確認できます。 | edb24f8f-38af-4b3e-9475-0da243678d5a |
...
<iframe height='1020' title='Microsoft Cloud App Security情報' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35751' frameborder='no'></iframe>
