---
title: iPlanner Pro Office 365のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 06/22/2021
ms.topic: article
...
---
# <a name="application-information-for-iplanner-pro-office-365"></a>iPlanner Pro Office 365のアプリケーション情報
...
| 使用条件の URL | [https://iglobecrm.com/content/end-user-license-agreement-ig...](https://iglobecrm.com/content/end-user-license-agreement-iglobe-iplanner-add-ins) |
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Calendars.ReadWrite | 委任 | アプリケーション データベースにはデータは格納されません。 | Planner タスクを取得し、新しいタスクを追加するには、特定のユーザーのバケットとスイム ラインを更新します | a6f5c2f4-0bc2-48bf-8afe-6c93583a152b |
>| Contacts.ReadWrite | 委任 | アプリケーション データベースにはデータは格納されません。 | タスクの期限日にユーザーの予定表に予定を作成する | a6f5c2f4-0bc2-48bf-8afe-6c93583a152b |
...
>| Files.Read | 委任 | アプリケーション データベースにはデータは格納されません。 | 添付ファイルとしてファイルにアクセスし、ファイルをタスクにアップロードするには | a6f5c2f4-0bc2-48bf-8afe-6c93583a152b |
>| Files.ReadWrite.All | 委任 | アプリケーション データベースにはデータは格納されません。 | 選択したメールからメールの件名を取得します。 アプリが選択したメールから情報を取得し、説明フィールドをタスクの説明にコピーし、メールまたはメール自体からタスクに添付ファイルを保存できるようにします。 | a6f5c2f4-0bc2-48bf-8afe-6c93583a152b |
>| Group.Read.All | 委任 | アプリケーション データベースにはデータは格納されません。 | Planner タスクを取得し、特定のユーザーのバケットとスイム ラインを更新する新しいタスクを追加する | a6f5c2f4-0bc2-48bf-8afe-6c93583a152b |
>| User.Read | 委任 | アプリケーション データベースにはデータは格納されません。 | Planner タスクを取得し、新しいタスクを追加するには、特定のユーザーのバケットとスイム ラインを更新します | a6f5c2f4-0bc2-48bf-8afe-6c93583a152b |
>| User.ReadBasic.All | 委任 | アプリケーション データベースにはデータは格納されません。 | アクセス許可を確認し、プランナー タスクを取得し、特定のユーザーのバケットとスイム ラインを更新する新しいタスクを追加する | a6f5c2f4-0bc2-48bf-8afe-6c93583a152b |
>| profile | 委任 | アプリケーション データベースにはデータは格納されません。 | Planner タスクを取得し、新しいタスクを追加するには、特定のユーザーのバケットとスイム ラインを更新します | a6f5c2f4-0bc2-48bf-8afe-6c93583a152b |
