---
title: テンプレート Chooser ブラウザーのアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 06/22/2021
ms.topic: article
...
description: Template Chooser Browser で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
---
# <a name="application-information-for-template-chooser-browser-by-officeatwork"></a>Officeatwork によるテンプレート Chooser Browser のアプリケーション情報

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 6 月 22 日</p>

* <a href="https://appsource.microsoft.com/product/web-apps/officeatwork-ag.template-chooser-browser" target="_blank">AppSource で表示する</a>
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Files.ReadWrite.All | 委任 | データは格納されません。 | お気に入り: OneDriveユーザーにデータを読み書きできるようにする。OneDrive: OneDriveユーザーに対してデータの読み取りと書き込みを行うことができる。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| Group.ReadWrite.All | 委任 | データは格納されません。 | Teams: グループに対してデータの読み取りと書き込みを行うことができる。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| GroupMember.Read.All | 委任 | データは格納されません。 | SharePoint Online: SharePoint Online からデータの読み取りを有効にするユーザーアクセス許可。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| Sites.Read.All | 委任 | データは格納されません。 | オンラインSharePoint: SharePoint Online からデータの読み取りを有効にします。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| User.Read | 委任 | データは格納されません。 | Sing-In: officeatwork アプリがユーザーの基本プロパティを読み取られるようにします。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| User.Read.All | 委任 | データは格納されません。 | Teams: ユーザーが属しているグループを確認します。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| offline_access | 委任 | データは格納されません。 | Sing-In: 更新トークンを使用して自動サインインを有効にするには、ユーザーが officeatwork アプリを起動するたびに手動でサインインする必要があります。 このスコープは、SSO が有効でないホスト アプリケーションでのみ必要です。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| openid | 委任 | データは格納されません。 | Sing-In: ユーザーが組織または Microsoft アカウントを使用して officeatwork アプリにサインインできるようにする | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
>| profile | 委任 | データは格納されません。 | Sing-In: Officeatwork アプリでサインインしているユーザーを表示します。 これにより、Officeatwork アプリへのサインインに使用されたアカウントをユーザーに保証/確認できます。 | dae2eacf-3eb5-4440-baff-984fbd5cae68 |
