...
description: Designer で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "65225301"
---
# <a name="application-information-for-designer-by-officeatwork"></a>Officeatwork による Designer のアプリケーション情報

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 6 月 23 日</p>

* [AppSource で表示する](https://appsource.microsoft.com/product/web-apps/officeatwork-ag.designer)
...
>|:----------------|:--------------------|:---------------------------------------------------|:--------------------------|:--------------------------|
>| Contacts.Read | 委任 | データは格納されません。 | 連絡先: サインインしているユーザーのすべての連絡先の読み取りを有効にします。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Files.Read | 委任 | データは格納されません。 | OneDrive - ファイル (コンテンツ): サインインしているユーザーのファイルの読み取りを有効にします。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Files.Read.All | 委任 | データは格納されません。 | Teams - ファイル (コンテンツ): サインインしているユーザーのすべてのファイルの読み取りを有効にします。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Group.Read.All | 委任 | データは格納されません。 | Office 365 ユーザー - グループに制限: サインインしているユーザーのすべてのグループの読み取りを有効にします。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| Sites.Read.All | 委任 | データは格納されません。 | オンラインSharePoint: SharePoint Online からデータの読み取りを有効にします。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| User.Read | 委任 | データは格納されません。 | Sing-In: officeatwork アプリがユーザーの基本プロパティを読み取られるようにします。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| User.Read.All | 委任 | データは格納されません。 | Office 365 ユーザー - すべてのプロパティ: すべてのユーザーのすべてのプロパティの読み取りを有効にします。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| User.ReadBasic.All | 委任 | データは格納されません。 | Office 365 ユーザー - 基本プロパティ: すべてのユーザーの基本プロパティの読み取りを有効にする | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| offline_access | 委任 | データは格納されません。 | Sing-In: 更新トークンを使用して自動サインインを有効にするには、ユーザーが officeatwork アプリを起動するたびに手動でサインインする必要があります。 このスコープは、SSO が有効でないホスト アプリケーションでのみ必要です。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| openid | 委任 | データは格納されません。 | Sing-In: ユーザーが組織または Microsoft アカウントを使用して officeatwork アプリにサインインできるようにする | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
>| profile | 委任 | データは格納されません。 | Sing-In: Officeatwork アプリでサインインしているユーザーを表示します。 これにより、Officeatwork アプリへのサインインに使用されたアカウントをユーザーに保証/確認できます。 | 0c67871c-ffbc-4b37-bd61-afce12b299f9 |
...
<iframe height='1020' title='Microsoft Cloud App Security情報' src='https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749' frameborder='0'></iframe>

[タブで表示](https://appmcasinfoprod.azurewebsites.net/#/dashboard/35749){:target="_blank"}
