---
title: SharePointSapiens SharePoint|sapiens モダン ユーザー インターフェイスのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/31/2022
...
description: SharePoint|sapiens モダン ユーザー インターフェイス、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
---
# <a name="sharepointsapiens-modern-user-interface"></a>SharePoint|sapiens モダン ユーザー インターフェイス

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 30 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003529" target="_blank">AppSource での表示</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | SharePoint-sapiens モダン ユーザー インターフェイス |
| ID | WA200003529 |
...
| アプリのコア機能 | このアプリは、アプリと組み合わせて使用する必要SharePoint|sapiens イベント管理アプリ (WA104380834) または SharePoint|sapiens Employee Training Management アプリ (WA104380833)。  このアプリは直感的なユーザー インターフェイスを提供し、SharePoint でイベント、トピック、コース、カリキュラムを作成および管理したり、ユーザーを登録したり、登録したり、すべての出席者、割り当て、実績を追跡することができます。 |
| 会社の本社所在地 | オーストリア |
| アプリ情報ページ | |
