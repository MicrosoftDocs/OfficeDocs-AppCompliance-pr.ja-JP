...
description: Power BI Collaboration の利用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報。
...
| アプリの利用規約 | [https://www.ataira.com/TermsofUse](https://www.ataira.com/TermsofUse) |
| アプリのコア機能 | Ataira アドインを使用すると、ダッシュボードとレポートPower BIを表示できます。 企業グループやチームに通知を送信し、フォローアップ アクションを追加し、Power BI パブリック リンクを埋め込み、レポートのデータ ポイントにコメントを追加し、データ ファイルをデータ ソースとして Power BI レポートに追加し、リアルタイムで更新します。 ビジネス インテリジェンス チームが 1 つの場所でビジネス インテリジェンスの取り組みについてより緊密に共同作業を行うのを許可します。 |
| 会社の本社所在地 | アメリカ |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.Read | 委任 | ChannelMessage.Send Team.ReadBasic.All User.Read のアクセス許可。 これらは、ユーザーが通知のグループとチャネルTeamsを選択できるようにするために使用されます。 | [00738e07-f9a4-4bf5-b6f9-851ec7ea31d5](../azure/00738e07-f9a4-4bf5-b6f9-851ec7ea31d5.md) |
