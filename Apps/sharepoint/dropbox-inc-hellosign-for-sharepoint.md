...
description: SharePoint の HelloSign、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関する利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
microsoft に Dropboxによって提供される情報:
...
| パートナー会社名 | Dropbox株式会社 |
| 会社の Web サイト | [https://hellosign.com](https://hellosign.com) |
| アプリの利用規約 | [https://hellosign.com/terms](https://hellosign.com/terms) |
| アプリのコア機能 | HelloSign&#8217;のデジタル ワークフロー プラットフォーム &#8211; には、eSignature、デジタル ワークフロー、および電子 FAX ソリューション &#8212; が含まれています。これにより、80,000 人以上の顧客と数百万人のユーザーが迅速にビジネスを行うことができます。 お客様が取引を迅速に終了し、新入社員を簡単にオンボードし、エラーのないドキュメントを完成し、さらに多くの情報を得るお手伝いをします。 |
| 会社の本社所在地 | アメリカ |
...
| データベースに格納されているデータは何ですか? | テナント ID、サイト ID、メール、ドライブ ID、ドライブ アイテム ID |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Files.ReadWrite.All | アプリケーション | 電子署名されたファイルを電子署名済みファイルにアップロードSharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
>| Sites.ReadWrite.All | アプリケーション | 電子署名されたファイルを電子署名済みファイルにアップロードSharePoint | [6fcff87e-0f86-49c3-81eb-bc028d1ccfe6](../azure/6fcff87e-0f86-49c3-81eb-bc028d1ccfe6.md) |
