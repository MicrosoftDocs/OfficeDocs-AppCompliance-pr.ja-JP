---
title: ビヨンド テクノロジによる Bid Management System のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/03/2022
...
description: 入札管理システム、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
---
# <a name="bid-management-system"></a>Bid Management System

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 11 月 16 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001787" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Beyond Technologies から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Bid Management System |
| ID | WA200001787 |
| Office 365サポートされているクライアント | SharePoint 2013 以降 |
| パートナー会社名 | Beyond Technologies |
| 会社の Web サイト | [https://www.beyondintranet.com](https://www.beyondintranet.com) |
| アプリの利用規約 | [https://www.beyondintranet.com/eula](https://www.beyondintranet.com/eula) |
| アプリのコア機能 | 入札SharePointをデジタル化する、提案管理/入札管理ソフトウェアを搭載したソフトウェアです。 |
| 会社の本社所在地 | アメリカ |
| アプリ情報ページ | [https://www.beyondintranet.com/bid-management-software](https://www.beyondintranet.com/bid-management-software) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Beyond Technologies によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザーの電子メールとSharePointサイトの URL |
...
| プライバシー ポリシーの URL | https://www.beyondintranet.com/privacypolicy |
