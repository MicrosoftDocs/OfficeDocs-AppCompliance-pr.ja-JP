...
description: Konnect eMail Parser で使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64877344"
---
# <a name="konnect-email-parser"></a>Konnect eMail Parser

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 2 月 1 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001893" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Konnect eMail から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Konnect eMail Parser |
| ID | WA200001893 |
| サポートされているOffice 365 クライアント | SharePoint 2016 以降 |
| パートナー会社名 | Konnect eMail |
| 会社の Web サイト | [https://www.konnectemail.com](https://www.konnectemail.com) |
| アプリの使用条件 | [https://www.konnectemail.com/eula](https://www.konnectemail.com/eula) |
| アプリのコア機能 | 電子メール属性をメタデータとして自動的にキャプチャします。 |
| 会社の本社の場所 | オーストラリア |
| アプリ情報ページ | [https://www.konnectemail.com/sharepoint-email-management](https://www.konnectemail.com/sharepoint-email-management) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関する Konnect eMail によって提供されています。

| **Information** | **応答** |
|:----------------|:-------------|
| アプリまたは基になるインフラストラクチャは、Microsoft のお客様またはデバイスに関連するデータを処理しますか? | はい |
| アプリによって処理されるデータは何ですか? | ユーザー メール データ |
