...
Accuracy Software Inc. から Microsoft に提供される情報:
...
| パートナー会社名 | Accuracy Software Inc. |
| 会社の Web サイト | [https://accuracysoftware.ca](https://accuracysoftware.ca) |
| アプリの利用規約 | [https://accuracysoftware.ca/taxonomy-terms-of-service](https://accuracysoftware.ca/taxonomy-terms-of-service) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つ制御に関して、Accuracy Software Inc.によって提供されています。
...
| パッチの適用に関するサービス レベル契約 (SLA) を管理するポリシーはありますか? | なし |
...
| 変更要求が運用に展開される前に、変更要求を確認および承認するために使用される、確立された変更管理プロセスがありますか? | なし |
