...
description: officeatwork サービスで使用可能なすべてのセキュリティおよびコンプライアンス情報|CSA STAR レジストリSharePoint、データ処理ポリシー、アプリ カタログ情報Microsoft Cloud App Security、セキュリティ/コンプライアンス情報のテンプレート選択機能。
