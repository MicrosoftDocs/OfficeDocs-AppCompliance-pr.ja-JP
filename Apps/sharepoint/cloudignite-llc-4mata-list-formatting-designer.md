---
title: 4Mata のアプリケーション情報 - CLOUDIGNITE LLC による書式設定デザイナーの一覧表示
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 05/31/2022
...
description: 4Mata で使用可能なすべてのセキュリティとコンプライアンス情報 - 書式設定デザイナー、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報を一覧表示します。
...
---
# <a name="4mata---list-formatting-designer"></a>4Mata - リストの書式設定デザイナー

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 5 月 31 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200002892" target="_blank">AppSource で表示する</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

CLOUDIGNITE LLC から Microsoft に提供される情報:

| **Information** | **Response** |
|:----------------|:-------------|
| アプリ名 | 4Mata - リストの書式設定デザイナー |
| ID | WA200002892 |
| サポートされているOffice 365 クライアント | SharePoint 2016 以降 |
| パートナー会社名 | CLOUDIGNITE LLC |
| 会社の Web サイト | [https://4mata.com](https://4mata.com) |
| アプリの使用条件 | [https://docs.4mata.com/legal/terms-of-service](https://docs.4mata.com/legal/terms-of-service) |
| アプリのコア機能 | 4Mata by CloudIgnite は、企業がリストとフォームのデザインと書式設定を行ってデータSharePoint視覚化できるようにする一連のツールです。  このアプリケーションを使用すると、ユーザーは、ビジネス プロセスの要件と簡単に統合するために、レポート、請求書、製品の詳細の発行、連絡先情報の収集用に、高度にカスタマイズされた複雑なSharePointフォームとリストを直感的に構成できます。  |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://4mata.com](https://4mata.com) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて CLOUDIGNITE LLC によって提供されています。
