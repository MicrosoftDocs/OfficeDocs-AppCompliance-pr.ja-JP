---
title: Ichicraft Boardsのアプリケーション情報 - デジタル ワークプレース by ichicraft b.v.
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/25/2022
...
description: Ichicraft Boards で使用可能なすべてのセキュリティおよびコンプライアンス情報 - デジタル ワークプレース、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "63550295"
---
# <a name="ichicraft-boards---your-digital-workplace"></a>Ichicraft Boards - デジタル ワークプレース

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 9 月 24 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001990" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

ichicraft b.v によって提供される情報。 Microsoft に:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Ichicraft Boards - デジタル ワークプレース |
| ID | WA200001990 |
| Office 365サポートされているクライアント | SharePoint 2016 以降 |
| パートナー会社名 | ichicraft b.v. |
| 会社の Web サイト | [https://ichicraft.com](https://ichicraft.com) |
| アプリの利用規約 | [https://ichicraft.com/terms/](https://ichicraft.com/terms/) |
| アプリのコア機能 | 最も包括的で使いやすい個人のデジタルワークプレース。  |
| 会社の本社所在地 | オランダ (the) |
| アプリ情報ページ | [https://ichicraft.com](https://ichicraft.com) |
...
この情報は、ichicraft b.v によって提供されています。 このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールについて。
...
| プライバシー ポリシーの URL | https://ichicraft.com/privacy |
