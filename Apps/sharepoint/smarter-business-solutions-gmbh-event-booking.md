---
title: よりスマートなビジネス ソリューション GmbH による、よりスマートなイベント予約のためのアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 10/14/2021
...
description: Smarter Event Booking に使用可能なすべてのセキュリティ情報とコンプライアンス情報、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
ms.locfileid: "64876534"
---
# <a name="smarter-event-booking"></a>よりスマートなイベントの予約

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 7 月 20 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200003125" target="_blank">AppSource で表示する</a>
...
| パートナー会社名 | よりスマートなビジネス ソリューション GmbH |
| 会社の Web サイト | [https://smarterbusiness.at](https://smarterbusiness.at) |
| アプリの使用条件 | [https://www.smarterbusiness.at/en/terms-of-use-for-smarter-...](https://www.smarterbusiness.at/en/terms-of-use-for-smarter-event-booking) |
| アプリのコア機能 | Smarter Event Booking を使用すると、Microsoft365 ユーザーは以前に作成したイベントにサインアップできます。 |
| 会社の本社の場所 | オーストリア |
| アプリ情報ページ | [https://www.smarterbusiness.at/en/smarter-event-booking](https://www.smarterbusiness.at/en/smarter-event-booking) |
...
この情報は、このアプリが組織のデータを収集して保存する方法と、アプリが収集するデータに対して組織が持つ制御について、Smarter Business Solutions GmbH から提供されています。
