...
| アプリの利用規約 | [https://www.smarterbusiness.at/en/terms-of-use-for-smarter-...](https://www.smarterbusiness.at/en/terms-of-use-for-smarter-event-booking) |
| アプリのコア機能 | よりスマートなイベント予約を使用すると、Microsoft365 ユーザーは以前に作成したイベントにサインアップできます。 |
| 会社の本社所在地 | オーストリア |
