---
title: SharePointSapiens による SharePoint|sapiens 従業員トレーニング管理のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: SharePoint|sapiens Employee Training Management、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA104380833" target="_blank">AppSource での表示</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | SharePoint-sapiens 従業員トレーニング管理 |
| ID | WA104380833 |
...
| アプリのコア機能 | 従業員トレーニング管理アドインを使用すると、従業員の継続的な専門的な開発を誰でも簡単に整理および管理できます。 トレーニング イベントの設定とスケジュール設定、学習者とその割り当てと登録の管理、実績とフィードバックの追跡まで、すべてが対象となります。 このアドインは、コンプライアンス規制と安全ポリシーを満たすのに役立ちます。 これにより、必要なトレーニングを割り当て、実績を追跡し、有効期限を管理できます。 |
| 会社の本社所在地 | オーストリア |
| アプリ情報ページ | [https://www.sharepointsapiens.com/employee-training-managem...](https://www.sharepointsapiens.com/employee-training-management-office365/) |
