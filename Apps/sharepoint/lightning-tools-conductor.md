---
title: Lightning Tools による Lightning Tools Lightning の導線のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 09/29/2021
...
description: Lightning Tools Lightning の指揮者、データ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
ms.locfileid: "64881034"
---
# <a name="lightning-tools-lightning-conductor"></a>Lightning Tools Lightning の指揮者

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2021 年 7 月 12 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA200001926" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Lightning Tools Lightning の指揮者 |
| ID | WA200001926 |
| サポートされているOffice 365 クライアント | SharePoint 2016 以降 |
| パートナー会社名 | Lightning ツール |
| 会社の Web サイト | [https://lightningtools.com](https://lightningtools.com) |
| アプリの使用条件 | [https://lightningtools.com/lightning-tools-lightning-conduc...](https://lightningtools.com/lightning-tools-lightning-conductor-client-side-web-part-software-license-agreement) |
| アプリのコア機能 | SharePointおよびTeams用のSharePoint リストと Microsoft Graph コンテンツ集計およびレポート ツール |
| 会社の本社の場所 | 英国の英国と北アイルランド (the) |
| アプリ情報ページ | [https://lightningtools.com/product/lightning-conductor-clie...](https://lightningtools.com/product/lightning-conductor-client-side-web-part/) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Lightning Tools によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Calendars.Read | アプリケーション | 予定表情報に関するクエリとレポートを作成するには | [a96cbd10-e960-47b8-855b-3af4b5dbd6f4](../azure/a96cbd10-e960-47b8-855b-3af4b5dbd6f4.md) |
>| Contacts.Read | アプリケーション | データは収集または保存されません。 データは、現在のユーザーの連絡先の DisplayName を表示するために使用されます | [a96cbd10-e960-47b8-855b-3af4b5dbd6f4](../azure/a96cbd10-e960-47b8-855b-3af4b5dbd6f4.md) |
>| Directory.Read.All | アプリケーション | Lightning の導線にユーザーを表示する | [a96cbd10-e960-47b8-855b-3af4b5dbd6f4](../azure/a96cbd10-e960-47b8-855b-3af4b5dbd6f4.md) |
>| Files.Read.All | アプリケーション | Lightning の導線にOneDriveファイルを表示する | [a96cbd10-e960-47b8-855b-3af4b5dbd6f4](../azure/a96cbd10-e960-47b8-855b-3af4b5dbd6f4.md) |
>| Mail.Read | アプリケーション | Lightning の指揮者のクエリに、現在のユーザー メールボックスからのメッセージが表示される場合 | [a96cbd10-e960-47b8-855b-3af4b5dbd6f4](../azure/a96cbd10-e960-47b8-855b-3af4b5dbd6f4.md) |
>| People.Read.All | アプリケーション | サイトのメンバーとしてユーザーにクエリを実行する場合に、Lightning の指揮者にユーザー ビューを表示するには。 | [a96cbd10-e960-47b8-855b-3af4b5dbd6f4](../azure/a96cbd10-e960-47b8-855b-3af4b5dbd6f4.md) |
>| Presence.Read.All | アプリケーション | People カードにユーザーのプレゼンスを表示するには | [a96cbd10-e960-47b8-855b-3af4b5dbd6f4](../azure/a96cbd10-e960-47b8-855b-3af4b5dbd6f4.md) |
>| Sites.Read.All | アプリケーション | Lightning の指揮者ツリービューでサイトを列挙するには | [a96cbd10-e960-47b8-855b-3af4b5dbd6f4](../azure/a96cbd10-e960-47b8-855b-3af4b5dbd6f4.md) |
