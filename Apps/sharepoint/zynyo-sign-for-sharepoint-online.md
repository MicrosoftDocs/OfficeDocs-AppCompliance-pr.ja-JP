---
title: Zynyo による Zynyo Sign for SharePoint Online のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 01/24/2022
...
description: Zynyo Sign for SharePoint Online で使用可能なすべてのセキュリティおよびコンプライアンス情報、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003673" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Zynyo から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Zynyo Sign for SharePoint Online |
| ID | WA200003673 |
| Office 365サポートされているクライアント | SharePoint 2016 以降 |
| パートナー会社名 | Zynyo |
| 会社の Web サイト | [https://zynyo.com](https://zynyo.com) |
| アプリの利用規約 | [https://zynyo.com/Algemene%20Voorwaarden%20Zynyo%20BV.pdf](https://zynyo.com/Algemene%20Voorwaarden%20Zynyo%20BV.pdf) |
| アプリのコア機能 | Alle documenten eenvoudig en rechtsgeldig digitaal laten ondertekenen. |
| 会社の本社所在地 | オランダ (the) |
| アプリ情報ページ | [https://zynyo.com/signing-service-diensten/sharepoint/](https://zynyo.com/signing-service-diensten/sharepoint/) |
...
この情報は、このアプリが組織データを収集および保存する方法と、アプリが収集するデータに対して組織が持つコントロールに関して Zynyo によって提供されています。
...
| データベースに格納されているデータは何ですか? | ユーザーが署名要求を送信すると、選択したドキュメントと入力したデータが保存され、これには名前、電子メール、電話番号などの顧客データが含まれます。 このデータは、既定で 30 日間、署名要求の有効期限が切れると削除されます。 |
...
| プライバシー ポリシーの URL | https://zynyo.com/Zynyo-Privacyverklaring.pdf |
