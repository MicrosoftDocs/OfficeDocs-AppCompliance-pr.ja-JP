---
title: SharePointSapiens SharePoint|sapiens イベント管理のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 03/23/2022
...
description: SharePoint|sapiens イベント管理、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、および CSA STAR レジストリのセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
ms.locfileid: "63778437"
---
# <a name="sharepointsapiens-event-management"></a>SharePoint|sapiens イベント管理

<p></p>
<img alt="Publisher Attestation: The information on this page is based on a self-assessment report provided by the app developer on the security, compliance, and data handling practices followed by this app. Microsoft makes no guarantees regarding the accuracy of the information." src="../media/attested.png" width="650" />
<p>開発者が最終更新日: 2022 年 3 月 22 日</p>

* <a href="https://appsource.microsoft.com/product/office/WA104380834" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

SharePointSapiens から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | SharePoint-sapiens イベント管理 |
| ID | WA104380834 |
| Office 365サポートされているクライアント | SharePoint 2016 以降 |
| パートナー会社名 | SharePointSapiens |
| 会社の Web サイト | [https://www.sharepointsapiens.com](https://www.sharepointsapiens.com) |
| アプリの利用規約 | [https://addins.sharepointsapiens.com/licensing/services-agr...](https://addins.sharepointsapiens.com/licensing/services-agreement.html) |
| アプリのコア機能 | イベント管理アドインは、さまざまな種類のイベントを整理するのに役立ちます。 イベントは、いくつかの簡単な手順で、時間がかからなくスケジュールできます。 参加者は、クリック 1 回でオンラインで登録できます。 オーガナイザーとして、内部または外部のユーザーを代理で登録したり、電子メールで招待状を送信したりできます。 参加者は、会議出席依頼と更新プログラムを電子メールで受け取り、会議の予定表に常に最新のOutlookします。 アドインは、すべての出席者を 1 か所で追跡します。 |
| 会社の本社所在地 | オーストリア |
| アプリ情報ページ | [https://www.sharepointsapiens.com/event-management-office36...](https://www.sharepointsapiens.com/event-management-office365/) |
...
この情報は、このアプリが組織データを収集して格納する方法と、アプリが収集するデータに対して組織が持つコントロールに関する SharePointSapiens によって提供されています。
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| User.ReadBasic.All | 委任 | 基本的なユーザー情報を読み取り、Exchangeを有効にする | [9e8e113c-8a08-4606-b08a-de4decc7252f](../azure/9e8e113c-8a08-4606-b08a-de4decc7252f.md) |
