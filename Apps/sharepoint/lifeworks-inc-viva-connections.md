---
title: Lifeworks 社による LifeWorks Viva Connections のアプリケーション情報
ms.author: elmalova
author: elenamalova
ms.date: 11/29/2021
ms.topic: article
...
description: LifeWorks Viva Connections、そのデータ処理ポリシー、Microsoft Cloud App Security アプリ カタログ情報、CSA STAR レジストリ内のセキュリティ/コンプライアンス情報に関して利用可能なすべてのセキュリティおよびコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA200003517" target="_blank">AppSource での表示</a>

::: zone pivot="general"

### <a name="general-information"></a>一般情報

Lifeworks Inc から Microsoft に提供される情報:

| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | LifeWorks Viva Connections |
| ID | WA200003517 |
| Office 365サポートされているクライアント | SharePoint 2016 以降 |
| パートナー会社名 | Lifeworks Inc |
| 会社の Web サイト | [https://www.lifeworks.com](https://www.lifeworks.com) |
| アプリの利用規約 | [https://help.lifeworks.com/hc/en-gb/articles/209973913-End-...](https://help.lifeworks.com/hc/en-gb/articles/209973913-End-User-Licence-Agreement) |
| アプリのコア機能 | ウェルビーコンテンツにアクセスし、ビバ接続から直接同僚を認識しましょう! |
| 会社の本社所在地 | カナダ |
| アプリ情報ページ | |
...
この情報は、このアプリが組織データを収集して保存する方法と、アプリが収集するデータに対して組織が持つコントロールについて、Lifeworks Inc.によって提供されています。
...
| プライバシー ポリシーの URL | https://help.lifeworks.com/hc/en-gb/articles/209973913-End-User-Licence-Agreement |
