---
title: Adobe Inc. による Adobe Acrobat Sign for Microsoft Office SharePoint Online のアプリケーション情報
ms.author: elmalova
author: elenamalova
manager: tonybal
ms.date: 02/23/2022
...
description: Adobe Acrobat Sign for Microsoft Office SharePoint Online、そのデータ処理ポリシー、Microsoft Cloud App Securityアプリ カタログ情報、CSA STAR レジストリのセキュリティ/コンプライアンス情報に関するすべての利用可能なセキュリティ情報とコンプライアンス情報。
...
* <a href="https://appsource.microsoft.com/product/office/WA104381012" target="_blank">AppSource で表示する</a>
...
| **Information** | **応答** |
|:----------------|:-------------|
| アプリ名 | Adobe Acrobat Sign for Microsoft Office SharePoint Online |
| ID | WA104381012 |
...
| アプリのコア機能 | Adobe Sign をTeamsに追加するときに、ドキュメント署名ワークフローを高速に移動します。 これで、Teamsで、ドキュメントに署名し、Microsoft の優先電子署名ソリューションを使用&#8212;法的に拘束力のある電子署名と承認のためにドキュメントを送信できます。 |
| 会社の本社の場所 | 米国 オブ アメリカ |
| アプリ情報ページ | [https://helpx.adobe.com/sign/using/microsoft-sharepoint-use...](https://helpx.adobe.com/sign/using/microsoft-sharepoint-user-guide.html) |
...
>|:------------------------|:--------------------|:------------------------------------|:--------------------|
>| Directory.Read.All | 委任 | ユーザー ロールを取得し、ユーザーにアプリケーション機能の特定のアクセス許可が付与されているかどうかを検証する。 | [99a3ad8d-8682-4f2a-9c2c-b4b27e99585c](../azure/99a3ad8d-8682-4f2a-9c2c-b4b27e99585c.md) |
